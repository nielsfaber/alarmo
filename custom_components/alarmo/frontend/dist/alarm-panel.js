!function (e) {
  ...
  function a(e, a, t, i) {
    var s,
        n = arguments.length,
        r = n < 3 ? a : null === i ? i = Object.getOwnPropertyDescriptor(a, t) : i;
    if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) r = Reflect.decorate(e, a, t, i);else for (var o = e.length - 1; o >= 0; o--) (s = e[o]) && (r = (n < 3 ? s(r) : n > 3 ? s(a, t, r) : s(a, t)) || r);
    return n > 3 && r && Object.defineProperty(a, t, r), r;
    /**
         * @license
  ...
  class n {
    constructor(e, a) {
      if (this._$cssResult$ = !0, a !== i) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
      this.cssText = e;
    }

    get styleSheet() {
      let e = s.get(this.cssText);
      return t && void 0 === e && (s.set(this.cssText, e = new CSSStyleSheet()), e.replaceSync(this.cssText)), e;
    }
  ...
  const r = e => new n("string" == typeof e ? e : e + "", i),
        o = (e, ...a) => {
    const t = 1 === e.length ? e[0] : a.reduce((a, t, i) => a + (e => {
    ...
    return new n(t, i);
        ...
        d = (e, a) => {
    t ? e.adoptedStyleSheets = a.map(e => e instanceof CSSStyleSheet ? e : e.styleSheet) : a.forEach(a => {
      const t = document.createElement("style"),
            i = window.litNonce;
      void 0 !== i && t.setAttribute("nonce", i), t.textContent = a.cssText, e.appendChild(t);
    });
  },
        l = t ? e => e : e => e instanceof CSSStyleSheet ? (e => {
    let a = "";
  ...
  class g extends HTMLElement {
    ...
    static addInitializer(e) {
      var a;
      null !== (a = this.l) && void 0 !== a || (this.l = []), this.l.push(e);
    }
    ...
    static get observedAttributes() {
      ...
      return this.elementProperties.forEach((a, t) => {
        const i = this._$Eh(t, a);

        void 0 !== i && (this._$Eu.set(i, t), e.push(i));
      }), e;
    }

    static createProperty(e, a = p) {
      if (a.state && (a.attribute = !1), this.finalize(), this.elementProperties.set(e, a), !a.noAccessor && !this.prototype.hasOwnProperty(e)) {
        const t = "symbol" == typeof e ? Symbol() : "__" + e,
              i = this.getPropertyDescriptor(e, t, a);
    ...
    static getPropertyDescriptor(e, a, t) {
      return {
        ...
        set(i) {
          const s = this[e];
          this[a] = i, this.requestUpdate(e, s, t);
        },
    ...
    static finalize() {
      ...
      if (e.finalize(), this.elementProperties = new Map(e.elementProperties), this._$Eu = new Map(), this.hasOwnProperty("properties")) {
        const e = this.properties,
              a = [...Object.getOwnPropertyNames(e), ...Object.getOwnPropertySymbols(e)];
    ...
    static finalizeStyles(e) {
      ...
      if (Array.isArray(e)) {
        ...
        for (const e of t) a.unshift(l(e));
      } else void 0 !== e && a.push(l(e));
    ...
    o() {
      var e;
      this._$Ev = new Promise(e => this.enableUpdating = e), this._$AL = new Map(), this._$Ep(), this.requestUpdate(), null === (e = this.constructor.l) || void 0 === e || e.forEach(e => e(this));
    }

    addController(e) {
      var a, t;
      (null !== (a = this._$Em) && void 0 !== a ? a : this._$Em = []).push(e), void 0 !== this.renderRoot && this.isConnected && (null === (t = e.hostConnected) || void 0 === t || t.call(e));
    }

    removeController(e) {
      var a;
      null === (a = this._$Em) || void 0 === a || a.splice(this._$Em.indexOf(e) >>> 0, 1);
    }

    _$Ep() {
      this.constructor.elementProperties.forEach((e, a) => {
        this.hasOwnProperty(a) && (this._$Et.set(a, this[a]), delete this[a]);
      });
    }

    createRenderRoot() {
      var e;
      const a = null !== (e = this.shadowRoot) && void 0 !== e ? e : this.attachShadow(this.constructor.shadowRootOptions);
      return d(a, this.constructor.elementStyles), a;
    }

    connectedCallback() {
      var e;
      void 0 === this.renderRoot && (this.renderRoot = this.createRenderRoot()), this.enableUpdating(!0), null === (e = this._$Em) || void 0 === e || e.forEach(e => {
        var a;
        return null === (a = e.hostConnected) || void 0 === a ? void 0 : a.call(e);
      });
    }
    ...
    disconnectedCallback() {
      var e;
      null === (e = this._$Em) || void 0 === e || e.forEach(e => {
        var a;
        return null === (a = e.hostDisconnected) || void 0 === a ? void 0 : a.call(e);
      });
    }
    ...
    _$Eg(e, a, t = p) {
      ...
      const n = this.constructor._$Eh(e, t);

      if (void 0 !== n && !0 === t.reflect) {
        const r = (null !== (s = null === (i = t.converter) || void 0 === i ? void 0 : i.toAttribute) && void 0 !== s ? s : m.toAttribute)(a, t.type);
        this._$Ei = e, null == r ? this.removeAttribute(n) : this.setAttribute(n, r), this._$Ei = null;
      }
    }
    ...
    _$AK(e, a) {
      ...
      if (void 0 !== r && this._$Ei !== r) {
        const e = n.getPropertyOptions(r),
              o = e.converter,
              d = null !== (s = null !== (i = null === (t = o) || void 0 === t ? void 0 : t.fromAttribute) && void 0 !== i ? i : "function" == typeof o ? o : null) && void 0 !== s ? s : m.fromAttribute;
        this._$Ei = r, this[r] = d(a, e.type), this._$Ei = null;
      }
    }

    requestUpdate(e, a, t) {
      let i = !0;
      void 0 !== e && (((t = t || this.constructor.getPropertyOptions(e)).hasChanged || u)(this[e], a) ? (this._$AL.has(e) || this._$AL.set(e, a), !0 === t.reflect && this._$Ei !== e && (void 0 === this._$ES && (this._$ES = new Map()), this._$ES.set(e, t))) : i = !1), !this.isUpdatePending && i && (this._$Ev = this._$EC());
    }
    ...
    performUpdate() {
      ...
      this.hasUpdated, this._$Et && (this._$Et.forEach((e, a) => this[a] = e), this._$Et = void 0);
      let a = !1;
      const t = this._$AL;

      try {
        a = this.shouldUpdate(t), a ? (this.willUpdate(t), null === (e = this._$Em) || void 0 === e || e.forEach(e => {
          var a;
          return null === (a = e.hostUpdate) || void 0 === a ? void 0 : a.call(e);
    ...
    _$AE(e) {
      var a;
      null === (a = this._$Em) || void 0 === a || a.forEach(e => {
        var a;
        return null === (a = e.hostUpdated) || void 0 === a ? void 0 : a.call(e);
    ...
    update(e) {
      void 0 !== this._$ES && (this._$ES.forEach((e, a) => this._$Eg(a, this[a], e)), this._$ES = void 0), this._$EU();
    }
  ...
  var v;
  g.finalized = !0, g.elementProperties = new Map(), g.elementStyles = [], g.shadowRootOptions = {
    mode: "open"
  }, null == h || h({
    ReactiveElement: g
  }), (null !== (c = globalThis.reactiveElementVersions) && void 0 !== c ? c : globalThis.reactiveElementVersions = []).push("1.0.1");

  const _ = globalThis.trustedTypes,
        f = _ ? _.createPolicy("lit-html", {
    createHTML: e => e
  }) : void 0,
    ...
    for (let a = 0; a < t; a++) {
      ...
      for (; c < t.length && (r.lastIndex = c, d = r.exec(t), null !== d);) c = r.lastIndex, r === j ? "!--" === d[1] ? r = O : void 0 !== d[1] ? r = C : void 0 !== d[2] ? (E.test(d[2]) && (s = RegExp("</" + d[2], "g")), r = S) : void 0 !== d[3] && (r = S) : r === S ? ">" === d[0] ? (r = null != s ? s : j, l = -1) : void 0 === d[1] ? l = -2 : (l = r.lastIndex - d[2].length, o = d[1], r = void 0 === d[3] ? S : '"' === d[3] ? T : M) : r === T || r === M ? r = S : r === O || r === C ? r = j : (r = S, s = void 0);

      const h = r === S && e[a + 1].startsWith("/>") ? " " : "";
      n += r === j ? t + w : l >= 0 ? (i.push(o), t.slice(0, l) + "$lit$" + t.slice(l) + b + h) : t + b + (-2 === l ? (i.push(void 0), a) : h);
    }

    const o = n + (e[t] || "<?>") + (2 === a ? "</svg>" : "");
    return [void 0 !== f ? f.createHTML(o) : o, i];
  };
  ...
  class U {
    constructor({
      ...
      if (this.el = U.createElement(d, t), P.currentNode = this.el.content, 2 === a) {
        const e = this.el.content,
              a = e.firstChild;
        a.remove(), e.append(...a.childNodes);
      }

      for (; null !== (i = P.nextNode()) && o.length < r;) {
        if (1 === i.nodeType) {
          if (i.hasAttributes()) {
            const e = [];

            for (const a of i.getAttributeNames()) if (a.endsWith("$lit$") || a.startsWith(b)) {
              const t = l[n++];

              if (e.push(a), void 0 !== t) {
                const e = i.getAttribute(t.toLowerCase() + "$lit$").split(b),
                      a = /([.?@])?(.*)/.exec(t);
                o.push({
                  type: 1,
                  index: s,
            ...
            for (const a of e) i.removeAttribute(a);
          }
          ...
          if (E.test(i.tagName)) {
            ...
            if (a > 0) {
              ...
              for (let t = 0; t < a; t++) i.append(e[t], k()), P.nextNode(), o.push({
                type: 2,
                index: ++s
              });
        ...
        } else if (8 === i.nodeType) if (i.data === y) o.push({
          type: 2,
          index: s
        });else {
          let e = -1;

          for (; -1 !== (e = i.data.indexOf(b, e + 1));) o.push({
            type: 7,
            index: s
          }), e += b.length - 1;
        }
  ...
  function R(e, a, t = e, i) {
    var s, n, r, o;
    if (a === q) return a;
    let d = void 0 !== i ? null === (s = t._$Cl) || void 0 === s ? void 0 : s[i] : t._$Cu;
    const l = A(a) ? void 0 : a._$litDirective$;
    return (null == d ? void 0 : d.constructor) !== l && (null === (n = null == d ? void 0 : d._$AO) || void 0 === n || n.call(d, !1), void 0 === l ? d = void 0 : (d = new l(e), d._$AT(e, t, i)), void 0 !== i ? (null !== (r = (o = t)._$Cl) && void 0 !== r ? r : o._$Cl = [])[i] = d : t._$Cu = d), void 0 !== d && (a = R(e, d._$AS(e, a.values), d, i)), a;
  }

  class I {
    constructor(e, a) {
      this.v = [], this._$AN = void 0, this._$AD = e, this._$AM = a;
    }
    ...
    p(e) {
      ...
      const {
        ...
        parts: i
            ...
            s = (null !== (a = null == e ? void 0 : e.creationScope) && void 0 !== a ? a : $).importNode(t, !0);
      P.currentNode = s;
      let n = P.nextNode(),
          r = 0,
          o = 0,
      ...
      for (; void 0 !== d;) {
        if (r === d.index) {
          let a;
          2 === d.type ? a = new H(n, n.nextSibling, this, e) : 1 === d.type ? a = new d.ctor(n, d.name, d.strings, this, e) : 6 === d.type && (a = new B(n, this, e)), this.v.push(a), d = i[++o];
        }

        r !== (null == d ? void 0 : d.index) && (n = P.nextNode(), r++);
      }
    ...
    m(e) {
      ...
      for (const t of this.v) void 0 !== t && (void 0 !== t.strings ? (t._$AI(e, t, a), a += t.strings.length - 2) : t._$AI(e[a])), a++;
    }
  ...
  class H {
    constructor(e, a, t, i) {
      var s;
      this.type = 2, this._$AH = D, this._$AN = void 0, this._$AA = e, this._$AB = a, this._$AM = t, this.options = i, this._$Cg = null === (s = null == i ? void 0 : i.isConnected) || void 0 === s || s;
    }

    get _$AU() {
      var e, a;
      return null !== (a = null === (e = this._$AM) || void 0 === e ? void 0 : e._$AU) && void 0 !== a ? a : this._$Cg;
    }

    get parentNode() {
      let e = this._$AA.parentNode;
      const a = this._$AM;
      return void 0 !== a && 11 === e.nodeType && (e = a.parentNode), e;
    }
    ...
    _$AI(e, a = this) {
      e = R(this, e, a), A(e) ? e === D || null == e || "" === e ? (this._$AH !== D && this._$AR(), this._$AH = D) : e !== this._$AH && e !== q && this.$(e) : void 0 !== e._$litType$ ? this.T(e) : void 0 !== e.nodeType ? this.S(e) : (e => {
        var a;
        return x(e) || "function" == typeof (null === (a = e) || void 0 === a ? void 0 : a[Symbol.iterator]);
      })(e) ? this.M(e) : this.$(e);
    }
    ...
    $(e) {
      this._$AH !== D && A(this._$AH) ? this._$AA.nextSibling.data = e : this.S($.createTextNode(e)), this._$AH = e;
    }
    ...
    T(e) {
      ...
      const {
        ...
        _$litType$: i
            ...
            s = "number" == typeof i ? this._$AC(e) : (void 0 === i.el && (i.el = U.createElement(i.h, this.options)), i);
      if ((null === (a = this._$AH) || void 0 === a ? void 0 : a._$AD) === s) this._$AH.m(t);else {
        const e = new I(s, this),
              a = e.p(this.options);
        e.m(t), this.S(a), this._$AH = e;
      }
    }

    _$AC(e) {
      let a = N.get(e.strings);
      return void 0 === a && N.set(e.strings, a = new U(e)), a;
    }
    ...
    M(e) {
      ...
      for (const s of e) i === a.length ? a.push(t = new H(this.A(k()), this.A(k()), this, this.options)) : t = a[i], t._$AI(s), i++;
    ...
    _$AR(e = this._$AA.nextSibling, a) {
      ...
      for (null === (t = this._$AP) || void 0 === t || t.call(this, !1, !0, a); e && e !== this._$AB;) {
    ...
    setConnected(e) {
      var a;
      void 0 === this._$AM && (this._$Cg = e, null === (a = this._$AP) || void 0 === a || a.call(this, e));
    }

  }

  class F {
    constructor(e, a, t, i, s) {
      this.type = 1, this._$AH = D, this._$AN = void 0, this.element = e, this.name = a, this._$AM = i, this.options = s, t.length > 2 || "" !== t[0] || "" !== t[1] ? (this._$AH = Array(t.length - 1).fill(new String()), this.strings = t) : this._$AH = D;
    }
    ...
    _$AI(e, a = this, t, i) {
      ...
      let n = !1;
      if (void 0 === s) e = R(this, e, a, 0), n = !A(e) || e !== this._$AH && e !== q, n && (this._$AH = e);else {
        const i = e;
        let r, o;

        for (e = s[0], r = 0; r < s.length - 1; r++) o = R(this, i[t + r], a, r), o === q && (o = this._$AH[r]), n || (n = !A(o) || o !== this._$AH[r]), o === D ? e = D : e !== D && (e += (null != o ? o : "") + s[r + 1]), this._$AH[r] = o;
      }
      n && !i && this.k(e);
    }
  ...
  class Y extends F {
    ...
    k(e) {
      e && e !== D ? this.element.setAttribute(this.name, "") : this.element.removeAttribute(this.name);
    }
  ...
  class V extends F {
    constructor(e, a, t, i, s) {
      super(e, a, t, i, s), this.type = 5;
    }

    _$AI(e, a = this) {
      var t;
      if ((e = null !== (t = R(this, e, a, 0)) && void 0 !== t ? t : D) === q) return;
      const i = this._$AH,
    ...
    handleEvent(e) {
      var a, t;
      "function" == typeof this._$AH ? this._$AH.call(null !== (t = null === (a = this.options) || void 0 === a ? void 0 : a.host) && void 0 !== t ? t : this.element, e) : this._$AH.handleEvent(e);
    }
  ...
  var W, K;
  null == Q || Q(U, H), (null !== (v = globalThis.litHtmlVersions) && void 0 !== v ? v : globalThis.litHtmlVersions = []).push("2.0.1");
  ...
  class Z extends g {
    ...
    createRenderRoot() {
      ...
      return null !== (e = (a = this.renderOptions).renderBefore) && void 0 !== e || (a.renderBefore = t.firstChild), t;
    }

    update(e) {
      const a = this.render();
      this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Dt = ((e, a, t) => {
        var i, s;
        const n = null !== (i = null == t ? void 0 : t.renderBefore) && void 0 !== i ? i : a;
        let r = n._$litPart$;

        if (void 0 === r) {
          const e = null !== (s = null == t ? void 0 : t.renderBefore) && void 0 !== s ? s : null;
          n._$litPart$ = r = new H(a.insertBefore(k(), e), e, void 0, null != t ? t : {});
        }
  ...
  Z.finalized = !0, Z._$litElement$ = !0, null === (W = globalThis.litElementHydrateSupport) || void 0 === W || W.call(globalThis, {
    LitElement: Z
  });
  ...
  const X = e => a => "function" == typeof a ? ((e, a) => (window.customElements.define(e, a), a))(e, a) : ((e, a) => {
    const {
      kind: t,
      elements: i
    } = a;
    return {
      ...
      finisher(a) {
        window.customElements.define(e, a);
      }
  ...
  /**
       ...
       */
  ,
        ee = (e, a) => "method" === a.kind && a.descriptor && !("value" in a.descriptor) ? { ...a,

    finisher(t) {
      t.createProperty(a.key, e);
    }
  ...
  function ae(e) {
    return (a, t) => void 0 !== t ? ((e, a, t) => {
      a.constructor.createProperty(t, e);
    })(e, a, t) : ee(e, a);
    /**
         * @license
         * Copyright 2017 Google LLC
  ...
  var ie = /d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,
      se = "[^\\s]+",
      ne = /\[([^]*?)\]/gm;

  function re(e, a) {
    for (var t = [], i = 0, s = e.length; i < s; i++) t.push(e[i].substr(0, a));
  ...
  var le = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
    ...
    DoFn: function (e) {
      ...
      ue = de({}, me),
      pe = function (e, a) {
    for (void 0 === a && (a = 2), e = String(e); e.length < a;) e = "0" + e;
    ...
    ddd: function (e, a) {
      return a.dayNamesShort[e.getDay()];
    },
    dddd: function (e, a) {
      return a.dayNames[e.getDay()];
    },
    M: function (e) {
    ...
    MMM: function (e, a) {
      return a.monthNamesShort[e.getMonth()];
    },
    MMMM: function (e, a) {
      return a.monthNames[e.getMonth()];
    },
    YY: function (e) {
      return pe(String(e.getFullYear()), 4).substr(2);
    },
    YYYY: function (e) {
    ...
    SS: function (e) {
      return pe(Math.round(e.getMilliseconds() / 10), 2);
    },
    SSS: function (e) {
      return pe(e.getMilliseconds(), 3);
    },
    a: function (e, a) {
      return e.getHours() < 12 ? a.amPm[0] : a.amPm[1];
    },
    A: function (e, a) {
      return e.getHours() < 12 ? a.amPm[0].toUpperCase() : a.amPm[1].toUpperCase();
    },
    ZZ: function (e) {
      var a = e.getTimezoneOffset();
      return (a > 0 ? "-" : "+") + pe(100 * Math.floor(Math.abs(a) / 60) + Math.abs(a) % 60, 4);
    },
    Z: function (e) {
      var a = e.getTimezoneOffset();
      return (a > 0 ? "-" : "+") + pe(Math.floor(Math.abs(a) / 60), 2) + ":" + pe(Math.abs(a) % 60, 2);
    }
  },
      ve = function (e) {
    return +e - 1;
      ...
      _e = [null, "[1-9]\\d?"],
      fe = [null, se],
      be = ["isPm", se, function (e, a) {
    var t = e.toLowerCase();
    return t === a.amPm[0] ? 0 : t === a.amPm[1] ? 1 : null;
  }],
      ye = ["timezoneOffset", "[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?", function (e) {
    var a = (e + "").match(/([+-]|\d\d)/gi);

    if (a) {
      var t = 60 * +a[1] + parseInt(a[2], 10);
      return "+" === a[0] ? t : -t;
    }
  ...
  var $e,
      ke,
      Ae = function (e, a, t) {
    if (void 0 === a && (a = we.default), void 0 === t && (t = {}), "number" == typeof e && (e = new Date(e)), "[object Date]" !== Object.prototype.toString.call(e) || isNaN(e.getTime())) throw new Error("Invalid Date pass to format");
    var i = [];
    a = (a = we[a] || a).replace(ne, function (e, a) {
      return i.push(a), "@@@";
    });
    var s = de(de({}, ue), t);
    return (a = a.replace(ie, function (a) {
      return ge[a](e, s);
    })).replace(/@@@/g, function () {
      return i.shift();
    });
  ...
  function Se(e, a) {
    ...
    switch (e) {
      ...
      case "binary_sensor":
        return a && "off" === a ? "hass:radiobox-blank" : "hass:checkbox-marked-circle";

      case "cover":
        return "closed" === a ? "hass:window-closed" : "hass:window-open";

      case "lock":
        return a && "unlocked" === a ? "hass:lock-open" : "hass:lock";

      case "media_player":
        return a && "off" !== a && "idle" !== a ? "hass:cast-connected" : "hass:cast";
      ...
      default:
        return console.warn("Unable to find icon for domain " + e + " (" + a + ")"), "hass:bookmark";
    }
  }

  var Me = function (e, a, t) {
    void 0 === t && (t = !1), t ? history.replaceState(null, "", a) : history.pushState(null, "", a), Oe(window, "location-changed", {
      replace: t
    });
  },
      Te = {
    ...
    binary_sensor: function (e) {
      var a = e.state && "off" === e.state;

      switch (e.attributes.device_class) {
        case "battery":
          return a ? "hass:battery" : "hass:battery-outline";

        case "cold":
          return a ? "hass:thermometer" : "hass:snowflake";

        case "connectivity":
          return a ? "hass:server-network-off" : "hass:server-network";

        case "door":
          return a ? "hass:door-closed" : "hass:door-open";

        case "garage_door":
          return a ? "hass:garage" : "hass:garage-open";
        ...
        case "safety":
        case "smoke":
          return a ? "hass:shield-check" : "hass:alert";

        case "heat":
          return a ? "hass:thermometer" : "hass:fire";

        case "light":
          return a ? "hass:brightness-5" : "hass:brightness-7";

        case "lock":
          return a ? "hass:lock" : "hass:lock-open";

        case "moisture":
          return a ? "hass:water-off" : "hass:water";

        case "motion":
          return a ? "hass:walk" : "hass:run";

        case "occupancy":
          return a ? "hass:home-outline" : "hass:home";

        case "opening":
          return a ? "hass:square" : "hass:square-outline";

        case "plug":
          return a ? "hass:power-plug-off" : "hass:power-plug";

        case "presence":
          return a ? "hass:home-outline" : "hass:home";

        case "sound":
          return a ? "hass:music-note-off" : "hass:music-note";

        case "vibration":
          return a ? "hass:crop-portrait" : "hass:vibrate";

        case "window":
          return a ? "hass:window-closed" : "hass:window-open";

        default:
          return a ? "hass:radiobox-blank" : "hass:checkbox-marked-circle";
      }
    },
    cover: function (e) {
      var a = "closed" !== e.state;

      switch (e.attributes.device_class) {
        case "garage":
          return a ? "hass:garage-open" : "hass:garage";

        case "door":
          return a ? "hass:door-open" : "hass:door-closed";

        case "shutter":
          return a ? "hass:window-shutter-open" : "hass:window-shutter";

        case "blind":
          return a ? "hass:blinds-open" : "hass:blinds";

        case "window":
          return a ? "hass:window-open" : "hass:window-closed";

        default:
          return Se("cover", e.state);
      }
    },
    sensor: function (e) {
      var a = e.attributes.device_class;
      if (a && a in Te) return Te[a];

      if ("battery" === a) {
        var t = Number(e.state);
      ...
      return "°C" === s || "°F" === s ? "hass:thermometer" : Se("sensor");
    },
    input_datetime: function (e) {
      return e.attributes.has_date ? e.attributes.has_time ? Se("input_datetime") : "hass:calendar" : "hass:clock";
    }
  };
  ...
  const ze = async () => {
    ...
    await a.routerOptions.routes.automation.load(), e.hass = {
      panels: [{
        url_path: "tmp",
        component_name: "developer-tools"
      }]
    }, e._updateRoutes(), await e.routerOptions.routes.tmp.load(), await customElements.whenDefined("ha-app-layout");
  },
        qe = o`
  ha-card {
    display: flex;
...
`;
  ...
  function _a(e, a, t = "", i = "") {
    const s = a.replace(/['"]+/g, "").replace("-", "_");
    var n;

    try {
      n = e.split(".").reduce((e, a) => e[a], va[s]);
    } catch (a) {
      n = e.split(".").reduce((e, a) => e[a], va.en);
    }

    if (void 0 === n && (n = e.split(".").reduce((e, a) => e[a], va.en)), "" !== t && "" !== i) {
      Array.isArray(t) || (t = [t]), Array.isArray(i) || (i = [i]);

      for (let e = 0; e < t.length; e++) n = n.replace(t[e], i[e]);
    }
  ...
  !function (e) {
    e.ArmedAway = "armed_away", e.ArmedHome = "armed_home", e.ArmedNight = "armed_night", e.ArmedCustom = "armed_custom_bypass";
  }(Ne || (Ne = {})), function (e) {
    e.Armed = "armed", e.Disarmed = "disarmed", e.Triggered = "triggered", e.ArmFailure = "arm_failure", e.Arming = "arming", e.Pending = "pending";
  }(Pe || (Pe = {}));
  ...
  const fa = e => e.callWS({
    ...
    type: "alarmo/sensor_groups"
        ...
        ka = (e, a) => e.callApi("POST", "alarmo/config", a),
        Aa = (e, a) => e.callApi("POST", "alarmo/sensors", a),
        xa = (e, a) => e.callApi("POST", "alarmo/automations", a),
        ja = (e, a) => e.callApi("POST", "alarmo/automations", {
    automation_id: a,
    remove: !0
  }),
        Oa = e => e.callWS({
    type: "alarmo/areas"
        ...
        Ca = (e, a) => e.callApi("POST", "alarmo/area", a);

  var Sa, Ma, Ta, Ea, za, qa;

  function Da(e) {
    return function (e) {
      if (!e) return "hass:bookmark";
      if (e.attributes.icon) return e.attributes.icon;
      var a = xe(e.entity_id);
      return a in Ee ? Ee[a](e) : Se(a, e.state);
    }(e);
  }
  ...
  function La(e) {
    let a = [];
    return e.forEach(e => {
      a.find(a => "object" == typeof e ? function (...e) {
        return e.every(a => JSON.stringify(a) === JSON.stringify(e[0]));
      }(a, e) : a === e) || a.push(e);
    }), a;
  }
  ...
  !function (e) {
    e.ArmedAway = "hass:car-traction-control", e.ArmedHome = "hass:home-outline", e.ArmedNight = "hass:weather-night", e.ArmedCustom = "hass:star-outline";
  }(Sa || (Sa = {})), function (e) {
    ...
    e.COMMAND_ALARM_DISARM = "disarm", e.COMMAND_ALARM_ARM_HOME = "arm_home", e.COMMAND_ALARM_ARM_AWAY = "arm_away", e.COMMAND_ALARM_ARM_NIGHT = "arm_night", e.COMMAND_ALARM_ARM_CUSTOM_BYPASS = "arm_custom_bypass";
  }(Ta || (Ta = {})), function (e) {
    e.Door = "door", e.Window = "window", e.Motion = "motion", e.Tamper = "tamper", e.Environmental = "environmental", e.Other = "other";
  }(Ea || (Ea = {})), function (e) {
    e.Door = "hass:door-closed", e.Window = "hass:window-closed", e.Motion = "hass:motion-sensor", e.Tamper = "hass:vibrate", e.Environmental = "hass:fire", e.Other = "hass:contactless-payment-circle-outline";
  }(za || (za = {})), function (e) {
    e.Notification = "notification", e.Action = "action";
  }(qa || (qa = {}));
  ...
  const Ra = (e, ...a) => {
    ...
    for (i in e) a.includes(i) || (t[i] = e[i]);
  ...
  function Ha(e, a) {
    ...
    for (const i of t) if ("object" == typeof e[i] && "object" == typeof a[i]) {
      if (!Ha(e[i], a[i])) return !1;
    } else if (e[i] !== a[i]) return !1;
  ...
  const Ya = (e, a) => {
    ...
    switch (e) {
      case Ma.STATE_ALARM_ARMED_AWAY:
        return a[Ne.ArmedAway].enabled;

      case Ma.STATE_ALARM_ARMED_HOME:
        return a[Ne.ArmedHome].enabled;

      case Ma.STATE_ALARM_ARMED_NIGHT:
        return a[Ne.ArmedNight].enabled;

      case Ma.STATE_ALARM_ARMED_CUSTOM_BYPASS:
        return a[Ne.ArmedCustom].enabled;
  ...
  function Va(e, a) {
    return Object.entries(a).forEach(([a, t]) => {
      e = a in e && "object" == typeof e[a] && null !== e[a] ? Object.assign(Object.assign({}, e), {
        [a]: Va(e[a], t)
  ...
  function Ba(e, a) {
    const t = e => "object" == typeof e ? t(e.name) : e.trim().toLowerCase();
  ...
  let Wa = class extends Z {
    constructor() {
      super(...arguments), this.min = 0, this.max = 100, this.step = 10, this.value = 0, this.scaleFactor = 1, this.unit = "", this.disabled = !1;
    }

    firstUpdated() {
      this.value > 0 && this.value < 60 && (this.unit = "sec"), "min" == this.unit && (this.scaleFactor = 1 / 60), "min" == this.unit && (this.step = 1);
    }
    ...
    getValue() {
      const e = Number(Math.round(this.value * this.scaleFactor));
      return !e && this.zeroValue ? this.zeroValue : `${e} ${this.getUnit()}`;
    }

    getUnit() {
      switch (this.unit) {
        case "sec":
          return _a("components.time_slider.seconds", this.hass.language);

        case "min":
          return _a("components.time_slider.minutes", this.hass.language);
    ...
    updateValue(e) {
      ...
      this.value = Math.round(a / this.scaleFactor);
    }

    toggleUnit() {
      this.unit = "min" == this.unit ? "sec" : "min", this.scaleFactor = "min" == this.unit ? 1 / 60 : 1, this.step = "min" == this.unit ? 1 : 10;
    }
  ...
  `, a([ae({
    type: Number
  })], Wa.prototype, "min", void 0), a([ae({
    type: Number
  })], Wa.prototype, "max", void 0), a([ae({
    type: Number
  })], Wa.prototype, "step", void 0), a([ae({
    type: Number
  })], Wa.prototype, "value", void 0), a([ae()], Wa.prototype, "scaleFactor", void 0), a([ae({
    type: String
  })], Wa.prototype, "unit", void 0), a([ae({
    type: Boolean
  })], Wa.prototype, "disabled", void 0), a([ae({
    type: String
  })], Wa.prototype, "zeroValue", void 0), Wa = a([X("time-slider")], Wa);
  let Ka = class extends Z {
    constructor() {
      super(...arguments), this.label = "", this.items = [], this.clearable = !1, this.icons = !1, this.disabled = !1, this.invalid = !1, this.rowRenderer = (e, a, t) => {
        !e.firstElementChild && this.icons ? e.innerHTML = '\n        <style>\n          paper-icon-item {\n              margin: -10px;\n              padding: 0;\n          }\n          ha-icon {\n              display: flex;\n              flex: 0 0 40px;\n              color: var(--state-icon-color);\n          }\n          :host([selected]) paper-icon-item {\n            margin-left: 24px;\n          }\n        </style>\n        <paper-icon-item>\n          <ha-icon icon="" slot="item-icon"></ha-icon>\n          <paper-item-body two-line>\n            <div class="name"></div>\n            <div secondary></div>\n          </paper-item-body>\n        </paper-icon-item>\n        ' : e.firstElementChild || (e.innerHTML = '\n        <style>\n          paper-item {\n              margin: -10px;\n              padding: 0;\n          }\n          :host([selected]) paper-item {\n            margin-left: 24px;\n          }\n        </style>\n        <paper-item>\n          <paper-item-body two-line>\n            <div class="name"></div>\n            <div secondary></div>\n          </paper-item-body>\n        </paper-item>\n        '), e.querySelector(".name").textContent = t.item.name, e.querySelector("[secondary]").textContent = t.item.description || "", this.icons && (e.querySelector("ha-icon").icon = t.item.icon);
      };
    }
    ...
    open() {
      this.updateComplete.then(() => {
        var e, a;
        null === (a = null === (e = this.shadowRoot) || void 0 === e ? void 0 : e.querySelector("vaadin-combo-box-light")) || void 0 === a || a.open();
      });
    }
    ...
    focus() {
      this.updateComplete.then(() => {
        var e;
        (null === (e = this.shadowRoot) || void 0 === e ? void 0 : e.querySelector("paper-input")).focus();
      });
    }

    shouldUpdate(e) {
      if (e.get("items")) if (Ha(this.items, e.get("items"))) {
        if (1 == e.size) return !1;
      } else this.firstUpdated();
      return !0;
    }
    ...
    render() {
      ...
      >
        ...
        >
          ${Ia(this._value) && this.items.find(e => e.value == this._value) ? z`
                ${this.icons ? z`
    ...
    _clearValue(e) {
      e.stopPropagation(), this._setValue("");
    }

    get _value() {
      return Ia(this.value) ? this.value : "";
    }
    ...
    _valueChanged(e) {
      ...
      a !== this._value && this._setValue(a);
    }

    _setValue(e) {
      this.value = e, setTimeout(() => {
        Oe(this, "value-changed", {
          value: e
        });
      }, 0);
    }
  ...
  a([ae({
    attribute: !1
  })], Ka.prototype, "hass", void 0), a([ae()], Ka.prototype, "label", void 0), a([ae()], Ka.prototype, "value", void 0), a([ae()], Ka.prototype, "items", void 0), a([ae()], Ka.prototype, "clearable", void 0), a([ae()], Ka.prototype, "icons", void 0), a([ae({
    type: Boolean
  })], Ka.prototype, "disabled", void 0), a([te()], Ka.prototype, "_opened", void 0), a([ae({
    attribute: "allow-custom-value",
    type: Boolean
  })], Ka.prototype, "allowCustomValue", void 0), a([ae({
    type: Boolean
  })], Ka.prototype, "invalid", void 0), a([
  /**
       * @license
       * Copyright 2017 Google LLC
       * SPDX-License-Identifier: BSD-3-Clause
  ...
  function (e, a) {
    return (({
      ...
      if (void 0 === i) {
        const i = null !== (s = t.originalKey) && void 0 !== s ? s : t.key,
              n = null != a ? {
          kind: "method",
          placement: "prototype",
          key: i,
        ...
        return null != e && (n.finisher = function (a) {
          e(a, i);
        }), n;
      }

      {
        ...
        void 0 !== a && Object.defineProperty(t, i, a(i)), null == e || e(s, i);
      }
    })({
      descriptor: t => {
        const i = {
          get() {
            var a, t;
            return null !== (t = null === (a = this.renderRoot) || void 0 === a ? void 0 : a.querySelector(e)) && void 0 !== t ? t : null;
          },
        ...
        if (a) {
          const a = "symbol" == typeof t ? Symbol() : "__" + t;

          i.get = function () {
            var t, i;
            return void 0 === this[a] && (this[a] = null !== (i = null === (t = this.renderRoot) || void 0 === t ? void 0 : t.querySelector(e)) && void 0 !== i ? i : null), this[a];
          };
        }
  ...
  }("vaadin-combo-box-light", !0)], Ka.prototype, "_comboBox", void 0), Ka = a([X("alarmo-select")], Ka);
  let Za = class extends Qa(Z) {
    constructor() {
      super(...arguments), this.currentTab = 0;
    }
    ...
    async _fetchData() {
      this.hass && (this.areas = await Oa(this.hass));
    }

    async firstUpdated() {
      this.areas = await Oa(this.hass), this.selectedArea = Object.keys(this.areas)[0], this.data = Object.assign({}, this.areas[this.selectedArea].modes);
    }

    render() {
      if (!this.data) return z``;
      const e = Object.values(Ne)[this.currentTab];
      return z`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${_a("panels.general.cards.modes.title", this.hass.language)}
          </div>

          ${Object.keys(this.areas).length > 1 ? z`
              <alarmo-select
        ...
        <div class="card-content">
          ${_a("panels.general.cards.modes.description", this.hass.language)}
        </div>
        ...
        >
          ${Object.entries(Ne).map(([e, a]) => z`
              <mwc-tab
                label="${_a("common.modes_short." + a, this.hass.language)}"
                hasImageIcon
                stacked
                class="${this.data[a].enabled ? "" : "disabled"}"
              >
                <ha-icon icon="${Sa[e]}" slot="icon"></ha-icon>
              </mwc-tab>
            `)}
        </mwc-tab-bar>

        <settings-row .narrow=${this.narrow} .large=${!0}>
          <span slot="heading">${_a("common.modes_long." + e, this.hass.language)}</span>
          <span slot="description"
            >${_a("panels.general.cards.modes.fields.mode." + e, this.hass.language)}</span
          >

          <div style="display: flex; margin: 10px 0px; justify-content: center; width: 100%">
            <mwc-button
              class="${this.data[e].enabled ? "active" : ""}"
              @click=${() => this.data = { ...this.data,
        [e]: { ...this.data[e],
          enabled: !0
        }
      }}
            >
              ${_a("panels.general.cards.modes.fields.mode.enabled", this.hass.language)}
            </mwc-button>
            <mwc-button
              class="${this.data[e].enabled ? "" : "active"}"
              @click=${() => this.data = { ...this.data,
        [e]: { ...this.data[e],
          enabled: !1
            ...
            >
              ${_a("panels.general.cards.modes.fields.mode.disabled", this.hass.language)}
            </mwc-button>
          </div>
        </settings-row>

        ${this.data[e].enabled ? z`
              <settings-row .narrow=${this.narrow}>
                <span slot="heading"
                  >${_a("panels.general.cards.modes.fields.exit_delay.heading", this.hass.language)}</span
                >
                <span slot="description"
                  >${_a("panels.general.cards.modes.fields.exit_delay.description", this.hass.language)}</span
                >
                <time-slider
                  .hass=${this.hass}
                  unit="sec"
                  max="180"
                  zeroValue=${_a("components.time_slider.none", this.hass.language)}
                  value=${this.data[e].exit_time || 0}
                  @change=${a => this.data = { ...this.data,
        [e]: { ...this.data[e],
          exit_time: Number(a.target.value)
        }
      }}
                >
                </time-slider>
              ...
              <settings-row .narrow=${this.narrow}>
                <span slot="heading"
                  >${_a("panels.general.cards.modes.fields.entry_delay.heading", this.hass.language)}</span
                >
                <span slot="description"
                  >${_a("panels.general.cards.modes.fields.entry_delay.description", this.hass.language)}</span
                >
                <time-slider
                  .hass=${this.hass}
                  unit="sec"
                  ...
                  @change=${a => this.data = { ...this.data,
        [e]: { ...this.data[e],
          entry_time: Number(a.target.value)
        }
      }}
                >
                </time-slider>
              ...
              <settings-row .narrow=${this.narrow}>
                <span slot="heading"
                  >${_a("panels.general.cards.modes.fields.trigger_time.heading", this.hass.language)}</span
                >
                <span slot="description"
                  >${_a("panels.general.cards.modes.fields.trigger_time.description", this.hass.language)}</span
                >
                <time-slider
                  .hass=${this.hass}
                  unit="min"
                  max="3600"
                  zeroValue=${_a("components.time_slider.infinite", this.hass.language)}
                  value=${this.data[e].trigger_time || 0}
                  @change=${a => this.data = { ...this.data,
        [e]: { ...this.data[e],
          trigger_time: Number(a.target.value)
        }
      }}
                >
                </time-slider>
  ...
  Za.styles = qe, a([ae()], Za.prototype, "hass", void 0), a([ae()], Za.prototype, "narrow", void 0), a([ae()], Za.prototype, "currentTab", void 0), a([ae()], Za.prototype, "config", void 0), a([ae()], Za.prototype, "areas", void 0), a([ae()], Za.prototype, "data", void 0), a([ae()], Za.prototype, "selectedArea", void 0), Za = a([X("alarm-mode-card")], Za);
  ...
  a([ae({
    type: Boolean,
    reflect: !0
  })], Ja.prototype, "narrow", void 0), a([ae({
    type: Boolean,
    reflect: !0
  })], Ja.prototype, "large", void 0), a([ae({
    type: Boolean,
    attribute: "three-line"
  })], Ja.prototype, "threeLine", void 0), a([ae({
    type: Boolean
  })], Ja.prototype, "nested", void 0), a([ae({
    type: Boolean
  })], Ja.prototype, "dialog", void 0), Ja = a([X("settings-row")], Ja);
  let Xa = class extends Z {
    constructor() {
  ...
  a([ae({
    type: Boolean,
    reflect: !0
  })], Xa.prototype, "narrow", void 0), a([ae()], Xa.prototype, "header", void 0), a([ae()], Xa.prototype, "open", void 0), Xa = a([X("collapsible-section")], Xa);
  let et = class extends Qa(Z) {
    constructor() {
      super(...arguments), this.areas = {};
    }
    ...
    async _fetchData() {
      if (!this.hass) return;
      const e = await fa(this.hass);
      this.config = e, this.areas = await Oa(this.hass), this.selection = e.mqtt;
    }
    ...
    render() {
      return this.hass && this.selection ? z`
      <ha-card>
        <div class="card-header">
          <div class="name">${_a("panels.general.cards.mqtt.title", this.hass.language)}</div>
          <ha-icon-button icon="hass:close" @click=${this.cancelClick}>
            <ha-icon icon="hass:close"></ha-icon>
          </ha-icon-button>
        </div>
        <div class="card-content">${_a("panels.general.cards.mqtt.description", this.hass.language)}</div>

        <settings-row .narrow=${this.narrow}>
          <span slot="heading"
            >${_a("panels.general.cards.mqtt.fields.state_topic.heading", this.hass.language)}</span
          >
          <span slot="description"
            >${_a("panels.general.cards.mqtt.fields.state_topic.description", this.hass.language)}</span
          >
          <paper-input
            label="${_a("panels.general.cards.mqtt.fields.state_topic.heading", this.hass.language)}"
            value=${this.selection.state_topic}
            @change=${e => {
        this.selection = { ...this.selection,
          state_topic: e.target.value
        };
      }}
          ></paper-input>
        </settings-row>
        ...
        <collapsible-section
          .narrow=${this.narrow}
          header=${_a("panels.general.cards.mqtt.fields.state_payload.heading", this.hass.language)}
        >
          ${Object.values(Ma).filter(e => Object.values(this.areas).some(a => Ya(e, a.modes))).map(e => z`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">${Na(e)}</span>
                  <span slot="description"
                    >${_a("panels.general.cards.mqtt.fields.state_payload.item", this.hass.language, "{state}", Na(e))}</span
                  >
                  <paper-input
                    label=${Na(e)}
                    placeholder=${e}
                    ...
                    @change=${a => {
        this.selection = Va(this.selection, {
          state_payload: {
            [e]: a.target.value
          }
        });
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading"
            >${_a("panels.general.cards.mqtt.fields.event_topic.heading", this.hass.language)}</span
          >
          <span slot="description"
            >${_a("panels.general.cards.mqtt.fields.event_topic.description", this.hass.language)}</span
          >
          <paper-input
            label="${_a("panels.general.cards.mqtt.fields.event_topic.heading", this.hass.language)}"
            value=${this.selection.event_topic}
            @change=${e => {
        this.selection = { ...this.selection,
          event_topic: e.target.value
        };
      }}
          ></paper-input>
        </settings-row>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading"
            >${_a("panels.general.cards.mqtt.fields.command_topic.heading", this.hass.language)}</span
          >
          <span slot="description"
            >${_a("panels.general.cards.mqtt.fields.command_topic.description", this.hass.language)}</span
          >
          <paper-input
            label="${_a("panels.general.cards.mqtt.fields.command_topic.heading", this.hass.language)}"
            value=${this.selection.command_topic}
            @change=${e => {
        this.selection = { ...this.selection,
          command_topic: e.target.value
        };
      }}
          ></paper-input>
        </settings-row>
        ...
        <collapsible-section
          .narrow=${this.narrow}
          header=${_a("panels.general.cards.mqtt.fields.command_payload.heading", this.hass.language)}
        >
          ${Object.values(Ta).filter(e => Object.values(this.areas).some(a => Ya((e => {
        switch (e) {
          case Ta.COMMAND_ALARM_DISARM:
            return Ma.STATE_ALARM_DISARMED;

          case Ta.COMMAND_ALARM_ARM_HOME:
            return Ma.STATE_ALARM_ARMED_HOME;

          case Ta.COMMAND_ALARM_ARM_AWAY:
            return Ma.STATE_ALARM_ARMED_AWAY;

          case Ta.COMMAND_ALARM_ARM_NIGHT:
            return Ma.STATE_ALARM_ARMED_NIGHT;

          case Ta.COMMAND_ALARM_ARM_CUSTOM_BYPASS:
            return Ma.STATE_ALARM_ARMED_CUSTOM_BYPASS;
          ...
          default:
            return;
                ...
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">${Na(e)}</span>
                  <span slot="description"
                    >${_a("panels.general.cards.mqtt.fields.command_payload.item", this.hass.language, "{command}", Na(e))}</span
                  >
                  <paper-input
                    label=${Na(e)}
                    placeholder=${e}
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading"
            >${_a("panels.general.cards.mqtt.fields.require_code.heading", this.hass.language)}</span
          >
          <span slot="description"
            >${_a("panels.general.cards.mqtt.fields.require_code.description", this.hass.language)}</span
          >
          <ha-switch
    ...
    saveClick(e) {
      this.hass && ka(this.hass, {
        mqtt: Object.assign(Object.assign({}, this.selection), {
          enabled: !0
        })
      }).catch(a => Ga(a, e)).then(() => {
        this.cancelClick();
    ...
    cancelClick() {
      Me(0, "/alarmo/general", !0);
    }

  };
  et.styles = qe, a([ae()], et.prototype, "narrow", void 0), a([ae()], et.prototype, "config", void 0), a([ae()], et.prototype, "areas", void 0), a([ae()], et.prototype, "selection", void 0), et = a([X("mqtt-config-card")], et);
  /**
       * @license
       * Copyright 2017 Google LLC
       * SPDX-License-Identifier: BSD-3-Clause
  ...
  class tt extends class {
    ...
    _$AT(e, a, t) {
      this._$Ct = e, this._$AM = a, this._$Ci = t;
    }
    ...
    constructor(e) {
      if (super(e), this.it = D, e.type !== at) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
    }

    render(e) {
      if (e === D || null == e) return this.vt = void 0, this.it = e;
      if (e === q) return e;
      if ("string" != typeof e) throw Error(this.constructor.directiveName + "() called with a non-string value");
      if (e === this.it) return this.vt;
      this.it = e;
      const a = [e];
      return a.raw = a, this.vt = {
  ...
  let st = class extends Z {
    render() {
      return this.columns && this.data ? z`
      <div class="table">
    ...
    renderDataRow(e) {
      ...
      <div class="table-row ${this.selectable ? "selectable" : ""}" @click=${() => this.handleClick(String(e.id))}>
        ${Object.entries(this.columns).map(([a, t]) => t.hide ? "" : z`
                <div
    ...
    handleClick(e) {
      ...
      const a = new CustomEvent("row-click", {
        detail: {
          id: e
        }
      });
  ...
  `, a([ae()], st.prototype, "columns", void 0), a([ae()], st.prototype, "data", void 0), a([ae({
    type: Boolean
  })], st.prototype, "selectable", void 0), st = a([X("alarmo-table")], st);
  ...
  a([ae({
    attribute: !1
  })], nt.prototype, "hass", void 0), a([te()], nt.prototype, "_params", void 0), nt = a([X("confirm-delete-dialog")], nt);
  ...
  let ot = class extends Qa(Z) {
    constructor() {
      super(...arguments), this.areas = {}, this.sensors = {}, this.automations = {}, this.name = "";
    }
    ...
    async _fetchData() {
      this.hass && (this.areas = await Oa(this.hass), this.sensors = await ba(this.hass), this.automations = await wa(this.hass));
    }
      ...
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <div slot="heading">
          <ha-header-bar>
            ...
            <span slot="title">
              ${this.area_id ? _a("panels.general.dialogs.edit_area.title", this.hass.language, "{area}", this.areas[this.area_id].name) : _a("panels.general.dialogs.create_area.title", this.hass.language)}
            </span>
          </ha-header-bar>
        </div>
        <div class="wrapper">
          ...
          ${this.area_id ? z`
                <span class="note"
                  >${_a("panels.general.dialogs.edit_area.name_warning", this.hass.language)}</span
                >
              ` : ""}
          ${this.area_id ? "" : z`
                <alarmo-select
        ...
        name: e.name
                  ...
                  value=${this.selectedArea}
                  label="${_a("panels.general.dialogs.create_area.fields.copy_from", this.hass.language)}"
                  clearable=${!0}
    ...
    saveClick(e) {
      const a = this.name.trim();
      if (!a.length) return;
      let t = {
        name: a
      };
      this.area_id ? t = Object.assign(Object.assign({}, t), {
        area_id: this.area_id
      }) : this.selectedArea && (t = Object.assign(Object.assign({}, t), {
        modes: Object.assign({}, this.areas[this.selectedArea].modes)
      })), Ca(this.hass, t).catch(a => Ga(a, e)).then(() => {
        this.closeDialog();
      });
    }
    ...
    async deleteClick(e) {
      ...
      const a = Object.values(this.sensors).filter(e => e.area == this.area_id).length,
            t = Object.values(this.automations).filter(e => {
        var a;
        return null === (a = e.triggers) || void 0 === a ? void 0 : a.map(e => e.area).includes(this.area_id);
      }).length;
      let i = !1;
      var s, n;
      i = !a && !t || (await new Promise(i => {
        Oe(e.target, "show-dialog", {
          dialogTag: "confirm-delete-dialog",
          dialogImport: () => Promise.resolve().then(function () {
            return rt;
          }),
          dialogParams: {
            title: _a("panels.general.dialogs.remove_area.title", this.hass.language),
            description: _a("panels.general.dialogs.remove_area.description", this.hass.language, ["{sensors}", "{automations}"], [String(a), String(t)]),
            cancel: () => i(!1),
            confirm: () => i(!0)
          }
        });
      })), i && (s = this.hass, n = this.area_id, s.callApi("POST", "alarmo/area", {
        area_id: n,
        remove: !0
      })).catch(a => Ga(a, e)).then(() => {
        this.closeDialog();
  ...
  a([ae({
    attribute: !1
  })], ot.prototype, "hass", void 0), a([te()], ot.prototype, "_params", void 0), a([ae()], ot.prototype, "areas", void 0), a([ae()], ot.prototype, "sensors", void 0), a([ae()], ot.prototype, "automations", void 0), a([ae()], ot.prototype, "name", void 0), a([ae()], ot.prototype, "area_id", void 0), a([ae()], ot.prototype, "selectedArea", void 0), ot = a([X("create-area-dialog")], ot);
  ...
  let lt = class extends Qa(Z) {
    constructor() {
      super(...arguments), this.areas = {}, this.sensors = {}, this.automations = {};
    }
    ...
    render() {
      ...
      const a = {
        ...
        remarks: {
          title: _a("panels.general.cards.areas.table.remarks", this.hass.language),
          width: "60%",
          hide: this.narrow,
          text: !0
        }
      },
            t = Object.values(e).map(a => {
        const t = Object.values(this.sensors).filter(e => e.area == a.area_id).length,
              i = 1 == Object.values(e).length ? Object.values(this.automations).filter(e => {
          var t, i;
          return (null === (t = e.triggers) || void 0 === t ? void 0 : t.map(e => e.area).includes(a.area_id)) || !(null === (i = e.triggers) || void 0 === i ? void 0 : i.map(e => e.area).length);
        }).length : Object.values(this.automations).filter(e => {
          var t;
          return null === (t = e.triggers) || void 0 === t ? void 0 : t.map(e => e.area).includes(a.area_id);
        }).length,
              s = `<a href="/alarmo/sensors/filter/${a.area_id}">${_a("panels.general.cards.areas.table.summary_sensors", this.hass.language, "{number}", String(t))}</a>`,
              n = `<a href="/alarmo/actions/filter/${a.area_id}">${_a("panels.general.cards.areas.table.summary_automations", this.hass.language, "{number}", String(i))}</a>`;
        return {
          id: a.area_id,
          actions: z`
          <ha-icon-button @click=${e => this.editClick(e, a.area_id)} icon="hass:pencil">
            <ha-icon icon="hass:pencil"></ha-icon>
          </ha-icon-button>
        `,
          name: Na(a.name),
          remarks: it(_a("panels.general.cards.areas.table.summary", this.hass.language, ["{summary_sensors}", "{summary_automations}"], [s, n]))
        };
      });
      return z`
      <ha-card header="${_a("panels.general.cards.areas.title", this.hass.language)}">
        <div class="card-content">
          ${_a("panels.general.cards.areas.description", this.hass.language)}
        </div>

        <alarmo-table .columns=${a} .data=${t}>
          ${_a("panels.general.cards.areas.no_items", this.hass.language)}
        </alarmo-table>
        <div class="card-actions">
          <mwc-button @click=${this.addClick}>
            ${_a("panels.general.cards.areas.actions.add", this.hass.language)}
          </mwc-button>
        </div>
      </ha-card>
    `;
  ...
  lt.styles = qe, a([ae()], lt.prototype, "narrow", void 0), a([ae()], lt.prototype, "path", void 0), a([ae()], lt.prototype, "config", void 0), a([ae()], lt.prototype, "areas", void 0), a([ae()], lt.prototype, "sensors", void 0), a([ae()], lt.prototype, "automations", void 0), lt = a([X("area-config-card")], lt);
  let ct = class extends Z {
    ...
    async showDialog(e) {
      this._params = e;
      const a = await fa(this.hass);
      this.name = a.master.name || "", await this.updateComplete;
    }
      ...
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <div slot="heading">
          <ha-header-bar>
            ...
            <span slot="title"> ${_a("panels.general.dialogs.edit_master.title", this.hass.language)}</span>
          </ha-header-bar>
        </div>
        <div class="wrapper">
          <paper-input
          ...
          <span class="note">${_a("panels.general.dialogs.edit_area.name_warning", this.hass.language)}</span>
        </div>
        <mwc-button slot="primaryAction" @click=${this.saveClick}>
          ${this.hass.localize("ui.common.save")}
        </mwc-button>
    ...
    saveClick() {
      const e = this.name.trim();
      e.length && ka(this.hass, {
        master: {
          enabled: !0,
          name: e
        }
  ...
  a([ae({
    attribute: !1
  })], ct.prototype, "hass", void 0), a([te()], ct.prototype, "_params", void 0), a([ae()], ct.prototype, "name", void 0), ct = a([X("edit-master-dialog")], ct);
  var ht = Object.freeze({
    __proto__: null,

    get EditMasterDialog() {
      return ct;
    }

  });
  let mt = class extends Qa(Z) {
    constructor() {
      super(...arguments), this.areas = {}, this.automations = {};
    }
    ...
    async _fetchData() {
      var e, a;
      this.hass && (this.config = await fa(this.hass), this.areas = await Oa(this.hass), this.automations = await wa(this.hass), this.data = (e = this.config, a = ["trigger_time", "disarm_after_trigger", "mqtt", "master"], e ? Object.entries(e).filter(([e]) => a.includes(e)).reduce((e, [a, t]) => Object.assign(e, {
        [a]: t
      }), {}) : {}));
    }
    ...
    render() {
      var e, a, t, i, s, n, r, o;
      return this.hass && this.config && this.data ? this.path && "mqtt_configuration" == this.path[0] ? z`
        <mqtt-config-card .hass=${this.hass} .narrow=${this.narrow}> </mqtt-config-card>
      ` : this.path && "edit_area" == this.path[0] && 2 == this.path.length ? z`
        <area-editor-card .hass=${this.hass} .narrow=${this.narrow} item=${this.path[1]}> </area-editor-card>
      ` : z`
        <ha-card header="${_a("panels.general.title", this.hass.language)}">
          <div class="card-content">
            ${_a("panels.general.cards.general.description", this.hass.language)}
          </div>

          <settings-row .narrow=${this.narrow}>
            <span slot="heading"
              >${_a("panels.general.cards.general.fields.disarm_after_trigger.heading", this.hass.language)}</span
            >
            <span slot="description"
              >${_a("panels.general.cards.general.fields.disarm_after_trigger.description", this.hass.language)}</span
            >
            <ha-switch
              ?checked=${this.data.disarm_after_trigger}
              @change=${e => this.data = { ...this.data,
        disarm_after_trigger: e.target.checked
      }}
              }}
            >
            </ha-switch>
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading"
              >${_a("panels.general.cards.general.fields.enable_mqtt.heading", this.hass.language)}</span
            >
            <span slot="description"
              >${_a("panels.general.cards.general.fields.enable_mqtt.description", this.hass.language)}</span
            >
            <ha-switch
        ...
        this.data = { ...this.data,
          ...
          ${(null === (i = null === (t = this.data) || void 0 === t ? void 0 : t.mqtt) || void 0 === i ? void 0 : i.enabled) ? z`
                <div style="padding: 0px 0px 16px 16px">
                  <mwc-button outlined @click=${() => Me(0, "/alarmo/general/mqtt_configuration", !0)}>
                    ${_a("panels.general.cards.general.actions.setup_mqtt", this.hass.language)}
                  </mwc-button>
                </div>
              ` : ""}
          ${Object.keys(this.areas).length >= 2 ? z`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading"
                    >${_a("panels.general.cards.general.fields.enable_master.heading", this.hass.language)}</span
                  >
                  <span slot="description"
                    >${_a("panels.general.cards.general.fields.enable_master.description", this.hass.language)}</span
                  >
                  <ha-switch
              ...
              ` : ""}
          ${(null === (o = null === (r = this.data) || void 0 === r ? void 0 : r.master) || void 0 === o ? void 0 : o.enabled) && Object.keys(this.areas).length >= 2 ? z`
                <div style="padding: 0px 0px 16px 16px">
                  <mwc-button outlined @click=${this.setupMasterClick}>
                    ${_a("panels.general.cards.general.actions.setup_master", this.hass.language)}
                  </mwc-button>
                </div>
              ` : ""}
    ...
    async toggleEnableMaster(e) {
      const a = e.target;
      let t = a.checked;

      if (!t) {
        const e = Object.values(this.automations).filter(e => {
          var a;
          return !(null === (a = e.triggers) || void 0 === a ? void 0 : a.map(e => e.area).length);
        }).length;
        ...
        if (e) {
          (await new Promise(t => {
            Oe(a, "show-dialog", {
              ...
              dialogParams: {
                title: _a("panels.general.dialogs.disable_master.title", this.hass.language),
                description: _a("panels.general.dialogs.disable_master.description", this.hass.language, ["{automations}"], [String(e)]),
                cancel: () => t(!1),
                confirm: () => t(!0)
              }
            });
      ...
      this.data = Object.assign(Object.assign({}, this.data), {
        master: Object.assign(Object.assign({}, this.data.master), {
          enabled: t
        })
      });
    }
    ...
    saveClick(e) {
      this.hass && this.data && ka(this.hass, this.data).catch(a => Ga(a, e)).then();
    }

  };
  mt.styles = qe, a([ae()], mt.prototype, "narrow", void 0), a([ae()], mt.prototype, "path", void 0), a([ae()], mt.prototype, "data", void 0), a([ae()], mt.prototype, "config", void 0), a([ae()], mt.prototype, "areas", void 0), a([ae()], mt.prototype, "automations", void 0), mt = a([X("alarm-view-general")], mt);

  const ut = (e, a) => {
    if ("binary_sensor" == function (e) {
      const a = "string" == typeof e ? e : e.entity_id;
      return String(a.split(".").shift());
    }(e.entity_id)) {
      if (a) return !0;
      const t = e.attributes.device_class;
      return !!t && !!["door", "garage_door", "gas", "heat", "lock", "moisture", "motion", "moving", "occupancy", "opening", "presence", "safety", "smoke", "sound", "vibration", "window"].includes(t);
    }
    ...
    switch (e.attributes.device_class) {
      ...
      default:
        ...
        gt = e => {
    const a = a => a.filter(a => e.includes(a));

    return {
      [Ea.Door]: {
        modes: a([Ne.ArmedAway, Ne.ArmedHome, Ne.ArmedNight]),
        always_on: !1,
        allow_open: !1,
        arm_on_close: !1,
        use_entry_delay: !0,
      ...
      [Ea.Tamper]: {
        modes: a([Ne.ArmedAway, Ne.ArmedHome, Ne.ArmedNight, Ne.ArmedCustom]),
        always_on: !1,
        allow_open: !1,
        arm_on_close: !1,
        use_entry_delay: !1,
  ...
  a([ae({
    attribute: !1
  })], vt.prototype, "hass", void 0), a([te()], vt.prototype, "_params", void 0), vt = a([X("error-dialog")], vt);
  ...
  let ft = class extends Z {
    constructor() {
      super(...arguments), this.items = [], this.value = null, this.selectable = !1, this.multiple = !1;
    }
    ...
    selectItem(e) {
      ...
      if (this.selectable) {
        if (this.multiple) {
          const a = Array.isArray(this.value) ? [...this.value] : Ia(this.value) ? [this.value] : [];
          this.value = a.includes(e) ? Ua(a, e) : [...a, e];
        } else this.value = this.value == e ? null : e;
  ...
  a([ae()], ft.prototype, "items", void 0), a([ae()], ft.prototype, "value", void 0), a([ae({
    type: Boolean
  })], ft.prototype, "selectable", void 0), a([ae({
    type: Boolean
  })], ft.prototype, "multiple", void 0), ft = a([X("alarmo-chips")], ft);
  let bt = class extends Qa(Z) {
    constructor() {
    ...
    async _fetchData() {
      this.hass && (this.sensorGroups = await $a(this.hass), this.sensors = await ba(this.hass));
    }
    ...
    render() {
      ...
      <ha-dialog open @closed=${this.closeDialog} @close-dialog=${this.closeDialog} .heading=${this.renderHeader()}>
        <div class="wrapper">
          <settings-row dialog>
            <span slot="heading"
              >${_a("panels.sensors.dialogs.create_group.fields.name.heading", this.hass.language)}</span
            >
            <span slot="description"
              >${_a("panels.sensors.dialogs.create_group.fields.name.description", this.hass.language)}</span
            >
            <paper-input
              label=${this.hass.localize("ui.components.area-picker.add_dialog.name")}
              @value-changed=${e => this.data = { ...this.data,
        name: String(e.target.value).trim()
          ...
          <settings-row large dialog>
            <span slot="heading"
              >${_a("panels.sensors.dialogs.create_group.fields.sensors.heading", this.hass.language)}</span
            >
            <span slot="description"
              >${_a("panels.sensors.dialogs.create_group.fields.sensors.description", this.hass.language)}</span
            >
          ...
          <settings-row dialog>
            <span slot="heading"
              >${_a("panels.sensors.dialogs.create_group.fields.timeout.heading", this.hass.language)}</span
            >
            <span slot="description"
              >${_a("panels.sensors.dialogs.create_group.fields.timeout.description", this.hass.language)}</span
            >
    ...
    renderHeader() {
      ...
      <span class="header_title">
        ${this.data.group_id ? _a("panels.sensors.dialogs.edit_group.title", this.hass.language, "{name}", this.sensorGroups[this.data.group_id].name) : _a("panels.sensors.dialogs.create_group.title", this.hass.language)}
      </span>
      <ha-icon-button
    ...
    renderSensorOptions() {
      const e = Object.keys(this.sensors).filter(e => !Ia(this.sensors[e].group) || this.sensors[e].group === this.data.group_id).map(e => {
        const a = this.hass.states[e],
              t = Object.entries(Ea).find(([, a]) => a == this.sensors[e].type)[0];
        return {
          value: e,
          name: this.sensors[e].name || Na(Pa(a)),
          icon: za[t]
        };
      });
      return e.sort(Ba), e.length ? z`
      <alarmo-chips
        .items=${e}
        ...
        ?multiple=${!0}
        @value-changed=${e => this.data = { ...this.data,
        entities: e.detail.value
      }}
      >
      </alarmo-chips>
    ` : _a("panels.sensors.cards.sensors.no_items", this.hass.language);
    }

    saveClick(e) {
      var a, t;
      this.data.name.length && (this.data.group_id && this.data.name == this.sensorGroups[this.data.group_id].name || !Object.values(this.sensorGroups).find(e => e.name.toLowerCase() == this.data.name.toLowerCase())) ? this.data.entities.length < 2 ? Fa(e, _a("panels.sensors.dialogs.create_group.errors.insufficient_sensors", this.hass.language)) : (a = this.hass, t = this.data, a.callApi("POST", "alarmo/sensor_groups", t)).catch(a => Ga(a, e)).then(() => {
        this.closeDialog();
      }) : Fa(e, _a("panels.sensors.dialogs.create_group.errors.invalid_name", this.hass.language));
    }

    deleteClick(e) {
      var a, t;
      this.data.group_id && (a = this.hass, t = this.data.group_id, a.callApi("POST", "alarmo/sensor_groups", {
        group_id: t,
        remove: !0
      })).catch(a => Ga(a, e)).then(() => {
        this.closeDialog();
  ...
  a([ae({
    attribute: !1
  })], bt.prototype, "hass", void 0), a([te()], bt.prototype, "_params", void 0), a([ae()], bt.prototype, "sensorGroups", void 0), a([ae()], bt.prototype, "sensors", void 0), a([ae()], bt.prototype, "data", void 0), bt = a([X("create-sensor-group-dialog")], bt);
  ...
  let wt = class extends Qa(Z) {
      ...
      <ha-dialog open .heading=${this.renderHeader()} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <div class="wrapper">
          <div class="description">
            ${_a("panels.sensors.dialogs.manage_groups.description", this.hass.language)}
          </div>
          <div class="container">
            ${Object.keys(this.sensorGroups).length ? Object.values(this.sensorGroups).map(e => this.renderGroup(e)) : _a("panels.sensors.dialogs.manage_groups.no_items", this.hass.language)}
          </div>
        </div>
        <mwc-button slot="secondaryAction" @click=${this.createGroupClick}>
          <ha-icon icon="hass:plus"></ha-icon>
          ${_a("panels.sensors.dialogs.manage_groups.actions.new_group", this.hass.language)}
        </mwc-button>
      </ha-dialog>
    ` : z``;
    }
    ...
    renderHeader() {
      return z`
      <span class="header_title">${_a("panels.sensors.dialogs.manage_groups.title", this.hass.language)}</span>
      <ha-icon-button
        .label=${this.hass.localize("ui.dialogs.generic.close")}
        icon="mdi:close"
        dialogAction="close"
    ...
    >
      ...
      <div>
        ...
        <span class="description">${_a("panels.general.cards.areas.table.summary_sensors", this.hass.language, "{number}", String(e.entities.length))}
      </div>
  ...
  a([ae({
    attribute: !1
  })], wt.prototype, "hass", void 0), a([te()], wt.prototype, "_params", void 0), a([ae()], wt.prototype, "sensorGroups", void 0), a([ae()], wt.prototype, "sensors", void 0), wt = a([X("manage-sensor-groups-dialog")], wt);
  var $t = Object.freeze({
    __proto__: null,
  ...
  let kt = class extends Qa(Z) {
    constructor() {
      super(...arguments), this.showBypassModes = !1;
    }
    ...
    async _fetchData() {
      var e;
      if (!this.hass) return;
      const a = await Oa(this.hass);
      this.areas = a;
      const t = await $a(this.hass);
      this.sensorGroups = t;
      const i = await ba(this.hass);
      this.data = Object.keys(i).includes(this.item) ? i[this.item] : void 0, this.data && !(null === (e = this.data) || void 0 === e ? void 0 : e.area) && 1 == Object.keys(a).length && (this.data = Object.assign(Object.assign({}, this.data), {
    ...
    render() {
      if (!this.data) return z``;
      const e = this.hass.states[this.data.entity_id];
      return z`
      <ha-card>
        <div class="card-header">
          <div class="name">${_a("panels.sensors.cards.editor.title", this.hass.language)}</div>
          <ha-icon-button icon="hass:close" @click=${this.cancelClick}>
            <ha-icon icon="hass:close"></ha-icon>
          </ha-icon-button>
        </div>
        <div class="card-content">
          ${_a("panels.sensors.cards.editor.description", this.hass.language, "{entity}", this.item)}
        </div>

        <settings-row .narrow=${this.narrow}>
          <span slot="heading">${_a("panels.sensors.cards.editor.fields.name.heading", this.hass.language)}</span>
          <span slot="description">${_a("panels.sensors.cards.editor.fields.name.description", this.hass.language)}</span>

          <paper-input
            label="${_a("panels.sensors.cards.editor.fields.name.heading", this.hass.language)}"
        ...
        ${Object.keys(this.areas).length > 1 ? z`
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">${_a("panels.sensors.cards.editor.fields.area.heading", this.hass.language)}</span>
          <span slot="description">${_a("panels.sensors.cards.editor.fields.area.description", this.hass.language)}</span>
        ...
        name: e.name
            ...
            label=${_a("panels.sensors.cards.editor.fields.area.heading", this.hass.language)}
            @value-changed=${e => this.data = { ...this.data,
        area: e.target.value
      }}
          </alarmo-select>
        ...
        <settings-row .narrow=${this.narrow} .large=${!0}>
          <span slot="heading">${_a("panels.sensors.cards.editor.fields.device_type.heading", this.hass.language)}</span>
          <span slot="description">${_a("panels.sensors.cards.editor.fields.device_type.description", this.hass.language)}</span>

          <alarmo-select
            .hass=${this.hass}
            .items=${(a = this.hass, Object.entries(Ea).filter(([, e]) => e != Ea.Other).map(([e, t]) => Object({
        value: t,
        name: _a(`panels.sensors.cards.editor.fields.device_type.choose.${t}.name`, a.language),
        description: _a(`panels.sensors.cards.editor.fields.device_type.choose.${t}.description`, a.language),
        icon: za[e]
      })))}
            label=${_a("panels.sensors.cards.editor.fields.device_type.heading", this.hass.language)}
            clearable=${!0}
            icons=${!0}
            value=${this.data.type}
            @value-changed=${e => this.setType(e.target.value || Ea.Other)}
          >
          </alarmo-select>
        </settings-row>

        <settings-row .narrow=${this.narrow}>
          <span slot="heading">${_a("panels.sensors.cards.editor.fields.modes.heading", this.hass.language)}</span>
          <span slot="description">${_a("panels.sensors.cards.editor.fields.modes.description", this.hass.language)}</span>

          <div>
            ${this.modesByArea(this.data.area).map(e => z`
                <mwc-button
        ...
        this.setMode(e);
                ...
                >
                  <ha-icon icon="${Sa[Object.entries(Ne).find(([, a]) => a == e)[0]]}"></ha-icon>
                  ${_a("common.modes_short." + e, this.hass.language)}
                </mwc-button>
              `)}
          </div>
        </settings-row>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">${_a("panels.sensors.cards.editor.fields.group.heading", this.hass.language)}</span>
          <span slot="description">${_a("panels.sensors.cards.editor.fields.group.description", this.hass.language)}</span>

          <div>
           ${Object.keys(this.sensorGroups).length ? z`
            <alarmo-select
              .clearable=${!0}
              .items=${this.getSensorGroups()}
              value=${this.data.group}
              label="${_a("panels.sensors.cards.editor.fields.group.heading", this.hass.language)}"
              @value-changed=${e => {
        this.data = { ...this.data,
          group: e.detail.value
            ...
            >
              ${_a("panels.sensors.cards.editor.actions.setup_groups", this.hass.language)}
            </mwc-button>
          </div>
        ...
        <collapsible-section
          .narrow=${this.narrow}
          header=${_a("panels.sensors.cards.editor.actions.toggle_advanced", this.hass.language)}
        >
        ${!this.data.type || [Ea.Environmental, Ea.Other].includes(this.data.type) ? z`
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">${_a("panels.sensors.cards.editor.fields.always_on.heading", this.hass.language)}</span>
            <span slot="description">${_a("panels.sensors.cards.editor.fields.always_on.description", this.hass.language)}</span>
        ...
        ${!this.data.type || [Ea.Window, Ea.Door, Ea.Motion, Ea.Other].includes(this.data.type) ? z`
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">${_a("panels.sensors.cards.editor.fields.use_exit_delay.heading", this.hass.language)}</span>
            <span slot="description">${_a("panels.sensors.cards.editor.fields.use_exit_delay.description", this.hass.language)}</span>
        ...
        ${this.data.type && ![Ea.Motion, Ea.Other].includes(this.data.type) || !this.data.use_exit_delay ? "" : z`
          <settings-row .narrow=${this.narrow} nested>
            <span slot="heading">${_a("panels.sensors.cards.editor.fields.allow_open.heading", this.hass.language)}</span>
            <span slot="description">${_a("panels.sensors.cards.editor.fields.allow_open.description", this.hass.language)}</span>
        ...
        ${!this.data.type || [Ea.Window, Ea.Door, Ea.Motion, Ea.Other].includes(this.data.type) ? z`
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">${_a("panels.sensors.cards.editor.fields.use_entry_delay.heading", this.hass.language)}</span>
            <span slot="description">${_a("panels.sensors.cards.editor.fields.use_entry_delay.description", this.hass.language)}</span>
        ...
        ${!this.data.type || [Ea.Door, Ea.Other].includes(this.data.type) ? z`
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">${_a("panels.sensors.cards.editor.fields.arm_on_close.heading", this.hass.language)}</span>
            <span slot="description">${_a("panels.sensors.cards.editor.fields.arm_on_close.description", this.hass.language)}</span>
        ...
        ${!this.data.type || [Ea.Window, Ea.Door, Ea.Other].includes(this.data.type) ? z`
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">${_a("panels.sensors.cards.editor.fields.auto_bypass.heading", this.hass.language)}</span>
            <span slot="description">${_a("panels.sensors.cards.editor.fields.auto_bypass.description", this.hass.language)}</span>

            <ha-switch
              ?checked=${this.data.auto_bypass}
              ?disabled=${this.data.always_on}
              @change=${e => this._SetData({
        auto_bypass: e.target.checked
      })}
            >
            </ha-switch>
          </settings-row>

          ${this.data.auto_bypass ? z`
            <settings-row .narrow=${this.narrow} nested>
              <span slot="heading">${_a("panels.sensors.cards.editor.fields.auto_bypass.modes", this.hass.language)}</span>
              <div>
              ${this.modesByArea(this.data.area).map(e => z`
                <mwc-button
        ...
        ` : ""}
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">${_a("panels.sensors.cards.editor.fields.trigger_unavailable.heading", this.hass.language)}</span>
            <span slot="description">${_a("panels.sensors.cards.editor.fields.trigger_unavailable.description", this.hass.language)}</span>

            <ha-switch
              ?checked=${this.data.trigger_unavailable}
              @change=${e => this._SetData({
        trigger_unavailable: e.target.checked
      })}
            >
            </ha-switch>
          </settings-row>
        ...
        <div class="card-actions">
          ...
          <mwc-button class="warning" @click=${this.deleteClick}>
            ${_a("panels.sensors.cards.editor.actions.remove", this.hass.language)}
          </mwc-button>
        </div>
      </ha-card>
    `;
    ...
    modesByArea(e) {
      const a = Object.keys(this.areas).reduce((e, a) => Object.assign(e, {
        [a]: Object.entries(this.areas[a].modes).filter(([, e]) => e.enabled).map(([e]) => e)
      }), {});
      return e ? a[e] : Object.values(a).reduce((e, a) => e.filter(e => a.includes(e)));
    }

    _SetData(e) {
      if (this.data) for (const [a, t] of Object.entries(e)) switch (a) {
        case "always_on":
          this.data = Object.assign(Object.assign({}, this.data), {
            always_on: 1 == t
          }), t && (this.data = Object.assign(Object.assign({}, this.data), {
            arm_on_close: !1,
            use_exit_delay: !1,
            use_entry_delay: !1,
            allow_open: !1,
    ...
    setMode(e) {
      this.data && (this.data = Object.assign(Object.assign({}, this.data), {
        modes: this.data.modes.includes(e) ? Ua(this.data.modes, e) : La(this.data.modes.concat([e]))
      }));
    }

    setBypassMode(e) {
      this.data && (this.data = Object.assign(Object.assign({}, this.data), {
        auto_bypass_modes: this.data.auto_bypass_modes.includes(e) ? Ua(this.data.auto_bypass_modes, e) : La(this.data.auto_bypass_modes.concat([e]))
      }));
    }

    setType(e) {
      if (!this.data) return;
      const a = e != Ea.Other ? gt(this.modesByArea(this.data.area))[e] : {};
    ...
    deleteClick(e) {
      var a, t;
      (a = this.hass, t = this.item, a.callApi("POST", "alarmo/sensors", {
        entity_id: t,
        remove: !0
      })).catch(a => Ga(a, e)).then(() => {
        this.cancelClick();
    ...
    saveClick(e) {
      ...
      }), this.data.area || a.push(_a("panels.sensors.cards.editor.errors.no_area", this.hass.language)), this.data.modes.length || this.data.always_on || a.push(_a("panels.sensors.cards.editor.errors.no_modes", this.hass.language)), this.data.auto_bypass && !this.data.auto_bypass_modes.length && a.push(_a("panels.sensors.cards.editor.errors.no_auto_bypass_modes", this.hass.language)), a.length ? Fa(e, z`
          ${_a("panels.sensors.cards.editor.errors.description", this.hass.language)}
          <ul>
            ${a.map(e => z`<li>${e}</li>`)}
          </ul>
        `) : Aa(this.hass, Object.assign({}, this.data)).catch(a => Ga(a, e)).then(() => {
        this.cancelClick();
      });
    }

    cancelClick() {
      Me(0, "/alarmo/sensors", !0);
    }
  ...
  kt.styles = qe, a([ae()], kt.prototype, "hass", void 0), a([ae()], kt.prototype, "narrow", void 0), a([ae()], kt.prototype, "item", void 0), a([ae()], kt.prototype, "data", void 0), a([ae()], kt.prototype, "showBypassModes", void 0), kt = a([X("sensor-editor-card")], kt);
  let At = class extends Qa(Z) {
    constructor() {
      super(...arguments), this.areas = {}, this.sensors = {}, this.areaFilterOptions = [];
    }
    ...
    async _fetchData() {
      this.hass && (this.areas = await Oa(this.hass), this.sensors = await ba(this.hass), this.areaFilterOptions = Object.values(this.areas).map(e => Object({
        value: e.area_id,
        name: e.name,
        count: Object.values(this.sensors).filter(a => a.area == e.area_id).length
      })).sort(Ba), Object.values(this.sensors).filter(e => !e.area).length && (this.areaFilterOptions = [{
        value: "no_area",
        name: _a("panels.sensors.cards.sensors.filter.no_area", this.hass.language),
    ...
    render() {
      return this.hass ? z`
      <ha-card header="${_a("panels.sensors.title", this.hass.language)}">
        <div class="card-content">
          ${_a("panels.sensors.cards.sensors.description", this.hass.language)}
        </div>

        ${this.areaFilterOptions.length > 1 ? z`
            <div class="table-filter" ?narrow=${this.narrow}>
            <span class="header">${_a("panels.sensors.cards.sensors.filter.label", this.hass.language)}:</span>
            <alarmo-chips
        ...
        <alarmo-table
          ...
          @row-click=${e => {
        Me(0, "/alarmo/sensors/edit/" + String(e.detail.id), !0);
      }}
        >
          ${_a("panels.sensors.cards.sensors.no_items", this.hass.language)}
        </alarmo-table>
    ...
    tableColumns() {
      return {
        ...
        modes: {
          title: _a("panels.sensors.cards.sensors.table.arm_modes", this.hass.language),
          width: "25%",
          hide: this.narrow,
          text: !0
        },
        enabled: {
          title: _a("panels.actions.cards.notifications.table.enabled", this.hass.language),
          width: "68px",
          align: "center"
        }
      };
    ...
    renderTableData() {
      let e = Object.keys(this.sensors).map(e => {
        const a = this.hass.states[e];
        return {
          id: e,
          name: Pa(a),
      ...
      return e.sort(Ba), e = e.filter(e => !this.selectedArea || !this.areaFilterOptions.find(e => e.value == this.selectedArea) || this.sensors[e.id].area == this.selectedArea || "no_area" === this.selectedArea && !this.sensors[e.id].area), e.map(e => this.renderTableDataRow(e));
    }

    renderTableDataRow(e) {
      const a = Object.entries(Ea).find(([, a]) => a == this.sensors[e.id].type)[0],
            t = this.hass.states[e.id];
      return {
        icon: z`
        <paper-tooltip animation-delay="0">
          ${t ? _a(`panels.sensors.cards.editor.fields.device_type.choose.${Ea[a]}.name`, this.hass.language) : this.hass.localize("state_badge.default.entity_not_found")}
        </paper-tooltip>
        <ha-icon icon="${t ? za[a] : "hass:help-circle-outline"}"> </ha-icon>
      `,
        name: z`
        ${t && this.sensors[e.id].name || Na(e.name)}
        <span class="secondary">${e.id}</span>
      `,
        id: e.id,
        modes: z`
        ${this.sensors[e.id].always_on ? _a("panels.sensors.cards.sensors.table.always_on", this.hass.language) : Object.values(Ne).filter(a => this.sensors[e.id].modes.includes(a)).map(e => _a("common.modes_short." + e, this.hass.language)).join(", ")}
      `,
        enabled: z`
        <ha-switch
          @click=${e => {
  ...
  At.styles = qe, a([ae()], At.prototype, "hass", void 0), a([ae()], At.prototype, "narrow", void 0), a([ae()], At.prototype, "areas", void 0), a([ae()], At.prototype, "sensors", void 0), a([ae()], At.prototype, "selectedArea", void 0), a([ae()], At.prototype, "areaFilterOptions", void 0), a([ae()], At.prototype, "path", void 0), At = a([X("sensors-overview-card")], At);
  let xt = class extends Qa(Z) {
    constructor() {
      super(...arguments), this.showAllSensorEntities = !1, this.addSelection = [], this.areas = {}, this.sensors = {};
    }
    ...
    async firstUpdated() {
      this.areas = await Oa(this.hass), this.sensors = await ba(this.hass);
    }
    ...
    render() {
      const e = {
        ...
        type: {
          title: _a("panels.sensors.cards.add_sensors.table.type", this.hass.language),
          width: "40%",
          hide: this.narrow,
          text: !0
        }
            ...
            a = ((e, a, t = !1) => {
        const i = Object.values(e.states).filter(e => ut(e, t)).filter(e => !a.includes(e.entity_id)).map(e => Object({
          id: e.entity_id,
          name: Pa(e),
          icon: Da(e)
        }));
        return i.sort(Ba), i;
      })(this.hass, Object.keys(this.sensors), this.showAllSensorEntities).map(e => ({
        checkbox: z`
            <ha-checkbox
        ...
        name: z`
            ...
            <span class="secondary">${e.id}</span>
          `,
        type: pt(this.hass.states[e.id]) ? _a(`panels.sensors.cards.editor.fields.device_type.choose.${pt(this.hass.states[e.id])}.name`, this.hass.language) : this.hass.localize("state.default.unknown")
      }));

      return z`
    <ha-card header="${_a("panels.sensors.cards.add_sensors.title", this.hass.language)}">
      <div class="card-content">
        ${_a("panels.sensors.cards.add_sensors.description", this.hass.language)}
      </div>
      ...
      <div style="display: flex; justify-content: flex-end; padding: 8px 16px">
        ...
        ${_a("panels.sensors.cards.add_sensors.actions.show_all", this.hass.language)}
      </div>

      <alarmo-table .columns=${e} .data=${a}>
        ${_a("panels.sensors.cards.add_sensors.no_items", this.hass.language)}
      </alarmo-table>

      <div class="card-actions">
        <mwc-button @click=${this.addSelected} ?disabled=${0 == this.addSelection.length}>
          ${_a("panels.sensors.cards.add_sensors.actions.add_to_alarm", this.hass.language)}
        </mwc-button>
      </div>
    </ha-card>
  `;
    ...
    toggleSelect(e, a) {
      const t = e.target.checked;
      this.addSelection = t && !this.addSelection.includes(a) ? [...this.addSelection, a] : t ? this.addSelection : this.addSelection.filter(e => e != a);
    }

    addSelected(e) {
      if (!this.hass) return;
      const a = Object.values(this.areas).map(e => Object.entries(e.modes).filter(([, e]) => e.enabled).map(([e]) => e)).reduce((e, a) => e.filter(e => a.includes(e)));
      this.addSelection.map(e => function (e, a) {
        if (!e) return null;
        const t = xe(e.entity_id);
        let i = {
        ...
        if ("binary_sensor" == t) {
          const t = pt(e);
          t && (i = Object.assign(Object.assign(Object.assign({}, i), {
            type: t
          }), gt(a)[t]));
        }

        return i;
      }(this.hass.states[e], a)).map(e => 1 == Object.keys(this.areas).length ? Object.assign(e, {
        area: Object.keys(this.areas)[0]
      }) : e).filter(e => e).forEach(a => {
        Aa(this.hass, a).catch(a => Ga(a, e)).then();
      }), this.addSelection = [];
    }

  };
  xt.styles = qe, a([ae()], xt.prototype, "hass", void 0), a([ae()], xt.prototype, "narrow", void 0), a([ae()], xt.prototype, "showAllSensorEntities", void 0), a([ae()], xt.prototype, "addSelection", void 0), a([ae()], xt.prototype, "areas", void 0), a([ae()], xt.prototype, "sensors", void 0), xt = a([X("add-sensors-card")], xt);
  let jt = class extends Z {
    ...
    render() {
      return this.hass ? this.path && 2 == this.path.length && "edit" == this.path[0] ? z`
  ...
  a([ae()], jt.prototype, "hass", void 0), a([ae()], jt.prototype, "narrow", void 0), a([ae()], jt.prototype, "path", void 0), a([ae()], jt.prototype, "selectedArea", void 0), jt = a([X("alarm-view-sensors")], jt);
  let Ot = class extends Z {
    ...
    async firstUpdated() {
      if (this.users = await ya(this.hass), this.areas = await Oa(this.hass), this.item) {
        const e = this.users[this.item];
        this.data = Ra(e, "code", "code_format", "code_length");
      }
    ...
    render() {
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${this.item ? _a("panels.codes.cards.edit_user.title", this.hass.language) : _a("panels.codes.cards.new_user.title", this.hass.language)}
          </div>
          <ha-icon-button icon="hass:close" @click=${this.cancelClick}>
            <ha-icon icon="hass:close"></ha-icon>
          </ha-icon-button>
        ...
        <div class="card-content">
          ${this.item ? _a("panels.codes.cards.edit_user.description", this.hass.language, "{name}", this.users[this.item].name) : _a("panels.codes.cards.new_user.description", this.hass.language)}
        </div>

        <settings-row .narrow=${this.narrow}>
          <span slot="heading">${_a("panels.codes.cards.new_user.fields.name.heading", this.hass.language)}</span>
          <span slot="description">${_a("panels.codes.cards.new_user.fields.name.description", this.hass.language)}</span>

          <paper-input
            label="${_a("panels.codes.cards.new_user.fields.name.heading", this.hass.language)}"
            placeholder=""
            value=${this.data.name}
            @change=${e => this.data = { ...this.data,
        name: e.target.value
        ...
        ${this.item ? z`
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">${_a("panels.codes.cards.edit_user.fields.old_code.heading", this.hass.language)}</span>
                <span slot="description">${_a("panels.codes.cards.edit_user.fields.old_code.description", this.hass.language)}</span>

                <paper-input
                  label="${_a("panels.codes.cards.edit_user.fields.old_code.heading", this.hass.language)}"
                  placeholder=""
                  type="password"
                  value=${this.data.old_code || ""}
                  @change=${e => this.data = { ...this.data,
        old_code: String(e.target.value).trim()
      }}
                >
                </paper-input>
              </settings-row>
            ` : ""}
        ${this.item && !(null === (e = this.data.old_code) || void 0 === e ? void 0 : e.length) ? "" : z`
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">${_a("panels.codes.cards.new_user.fields.code.heading", this.hass.language)}</span>
                <span slot="description">${_a("panels.codes.cards.new_user.fields.code.description", this.hass.language)}</span>

                <paper-input
                  label="${_a("panels.codes.cards.new_user.fields.code.heading", this.hass.language)}"
                  placeholder=""
                  type="password"
        ...
        code: String(e.target.value).trim()
              ...
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">${_a("panels.codes.cards.new_user.fields.confirm_code.heading", this.hass.language)}</span>
                <span slot="description">${_a("panels.codes.cards.new_user.fields.confirm_code.description", this.hass.language)}</span>

                <paper-input
                  label="${_a("panels.codes.cards.new_user.fields.confirm_code.heading", this.hass.language)}"
                  placeholder=""
                  type="password"
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">${_a("panels.codes.cards.new_user.fields.is_admin.heading", this.hass.language)}</span>
          <span slot="description">${_a("panels.codes.cards.new_user.fields.is_admin.description", this.hass.language)}</span>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">${_a("panels.codes.cards.new_user.fields.can_arm.heading", this.hass.language)}</span>
          <span slot="description">${_a("panels.codes.cards.new_user.fields.can_arm.description", this.hass.language)}</span>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">${_a("panels.codes.cards.new_user.fields.can_disarm.heading", this.hass.language)}</span>
          <span slot="description">${_a("panels.codes.cards.new_user.fields.can_disarm.description", this.hass.language)}</span>
        ...
        ${this.getAreaOptions().length >= 2 ? z`
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">${_a("panels.codes.cards.new_user.fields.area_limit.heading", this.hass.language)}</span>
          <span slot="description">${_a("panels.codes.cards.new_user.fields.area_limit.description", this.hass.language)}</span>

          <div class="checkbox-list">
            ${this.getAreaOptions().map(e => {
        var a;
        const t = (this.data.area_limit || []).includes(e.value) || !(null === (a = this.data.area_limit) || void 0 === a ? void 0 : a.length) || this.data.is_admin;
        return z`
              <div>
                <ha-checkbox
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">${_a("panels.codes.cards.new_user.fields.is_override_code.heading", this.hass.language)}</span>
          <span slot="description">${_a("panels.codes.cards.new_user.fields.is_override_code.description", this.hass.language)}</span>
    ...
    toggleSelectArea(e, a) {
      if (this.data.is_admin || (this.data.area_limit || []).length <= 1 && !a) return;
      let t = this.data.area_limit || [];
      t = a ? t.includes(e) ? t : [...t, e] : t.includes(e) ? t.filter(a => a != e) : t, this.data = Object.assign(Object.assign({}, this.data), {
        area_limit: t
      });
    }
    ...
    deleteClick(e) {
      var a, t;
      this.item && (a = this.hass, t = this.item, a.callApi("POST", "alarmo/users", {
        user_id: t,
        remove: !0
      })).catch(a => Ga(a, e)).then(() => {
        this.cancelClick();
    ...
    saveClick(e) {
      var a, t, i;
      let s = Object.assign({}, this.data);
      var n, r;
      (null === (a = s.name) || void 0 === a ? void 0 : a.length) ? (null === (t = s.code) || void 0 === t ? void 0 : t.length) && !(s.code.length < 4) || this.item && !(null === (i = s.old_code) || void 0 === i ? void 0 : i.length) ? (s.code || "").length && s.code !== this.repeatCode ? (Fa(e, _a("panels.codes.cards.new_user.errors.code_mismatch", this.hass.language)), this.data = Ra(this.data, "code"), this.repeatCode = "") : (s.is_admin && (s = Object.assign(Object.assign({}, s), {
        can_arm: !0,
        can_disarm: !0,
        area_limit: []
      })), this.item && (s.old_code || "").length < 4 && Ra(s, "old_code", "code"), this.getAreaOptions().length && !this.getAreaOptions().every(e => (this.data.area_limit || []).includes(e.value)) || (s = Object.assign(Object.assign({}, s), {
        area_limit: []
      })), (n = this.hass, r = s, n.callApi("POST", "alarmo/users", r)).catch(a => Ga(a, e)).then(() => {
        this.cancelClick();
      })) : Fa(e, _a("panels.codes.cards.new_user.errors.no_code", this.hass.language)) : Fa(e, _a("panels.codes.cards.new_user.errors.no_name", this.hass.language));
    }
  ...
  a([ae()], Ot.prototype, "hass", void 0), a([ae()], Ot.prototype, "narrow", void 0), a([ae()], Ot.prototype, "item", void 0), a([ae()], Ot.prototype, "data", void 0), a([ae()], Ot.prototype, "repeatCode", void 0), Ot = a([X("user-editor-card")], Ot);
  let Ct = class extends Qa(Z) {
    constructor() {
      super(...arguments), this.users = {}, this.code_arm_required = !1, this.code_disarm_required = !1, this.code_format = "number";
    }
    ...
    async _fetchData() {
      if (!this.hass) return;
      const e = await fa(this.hass);
      this.config = e, this.code_arm_required = e.code_arm_required, this.code_disarm_required = e.code_disarm_required, this.code_format = e.code_format;
      const a = await ya(this.hass);
      this.users = a;
    }

    render() {
      return this.hass ? this.path && "new_user" == this.path[0] ? z`
      ...
      ` : z`
        <ha-card header="${_a("panels.codes.title", this.hass.language)}">
          <div class="card-content">
            ${_a("panels.codes.cards.codes.description", this.hass.language)}
          </div>

          <settings-row .narrow=${this.narrow}>
            <span slot="heading"
              >${_a("panels.codes.cards.codes.fields.code_arm_required.heading", this.hass.language)}</span
            >
            <span slot="description"
              >${_a("panels.codes.cards.codes.fields.code_arm_required.description", this.hass.language)}</span
            >
            <ha-switch
              ?checked=${this.code_arm_required}
              @change=${e => {
        this.code_arm_required = e.target.checked;
      }}
            >
            </ha-switch>
          </settings-row>
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading"
              >${_a("panels.codes.cards.codes.fields.code_disarm_required.heading", this.hass.language)}</span
            >
            <span slot="description"
              >${_a("panels.codes.cards.codes.fields.code_disarm_required.description", this.hass.language)}</span
            >
            <ha-switch
              ?checked=${this.code_disarm_required}
              @change=${e => {
        this.code_disarm_required = e.target.checked;
      }}
            >
            </ha-switch>
          </settings-row>
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading"
              >${_a("panels.codes.cards.codes.fields.code_format.heading", this.hass.language)}</span
            >
            <span slot="description"
              >${_a("panels.codes.cards.codes.fields.code_format.description", this.hass.language)}</span
            >
            <mwc-button
        ...
        this.code_format = "number";
              ...
              >${_a("panels.codes.cards.codes.fields.code_format.code_format_number", this.hass.language)}</mwc-button
            >
            <mwc-button
        ...
        this.code_format = "text";
              ...
              ?disabled=${!this.code_arm_required && !this.code_disarm_required}
            >
              ${_a("panels.codes.cards.codes.fields.code_format.code_format_text", this.hass.language)}</mwc-button
            >
          </settings-row>
    ...
    usersPanel() {
      ...
      const a = {
        ...
        remarks: {
          title: _a("panels.codes.cards.user_management.table.remarks", this.hass.language),
          width: "40%",
          hide: this.narrow,
          text: !0
        }
        ...
        `,
        name: Na(e.name),
        remarks: e.is_admin ? _a("panels.codes.cards.user_management.table.administrator", this.hass.language) : ""
      }));
      return z`
      <ha-card header="${_a("panels.codes.cards.user_management.title", this.hass.language)}">
        <div class="card-content">
          ${_a("panels.codes.cards.user_management.description", this.hass.language)}
        </div>
        ...
        <alarmo-table
          ...
          .data=${t}
          @row-click=${e => {
        const a = String(e.detail.id);
        Me(0, "/alarmo/codes/edit_user/" + a, !0);
      }}
        >
          ${_a("panels.codes.cards.user_management.no_items", this.hass.language)}
        </alarmo-table>
        <div class="card-actions">
          <mwc-button @click=${this.addUserClick}>
            ${_a("panels.codes.cards.user_management.actions.new_user", this.hass.language)}
          </mwc-button>
        </div>
      </ha-card>
    `;
  ...
  Ct.styles = qe, a([ae()], Ct.prototype, "narrow", void 0), a([ae()], Ct.prototype, "path", void 0), a([ae()], Ct.prototype, "config", void 0), a([ae()], Ct.prototype, "users", void 0), a([ae()], Ct.prototype, "code_arm_required", void 0), a([ae()], Ct.prototype, "code_disarm_required", void 0), a([ae()], Ct.prototype, "code_format", void 0), Ct = a([X("alarm-view-codes")], Ct);
  ...
  const St = (e, a) => {
    switch (e) {
      case Ne.ArmedAway:
        return {
          value: Ne.ArmedAway,
          name: _a("common.modes_long.armed_away", a.language),
          icon: Sa.ArmedAway
        };
      ...
      case Ne.ArmedHome:
        return {
          value: Ne.ArmedHome,
          name: _a("common.modes_long.armed_home", a.language),
          icon: Sa.ArmedHome
        };
      ...
      case Ne.ArmedNight:
        return {
          value: Ne.ArmedNight,
          name: _a("common.modes_long.armed_night", a.language),
          icon: Sa.ArmedNight
        };

      case Ne.ArmedCustom:
        return {
          value: Ne.ArmedCustom,
          name: _a("common.modes_long.armed_custom_bypass", a.language),
          icon: Sa.ArmedCustom
        };
    }
  },
    ...
    switch (e) {
      case Pe.Armed:
        return {
          value: Pe.Armed,
          name: _a("panels.actions.cards.new_notification.fields.event.choose.armed.name", a.language),
          description: _a("panels.actions.cards.new_notification.fields.event.choose.armed.description", a.language),
      ...
      case Pe.Disarmed:
        return {
          value: Pe.Disarmed,
          name: _a("panels.actions.cards.new_notification.fields.event.choose.disarmed.name", a.language),
          description: _a("panels.actions.cards.new_notification.fields.event.choose.disarmed.description", a.language),
      ...
      case Pe.Triggered:
        return {
          value: Pe.Triggered,
          name: _a("panels.actions.cards.new_notification.fields.event.choose.triggered.name", a.language),
          description: _a("panels.actions.cards.new_notification.fields.event.choose.triggered.description", a.language),
      ...
      case Pe.ArmFailure:
        return {
          value: Pe.ArmFailure,
          name: _a("panels.actions.cards.new_notification.fields.event.choose.arm_failure.name", a.language),
          description: _a("panels.actions.cards.new_notification.fields.event.choose.arm_failure.description", a.language),
      ...
      case Pe.Arming:
        return {
          value: Pe.Arming,
          name: _a("panels.actions.cards.new_notification.fields.event.choose.arming.name", a.language),
          description: _a("panels.actions.cards.new_notification.fields.event.choose.arming.description", a.language),
      ...
      case Pe.Pending:
        return {
          value: Pe.Pending,
          name: _a("panels.actions.cards.new_notification.fields.event.choose.pending.name", a.language),
          description: _a("panels.actions.cards.new_notification.fields.event.choose.pending.description", a.language),
    ...
    name: t.master.name,
    value: 0
  } : Object.keys(a).includes(String(e)) ? {
    name: a[e].name,
    value: e
  } : {
    name: String(e),
    ...
    const t = a.map(a => {
      ...
      let s = {
        value: a,
        name: i.replace(/_/g, " ").split(" ").map(e => e.substring(0, 1).toUpperCase() + e.substring(1)).join(" "),
        icon: "hass:home",
        description: a
      };
      ...
      switch (t) {
        case "notify":
          const a = e.states["device_tracker." + i.replace("mobile_app_", "")];
          s = a ? Object.assign(Object.assign({}, s), {
            name: a.attributes.friendly_name || je(a.entity_id),
            icon: a.attributes.icon || "hass:cellphone-text"
          }) : Object.assign(Object.assign({}, s), {
            icon: "hass:comment-alert"
          });
          break;
    ...
    return t.sort(Ba), t;
        ...
        zt = (e, a) => {
    let t = [];
    const i = Object.keys(e).filter(a => Object.values(e[a].modes).some(e => e.enabled));
    return a.master.enabled && i.length > 1 && (t = [...t, 0]), t = [...t, ...i], t;
  },
        qt = (e, a) => {
    const t = e => Object.keys(e.modes).filter(a => e.modes[a].enabled);

    if (Ia(e) && Object.keys(a).includes(String(e))) return t(a[e]);
    {
      const e = Object.keys(a).map(e => t(a[e]));
      return e[0].filter(a => e.every(e => e.includes(a)));
    }
  },
        Dt = (e, a) => e.map(e => ({
    value: e,
    name: e in a.states ? a.states[e].attributes.friendly_name || je(e) : e,
    icon: e in a.states ? a.states[e].attributes.icon || Se(xe(e)) : void 0,
    description: e
  })),
        Nt = e => [...Object.keys(e.services.notify).map(e => "notify." + e)],
        Pt = (...e) => {
    if (!e.length || !e.every(e => e.length)) return [];
    if (1 == e.length && e[0].length > 1 && La(e[0].map(xe)).length > 1) return Pt(...e[0].map(e => Array(e)));
    let a = [...e[0]];
    return e.forEach(e => {
      a = a.map(a => e.includes(a) ? a : "script" == xe(a) && e.map(xe).includes("script") ? "script.script" : e.map(je).includes(je(a)) ? "homeassistant." + je(a) : null).filter(Ia);
    }), a;
  },
        Lt = (e, a) => {
    if (Array.isArray(e)) {
      const t = e.map(e => Lt(e, a));
      return Pt(...t);
    }
    ...
    switch (t) {
      ...
      case "group":
        const i = e in a.states ? a.states[e] : void 0,
              s = (null == i ? void 0 : i.attributes.entity_id) || [];
        return Lt(s, a);
      ...
      default:
        ...
        Ut = (e, a) => {
    let t = [...Object.keys(e.states).filter(a => Lt(a, e).length)];
    return a && a.length && (t = [...t, ...a.filter(e => !t.includes(e))]), t.sort(Ba), t;
  },
        Rt = e => "string" == typeof e && e.trim().length,
        It = (e, a) => Rt(e) && a.services[xe(e)] && a.services[xe(e)][je(e)],
        Ht = (e, a) => Rt(e) && a.states[e],
        Ft = e => "object" == typeof e && null !== e && !Array.isArray(e),
        Gt = e => "string" == typeof e;

  let Yt = class extends Z {
    constructor() {
      super(...arguments), this.items = [], this.value = [], this.label = "", this.invalid = !1;
    }

    shouldUpdate(e) {
      return e.get("items") && (Ha(this.items, e.get("items")) || this.firstUpdated()), !0;
    }

    firstUpdated() {
      this.value.some(e => !this.items.map(e => e.value).includes(e)) && (this.value = this.value.filter(e => this.items.map(e => e.value).includes(e)), Oe(this, "value-changed", {
        value: this.value
      }));
    }
    ...
    render() {
      return z`
      <div class="chip-set">
        ${this.value.length ? this.value.map(e => this.items.find(a => a.value == e)).filter(Ia).map(e => z`
          <div class="chip">
    ...
    _removeClick(e) {
      this.value = this.value.filter(a => a !== e), Oe(this, "value-changed", {
        value: this.value
      });
    }
    ...
    _addClick(e) {
      ...
      const a = e.target,
            t = a.value;
      this.value.includes(t) || (this.value = [...this.value, t]), a.value = "", Oe(this, "value-changed", {
        value: [...this.value]
      });
    }
  ...
  var Vt;
  a([ae()], Yt.prototype, "hass", void 0), a([ae()], Yt.prototype, "items", void 0), a([ae({
    type: Array
  })], Yt.prototype, "value", void 0), a([ae()], Yt.prototype, "label", void 0), a([ae({
    type: Boolean
  })], Yt.prototype, "invalid", void 0), Yt = a([X("alarmo-selector")], Yt), function (e) {
    e[e.Yaml = 0] = "Yaml", e[e.UI = 1] = "UI";
  }(Vt || (Vt = {}));
  let Bt = class extends Z {
    constructor() {
      super(...arguments), this.config = {
        ...
        triggers: [{}],
        actions: [{}]
      }, this.viewMode = Vt.UI, this.errors = {};
    }

    async firstUpdated() {
      if (this.areas = await Oa(this.hass), this.alarmoConfig = await fa(this.hass), this.item) {
        let e = this.item.actions.map(e => Ra(e, "entity_id"));
        this.config = Object.assign(Object.assign({}, this.item), {
          actions: [e[0], ...e.slice(1)]
        }), this.config.triggers.length > 1 && (this.config = Object.assign(Object.assign({}, this.config), {
          triggers: [this.config.triggers[0]]
        }));
        let a = this.config.triggers[0].area;
        Ia(a) && !zt(this.areas, this.alarmoConfig).includes(a) ? a = void 0 : null === a && (a = 0), this._setArea(new CustomEvent("value-changed", {
          detail: {
            value: a
          }
        }));
      ...
      if (!Ia(this.config.triggers[0].area)) {
        const e = zt(this.areas, this.alarmoConfig);
        1 == e.length ? this._setArea(new CustomEvent("value-changed", {
          detail: {
            value: e[0]
          }
        })) : e.includes(0) && this._setArea(new CustomEvent("value-changed", {
          detail: {
            value: 0
          }
        }));
    ...
    render() {
      var e, a, t;
      return this.hass && this.areas && this.alarmoConfig ? z`
      <div class="heading">
        <ha-icon-button icon="hass:close" @click=${this._cancelClick} class="icon">
          <ha-icon icon="hass:close"></ha-icon>
        </ha-icon-button>
        <div class="header">${_a("panels.actions.cards.new_notification.title", this.hass.language)}</div>
        <div class="description">${_a("panels.actions.cards.new_notification.description", this.hass.language)}</div>
      </div>
      <div class="section-header">${_a("panels.actions.cards.new_notification.trigger", this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${_a("panels.actions.cards.new_notification.fields.event.heading", this.hass.language)}
            </span>
            <span slot="description">
              ${_a("panels.actions.cards.new_notification.fields.event.description", this.hass.language)}
            </span>

            <alarmo-select
              .hass=${this.hass}
              .items=${Object.values(Pe).map(e => Mt(e, this.hass))}
              label=${_a("panels.actions.cards.new_action.fields.event.heading", this.hass.language)}
              icons=${!0}
          ...
          <settings-row .narrow=${this.narrow} .large=${!0}>
            <span slot="heading">
              ${_a("panels.actions.cards.new_action.fields.area.heading", this.hass.language)}
            </span>
            <span slot="description">
              ${_a("panels.actions.cards.new_action.fields.area.description", this.hass.language)}
            </span>
            
            <alarmo-select
              .hass=${this.hass}
              .items=${zt(this.areas, this.alarmoConfig).map(e => Tt(e, this.areas, this.alarmoConfig))}
              clearable=${!0}
              label=${_a("panels.actions.cards.new_action.fields.area.heading", this.hass.language)}
          ...
          <settings-row .narrow=${this.narrow} .large=${!0} last>
            <span slot="heading">
              ${_a("panels.actions.cards.new_notification.fields.mode.heading", this.hass.language)}
            </span>
            <span slot="description">
              ${_a("panels.actions.cards.new_notification.fields.mode.description", this.hass.language)}
            </span>

            <alarmo-selector
              .hass=${this.hass}
              .items=${qt(this.config.triggers[0].area, this.areas).map(e => St(e, this.hass))}
              label=${_a("panels.actions.cards.new_action.fields.mode.heading", this.hass.language)}
      ...
      <div class="section-header">${_a("panels.actions.cards.new_notification.action", this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          ${this.viewMode == Vt.UI ? z`
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${_a("panels.actions.cards.new_notification.fields.target.heading", this.hass.language)}
            </span>
            <span slot="description">
              ${_a("panels.actions.cards.new_notification.fields.target.description", this.hass.language)}
            </span>
    
            <alarmo-select
              .hass=${this.hass}
              .items=${Et(this.hass, ...Nt(this.hass))}
              ?disabled=${!Nt(this.hass).length}
              label=${_a("panels.actions.cards.new_notification.fields.target.heading", this.hass.language)}
              icons=${!0}
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${_a("panels.actions.cards.new_notification.fields.title.heading", this.hass.language)}
            </span>
            <span slot="description">
              ${_a("panels.actions.cards.new_notification.fields.title.description", this.hass.language)}
            </span>
    
            <paper-input
              label="${_a("panels.actions.cards.new_notification.fields.title.heading", this.hass.language)}"
          ...
          <settings-row .narrow=${this.narrow} .large=${!0} last>
            <span slot="heading">
              ${_a("panels.actions.cards.new_notification.fields.message.heading", this.hass.language)}
            </span>
            <span slot="description">
              ${_a("panels.actions.cards.new_notification.fields.message.description", this.hass.language)}
            </span>
    
            <paper-textarea
              id="message"
              label="${_a("panels.actions.cards.new_notification.fields.message.heading", this.hass.language)}"
            ...
            ${this.config.triggers[0].event ? z`
            <div style="margin-top: 10px">
              <span style="padding-right: 10px">
                ${_a("panels.actions.cards.new_notification.fields.message.insert_wildcard", this.hass.language)}:
              </span>
              <alarmo-chips
                .items=${(e => {
        let a = [];
        return a = [], e && ![Pe.Pending, Pe.Triggered, Pe.ArmFailure].includes(e) || (a = [...a, {
          name: "Open Sensors",
          value: "{{open_sensors}}"
        }]), e && ![Pe.Armed].includes(e) || (a = [...a, {
          name: "Bypassed Sensors",
          value: "{{bypassed_sensors}}"
        }]), e && ![Pe.Armed, Pe.Arming, Pe.Disarmed].includes(e) || (a = [...a, {
          name: "Changed By",
          value: "{{changed_by}}"
        }]), e && ![Pe.Armed, Pe.Arming, Pe.Pending, Pe.Triggered, Pe.ArmFailure].includes(e) || (a = [...a, {
          name: "Arm Mode",
          value: "{{arm_mode}}"
        }]), a;
          ...
          <h2>${_a("components.editor.edit_in_yaml", this.hass.language)}</h2>
          ...
          ${this.errors.service || this.errors.title || this.errors.message ? z`
        ...
        <div class="toggle-button">
          <mwc-button @click=${this._toggleYamlMode}>
            ...
            ${this.viewMode == Vt.Yaml ? _a("components.editor.ui_mode", this.hass.language) : _a("components.editor.yaml_mode", this.hass.language)}
          </mwc-button>
        </div>

        <div class="card-actions">
          <mwc-button trailingIcon ?disabled=${!this._validAction()} @click=${this._testClick}>
            ${_a("panels.actions.cards.new_notification.actions.test", this.hass.language)}
            <ha-icon icon="hass:arrow-right"></ha-icon>
          </mwc-button>
        </div>
      </ha-card>

      <div class="section-header">${_a("panels.actions.cards.new_notification.options", this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${_a("panels.actions.cards.new_notification.fields.name.heading", this.hass.language)}
            </span>
            <span slot="description">
              ${_a("panels.actions.cards.new_notification.fields.name.description", this.hass.language)}
            </span>

            <paper-input
              label="${_a("panels.actions.cards.new_notification.fields.name.heading", this.hass.language)}"
        ...
        ${(null === (t = this.item) || void 0 === t ? void 0 : t.automation_id) ? z`
          <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${_a("panels.actions.cards.new_notification.fields.delete.heading", this.hass.language)}
          </span>
          <span slot="description">
            ${_a("panels.actions.cards.new_notification.fields.delete.description", this.hass.language)}
          </span>
          <div>
    ...
    _setEvent(e) {
      e.stopPropagation();
      const a = e.detail.value;
      let t = this.config.triggers;
      Object.assign(t, {
        0: Object.assign(Object.assign({}, t[0]), {
          event: a
        })
      }), this.config = Object.assign(Object.assign({}, this.config), {
        triggers: t
      }), Object.keys(this.errors).includes("event") && this._validateConfig();
    }
    ...
    _setArea(e) {
      ...
      let i = this.config.triggers;
      Object.assign(i, {
        0: Object.assign(Object.assign({}, i[0]), {
          area: t
        })
      });
      const s = qt(t, this.areas);
      (null === (a = i[0].modes) || void 0 === a ? void 0 : a.length) ? this._setModes(new CustomEvent("value-changed", {
        detail: {
          value: i[0].modes.filter(e => s.includes(e))
        }
        ...
        triggers: i
      }), Object.keys(this.errors).includes("area") && this._validateConfig();
    }
    ...
    _setModes(e) {
      ...
      Object.assign(t, {
        ...
        triggers: t
      }), Object.keys(this.errors).includes("modes") && this._validateConfig();
    }

    _setService(e) {
      e.stopPropagation();
      const a = String(e.detail.value);
      let t = this.config.actions;
      Object.assign(t, {
        0: Object.assign(Object.assign(Object.assign({}, t[0]), {
          service: a
        }), Ra(t[0], "service"))
      }), this.config = Object.assign(Object.assign({}, this.config), {
        actions: t
      }), Object.keys(this.errors).includes("service") && this._validateConfig();
    }
    ...
    _setTitle(e) {
      ...
      Object.assign(t, {
        0: Object.assign(Object.assign({}, t[0]), {
          service: t[0].service || "",
          service_data: Object.assign(Object.assign({}, t[0].service_data || {}), {
            title: a
          })
        })
      }), this.config = Object.assign(Object.assign({}, this.config), {
        actions: t
      }), Object.keys(this.errors).includes("title") && this._validateConfig();
    }
    ...
    _setMessage(e) {
      ...
      Object.assign(t, {
        ...
        actions: t
      }), Object.keys(this.errors).includes("message") && this._validateConfig();
    }
    ...
    _setYaml(e) {
      const a = e.detail.value;
      let t = {};
      Gt(null == a ? void 0 : a.service) && (t = Object.assign(Object.assign({}, t), {
        service: String(a.service)
      })), Ft(null == a ? void 0 : a.service_data) && (t = Object.assign(Object.assign({}, t), {
        service_data: a.service_data
      })), Object.keys(t).length && (this.config = Object.assign(Object.assign({}, this.config), {
        actions: Object.assign(this.config.actions, {
          0: Object.assign(Object.assign({}, this.config.actions[0]), t)
        })
      })), Object.keys(this.errors).some(e => ["service", "message", "title"].includes(e)) && this._validateConfig();
    }
    ...
    _validateConfig() {
      ...
      const t = this._parseAutomation(),
            i = t.triggers[0];

      i.event && Object.values(Pe).includes(i.event) || (this.errors = Object.assign(Object.assign({}, this.errors), {
        event: !0
      })), Ia(i.area) && zt(this.areas, this.alarmoConfig).includes(i.area) || (this.errors = Object.assign(Object.assign({}, this.errors), {
        area: !0
      })), (null === (e = i.modes) || void 0 === e ? void 0 : e.every(e => qt(i.area, this.areas).includes(e))) || (this.errors = Object.assign(Object.assign({}, this.errors), {
        modes: !0
      }));
      const s = t.actions[0];
      return s.service && (Nt(this.hass).includes(s.service) || "script" == xe(s.service)) || (this.errors = Object.assign(Object.assign({}, this.errors), {
        service: !0
      })), Rt(null === (a = s.service_data) || void 0 === a ? void 0 : a.message) || (this.errors = Object.assign(Object.assign({}, this.errors), {
        message: !0
      })), Rt(t.name) || (this.errors = Object.assign(Object.assign({}, this.errors), {
        name: !0
    ...
    _validAction() {
      ...
      const a = this._parseAutomation().actions[0];

      return a.service && ("script" == xe(a.service) || Nt(this.hass).includes(a.service)) && Rt(null === (e = a.service_data) || void 0 === e ? void 0 : e.message);
    }

    _insertWildCard(e) {
      var a;
      const t = this.shadowRoot.querySelector("#message");
      t && t.focus();
      let i = (null === (a = this.config.actions[0].service_data) || void 0 === a ? void 0 : a.message) || "";
      i = t && null !== t.selectionStart && null !== t.selectionEnd ? i.substring(0, t.selectionStart) + e + i.substring(t.selectionEnd, i.length) : i + e, this._setMessage(new CustomEvent("value-changed", {
        detail: {
          value: i
        }
      }));
    ...
    _toggleYamlMode() {
      var e, a;
      this.viewMode = this.viewMode == Vt.UI ? Vt.Yaml : Vt.UI, this.viewMode == Vt.Yaml && (this.config = Object.assign(Object.assign({}, this.config), {
        actions: Object.assign(this.config.actions, {
          0: Object.assign(Object.assign({}, this.config.actions[0]), {
            service: this.config.actions[0].service || "",
            service_data: Object.assign(Object.assign({}, this.config.actions[0].service_data || {}), {
              title: (null === (e = this.config.actions[0].service_data) || void 0 === e ? void 0 : e.title) || "",
              message: (null === (a = this.config.actions[0].service_data) || void 0 === a ? void 0 : a.message) || ""
            })
          })
        })
      }));
    ...
    _namePlaceholder() {
      const e = this.config.triggers[0].event,
            a = this.config.actions[0].service ? xe(this.config.actions[0].service) : null,
            t = Et(this.hass, this.config.actions[0].service);
      return e && "notify" == a && t.length ? _a("panels.actions.cards.new_notification.fields.name.placeholders." + e, this.hass.language, "{target}", t[0].name) : "";
    }

    _messagePlaceholder() {
      const e = this.config.triggers[0].event;
      return e ? _a("panels.actions.cards.new_notification.fields.message.placeholders." + e, this.hass.language) : "";
    }

    _parseAutomation() {
      var e;
      let a = Object.assign({}, this.config),
          t = a.actions[0];
      return !Rt(null === (e = t.service_data) || void 0 === e ? void 0 : e.message) && this.viewMode == Vt.UI && this._messagePlaceholder() && (t = Object.assign(Object.assign({}, t), {
        service_data: Object.assign(Object.assign({}, t.service_data), {
          message: this._messagePlaceholder()
        })
      }), Object.assign(a, {
        actions: Object.assign(a.actions, {
          0: t
        })
      })), !Rt(a.name) && this._namePlaceholder() && (a = Object.assign(Object.assign({}, a), {
        name: this._namePlaceholder()
      })), a;
    }
    ...
    _saveClick(e) {
      ...
      let a = this._parseAutomation();

      qt(a.triggers[0].area, this.areas).every(e => {
        var t;
        return null === (t = a.triggers[0].modes) || void 0 === t ? void 0 : t.includes(e);
      }) && (a = Object.assign(Object.assign({}, a), {
        triggers: Object.assign(a.triggers, {
          0: Object.assign(Object.assign({}, a.triggers[0]), {
            modes: []
          })
        })
      })), this.item && (a = Object.assign(Object.assign({}, a), {
        automation_id: this.item.automation_id
      })), xa(this.hass, a).catch(a => Ga(a, e)).then(() => this._cancelClick());
    }

    _deleteClick(e) {
      var a;
      (null === (a = this.item) || void 0 === a ? void 0 : a.automation_id) && ja(this.hass, this.item.automation_id).catch(a => Ga(a, e)).then(() => this._cancelClick());
    }
    ...
    _testClick(e) {
      ...
      let s = a.service_data.message;
      s = s.replace("{{open_sensors}}", "Some Example Sensor is open"), s = s.replace("{{bypassed_sensors}}", "Some Bypassed Sensor"), s = s.replace("{{arm_mode}}", "Armed away"), s = s.replace("{{changed_by}}", "Some Example User"), this.hass.callService(t, i, Object.assign(Object.assign({}, a.service_data), {
        message: s
      })).then().catch(a => {
        Fa(e, a.message);
      });
  ...
  a([ae({
    attribute: !1
  })], Bt.prototype, "hass", void 0), a([ae()], Bt.prototype, "narrow", void 0), a([ae()], Bt.prototype, "config", void 0), a([ae()], Bt.prototype, "item", void 0), a([ae()], Bt.prototype, "areas", void 0), a([ae()], Bt.prototype, "alarmoConfig", void 0), a([ae()], Bt.prototype, "viewMode", void 0), a([ae()], Bt.prototype, "errors", void 0), Bt = a([X("notification-editor-card")], Bt), function (e) {
    e[e.Yaml = 0] = "Yaml", e[e.UI = 1] = "UI";
  }(Qt || (Qt = {}));
  let Wt = class extends Z {
    constructor() {
      super(...arguments), this.config = {
        ...
        triggers: [{}],
        actions: [{}]
      }, this.viewMode = Qt.UI, this.errors = {};
    }

    async firstUpdated() {
      if (this.areas = await Oa(this.hass), this.alarmoConfig = await fa(this.hass), this.item) {
        let e = this.item.actions.map(e => e.entity_id ? e : Ra(e, "entity_id"));
        this.config = Object.assign(Object.assign({}, this.item), {
          actions: [e[0], ...e.slice(1)]
        }), this.config.triggers.length > 1 && (this.config = Object.assign(Object.assign({}, this.config), {
          triggers: [this.config.triggers[0]]
        ...
        })), this._hasCustomEntities() && (this.viewMode = Qt.Yaml);
      }
    ...
    render() {
      ...
      <div class="heading">
        ...
        <div class="header">${_a("panels.actions.cards.new_action.title", this.hass.language)}</div>
        <div class="description">${_a("panels.actions.cards.new_action.description", this.hass.language)}</div>
      </div>
      <div class="section-header">${_a("panels.actions.cards.new_notification.trigger", this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
      ...
      <ha-card>
        <div class="card-content">
          ${this.viewMode == Qt.UI ? z`
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${_a("panels.actions.cards.new_action.fields.entity.heading", this.hass.language)}
            </span>
            <span slot="description">
              ${_a("panels.actions.cards.new_action.fields.entity.description", this.hass.language)}
            </span>
    
            <alarmo-selector
              .hass=${this.hass}
              .items=${Dt(Ut(this.hass, this._getEntities()), this.hass)}
              ?disabled=${!Ut(this.hass, this._getEntities()).length}
              label=${_a("panels.actions.cards.new_action.fields.entity.heading", this.hass.language)}
        ...
        ${this.config.actions.map(e => e.entity_id).length ? z`        
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${_a("panels.actions.cards.new_action.fields.action.heading", this.hass.language)}
            </span>
            <span slot="description">
              ${_a("panels.actions.cards.new_action.fields.action.description", this.hass.language)}
            </span>
        ...
        ${this.errors.service || this.errors.entity_id ? z`
          <span class="error-message">
        ...
        <div class="toggle-button">
          <mwc-button @click=${this._toggleYamlMode}>
            <ha-icon icon="hass:shuffle-variant"></ha-icon>
            ${this.viewMode == Qt.Yaml ? _a("components.editor.ui_mode", this.hass.language) : _a("components.editor.yaml_mode", this.hass.language)}
          </mwc-button>
        </div>
      ...
      <ha-card>
        <div class="card-content">
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${_a("panels.actions.cards.new_action.fields.name.heading", this.hass.language)}
            </span>
            <span slot="description">
              ${_a("panels.actions.cards.new_action.fields.name.description", this.hass.language)}
            </span>

            <paper-input
              label="${_a("panels.actions.cards.new_action.fields.name.heading", this.hass.language)}"
              placeholder=${this._namePlaceholder()}
              .value=${this.config.name}
              @value-changed=${this._setName}
              ?invalid=${this.errors.name}
        ...
        ${(null === (e = this.item) || void 0 === e ? void 0 : e.automation_id) ? z`
          <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${_a("panels.actions.cards.new_notification.fields.delete.heading", this.hass.language)}
          </span>
    ...
    renderActions() {
      let e = this.config.actions.map(e => e.entity_id),
          a = Lt(e, this.hass);
      if (!a.length) return _a("panels.actions.cards.new_action.fields.action.no_common_actions", this.hass.language);
      return a.map(e => z`
      <mwc-button
        class="${((...e) => !!e.every(Ia) && 1 == La(Pt(e.filter(Ia))).length)(this._selectedAction(), e) ? "active" : ""}"
      ...
      >
        ...
        switch ("script" == xe(e) && (t = "run"), t) {
          case "turn_on":
            return a.localize("ui.card.media_player.turn_on");

          case "turn_off":
            return a.localize("ui.card.media_player.turn_off");

          case "lock":
            return a.localize("ui.card.lock.lock");

          case "unlock":
            return a.localize("ui.card.lock.unlock");

          case "run":
            return a.localize("ui.card.script.run");
    ...
    _selectedAction() {
      let e = this.config.actions.map(e => e.service);
      return e.every(Ia) ? (e = La(Pt(e.filter(Ia))), 1 == e.length ? e[0] : null) : null;
    }
    ...
    _setArea(e) {
      ...
      Object.assign(i, {
        ...
        triggers: i
      }), (null === (a = this.config.triggers[0].modes) || void 0 === a ? void 0 : a.length) || this._setModes(new CustomEvent("value-changed", {
        detail: {
          value: qt(t, this.areas)
        }
      })), Object.keys(this.errors).includes("area") && this._validateConfig();
    }
    ...
    _setEntity(e) {
      ...
      if (a.length > t.length && this._selectedAction() && (i = this._selectedAction()), t.length > a.length) {
        let e = t.findIndex(e => !a.includes(e.entity_id || ""));
        e < 0 && (e = t.length - 1), t.splice(e, 1);
      }

      a.length || Object.assign(t, {
        0: Ra(t[0], "entity_id")
      }), a.forEach((e, a) => {
        let i = t.length > a ? Object.assign({}, t[a]) : {};
        i = i.entity_id == e ? Object.assign({}, i) : {
          entity_id: e
        }, Object.assign(t, {
          [a]: i
        });
        ...
        actions: t
      }), i && this._setAction(i), Object.keys(this.errors).includes("entity_id") && this._validateConfig();
    }

    _setAction(e) {
      let a = this.config.actions,
          t = this.config.actions.map(e => e.entity_id);
      Lt(t, this.hass).length && (a.forEach((t, i) => {
        let s = Lt(t.entity_id, this.hass),
            n = (r = e, s.find(e => e == r || "turn_on" == je(r) && "turn_on" == je(e) || "turn_off" == je(r) && "turn_off" == je(e) || "script" == xe(r) && "script" == xe(e)));
        var r;
        Object.assign(a, {
          [i]: Object.assign({
            service: n
    ...
    _setYaml(e) {
      let a = e.detail.value,
          t = [{}];
      var i;
      Ft(a) && (a = [a]), "object" == typeof (i = a) && null !== i && Array.isArray(i) && (a.forEach((e, a) => {
        let i = {};
        Ft(e) && Gt(e.service) && (i = Object.assign(Object.assign({}, i), {
          service: e.service
        })), Ft(e) && Gt(e.entity_id) && (i = Object.assign(Object.assign({}, i), {
          entity_id: e.entity_id
        })), Ft(e) && Ft(e.service_data) && (i = Object.assign(Object.assign({}, i), {
    ...
    _validateConfig() {
      ...
      const a = this._parseAutomation(),
            t = a.triggers[0];

      t.event && Object.values(Pe).includes(t.event) || (this.errors = Object.assign(Object.assign({}, this.errors), {
        event: !0
      })), Ia(t.area) && zt(this.areas, this.alarmoConfig).includes(t.area) || (this.errors = Object.assign(Object.assign({}, this.errors), {
        area: !0
      })), (null === (e = t.modes) || void 0 === e ? void 0 : e.every(e => qt(t.area, this.areas).includes(e))) || (this.errors = Object.assign(Object.assign({}, this.errors), {
        modes: !0
      }));
      let i = a.actions.map(e => e.entity_id);
      this.viewMode == Qt.Yaml && (i = i.filter(Ia)), a.actions.length && i.every(e => Ht(e, this.hass)) || (this.errors = Object.assign(Object.assign({}, this.errors), {
        entity_id: !0
      }));
      const s = a.actions.map(e => e.service);

      if (!s.length || !s.every(e => It(e, this.hass))) {
        this.errors = Object.assign(Object.assign({}, this.errors), {
          service: !0
        }), Lt(i, this.hass).length || (this.viewMode = Qt.Yaml);
      }

      return Rt(a.name) || (this.errors = Object.assign(Object.assign({}, this.errors), {
        name: !0
      })), !Object.values(this.errors).length;
    }

    _validAction() {
      const e = this._parseAutomation(),
            a = e.actions.map(e => e.service);

      let t = e.actions.map(e => e.entity_id);
      return this.viewMode == Qt.Yaml && (t = t.filter(Ia)), a.length && a.every(e => It(e, this.hass)) && t.every(e => Ht(e, this.hass));
    }

    _toggleYamlMode() {
      this.viewMode = this.viewMode == Qt.UI ? Qt.Yaml : Qt.UI, this.viewMode == Qt.Yaml && (this.config = Object.assign(Object.assign({}, this.config), {
        actions: Object.assign(this.config.actions, {
          0: Object.assign(Object.assign({}, this.config.actions[0]), {
            service: this.config.actions[0].service || "",
            service_data: Object.assign({}, this.config.actions[0].service_data || {})
          })
        })
      }));
    }
    ...
    _namePlaceholder() {
      ...
      const s = this.config.triggers[0].event,
            n = this.config.actions.map(e => e.entity_id).filter(Ia),
            r = Dt(n, this.hass).map(e => e.name).join(", "),
            o = La(this.config.actions.map(e => e.service).filter(Ia).map(e => je(e)));
      let d = void 0;
      return 1 == o.length && (null === (e = o[0]) || void 0 === e ? void 0 : e.includes("turn_on")) && (d = this.hass.localize("state.default.on")), 1 == o.length && (null === (a = o[0]) || void 0 === a ? void 0 : a.includes("turn_off")) && (d = this.hass.localize("state.default.off")), 1 == o.length && (null === (t = o[0]) || void 0 === t ? void 0 : t.includes("lock")) && (d = this.hass.localize("component.lock.state._.locked")), 1 == o.length && (null === (i = o[0]) || void 0 === i ? void 0 : i.includes("unlock")) && (d = this.hass.localize("component.lock.state._.unlocked")), s && r && d ? _a("panels.actions.cards.new_action.fields.name.placeholders." + s, this.hass.language, ["{entity}", "{state}"], [r, d]) : "";
    }

    _getEntities() {
      return La(this.config.actions.map(e => e.entity_id).filter(Ia)) || [];
    }

    _hasCustomEntities() {
      return this._getEntities().some(e => !Ut(this.hass).includes(e));
    }

    _parseAutomation() {
      let e = Object.assign({}, this.config);
      return !Rt(e.name) && this._namePlaceholder() && (e = Object.assign(Object.assign({}, e), {
        name: this._namePlaceholder()
      })), e;
    }
    ...
    _testClick(e) {
      this._parseAutomation().actions.forEach(a => {
        const [t, i] = a.service.split(".");
        let s = Object.assign({}, a.service_data);
        a.entity_id && (s = Object.assign(Object.assign({}, s), {
          entity_id: a.entity_id
        })), this.hass.callService(t, i, s).then().catch(a => {
          Fa(e, a.message);
        });
      });
    }
  ...
  a([ae({
    attribute: !1
  })], Wt.prototype, "hass", void 0), a([ae()], Wt.prototype, "narrow", void 0), a([ae()], Wt.prototype, "config", void 0), a([ae()], Wt.prototype, "item", void 0), a([ae()], Wt.prototype, "areas", void 0), a([ae()], Wt.prototype, "alarmoConfig", void 0), a([ae()], Wt.prototype, "viewMode", void 0), a([ae()], Wt.prototype, "errors", void 0), Wt = a([X("automation-editor-card")], Wt);
  let Kt = class extends Qa(Z) {
    constructor() {
      super(...arguments), this.areas = {}, this.notificationFilterOptions = [], this.automationFilterOptions = [], this.getAreaForAutomation = e => {
        const a = zt(this.areas, this.config);
        let t = e.triggers[0].area;
        return Ia(t) && a.includes(t) ? t : void 0;
      };
    }
    ...
    async _fetchData() {
      if (!this.hass) return;
      const e = await wa(this.hass);
      this.automations = Object.values(e), this.areas = await Oa(this.hass), this.config = await fa(this.hass), this.notificationFilterOptions = [...zt(this.areas, this.config).map(a => Object(Object.assign(Object.assign({}, Tt(a, this.areas, this.config)), {
        count: Object.values(e).filter(e => e.type == qa.Notification).map(this.getAreaForAutomation).filter(e => e == a).length
      })))].sort(Ba), this.automationFilterOptions = [...zt(this.areas, this.config).map(a => Object(Object.assign(Object.assign({}, Tt(a, this.areas, this.config)), {
        count: Object.values(e).filter(e => e.type == qa.Action).map(this.getAreaForAutomation).filter(e => e == a).length
      })))].sort(Ba), Object.values(e).filter(e => e.type == qa.Notification).map(this.getAreaForAutomation).filter(e => !Ia(e)).length && (this.notificationFilterOptions = [{
        value: "no_area",
        name: _a("panels.actions.cards.notifications.filter.no_area", this.hass.language),
        count: Object.values(e).filter(e => e.type == qa.Notification).map(this.getAreaForAutomation).filter(e => !Ia(e)).length
      }, ...this.notificationFilterOptions]), Object.values(e).filter(e => e.type == qa.Action).map(this.getAreaForAutomation).filter(e => !Ia(e)).length && (this.automationFilterOptions = [{
        value: "no_area",
        name: _a("panels.actions.cards.notifications.filter.no_area", this.hass.language),
        count: Object.values(e).filter(e => e.type == qa.Action).map(this.getAreaForAutomation).filter(e => !Ia(e)).length
      }, ...this.automationFilterOptions]);
    }

    firstUpdated() {
      this.path && 2 == this.path.length && "filter" == this.path[0] && (this.notificationFilter = this.path[1], this.automationFilter = this.path[1]), (async () => {
        await ze();
      })();
    }
    ...
    render() {
      var e;
      if (!this.hass || !this.automations) return z``;

      if ((null === (e = this.path) || void 0 === e ? void 0 : e.length) && ["new_notification", "edit_notification"].includes(this.path[0])) {
        const e = this.automations.find(e => this.path.length > 1 && e.automation_id == this.path[1] && e.type == qa.Notification);
        return z`
      ...
      if (this.path && 2 == this.path.length && "edit_action" == this.path[0]) {
        const e = this.automations.find(e => this.path.length > 1 && e.automation_id == this.path[1] && e.type == qa.Action);
        return z`
        <automation-editor-card
          .hass=${this.hass}
          .narrow=${this.narrow}
...

      {
        const e = {
          ...
          enabled: {
            ...
            align: "center"
              ...
              a = this.automations.filter(e => e.type == qa.Notification).filter(e => !Ia(this.notificationFilter) || !this.notificationFilterOptions.find(e => e.value == this.notificationFilter) || this.getAreaForAutomation(e) == this.notificationFilter || "no_area" === this.notificationFilter && !Ia(this.getAreaForAutomation(e))).map(e => Object({
          id: e.automation_id,
          type: z`
          ...
          enabled: z`
              <ha-switch
                ?checked=${e.enabled}
                @click=${a => {
            a.stopPropagation(), this.toggleEnable(a, e.automation_id);
          }}
              ></ha-switch>
            `
        })),
              t = this.automations.filter(e => e.type == qa.Action).filter(e => !Ia(this.notificationFilter) || !this.automationFilterOptions.find(e => e.value == this.automationFilter) || this.getAreaForAutomation(e) == this.notificationFilter || "no_area" === this.notificationFilter && !Ia(this.getAreaForAutomation(e))).map(e => Object({
          id: e.automation_id,
          type: z`
        ...
        return z`
        <ha-card header="${_a("panels.actions.cards.notifications.title", this.hass.language)}">
          <div class="card-content">
            ${_a("panels.actions.cards.notifications.description", this.hass.language)}
          </div>

          ${this.notificationFilterOptions.length > 1 ? z`
                <div class="table-filter" ?narrow=${this.narrow}>
                  <span class="header"
                    >${_a("panels.actions.cards.notifications.filter.label", this.hass.language)}:</span
                  >
                  <alarmo-chips
          ...
          <alarmo-table
            ...
            @row-click=${e => {
          const a = String(e.detail.id);
          Me(0, "/alarmo/actions/edit_notification/" + a, !0);
        }}
          >
            ${_a("panels.actions.cards.notifications.table.no_items", this.hass.language)}
          </alarmo-table>

          <div class="card-actions">
            <mwc-button @click=${this.addNotificationClick}>
              ${_a("panels.actions.cards.notifications.actions.new_notification", this.hass.language)}
            </mwc-button>
          </div>
        </ha-card>

        <ha-card header="${_a("panels.actions.title", this.hass.language)}">
          <div class="card-content">${_a("panels.actions.cards.actions.description", this.hass.language)}</div>

          ${this.automationFilterOptions.length > 1 ? z`
                <div class="table-filter" ?narrow=${this.narrow}>
                  <span class="header"
                    >${_a("panels.actions.cards.notifications.filter.label", this.hass.language)}:</span
                  >
          ...
          <alarmo-table
            ...
            @row-click=${e => {
          const a = String(e.detail.id);
          Me(0, "/alarmo/actions/edit_action/" + a, !0);
        }}
          >
            ${_a("panels.actions.cards.actions.table.no_items", this.hass.language)}
          </alarmo-table>

          <div class="card-actions">
            <mwc-button @click=${this.addActionClick}>
              ${_a("panels.actions.cards.actions.actions.new_action", this.hass.language)}
            </mwc-button>
          </div>
        </ha-card>
      `;
    ...
    addNotificationClick() {
      Me(0, "/alarmo/actions/new_notification", !0);
    }

    addActionClick() {
      Me(0, "/alarmo/actions/new_action", !0);
    }

  };
  Kt.styles = qe, a([ae()], Kt.prototype, "hass", void 0), a([ae()], Kt.prototype, "narrow", void 0), a([ae()], Kt.prototype, "path", void 0), a([ae()], Kt.prototype, "alarmEntity", void 0), a([ae()], Kt.prototype, "automations", void 0), a([ae()], Kt.prototype, "areas", void 0), a([ae()], Kt.prototype, "config", void 0), a([ae()], Kt.prototype, "notificationFilter", void 0), a([ae()], Kt.prototype, "automationFilter", void 0), a([ae()], Kt.prototype, "notificationFilterOptions", void 0), a([ae()], Kt.prototype, "automationFilterOptions", void 0), Kt = a([X("alarm-view-actions")], Kt), e.MyAlarmPanel = class extends Z {
    async firstUpdated() {
      window.addEventListener("location-changed", () => {
        this.requestUpdate();
      }), await ze(), this.userConfig = await ya(this.hass), this.requestUpdate();
    }

    render() {
      if (!customElements.get("ha-app-layout") || !this.userConfig) return z`
        loading...
      `;
      const e = Object.values(this.userConfig).find(e => e.name.toLowerCase() == this.hass.user.name.toLowerCase());
      return this.hass.user.is_admin || e && e.is_admin ? z`
        <ha-app-layout>
          <app-header fixed slot="header">
            <app-toolbar>
              <ha-menu-button .hass=${this.hass} .narrow=${this.narrow}> </ha-menu-button>
              <div main-title>
                ${_a("title", this.hass.language)}
              </div>
              <div class="version">
                v${"1.7.5"}
              </div>
            ...
            >
              <paper-tab page-name="general">
                ${_a("panels.general.title", this.hass.language)}
              </paper-tab>
              <paper-tab page-name="sensors">
                ${_a("panels.sensors.title", this.hass.language)}
              </paper-tab>
              <paper-tab page-name="codes">
                ${_a("panels.codes.title", this.hass.language)}
              </paper-tab>
              <paper-tab page-name="actions">
                ${_a("panels.actions.title", this.hass.language)}
              </paper-tab>
            </ha-tabs>
          </app-header>
        </ha-app-layout>
              ...
              <div class="card-content">
                ...
                <ul>
                  <li>
                    ...
                    ${e ? z`This user <b>${e.is_admin ? "does" : "does NOT"}</b> have administrator permission. ` : ""}
                  </li>
                </ul>
              </div>
            </ha-card>
    ...
    handlePageSelected(e) {
      const a = e.detail.item.getAttribute("page-name");
      a !== this.getPath() ? (Me(0, "/alarmo/" + a), this.requestUpdate()) : scrollTo(0, 0);
    }
  ...
  }, a([ae()], e.MyAlarmPanel.prototype, "hass", void 0), a([ae({
    type: Boolean,
    reflect: !0
  })], e.MyAlarmPanel.prototype, "narrow", void 0), a([ae()], e.MyAlarmPanel.prototype, "userConfig", void 0), e.MyAlarmPanel = a([X("alarm-panel")], e.MyAlarmPanel);
}({});
