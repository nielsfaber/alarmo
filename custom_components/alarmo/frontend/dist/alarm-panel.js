...
/*! *****************************************************************************
    ...
    OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
    PERFORMANCE OF THIS SOFTWARE.
    ***************************************************************************** */var ma,ua,pa,ga=function(){return(ga=Object.assign||function(e){for(var t,a=1,i=arguments.length;a<i;a++)for(var s in t=arguments[a])Object.prototype.hasOwnProperty.call(t,s)&&(e[s]=t[s]);return e}).apply(this,arguments)};function va(e){return e.type===ua.literal}function _a(e){return e.type===ua.argument}function fa(e){return e.type===ua.number}function ba(e){return e.type===ua.date}function ya(e){return e.type===ua.time}function wa(e){return e.type===ua.select}function ka(e){return e.type===ua.plural}function Aa(e){return e.type===ua.pound}function $a(e){return e.type===ua.tag}function ja(e){return!(!e||"object"!=typeof e||e.type!==pa.number)}function xa(e){return!(!e||"object"!=typeof e||e.type!==pa.dateTime)}!function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"}(ma||(ma={})),function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"}(ua||(ua={})),function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"}(pa||(pa={}));var Oa=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/,Ta=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function Ea(e){var t={};return e.replace(Ta,(function(e){var a=e.length;switch(e[0]){case"G":t.era=4===a?"long":5===a?"narrow":"short";break;case"y":t.year=2===a?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=4===a?"short":5===a?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][a-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][a-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][a-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][a-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][a-1];break;case"s":t.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""})),t}
/*! *****************************************************************************
    Copyright (c) Microsoft Corporation.
    ...
    OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
    PERFORMANCE OF THIS SOFTWARE.
    ***************************************************************************** */var za=function(){return(za=Object.assign||function(e){for(var t,a=1,i=arguments.length;a<i;a++)for(var s in t=arguments[a])Object.prototype.hasOwnProperty.call(t,s)&&(e[s]=t[s]);return e}).apply(this,arguments)},Sa=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;var Ca,Ma=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,Na=/^(@+)?(\+|#+)?[rs]?$/g,Da=/(\*)(0+)|(#+)(0+)|(0+)/g,La=/^(0+)$/;function Pa(e){var t={};return"r"===e[e.length-1]?t.roundingPriority="morePrecision":"s"===e[e.length-1]&&(t.roundingPriority="lessPrecision"),e.replace(Na,(function(e,a,i){return"string"!=typeof i?(t.minimumSignificantDigits=a.length,t.maximumSignificantDigits=a.length):"+"===i?t.minimumSignificantDigits=a.length:"#"===a[0]?t.maximumSignificantDigits=a.length:(t.minimumSignificantDigits=a.length,t.maximumSignificantDigits=a.length+("string"==typeof i?i.length:0)),""})),t}function qa(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function Ra(e){var t;if("E"===e[0]&&"E"===e[1]?(t={notation:"engineering"},e=e.slice(2)):"E"===e[0]&&(t={notation:"scientific"},e=e.slice(1)),t){var a=e.slice(0,2);if("+!"===a?(t.signDisplay="always",e=e.slice(2)):"+?"===a&&(t.signDisplay="exceptZero",e=e.slice(2)),!La.test(e))throw new Error("Malformed concise eng/scientific notation");t.minimumIntegerDigits=e.length}return t}function Ua(e){var t=qa(e);return t||{}}function Ia(e){for(var t={},a=0,i=e;a<i.length;a++){var s=i[a];switch(s.stem){case"percent":case"%":t.style="percent";continue;case"%x100":t.style="percent",t.scale=100;continue;case"currency":t.style="currency",t.currency=s.options[0];continue;case"group-off":case",_":t.useGrouping=!1;continue;case"precision-integer":case".":t.maximumFractionDigits=0;continue;case"measure-unit":case"unit":t.style="unit",t.unit=s.options[0].replace(/^(.*?)-/,"");continue;case"compact-short":case"K":t.notation="compact",t.compactDisplay="short";continue;case"compact-long":case"KK":t.notation="compact",t.compactDisplay="long";continue;case"scientific":t=za(za(za({},t),{notation:"scientific"}),s.options.reduce((function(e,t){return za(za({},e),Ua(t))}),{}));continue;case"engineering":t=za(za(za({},t),{notation:"engineering"}),s.options.reduce((function(e,t){return za(za({},e),Ua(t))}),{}));continue;case"notation-simple":t.notation="standard";continue;case"unit-width-narrow":t.currencyDisplay="narrowSymbol",t.unitDisplay="narrow";continue;case"unit-width-short":t.currencyDisplay="code",t.unitDisplay="short";continue;case"unit-width-full-name":t.currencyDisplay="name",t.unitDisplay="long";continue;case"unit-width-iso-code":t.currencyDisplay="symbol";continue;case"scale":t.scale=parseFloat(s.options[0]);continue;case"integer-width":if(s.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");s.options[0].replace(Da,(function(e,a,i,s,n,r){if(a)t.minimumIntegerDigits=i.length;else{if(s&&n)throw new Error("We currently do not support maximum integer digits");if(r)throw new Error("We currently do not support exact integer digits")}return""}));continue}if(La.test(s.stem))t.minimumIntegerDigits=s.stem.length;else if(Ma.test(s.stem)){if(s.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");s.stem.replace(Ma,(function(e,a,i,s,n,r){return"*"===i?t.minimumFractionDigits=a.length:s&&"#"===s[0]?t.maximumFractionDigits=s.length:n&&r?(t.minimumFractionDigits=n.length,t.maximumFractionDigits=n.length+r.length):(t.minimumFractionDigits=a.length,t.maximumFractionDigits=a.length),""}));var n=s.options[0];"w"===n?t=za(za({},t),{trailingZeroDisplay:"stripIfInteger"}):n&&(t=za(za({},t),Pa(n)))}else if(Na.test(s.stem))t=za(za({},t),Pa(s.stem));else{var r=qa(s.stem);r&&(t=za(za({},t),r));var o=Ra(s.stem);o&&(t=za(za({},t),o))}}return t}var Va=new RegExp("^".concat(Oa.source,"*")),Ga=new RegExp("".concat(Oa.source,"*$"));function Fa(e,t){return{start:e,end:t}}var Ha=!!String.prototype.startsWith,Ya=!!String.fromCodePoint,Ba=!!Object.fromEntries,Ka=!!String.prototype.codePointAt,Za=!!String.prototype.trimStart,Qa=!!String.prototype.trimEnd,Wa=!!Number.isSafeInteger?Number.isSafeInteger:function(e){return"number"==typeof e&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},Xa=!0;try{Xa="a"===(null===(Ca=ri("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu").exec("a"))||void 0===Ca?void 0:Ca[0])}catch(C){Xa=!1}var Ja,ei=Ha?function(e,t,a){return e.startsWith(t,a)}:function(e,t,a){return e.slice(a,a+t.length)===t},ti=Ya?String.fromCodePoint:function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];for(var a,i="",s=e.length,n=0;s>n;){if((a=e[n++])>1114111)throw RangeError(a+" is not a valid code point");i+=a<65536?String.fromCharCode(a):String.fromCharCode(55296+((a-=65536)>>10),a%1024+56320)}return i},ai=Ba?Object.fromEntries:function(e){for(var t={},a=0,i=e;a<i.length;a++){var s=i[a],n=s[0],r=s[1];t[n]=r}return t},ii=Ka?function(e,t){return e.codePointAt(t)}:function(e,t){var a=e.length;if(!(t<0||t>=a)){var i,s=e.charCodeAt(t);return s<55296||s>56319||t+1===a||(i=e.charCodeAt(t+1))<56320||i>57343?s:i-56320+(s-55296<<10)+65536}},si=Za?function(e){return e.trimStart()}:function(e){return e.replace(Va,"")},ni=Qa?function(e){return e.trimEnd()}:function(e){return e.replace(Ga,"")};function ri(e,t){return new RegExp(e,t)}if(Xa){var oi=ri("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu");Ja=function(e,t){var a;return oi.lastIndex=t,null!==(a=oi.exec(e)[1])&&void 0!==a?a:""}}else Ja=function(e,t){for(var a=[];;){var i=ii(e,t);if(void 0===i||hi(i)||mi(i))break;a.push(i),t+=i>=65536?2:1}return ti.apply(void 0,a)};var di=function(){function e(e,t){void 0===t&&(t={}),this.message=e,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(0!==this.offset())throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(e,t,a){for(var i=[];!this.isEOF();){var s=this.char();if(123===s){if((n=this.parseArgument(e,a)).err)return n;i.push(n.val)}else{if(125===s&&e>0)break;if(35!==s||"plural"!==t&&"selectordinal"!==t){if(60===s&&!this.ignoreTag&&47===this.peek()){if(a)break;return this.error(ma.UNMATCHED_CLOSING_TAG,Fa(this.clonePosition(),this.clonePosition()))}if(60===s&&!this.ignoreTag&&li(this.peek()||0)){if((n=this.parseTag(e,t)).err)return n;i.push(n.val)}else{var n;if((n=this.parseLiteral(e,t)).err)return n;i.push(n.val)}}else{var r=this.clonePosition();this.bump(),i.push({type:ua.pound,location:Fa(r,this.clonePosition())})}}}return{val:i,err:null}},e.prototype.parseTag=function(e,t){var a=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:ua.literal,value:"<".concat(i,"/>"),location:Fa(a,this.clonePosition())},err:null};if(this.bumpIf(">")){var s=this.parseMessage(e+1,t,!0);if(s.err)return s;var n=s.val,r=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!li(this.char()))return this.error(ma.INVALID_TAG,Fa(r,this.clonePosition()));var o=this.clonePosition();return i!==this.parseTagName()?this.error(ma.UNMATCHED_CLOSING_TAG,Fa(o,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:ua.tag,value:i,children:n,location:Fa(a,this.clonePosition())},err:null}:this.error(ma.INVALID_TAG,Fa(r,this.clonePosition())))}return this.error(ma.UNCLOSED_TAG,Fa(a,this.clonePosition()))}return this.error(ma.INVALID_TAG,Fa(a,this.clonePosition()))},e.prototype.parseTagName=function(){var e=this.offset();for(this.bump();!this.isEOF()&&ci(this.char());)this.bump();return this.message.slice(e,this.offset())},e.prototype.parseLiteral=function(e,t){for(var a=this.clonePosition(),i="";;){var s=this.tryParseQuote(t);if(s)i+=s;else{var n=this.tryParseUnquoted(e,t);if(n)i+=n;else{var r=this.tryParseLeftAngleBracket();if(!r)break;i+=r}}}var o=Fa(a,this.clonePosition());return{val:{type:ua.literal,value:i,location:o},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return this.isEOF()||60!==this.char()||!this.ignoreTag&&(li(e=this.peek()||0)||47===e)?null:(this.bump(),"<");var e},e.prototype.tryParseQuote=function(e){if(this.isEOF()||39!==this.char())return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if("plural"===e||"selectordinal"===e)break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var a=this.char();if(39===a){if(39!==this.peek()){this.bump();break}t.push(39),this.bump()}else t.push(a);this.bump()}return ti.apply(void 0,t)},e.prototype.tryParseUnquoted=function(e,t){if(this.isEOF())return null;var a=this.char();return 60===a||123===a||35===a&&("plural"===t||"selectordinal"===t)||125===a&&e>0?null:(this.bump(),ti(a))},e.prototype.parseArgument=function(e,t){var a=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(ma.EXPECT_ARGUMENT_CLOSING_BRACE,Fa(a,this.clonePosition()));if(125===this.char())return this.bump(),this.error(ma.EMPTY_ARGUMENT,Fa(a,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(ma.MALFORMED_ARGUMENT,Fa(a,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(ma.EXPECT_ARGUMENT_CLOSING_BRACE,Fa(a,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:ua.argument,value:i,location:Fa(a,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(ma.EXPECT_ARGUMENT_CLOSING_BRACE,Fa(a,this.clonePosition())):this.parseArgumentOptions(e,t,i,a);default:return this.error(ma.MALFORMED_ARGUMENT,Fa(a,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var e=this.clonePosition(),t=this.offset(),a=Ja(this.message,t),i=t+a.length;return this.bumpTo(i),{value:a,location:Fa(e,this.clonePosition())}},e.prototype.parseArgumentOptions=function(e,t,a,i){var s,n=this.clonePosition(),r=this.parseIdentifierIfPossible().value,o=this.clonePosition();switch(r){case"":return this.error(ma.EXPECT_ARGUMENT_TYPE,Fa(n,o));case"number":case"date":case"time":this.bumpSpace();var d=null;if(this.bumpIf(",")){this.bumpSpace();var l=this.clonePosition();if((v=this.parseSimpleArgStyleIfPossible()).err)return v;if(0===(m=ni(v.val)).length)return this.error(ma.EXPECT_ARGUMENT_STYLE,Fa(this.clonePosition(),this.clonePosition()));d={style:m,styleLocation:Fa(l,this.clonePosition())}}if((_=this.tryParseArgumentClose(i)).err)return _;var c=Fa(i,this.clonePosition());if(d&&ei(null==d?void 0:d.style,"::",0)){var h=si(d.style.slice(2));if("number"===r)return(v=this.parseNumberSkeletonFromString(h,d.styleLocation)).err?v:{val:{type:ua.number,value:a,location:c,style:v.val},err:null};if(0===h.length)return this.error(ma.EXPECT_DATE_TIME_SKELETON,c);var m={type:pa.dateTime,pattern:h,location:d.styleLocation,parsedOptions:this.shouldParseSkeletons?Ea(h):{}};return{val:{type:"date"===r?ua.date:ua.time,value:a,location:c,style:m},err:null}}return{val:{type:"number"===r?ua.number:"date"===r?ua.date:ua.time,value:a,location:c,style:null!==(s=null==d?void 0:d.style)&&void 0!==s?s:null},err:null};case"plural":case"selectordinal":case"select":var u=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(ma.EXPECT_SELECT_ARGUMENT_OPTIONS,Fa(u,ga({},u)));this.bumpSpace();var p=this.parseIdentifierIfPossible(),g=0;if("select"!==r&&"offset"===p.value){if(!this.bumpIf(":"))return this.error(ma.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,Fa(this.clonePosition(),this.clonePosition()));var v;if(this.bumpSpace(),(v=this.tryParseDecimalInteger(ma.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,ma.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE)).err)return v;this.bumpSpace(),p=this.parseIdentifierIfPossible(),g=v.val}var _,f=this.tryParsePluralOrSelectOptions(e,r,t,p);if(f.err)return f;if((_=this.tryParseArgumentClose(i)).err)return _;var b=Fa(i,this.clonePosition());return"select"===r?{val:{type:ua.select,value:a,options:ai(f.val),location:b},err:null}:{val:{type:ua.plural,value:a,options:ai(f.val),offset:g,pluralType:"plural"===r?"cardinal":"ordinal",location:b},err:null};default:return this.error(ma.INVALID_ARGUMENT_TYPE,Fa(n,o))}},e.prototype.tryParseArgumentClose=function(e){return this.isEOF()||125!==this.char()?this.error(ma.EXPECT_ARGUMENT_CLOSING_BRACE,Fa(e,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var e=0,t=this.clonePosition();!this.isEOF();){switch(this.char()){case 39:this.bump();var a=this.clonePosition();if(!this.bumpUntil("'"))return this.error(ma.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,Fa(a,this.clonePosition()));this.bump();break;case 123:e+=1,this.bump();break;case 125:if(!(e>0))return{val:this.message.slice(t.offset,this.offset()),err:null};e-=1;break;default:this.bump()}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(e,t){var a=[];try{a=function(e){if(0===e.length)throw new Error("Number skeleton cannot be empty");for(var t=[],a=0,i=e.split(Sa).filter((function(e){return e.length>0}));a<i.length;a++){var s=i[a].split("/");if(0===s.length)throw new Error("Invalid number skeleton");for(var n=s[0],r=s.slice(1),o=0,d=r;o<d.length;o++){if(0===d[o].length)throw new Error("Invalid number skeleton")}t.push({stem:n,options:r})}return t}(e)}catch(e){return this.error(ma.INVALID_NUMBER_SKELETON,t)}return{val:{type:pa.number,tokens:a,location:t,parsedOptions:this.shouldParseSkeletons?Ia(a):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(e,t,a,i){for(var s,n=!1,r=[],o=new Set,d=i.value,l=i.location;;){if(0===d.length){var c=this.clonePosition();if("select"===t||!this.bumpIf("="))break;var h=this.tryParseDecimalInteger(ma.EXPECT_PLURAL_ARGUMENT_SELECTOR,ma.INVALID_PLURAL_ARGUMENT_SELECTOR);if(h.err)return h;l=Fa(c,this.clonePosition()),d=this.message.slice(c.offset,this.offset())}if(o.has(d))return this.error("select"===t?ma.DUPLICATE_SELECT_ARGUMENT_SELECTOR:ma.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,l);"other"===d&&(n=!0),this.bumpSpace();var m=this.clonePosition();if(!this.bumpIf("{"))return this.error("select"===t?ma.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:ma.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,Fa(this.clonePosition(),this.clonePosition()));var u=this.parseMessage(e+1,t,a);if(u.err)return u;var p=this.tryParseArgumentClose(m);if(p.err)return p;r.push([d,{value:u.val,location:Fa(m,this.clonePosition())}]),o.add(d),this.bumpSpace(),d=(s=this.parseIdentifierIfPossible()).value,l=s.location}return 0===r.length?this.error("select"===t?ma.EXPECT_SELECT_ARGUMENT_SELECTOR:ma.EXPECT_PLURAL_ARGUMENT_SELECTOR,Fa(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!n?this.error(ma.MISSING_OTHER_CLAUSE,Fa(this.clonePosition(),this.clonePosition())):{val:r,err:null}},e.prototype.tryParseDecimalInteger=function(e,t){var a=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(a=-1);for(var s=!1,n=0;!this.isEOF();){var r=this.char();if(!(r>=48&&r<=57))break;s=!0,n=10*n+(r-48),this.bump()}var o=Fa(i,this.clonePosition());return s?Wa(n*=a)?{val:n,err:null}:this.error(t,o):this.error(e,o)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var e=this.position.offset;if(e>=this.message.length)throw Error("out of bound");var t=ii(this.message,e);if(void 0===t)throw Error("Offset ".concat(e," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(e,t){return{val:null,err:{kind:e,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var e=this.char();10===e?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=e<65536?1:2)}},e.prototype.bumpIf=function(e){if(ei(this.message,e,this.offset())){for(var t=0;t<e.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(e){var t=this.offset(),a=this.message.indexOf(e,t);return a>=0?(this.bumpTo(a),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(e){if(this.offset()>e)throw Error("targetOffset ".concat(e," must be greater than or equal to the current offset ").concat(this.offset()));for(e=Math.min(e,this.message.length);;){var t=this.offset();if(t===e)break;if(t>e)throw Error("targetOffset ".concat(e," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&hi(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var e=this.char(),t=this.offset(),a=this.message.charCodeAt(t+(e>=65536?2:1));return null!=a?a:null},e}();function li(e){return e>=97&&e<=122||e>=65&&e<=90}function ci(e){return 45===e||46===e||e>=48&&e<=57||95===e||e>=97&&e<=122||e>=65&&e<=90||183==e||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function hi(e){return e>=9&&e<=13||32===e||133===e||e>=8206&&e<=8207||8232===e||8233===e}function mi(e){return e>=33&&e<=35||36===e||e>=37&&e<=39||40===e||41===e||42===e||43===e||44===e||45===e||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||91===e||92===e||93===e||94===e||96===e||123===e||124===e||125===e||126===e||161===e||e>=162&&e<=165||166===e||167===e||169===e||171===e||172===e||174===e||176===e||177===e||182===e||187===e||191===e||215===e||247===e||e>=8208&&e<=8213||e>=8214&&e<=8215||8216===e||8217===e||8218===e||e>=8219&&e<=8220||8221===e||8222===e||8223===e||e>=8224&&e<=8231||e>=8240&&e<=8248||8249===e||8250===e||e>=8251&&e<=8254||e>=8257&&e<=8259||8260===e||8261===e||8262===e||e>=8263&&e<=8273||8274===e||8275===e||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||8608===e||e>=8609&&e<=8610||8611===e||e>=8612&&e<=8613||8614===e||e>=8615&&e<=8621||8622===e||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||8658===e||8659===e||8660===e||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||8968===e||8969===e||8970===e||8971===e||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||9001===e||9002===e||e>=9003&&e<=9083||9084===e||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||9655===e||e>=9656&&e<=9664||9665===e||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||9839===e||e>=9840&&e<=10087||10088===e||10089===e||10090===e||10091===e||10092===e||10093===e||10094===e||10095===e||10096===e||10097===e||10098===e||10099===e||10100===e||10101===e||e>=10132&&e<=10175||e>=10176&&e<=10180||10181===e||10182===e||e>=10183&&e<=10213||10214===e||10215===e||10216===e||10217===e||10218===e||10219===e||10220===e||10221===e||10222===e||10223===e||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||10627===e||10628===e||10629===e||10630===e||10631===e||10632===e||10633===e||10634===e||10635===e||10636===e||10637===e||10638===e||10639===e||10640===e||10641===e||10642===e||10643===e||10644===e||10645===e||10646===e||10647===e||10648===e||e>=10649&&e<=10711||10712===e||10713===e||10714===e||10715===e||e>=10716&&e<=10747||10748===e||10749===e||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||11158===e||e>=11159&&e<=11263||e>=11776&&e<=11777||11778===e||11779===e||11780===e||11781===e||e>=11782&&e<=11784||11785===e||11786===e||11787===e||11788===e||11789===e||e>=11790&&e<=11798||11799===e||e>=11800&&e<=11801||11802===e||11803===e||11804===e||11805===e||e>=11806&&e<=11807||11808===e||11809===e||11810===e||11811===e||11812===e||11813===e||11814===e||11815===e||11816===e||11817===e||e>=11818&&e<=11822||11823===e||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||11840===e||11841===e||11842===e||e>=11843&&e<=11855||e>=11856&&e<=11857||11858===e||e>=11859&&e<=11903||e>=12289&&e<=12291||12296===e||12297===e||12298===e||12299===e||12300===e||12301===e||12302===e||12303===e||12304===e||12305===e||e>=12306&&e<=12307||12308===e||12309===e||12310===e||12311===e||12312===e||12313===e||12314===e||12315===e||12316===e||12317===e||e>=12318&&e<=12319||12320===e||12336===e||64830===e||64831===e||e>=65093&&e<=65094}function ui(e,t){void 0===t&&(t={}),t=ga({shouldParseSkeletons:!0,requiresOtherClause:!0},t);var a=new di(e,t).parse();if(a.err){var i=SyntaxError(ma[a.err.kind]);throw i.location=a.err.location,i.originalMessage=a.err.message,i}return(null==t?void 0:t.captureLocation)||function e(t){t.forEach((function(t){if(delete t.location,wa(t)||ka(t))for(var a in t.options)delete t.options[a].location,e(t.options[a].value);else fa(t)&&ja(t.style)||(ba(t)||ya(t))&&xa(t.style)?delete t.style.location:$a(t)&&e(t.children)}))}(a.val),a.val}function pi(e,t){var a=t&&t.cache?t.cache:ki,i=t&&t.serializer?t.serializer:bi;return(t&&t.strategy?t.strategy:fi)(e,{cache:a,serializer:i})}function gi(e,t,a,i){var s,n=null==(s=i)||"number"==typeof s||"boolean"==typeof s?i:a(i),r=t.get(n);return void 0===r&&(r=e.call(this,i),t.set(n,r)),r}function vi(e,t,a){var i=Array.prototype.slice.call(arguments,3),s=a(i),n=t.get(s);return void 0===n&&(n=e.apply(this,i),t.set(s,n)),n}function _i(e,t,a,i,s){return a.bind(t,e,i,s)}function fi(e,t){return _i(e,this,1===e.length?gi:vi,t.cache.create(),t.serializer)}var bi=function(){return JSON.stringify(arguments)};function yi(){this.cache=Object.create(null)}yi.prototype.get=function(e){return this.cache[e]},yi.prototype.set=function(e,t){this.cache[e]=t};var wi,ki={create:function(){return new yi}},Ai={variadic:function(e,t){return _i(e,this,vi,t.cache.create(),t.serializer)},monadic:function(e,t){return _i(e,this,gi,t.cache.create(),t.serializer)}};!function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"}(wi||(wi={}));var $i,ji=function(e){function t(t,a,i){var s=e.call(this,t)||this;return s.code=a,s.originalMessage=i,s}return la(t,e),t.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},t}(Error),xi=function(e){function t(t,a,i,s){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(a,'". Options are "').concat(Object.keys(i).join('", "'),'"'),wi.INVALID_VALUE,s)||this}return la(t,e),t}(ji),Oi=function(e){function t(t,a,i){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(a),wi.INVALID_VALUE,i)||this}return la(t,e),t}(ji),Ti=function(e){function t(t,a){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(a,'"'),wi.MISSING_VALUE,a)||this}return la(t,e),t}(ji);function Ei(e){return"function"==typeof e}function zi(e,t,a,i,s,n,r){if(1===e.length&&va(e[0]))return[{type:$i.literal,value:e[0].value}];for(var o=[],d=0,l=e;d<l.length;d++){var c=l[d];if(va(c))o.push({type:$i.literal,value:c.value});else if(Aa(c))"number"==typeof n&&o.push({type:$i.literal,value:a.getNumberFormat(t).format(n)});else{var h=c.value;if(!s||!(h in s))throw new Ti(h,r);var m=s[h];if(_a(c))m&&"string"!=typeof m&&"number"!=typeof m||(m="string"==typeof m||"number"==typeof m?String(m):""),o.push({type:"string"==typeof m?$i.literal:$i.object,value:m});else if(ba(c)){var u="string"==typeof c.style?i.date[c.style]:xa(c.style)?c.style.parsedOptions:void 0;o.push({type:$i.literal,value:a.getDateTimeFormat(t,u).format(m)})}else if(ya(c)){u="string"==typeof c.style?i.time[c.style]:xa(c.style)?c.style.parsedOptions:void 0;o.push({type:$i.literal,value:a.getDateTimeFormat(t,u).format(m)})}else if(fa(c)){(u="string"==typeof c.style?i.number[c.style]:ja(c.style)?c.style.parsedOptions:void 0)&&u.scale&&(m*=u.scale||1),o.push({type:$i.literal,value:a.getNumberFormat(t,u).format(m)})}else{if($a(c)){var p=c.children,g=c.value,v=s[g];if(!Ei(v))throw new Oi(g,"function",r);var _=v(zi(p,t,a,i,s,n).map((function(e){return e.value})));Array.isArray(_)||(_=[_]),o.push.apply(o,_.map((function(e){return{type:"string"==typeof e?$i.literal:$i.object,value:e}})))}if(wa(c)){if(!(f=c.options[m]||c.options.other))throw new xi(c.value,m,Object.keys(c.options),r);o.push.apply(o,zi(f.value,t,a,i,s))}else if(ka(c)){var f;if(!(f=c.options["=".concat(m)])){if(!Intl.PluralRules)throw new ji('Intl.PluralRules is not available in this environment.\nTry polyfilling it using "@formatjs/intl-pluralrules"\n',wi.MISSING_INTL_API,r);var b=a.getPluralRules(t,{type:c.pluralType}).select(m-(c.offset||0));f=c.options[b]||c.options.other}if(!f)throw new xi(c.value,m,Object.keys(c.options),r);o.push.apply(o,zi(f.value,t,a,i,s,m-(c.offset||0)))}else;}}}return function(e){return e.length<2?e:e.reduce((function(e,t){var a=e[e.length-1];return a&&a.type===$i.literal&&t.type===$i.literal?a.value+=t.value:e.push(t),e}),[])}(o)}function Si(e,t){return t?Object.keys(e).reduce((function(a,i){var s,n;return a[i]=(s=e[i],(n=t[i])?ca(ca(ca({},s||{}),n||{}),Object.keys(s).reduce((function(e,t){return e[t]=ca(ca({},s[t]),n[t]||{}),e}),{})):s),a}),ca({},e)):e}function Ci(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,a){e[t]=a}}}}}!function(e){e[e.literal=0]="literal",e[e.object=1]="object"}($i||($i={}));var Mi=function(){function e(t,a,i,s){var n,r=this;if(void 0===a&&(a=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(e){var t=r.formatToParts(e);if(1===t.length)return t[0].value;var a=t.reduce((function(e,t){return e.length&&t.type===$i.literal&&"string"==typeof e[e.length-1]?e[e.length-1]+=t.value:e.push(t.value),e}),[]);return a.length<=1?a[0]||"":a},this.formatToParts=function(e){return zi(r.ast,r.locales,r.formatters,r.formats,e,void 0,r.message)},this.resolvedOptions=function(){return{locale:Intl.NumberFormat.supportedLocalesOf(r.locales)[0]}},this.getAst=function(){return r.ast},"string"==typeof t){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:null==s?void 0:s.ignoreTag})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Si(e.formats,i),this.locales=a,this.formatters=s&&s.formatters||(void 0===(n=this.formatterCache)&&(n={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:pi((function(){for(var e,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((e=Intl.NumberFormat).bind.apply(e,ha([void 0],t,!1)))}),{cache:Ci(n.number),strategy:Ai.variadic}),getDateTimeFormat:pi((function(){for(var e,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((e=Intl.DateTimeFormat).bind.apply(e,ha([void 0],t,!1)))}),{cache:Ci(n.dateTime),strategy:Ai.variadic}),getPluralRules:pi((function(){for(var e,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((e=Intl.PluralRules).bind.apply(e,ha([void 0],t,!1)))}),{cache:Ci(n.pluralRules),strategy:Ai.variadic})})}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=(new Intl.NumberFormat).resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.__parse=ui,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}(),Ni={ca:nt,cs:ct,en:gt,et:jt,es:yt,fr:St,it:Lt,nl:It,sk:Yt,sv:Wt,"zh-Hans":aa,ru:oa};function Di(e,t,...a){const i=t.replace(/['"]+/g,"");var s;try{s=e.split(".").reduce((e,t)=>e[t],Ni[i])}catch(t){s=e.split(".").reduce((e,t)=>e[t],Ni.en)}if(void 0===s&&(s=e.split(".").reduce((e,t)=>e[t],Ni.en)),!a.length)return s;const n={};for(let e=0;e<a.length;e+=2){let t=a[e];t=t.replace(/^{([^}]+)?}$/,"$1"),n[t]=a[e+1]}try{return new Mi(s,t).format(n)}catch(e){return"Translation "+e}}var Li,Pi,qi,Ri,Ui,Ii,Vi,Gi;function Fi(e){return function(e){if(!e)return Me;if(e.attributes.icon)return e.attributes.icon;var t=Se(e.entity_id);return t in Re?Re[t](e):Le(t,e.state)}(e)}function Hi(e){return(e=e.replace("_"," ")).charAt(0).toUpperCase()+e.slice(1)}function Yi(e){return e?e.attributes&&e.attributes.friendly_name?e.attributes.friendly_name:String(e.entity_id.split(".").pop()):"(unrecognized entity)"}function Bi(e){let t=[];return e.forEach(e=>{t.find(t=>"object"==typeof e?function(...e){return e.every(t=>JSON.stringify(t)===JSON.stringify(e[0]))}(t,e):t===e)||t.push(e)}),t}function Ki(e,t){return e.filter(e=>e!==t)}function Zi(e,t){return e?Object.entries(e).filter(([e])=>t.includes(e)).reduce((e,[t,a])=>Object.assign(e,{[t]:a}),{}):{}}!function(e){e.ArmedAway="hass:car-traction-control",e.ArmedHome="hass:home-outline",e.ArmedNight="hass:weather-night",e.ArmedCustom="hass:star-outline",e.ArmedVacation="hass:airplane-takeoff"}(Li||(Li={})),function(e){e.STATE_ALARM_DISARMED="disarmed",e.STATE_ALARM_ARMED_HOME="armed_home",e.STATE_ALARM_ARMED_AWAY="armed_away",e.STATE_ALARM_ARMED_NIGHT="armed_night",e.STATE_ALARM_ARMED_CUSTOM_BYPASS="armed_custom_bypass",e.STATE_ALARM_ARMED_VACATION="armed_vacation",e.STATE_ALARM_PENDING="pending",e.STATE_ALARM_ARMING="arming",e.STATE_ALARM_DISARMING="disarming",e.STATE_ALARM_TRIGGERED="triggered"}(Pi||(Pi={})),function(e){e.COMMAND_ALARM_DISARM="disarm",e.COMMAND_ALARM_ARM_HOME="arm_home",e.COMMAND_ALARM_ARM_AWAY="arm_away",e.COMMAND_ALARM_ARM_NIGHT="arm_night",e.COMMAND_ALARM_ARM_CUSTOM_BYPASS="arm_custom_bypass",e.COMMAND_ALARM_ARM_VACATION="arm_vacation"}(qi||(qi={})),function(e){e.Door="door",e.Window="window",e.Motion="motion",e.Tamper="tamper",e.Environmental="environmental",e.Other="other"}(Ri||(Ri={})),function(e){e.Door="hass:door-closed",e.Window="hass:window-closed",e.Motion="hass:motion-sensor",e.Tamper="hass:vibrate",e.Environmental="hass:fire",e.Other="hass:contactless-payment-circle-outline"}(Ui||(Ui={})),function(e){e.Notification="notification",e.Action="action"}(Ii||(Ii={})),function(e){e.ArmedAway="armed_away",e.ArmedHome="armed_home",e.ArmedNight="armed_night",e.ArmedVacation="armed_vacation",e.ArmedCustom="armed_custom_bypass"}(Vi||(Vi={})),function(e){e.Armed="armed",e.Disarmed="disarmed",e.Triggered="triggered",e.Untriggered="untriggered",e.ArmFailure="arm_failure",e.Arming="arming",e.Pending="pending"}(Gi||(Gi={}));const Qi=(e,...t)=>{const a={};let i;for(i in e)t.includes(i)||(a[i]=e[i]);return a};function Wi(e){return null!=e}function Xi(e,t){if(null===e||null===t)return e===t;const a=Object.keys(e),i=Object.keys(t);if(a.length!==i.length)return!1;for(const i of a)if("object"==typeof e[i]&&"object"==typeof t[i]){if(!Xi(e[i],t[i]))return!1}else if(e[i]!==t[i])return!1;return!0}function Ji(e,t){const a=e.hasOwnProperty("tagName")?e:e.target;Ne(a,"show-dialog",{dialogTag:"error-dialog",dialogImport:()=>Promise.resolve().then((function(){return Hs})),dialogParams:{error:t}})}function es(e,t){Ji(t,q`
    ...
    the bug.
  `)}const ts=(e,t)=>{var a,i,s,n,r;if(!e)return!1;switch(e){case Pi.STATE_ALARM_ARMED_AWAY:return null===(a=t[Vi.ArmedAway])||void 0===a?void 0:a.enabled;case Pi.STATE_ALARM_ARMED_HOME:return null===(i=t[Vi.ArmedHome])||void 0===i?void 0:i.enabled;case Pi.STATE_ALARM_ARMED_NIGHT:return null===(s=t[Vi.ArmedNight])||void 0===s?void 0:s.enabled;case Pi.STATE_ALARM_ARMED_CUSTOM_BYPASS:return null===(n=t[Vi.ArmedCustom])||void 0===n?void 0:n.enabled;case Pi.STATE_ALARM_ARMED_VACATION:return null===(r=t[Vi.ArmedVacation])||void 0===r?void 0:r.enabled;default:return!0}};function as(e,t){return Object.entries(t).forEach(([t,a])=>{e=t in e&&"object"==typeof e[t]&&null!==e[t]?Object.assign(Object.assign({},e),{[t]:as(e[t],a)}):Object.assign(Object.assign({},e),{[t]:a})}),e}function is(e,t){const a=e=>"object"==typeof e?a(e.name):e.trim().toLowerCase();return a(e)<a(t)?-1:1}const ss=o`
  ha-card {
    display: flex;
...
`,rs=()=>{const e=e=>{let t={};for(var a=0;a<e.length;a+=2){const i=e[a],s=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:s})}return t},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex(e=>"filter"==e),s=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(s)})}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})))}return a},os=(e,...t)=>{let a={page:e,params:{}};t.forEach(e=>{"string"==typeof e?a=Object.assign(Object.assign({},a),{subpage:e}):"params"in e?a=Object.assign(Object.assign({},a),{params:e.params}):"filter"in e&&(a=Object.assign(Object.assign({},a),{filter:e.filter}))});const i=e=>{let t=Object.keys(e);t=t.filter(t=>e[t]),t.sort();let a="";return t.forEach(t=>{let i=e[t];a=a.length?`${a}/${t}/${i}`:`${t}/${i}`}),a};let s="/alarmo/"+a.page;return a.subpage&&(s=`${s}/${a.subpage}`),i(a.params).length&&(s=`${s}/${i(a.params)}`),a.filter&&(s=`${s}/filter/${i(a.filter)}`),s};let ds=class extends ne{constructor(){super(...arguments),this.min=0,this.max=100,this.step=10,this.value=0,this.scaleFactor=1,this.unit="",this.disabled=!1}firstUpdated(){this.value>0&&this.value<60&&(this.unit="sec"),"min"==this.unit&&(this.scaleFactor=1/60),"min"==this.unit&&(this.step=1)}render(){return q`
    ...
    `}getValue(){const e=Number(Math.round(this.value*this.scaleFactor));return!e&&this.zeroValue?this.zeroValue:`${e} ${this.getUnit()}`}getUnit(){switch(this.unit){case"sec":return Di("components.time_slider.seconds",this.hass.language);case"min":return Di("components.time_slider.minutes",this.hass.language);default:return""}}getSlider(){return q`
      <ha-slider
        pin
      ...
      ></ha-slider>
    `}updateValue(e){const t=Number(e.target.value);this.value=Math.round(t/this.scaleFactor)}toggleUnit(){this.unit="min"==this.unit?"sec":"min",this.scaleFactor="min"==this.unit?1/60:1,this.step="min"==this.unit?1:10}};ds.styles=o`
    :host {
      display: flex;
      flex-direction: column;
      min-width: 250px;
  ...
  `,t([de({type:Number})],ds.prototype,"min",void 0),t([de({type:Number})],ds.prototype,"max",void 0),t([de({type:Number})],ds.prototype,"step",void 0),t([de({type:Number})],ds.prototype,"value",void 0),t([de()],ds.prototype,"scaleFactor",void 0),t([de({type:String})],ds.prototype,"unit",void 0),t([de({type:Boolean})],ds.prototype,"disabled",void 0),t([de({type:String})],ds.prototype,"zeroValue",void 0),ds=t([re("time-slider")],ds);var ls="M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z",cs="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z";
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */
const hs=2,ms=6,us=e=>(...t)=>({_$litDirective$:e,values:t});class ps{constructor(e){}T(e,t,a){this.Σdt=e,this.M=t,this.Σct=a}S(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}let gs=class extends ne{constructor(){super(...arguments),this.label="",this.items=[],this.clearable=!1,this.icons=!1,this.disabled=!1,this.invalid=!1,this.rowRenderer=e=>{const t=Wi(e.description);return this.icons?q`
        <style>
          mwc-list-item {
            font-size: 15px;
    ...
    `}};t([de()],gs.prototype,"label",void 0),t([de()],gs.prototype,"value",void 0),t([de()],gs.prototype,"items",void 0),t([de()],gs.prototype,"clearable",void 0),t([de()],gs.prototype,"icons",void 0),t([de({type:Boolean})],gs.prototype,"disabled",void 0),t([le()],gs.prototype,"_opened",void 0),t([de({attribute:"allow-custom-value",type:Boolean})],gs.prototype,"allowCustomValue",void 0),t([de({type:Boolean})],gs.prototype,"invalid",void 0),t([ce("vaadin-combo-box-light",!0)],gs.prototype,"_comboBox",void 0),gs=t([re("alarmo-select")],gs);const vs={};class _s extends ps{constructor(e){if(super(e),this.previousValue=vs,e.type!==ms)throw new Error("renderer only supports binding to element")}render(e,t){return U}update(e,[t,a]){var i;const s=this.previousValue===vs;if(!this.hasChanged(a))return U;this.previousValue=Array.isArray(a)?Array.from(a):a;const n=e.element;if(s){const a=null===(i=e.options)||void 0===i?void 0:i.host;this.addRenderer(n,t,{host:a})}else this.runRenderer(n);return U}hasChanged(e){let t=!0;return Array.isArray(e)?Array.isArray(this.previousValue)&&this.previousValue.length===e.length&&e.every((e,t)=>e===this.previousValue[t])&&(t=!1):this.previousValue===e&&(t=!1),t}}const fs=us(class extends _s{addRenderer(e,t,a){e.renderer=(e,i,s)=>{V(t.call(a.host,s.item,s,i),e,a)}}runRenderer(e){e.requestContentUpdate()}}),bs=(e,t)=>fs(e,t);let ys=class extends ne{static get styles(){return o`
      :host {
        display: block;
      }
    `}render(){return q`
      <slot></slot>
    `}constructor(){super(),this.addEventListener("clickHeader",this.manageSpoilers)}manageSpoilers(e){const t=e.target;t.getAttribute("active")?t.removeAttribute("active"):t.setAttribute("active","true"),this.querySelectorAll("alarmo-collapsible-header[active]").forEach((function(e){e!==t&&e.removeAttribute("active")}))}};ys=t([re("alarmo-collapsible-group")],ys);let ws=class extends ne{static get styles(){return o`
      :host {
        display: block;
      }
    `}render(){return q`
      <slot></slot>
    `}};ws=t([re("alarmo-collapsible-item")],ws);let ks=class extends ne{constructor(){super(),this.clickHeader=new CustomEvent("clickHeader",{detail:{message:"clickHeader happened."},bubbles:!0,composed:!0}),this.active=!1,this.addEventListener("click",this.handleClick)}handleClick(){this.dispatchEvent(this.clickHeader)}render(){return q`
    ...
    `}};As=t([re("alarmo-collapsible-body")],As);let $s=class extends(et(ne)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Xe(this.hass),this.sensors=await Ge(this.hass))}async firstUpdated(){await this._fetchData(),this.selectedArea=Object.keys(this.areas)[0],this.data=Object.assign({},this.areas[this.selectedArea].modes)}render(){return this.data?q`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${Di("panels.general.cards.modes.title",this.hass.language)}
          </div>
        ...
        <div class="card-content">
          ${Di("panels.general.cards.modes.description",this.hass.language)}
        </div>

        <alarmo-collapsible-group>
          ${Object.entries(Vi).map(([e,t])=>{var a;return q`
                <alarmo-collapsible-item>
                  <alarmo-collapsible-header>
                    <ha-icon slot="icon" icon="${Li[e]}"></ha-icon>
                    <span slot="title">
                      ${this.hass.localize("component.alarm_control_panel.state._."+t)}
                    </span>
                    <span slot="description">
                      ${(null===(a=this.data[t])||void 0===a?void 0:a.enabled)?q`
                            ${Di("common.enabled",this.hass.language)},
                            <a href="${os("sensors",{filter:{area:this.selectedArea,mode:t}})}">
                              ${Di("panels.general.cards.modes.number_sensors_active",this.hass.language,"number",this.getSensorsByMode(t))}
                            </a>
                          `:Di("common.disabled",this.hass.language)}
                    </span>
                  </alarmo-collapsible-header>
    ...
    `:q``}getSensorsByMode(e){return Object.values(this.sensors).filter(t=>t.modes.includes(e)||t.always_on).length}renderModeConfig(e){const t=e in this.data?this.data[e]:void 0;return q`
      <div class="description">
        ...
        ${Di("panels.general.cards.modes.modes."+e,this.hass.language)}
      </div>
      <settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${Di("panels.general.cards.modes.fields.status.heading",this.hass.language)}
        </span>
        <span slot="description">
          ${Di("panels.general.cards.modes.fields.status.description",this.hass.language)}
        </span>
        <div>
      ...
      <settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${Di("panels.general.cards.modes.fields.exit_delay.heading",this.hass.language)}
        </span>
        <span slot="description">
          ${Di("panels.general.cards.modes.fields.exit_delay.description",this.hass.language)}
        </span>
        <time-slider
          .hass=${this.hass}
          unit="sec"
          max="180"
          zeroValue=${Di("components.time_slider.none",this.hass.language)}
      ...
      <settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${Di("panels.general.cards.modes.fields.entry_delay.heading",this.hass.language)}
        </span>
        <span slot="description">
          ${Di("panels.general.cards.modes.fields.entry_delay.description",this.hass.language)}
        </span>
        <time-slider
          .hass=${this.hass}
          unit="sec"
      ...
      <settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${Di("panels.general.cards.modes.fields.trigger_time.heading",this.hass.language)}
        </span>
        <span slot="description">
          ${Di("panels.general.cards.modes.fields.trigger_time.description",this.hass.language)}
        </span>
        <time-slider
          .hass=${this.hass}
          unit="min"
          max="3600"
          zeroValue=${Di("components.time_slider.infinite",this.hass.language)}
          value=${(null==t?void 0:t.trigger_time)||0}
          @change=${t=>this.saveData(e,{trigger_time:Number(t.target.value)})}
          ?disabled=${!(null==t?void 0:t.enabled)}
        ></time-slider>
      </settings-row>
    `}selectArea(e){e!=this.selectedArea&&(this.selectedArea=e,this.data=Object.assign({},this.areas[e].modes))}saveClick(e){Je(this.hass,{area_id:this.selectedArea,modes:this.data}).catch(t=>es(t,e)).then()}saveData(e,t){this.data=Object.assign(Object.assign({},this.data),{[e]:Object.assign(Object.assign({},this.data[e]||{enabled:!1,exit_time:0,entry_time:0,trigger_time:0}),t)}),Je(this.hass,{area_id:this.selectedArea,modes:this.data}).catch(e=>es(e,this.shadowRoot.querySelector("ha-card"))).then()}static get styles(){return o`
      ${ss}
    ...
    `}};t([de()],$s.prototype,"hass",void 0),t([de({type:Boolean})],$s.prototype,"narrow",void 0),t([de()],$s.prototype,"config",void 0),t([de()],$s.prototype,"areas",void 0),t([de()],$s.prototype,"sensors",void 0),t([de()],$s.prototype,"data",void 0),t([de()],$s.prototype,"selectedArea",void 0),$s=t([re("alarm-mode-card")],$s);let js=class extends ne{constructor(){super(...arguments),this.threeLine=!1}render(){return q`
      <div class="info">
    ...
    `}};t([de({type:Boolean,reflect:!0})],js.prototype,"narrow",void 0),t([de({type:Boolean,reflect:!0})],js.prototype,"large",void 0),t([de({type:Boolean,attribute:"three-line"})],js.prototype,"threeLine",void 0),t([de({type:Boolean})],js.prototype,"nested",void 0),t([de({type:Boolean})],js.prototype,"dialog",void 0),js=t([re("settings-row")],js);let xs=class extends ne{constructor(){super(...arguments),this.header="",this.open=!1}render(){return q`
      ${this.open?q`
          ...
          `:q`
            <div class="header">
              ...
              <ha-icon-button .path=${ls} @click=${()=>{this.open=!0}}>
              </ha-icon-button>
            </div>
          `}
    `}static get styles(){return o`
    ...
    `}};t([de({type:Boolean,reflect:!0})],xs.prototype,"narrow",void 0),t([de()],xs.prototype,"header",void 0),t([de()],xs.prototype,"open",void 0),xs=t([re("collapsible-section")],xs);let Os=class extends(et(ne)){constructor(){super(...arguments),this.areas={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await Ve(this.hass);this.config=e,this.areas=await Xe(this.hass),this.selection=e.mqtt}firstUpdated(){(async()=>{await Ue()})()}render(){return this.hass&&this.selection?q`
      <ha-card>
        <div class="card-header">
          <div class="name">${Di("panels.general.cards.mqtt.title",this.hass.language)}</div>
          <ha-icon-button .path=${cs} @click=${this.cancelClick}></ha-icon-button>
        </div>
        <div class="card-content">${Di("panels.general.cards.mqtt.description",this.hass.language)}</div>

        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${Di("panels.general.cards.mqtt.fields.state_topic.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${Di("panels.general.cards.mqtt.fields.state_topic.description",this.hass.language)}
          </span>
          <ha-textfield
            label="${Di("panels.general.cards.mqtt.fields.state_topic.heading",this.hass.language)}"
        ...
        <collapsible-section
          .narrow=${this.narrow}
          header=${Di("panels.general.cards.mqtt.fields.state_payload.heading",this.hass.language)}
        >
          ${Object.values(Pi).filter(e=>Object.values(this.areas).some(t=>ts(e,t.modes))).map(e=>q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">${Hi(e)}</span>
                  <span slot="description">
                    ${Di("panels.general.cards.mqtt.fields.state_payload.item",this.hass.language,"{state}",Hi(e))}
                  </span>
                  <ha-textfield
                    label=${Hi(e)}
                    placeholder=${e}
                    value=${this.selection.state_payload[e]||""}
                    @change=${t=>{this.selection=as(this.selection,{state_payload:{[e]:t.target.value}})}}
                  ></ha-textfield>
                </settings-row>
              `)}
        </collapsible-section>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${Di("panels.general.cards.mqtt.fields.event_topic.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${Di("panels.general.cards.mqtt.fields.event_topic.description",this.hass.language)}
          </span>
          <ha-textfield
            label="${Di("panels.general.cards.mqtt.fields.event_topic.heading",this.hass.language)}"
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${Di("panels.general.cards.mqtt.fields.command_topic.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${Di("panels.general.cards.mqtt.fields.command_topic.description",this.hass.language)}
          </span>
          <ha-textfield
            label="${Di("panels.general.cards.mqtt.fields.command_topic.heading",this.hass.language)}"
        ...
        <collapsible-section
          .narrow=${this.narrow}
          header=${Di("panels.general.cards.mqtt.fields.command_payload.heading",this.hass.language)}
        >
          ${Object.values(qi).filter(e=>Object.values(this.areas).some(t=>ts((e=>{switch(e){case qi.COMMAND_ALARM_DISARM:return Pi.STATE_ALARM_DISARMED;case qi.COMMAND_ALARM_ARM_HOME:return Pi.STATE_ALARM_ARMED_HOME;case qi.COMMAND_ALARM_ARM_AWAY:return Pi.STATE_ALARM_ARMED_AWAY;case qi.COMMAND_ALARM_ARM_NIGHT:return Pi.STATE_ALARM_ARMED_NIGHT;case qi.COMMAND_ALARM_ARM_CUSTOM_BYPASS:return Pi.STATE_ALARM_ARMED_CUSTOM_BYPASS;case qi.COMMAND_ALARM_ARM_VACATION:return Pi.STATE_ALARM_ARMED_VACATION;default:return}})(e),t.modes))).map(e=>q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">${Hi(e)}</span>
                  <span slot="description">
                    ${Di("panels.general.cards.mqtt.fields.command_payload.item",this.hass.language,"{command}",Hi(e))}
                  </span>
                  <ha-textfield
                    label=${Hi(e)}
                    placeholder=${e}
                    value=${this.selection.command_payload[e]||""}
                    @change=${t=>{this.selection=as(this.selection,{command_payload:{[e]:t.target.value}})}}
                  ></ha-textfield>
                </settings-row>
              `)}
        </collapsible-section>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${Di("panels.general.cards.mqtt.fields.require_code.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${Di("panels.general.cards.mqtt.fields.require_code.description",this.hass.language)}
          </span>
          <ha-switch
    ...
    `:q``}saveClick(e){this.hass&&Be(this.hass,{mqtt:Object.assign(Object.assign({},this.selection),{enabled:!0})}).catch(t=>es(t,e)).then(()=>{this.cancelClick()})}cancelClick(){Pe(0,os("general"),!0)}};Os.styles=ss,t([de()],Os.prototype,"narrow",void 0),t([de()],Os.prototype,"config",void 0),t([de()],Os.prototype,"areas",void 0),t([de()],Os.prototype,"selection",void 0),Os=t([re("mqtt-config-card")],Os);
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */
class Ts extends ps{constructor(e){if(super(e),this.vt=U,e.type!==hs)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===U)return this.Vt=void 0,this.vt=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.vt)return this.Vt;this.vt=e;const t=[e];return t.raw=t,this.Vt={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Ts.directiveName="unsafeHTML",Ts.resultType=1;const Es=us(Ts);let zs=class extends ne{render(){return q`
    ...
    `}};t([de({type:String})],zs.prototype,"value",void 0),t([de({type:Boolean})],zs.prototype,"checked",void 0),t([de({type:Boolean})],zs.prototype,"checkmark",void 0),t([de({type:Boolean})],zs.prototype,"selectable",void 0),t([de({type:Boolean})],zs.prototype,"clickable",void 0),t([de({type:Boolean})],zs.prototype,"cancellable",void 0),t([de({type:Number})],zs.prototype,"badge",void 0),t([de({type:Boolean})],zs.prototype,"table",void 0),zs=t([re("alarmo-chip")],zs);let Ss=class extends ne{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
    ...
    `}};t([de()],Ss.prototype,"items",void 0),t([de()],Ss.prototype,"value",void 0),t([de({type:Boolean})],Ss.prototype,"selectable",void 0),Ss=t([re("alarmo-chip-set")],Ss);let Cs=class extends ne{set filters(e){this.filterConfig||(this.filterConfig=e)}shouldUpdate(e){return e.get("filters")&&!this.filterConfig&&(this.filterConfig=e.get("filters")),!0}render(){if(!this.columns||!this.data)return q``;const e=this.data.filter(e=>this.filterTableData(e,this.filterConfig));return q`
    ...
    `:q``}filterTableData(e,t){return!t||Object.keys(t).every(a=>{if(!Object.keys(e).includes(a))return!0;const i=t[a].value;return!i||!i.length||(Array.isArray(e[a])?e[a].some(e=>i.includes(e)):i.includes(e[a]))})}_getFilteredItems(){return this.data.filter(e=>!this.filterTableData(e,this.filterConfig)).length}handleClick(e){if(!this.selectable)return;const t=new CustomEvent("row-click",{detail:{id:e}});this.dispatchEvent(t)}renderFilterRow(){var e;return this.filterConfig?q`
      <div class="table-filter">
        <ha-icon-button
          ...
          label=${Di("components.table.filter.label",this.hass.language)}
        ...
        ${this._getFilteredItems()?q`
              <alarmo-chip cancellable table @button-clicked=${this._clearFilters}>
                ${Di("components.table.filter.hidden_items",this.hass.language,"number",this._getFilteredItems())}
              </alarmo-chip>
            `:""}
      </div>
    `:q``}_toggleFilterMenu(e){const t=e.target;this._menu.anchor=t,this._menu.open?this._menu.close():(this.filterSelection=Object.entries(this.filterConfig).reduce((e,[t,a])=>Object.assign(Object.assign({},e),{[t]:Zi(a,["value"])}),{}),this._menu.show())}renderFilterMenu(){return this.filterConfig&&this.filterSelection?q`
      <span class="header">
        ${Di("components.table.filter.label",this.hass.language)}
      </span>
      <ha-icon-button
        .path=${cs}
  ...
  `,t([de()],Cs.prototype,"hass",void 0),t([de()],Cs.prototype,"columns",void 0),t([de()],Cs.prototype,"data",void 0),t([le()],Cs.prototype,"filterConfig",void 0),t([le()],Cs.prototype,"filterSelection",void 0),t([de({type:Boolean})],Cs.prototype,"selectable",void 0),t([ce("mwc-menu",!0)],Cs.prototype,"_menu",void 0),Cs=t([re("alarmo-table")],Cs);let Ms=class extends ne{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <div slot="heading">
          <ha-header-bar>
            <ha-icon-button slot="navigationIcon" dialogAction="cancel" .path=${cs}>
            </ha-icon-button>
    ...
    `}};t([de({attribute:!1})],Ms.prototype,"hass",void 0),t([le()],Ms.prototype,"_params",void 0),Ms=t([re("confirm-delete-dialog")],Ms);var Ns=Object.freeze({__proto__:null,get ConfirmDeleteDialog(){return Ms}});let Ds=class extends(et(ne)){constructor(){super(...arguments),this.areas={},this.sensors={},this.automations={},this.name=""}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Xe(this.hass),this.sensors=await Ge(this.hass),this.automations=await He(this.hass))}async showDialog(e){await this._fetchData(),this._params=e,e.area_id&&(this.area_id=e.area_id,this.name=this.areas[this.area_id].name),await this.updateComplete}async closeDialog(){this._params=void 0,this.area_id=void 0,this.name=""}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        ...
        <div class="wrapper">
          ...
          ${this.area_id?q`
                <span class="note">
                  ${Di("panels.general.dialogs.edit_area.name_warning",this.hass.language)}
                </span>
              `:""}
          ${this.area_id?"":q`
                <alarmo-select
                  .items=${Object.values(this.areas).map(e=>Object({value:e.area_id,name:e.name}))}
                  value=${this.selectedArea}
                  label="${Di("panels.general.dialogs.create_area.fields.copy_from",this.hass.language)}"
                  clearable=${!0}
    ...
    `:q``}saveClick(e){const t=this.name.trim();if(!t.length)return;let a={name:t};this.area_id?a=Object.assign(Object.assign({},a),{area_id:this.area_id}):this.selectedArea&&(a=Object.assign(Object.assign({},a),{modes:Object.assign({},this.areas[this.selectedArea].modes)})),Je(this.hass,a).catch(t=>es(t,e)).then(()=>{this.closeDialog()})}async deleteClick(e){if(!this.area_id)return;const t=Object.values(this.sensors).filter(e=>e.area==this.area_id).length,a=Object.values(this.automations).filter(e=>{var t;return null===(t=e.triggers)||void 0===t?void 0:t.map(e=>e.area).includes(this.area_id)}).length;let i=!1;var s,n;i=!t&&!a||await new Promise(i=>{Ne(e.target,"show-dialog",{dialogTag:"confirm-delete-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ns})),dialogParams:{title:Di("panels.general.dialogs.remove_area.title",this.hass.language),description:Di("panels.general.dialogs.remove_area.description",this.hass.language,"sensors",String(t),"automations",String(a)),cancel:()=>i(!1),confirm:()=>i(!0)}})}),i&&(s=this.hass,n=this.area_id,s.callApi("POST","alarmo/area",{area_id:n,remove:!0})).catch(t=>es(t,e)).then(()=>{this.closeDialog()})}static get styles(){return o`
      ${ss}
      div.wrapper {
        color: var(--primary-text-color);
      }
    ...
    `}};t([de({attribute:!1})],Ds.prototype,"hass",void 0),t([le()],Ds.prototype,"_params",void 0),t([de()],Ds.prototype,"areas",void 0),t([de()],Ds.prototype,"sensors",void 0),t([de()],Ds.prototype,"automations",void 0),t([de()],Ds.prototype,"name",void 0),t([de()],Ds.prototype,"area_id",void 0),t([de()],Ds.prototype,"selectedArea",void 0),Ds=t([re("create-area-dialog")],Ds);var Ls=Object.freeze({__proto__:null,get CreateAreaDialog(){return Ds}});let Ps=class extends(et(ne)){constructor(){super(...arguments),this.areas={},this.sensors={},this.automations={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Xe(this.hass),this.sensors=await Ge(this.hass),this.automations=await He(this.hass))}render(){if(!this.hass)return q``;const e=Object.values(this.areas);e.sort(is);const t={actions:{width:"48px"},name:{title:this.hass.localize("ui.components.area-picker.add_dialog.name"),width:"40%",grow:!0,text:!0},remarks:{title:Di("panels.general.cards.areas.table.remarks",this.hass.language),width:"60%",hide:this.narrow,text:!0}},a=Object.values(e).map(t=>{const a=Object.values(this.sensors).filter(e=>e.area==t.area_id).length,i=1==Object.values(e).length?Object.values(this.automations).filter(e=>{var a,i;return(null===(a=e.triggers)||void 0===a?void 0:a.map(e=>e.area).includes(t.area_id))||!(null===(i=e.triggers)||void 0===i?void 0:i.map(e=>e.area).length)}).length:Object.values(this.automations).filter(e=>{var a;return null===(a=e.triggers)||void 0===a?void 0:a.map(e=>e.area).includes(t.area_id)}).length,s=`<a href="${os("sensors",{filter:{area:t.area_id}})}">${Di("panels.general.cards.areas.table.summary_sensors",this.hass.language,"number",a)}</a>`,n=`<a href="${os("actions",{filter:{area:t.area_id}})}">${Di("panels.general.cards.areas.table.summary_automations",this.hass.language,"number",i)}</a>`;return{id:t.area_id,actions:q`
        ...
        `,name:Hi(t.name),remarks:Es(Di("panels.general.cards.areas.table.summary",this.hass.language,"summary_sensors",s,"summary_automations",n))}});return q`
      <ha-card header="${Di("panels.general.cards.areas.title",this.hass.language)}">
        <div class="card-content">
          ${Di("panels.general.cards.areas.description",this.hass.language)}
        </div>

        <alarmo-table .columns=${t} .data=${a}>
          ${Di("panels.general.cards.areas.no_items",this.hass.language)}
        </alarmo-table>
        <div class="card-actions">
          <mwc-button @click=${this.addClick}>
            ${Di("panels.general.cards.areas.actions.add",this.hass.language)}
          </mwc-button>
        </div>
      </ha-card>
    `}addClick(e){const t=e.target;Ne(t,"show-dialog",{dialogTag:"create-area-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ls})),dialogParams:{}})}editClick(e,t){const a=e.target;Ne(a,"show-dialog",{dialogTag:"create-area-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ls})),dialogParams:{area_id:t}})}};Ps.styles=ss,t([de()],Ps.prototype,"narrow",void 0),t([de()],Ps.prototype,"path",void 0),t([de()],Ps.prototype,"config",void 0),t([de()],Ps.prototype,"areas",void 0),t([de()],Ps.prototype,"sensors",void 0),t([de()],Ps.prototype,"automations",void 0),Ps=t([re("area-config-card")],Ps);let qs=class extends ne{constructor(){super(...arguments),this.name=""}async showDialog(e){this._params=e;const t=await Ve(this.hass);this.name=t.master.name||"",await this.updateComplete}async closeDialog(){this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <div slot="heading">
          <ha-header-bar>
            <ha-icon-button slot="navigationIcon" dialogAction="cancel" .path=${cs}></ha-icon-button>
            <span slot="title">${Di("panels.general.dialogs.edit_master.title",this.hass.language)}</span>
          </ha-header-bar>
        </div>
        <div class="wrapper">
          <ha-textfield
            ...
            value="${this.name}"
          ></ha-textfield>
          <span class="note">${Di("panels.general.dialogs.edit_area.name_warning",this.hass.language)}</span>
        </div>
        <mwc-button slot="primaryAction" @click=${this.saveClick}>
          ${this.hass.localize("ui.common.save")}
        </mwc-button>
    ...
    `}};t([de({attribute:!1})],qs.prototype,"hass",void 0),t([le()],qs.prototype,"_params",void 0),t([de()],qs.prototype,"name",void 0),qs=t([re("edit-master-dialog")],qs);var Rs=Object.freeze({__proto__:null,get EditMasterDialog(){return qs}});let Us=class extends(et(ne)){constructor(){super(...arguments),this.areas={},this.automations={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.config=await Ve(this.hass),this.areas=await Xe(this.hass),this.automations=await He(this.hass),this.data=Zi(this.config,["trigger_time","disarm_after_trigger","mqtt","master"]))}firstUpdated(){(async()=>{await Ue()})()}render(){var e,t,a,i,s,n,r,o;return this.hass&&this.config&&this.data?"mqtt_configuration"==this.path.subpage?q`
      ...
      `:this.path.params.edit_area?q`
        ...
        ></area-editor-card>
      `:q`
        <ha-card header="${Di("panels.general.title",this.hass.language)}">
          <div class="card-content">
            ${Di("panels.general.cards.general.description",this.hass.language)}
          </div>

          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${Di("panels.general.cards.general.fields.disarm_after_trigger.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.general.cards.general.fields.disarm_after_trigger.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${Di("panels.general.cards.general.fields.enable_mqtt.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.general.cards.general.fields.enable_mqtt.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          ${(null===(i=null===(a=this.data)||void 0===a?void 0:a.mqtt)||void 0===i?void 0:i.enabled)?q`
                <div style="padding: 0px 0px 16px 16px">
                  <mwc-button
                    outlined
                    @click=${()=>Pe(0,os("general","mqtt_configuration"),!0)}
                  >
                    ${Di("panels.general.cards.general.actions.setup_mqtt",this.hass.language)}
                  </mwc-button>
                </div>
              `:""}
          ${Object.keys(this.areas).length>=2?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${Di("panels.general.cards.general.fields.enable_master.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${Di("panels.general.cards.general.fields.enable_master.description",this.hass.language)}
                  </span>
                  <ha-switch
          ...
          ${(null===(o=null===(r=this.data)||void 0===r?void 0:r.master)||void 0===o?void 0:o.enabled)&&Object.keys(this.areas).length>=2?q`
                <div style="padding: 0px 0px 16px 16px">
                  <mwc-button outlined @click=${this.setupMasterClick}>
                    ${Di("panels.general.cards.general.actions.setup_master",this.hass.language)}
                  </mwc-button>
                </div>
              `:""}
        </ha-card>
      ...
      `:q``}setupMasterClick(e){const t=e.target;Ne(t,"show-dialog",{dialogTag:"edit-master-dialog",dialogImport:()=>Promise.resolve().then((function(){return Rs})),dialogParams:{}})}async toggleEnableMaster(e){const t=e.target;let a=t.checked;if(!a){const i=Object.values(this.automations).filter(e=>e.triggers.some(e=>!e.area));if(i.length){await new Promise(e=>{Ne(t,"show-dialog",{dialogTag:"confirm-delete-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ns})),dialogParams:{title:Di("panels.general.dialogs.disable_master.title",this.hass.language),description:Di("panels.general.dialogs.disable_master.description",this.hass.language,"automations",String(i.length)),cancel:()=>e(!1),confirm:()=>e(!0)}})})?!a&&i.length&&i.forEach(t=>{We(this.hass,t.automation_id).catch(t=>es(t,e))}):(a=!0,t.checked=!0)}}this.saveData({master:Object.assign(Object.assign({},this.data.master),{enabled:a})})}saveData(e){this.hass&&this.data&&(this.data=Object.assign(Object.assign({},this.data),e),Be(this.hass,this.data).catch(e=>es(e,this.shadowRoot.querySelector("ha-card"))).then())}};Us.styles=ss,t([de()],Us.prototype,"narrow",void 0),t([de()],Us.prototype,"path",void 0),t([de()],Us.prototype,"data",void 0),t([de()],Us.prototype,"config",void 0),t([de()],Us.prototype,"areas",void 0),t([de()],Us.prototype,"automations",void 0),Us=t([re("alarm-view-general")],Us);const Is=(e,t)=>{if("binary_sensor"==function(e){const t="string"==typeof e?e:e.entity_id;return String(t.split(".").shift())}(e.entity_id)){if(t)return!0;const a=e.attributes.device_class;return!!a&&!!["carbon_monoxide","door","garage_door","gas","heat","lock","moisture","motion","moving","occupancy","opening","presence","safety","smoke","sound","tamper","vibration","window"].includes(a)}return!1},Vs=e=>{switch(e.attributes.device_class){case"door":case"garage_door":case"lock":return Ri.Door;case"window":return Ri.Window;case"carbon_monoxide":case"gas":case"heat":case"moisture":case"smoke":case"safety":return Ri.Environmental;case"motion":case"moving":case"occupancy":case"presence":return Ri.Motion;case"sound":case"opening":case"vibration":case"tamper":return Ri.Tamper;default:return}},Gs=e=>{const t=t=>t.filter(t=>e.includes(t));return{[Ri.Door]:{modes:t([Vi.ArmedAway,Vi.ArmedHome,Vi.ArmedNight,Vi.ArmedVacation]),always_on:!1,allow_open:!1,arm_on_close:!1,use_entry_delay:!0,use_exit_delay:!1},[Ri.Window]:{modes:t([Vi.ArmedAway,Vi.ArmedHome,Vi.ArmedNight,Vi.ArmedVacation]),always_on:!1,allow_open:!1,arm_on_close:!1,use_entry_delay:!1,use_exit_delay:!1},[Ri.Motion]:{modes:t([Vi.ArmedAway,Vi.ArmedVacation]),always_on:!1,allow_open:!0,arm_on_close:!1,use_entry_delay:!0,use_exit_delay:!0},[Ri.Tamper]:{modes:t([Vi.ArmedAway,Vi.ArmedHome,Vi.ArmedNight,Vi.ArmedVacation,Vi.ArmedCustom]),always_on:!1,allow_open:!1,arm_on_close:!1,use_entry_delay:!1,use_exit_delay:!1},[Ri.Environmental]:{modes:t([Vi.ArmedAway,Vi.ArmedHome,Vi.ArmedNight,Vi.ArmedVacation,Vi.ArmedCustom]),always_on:!0,allow_open:!1,arm_on_close:!1,use_entry_delay:!1,use_exit_delay:!1}}};let Fs=class extends ne{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <div slot="heading">
          <ha-header-bar>
            <ha-icon-button slot="navigationIcon" dialogAction="cancel" .path=${cs}>
      ...
      <ha-dialog open @closed=${this.closeDialog} @close-dialog=${this.closeDialog} .heading=${this.renderHeader()}>
        <div class="wrapper">
          ...
          <settings-row large dialog>
            <span slot="heading">
              ${Di("panels.sensors.dialogs.create_group.fields.sensors.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.sensors.dialogs.create_group.fields.sensors.description",this.hass.language)}
            </span>
            <div>
          ...
          <settings-row dialog>
            <span slot="heading">
              ${Di("panels.sensors.dialogs.create_group.fields.timeout.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.sensors.dialogs.create_group.fields.timeout.description",this.hass.language)}
            </span>
            <time-slider
              .hass=${this.hass}
              unit="min"
    ...
    `:q``}renderHeader(){return q`
      <span class="header_title">
        ${this.data.group_id?Di("panels.sensors.dialogs.edit_group.title",this.hass.language,"{name}",this.sensorGroups[this.data.group_id].name):Di("panels.sensors.dialogs.create_group.title",this.hass.language)}
      </span>
      <ha-icon-button
        ...
        class="header_button"
      ></ha-icon-button>
    `}renderSensorOptions(){const e=Object.keys(this.sensors).filter(e=>!Wi(this.sensors[e].group)||this.sensors[e].group===this.data.group_id).map(e=>{const t=this.hass.states[e],a=Object.entries(Ri).find(([,t])=>t==this.sensors[e].type)[0];return{value:e,name:Hi(Yi(t)),icon:Ui[a]}});return e.sort(is),e.length?q`
      <alarmo-chip-set
        .items=${e}
      ...
      ></alarmo-chip-set>
    `:Di("panels.sensors.cards.sensors.no_items",this.hass.language)}saveClick(e){var t,a;this.data.name.length&&(this.data.group_id&&this.data.name==this.sensorGroups[this.data.group_id].name||!Object.values(this.sensorGroups).find(e=>e.name.toLowerCase()==this.data.name.toLowerCase()))?this.data.entities.length<2?Ji(e,Di("panels.sensors.dialogs.create_group.errors.insufficient_sensors",this.hass.language)):(t=this.hass,a=this.data,t.callApi("POST","alarmo/sensor_groups",a)).catch(t=>es(t,e)).then(()=>{this.closeDialog()}):Ji(e,Di("panels.sensors.dialogs.create_group.errors.invalid_name",this.hass.language))}deleteClick(e){var t,a;this.data.group_id&&(t=this.hass,a=this.data.group_id,t.callApi("POST","alarmo/sensor_groups",{group_id:a,remove:!0})).catch(t=>es(t,e)).then(()=>{this.closeDialog()})}static get styles(){return o`
      ${ns}
      div.wrapper {
        color: var(--primary-text-color);
      }
    ...
    `}};t([de({attribute:!1})],Ys.prototype,"hass",void 0),t([le()],Ys.prototype,"_params",void 0),t([de()],Ys.prototype,"sensorGroups",void 0),t([de()],Ys.prototype,"sensors",void 0),t([de()],Ys.prototype,"data",void 0),Ys=t([re("create-sensor-group-dialog")],Ys);var Bs=Object.freeze({__proto__:null,get CreateSensorGroupDialog(){return Ys}});let Ks=class extends(et(ne)){constructor(){super(...arguments),this.sensorGroups={},this.sensors={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.sensorGroups=await Ye(this.hass),this.sensors=await Ge(this.hass))}async showDialog(e){await this._fetchData(),this._params=e,await this.updateComplete}async closeDialog(){this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${this.renderHeader()} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <div class="wrapper">
          <div class="description">
            ${Di("panels.sensors.dialogs.manage_groups.description",this.hass.language)}
          </div>
          <div class="container">
            ${Object.keys(this.sensorGroups).length?Object.values(this.sensorGroups).map(e=>this.renderGroup(e)):Di("panels.sensors.dialogs.manage_groups.no_items",this.hass.language)}
          </div>
        </div>
        <mwc-button slot="secondaryAction" @click=${this.createGroupClick}>
          <ha-icon icon="hass:plus"></ha-icon>
          ${Di("panels.sensors.dialogs.manage_groups.actions.new_group",this.hass.language)}
        </mwc-button>
      </ha-dialog>
    `:q``}renderHeader(){return q`
      <span class="header_title">${Di("panels.sensors.dialogs.manage_groups.title",this.hass.language)}</span>
      <ha-icon-button
        .label=${this.hass.localize("ui.dialogs.generic.close")}
        .path=${cs}
        dialogAction="close"
    ...
    `}};t([de({attribute:!1})],Ks.prototype,"hass",void 0),t([le()],Ks.prototype,"_params",void 0),t([de()],Ks.prototype,"sensorGroups",void 0),t([de()],Ks.prototype,"sensors",void 0),Ks=t([re("manage-sensor-groups-dialog")],Ks);var Zs=Object.freeze({__proto__:null,get ManageSensorGroupsDialog(){return Ks}});let Qs=class extends(et(ne)){constructor(){super(...arguments),this.showBypassModes=!1}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){var e;if(!this.hass)return;const t=await Xe(this.hass);this.areas=t;const a=await Ye(this.hass);this.sensorGroups=a;const i=await Ge(this.hass);this.data=Object.keys(i).includes(this.item)?i[this.item]:void 0,this.data&&!(null===(e=this.data)||void 0===e?void 0:e.area)&&1==Object.keys(t).length&&(this.data=Object.assign(Object.assign({},this.data),{area:Object.keys(this.areas)[0]}))}render(){if(!this.data)return q``;this.hass.states[this.data.entity_id];return q`
      <ha-card>
        <div class="card-header">
          <div class="name">${Di("panels.sensors.cards.editor.title",this.hass.language)}</div>
          <ha-icon-button .path=${cs} @click=${this.cancelClick}></ha-icon-button>
        </div>
        <div class="card-content">
          ${Di("panels.sensors.cards.editor.description",this.hass.language,"{entity}",Yi(this.hass.states[this.item]))}
        </div>

        ${Object.keys(this.areas).length>1?q`
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${Di("panels.sensors.cards.editor.fields.area.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${Di("panels.sensors.cards.editor.fields.area.description",this.hass.language)}
                </span>

                <alarmo-select
                  .items=${Object.values(this.areas).map(e=>Object({value:e.area_id,name:e.name}))}
                  value=${this.data.area}
                  label=${Di("panels.sensors.cards.editor.fields.area.heading",this.hass.language)}
        ...
        <settings-row .narrow=${this.narrow} .large=${!0}>
          <span slot="heading">
            ${Di("panels.sensors.cards.editor.fields.device_type.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${Di("panels.sensors.cards.editor.fields.device_type.description",this.hass.language)}
          </span>

          <alarmo-select
            .hass=${this.hass}
            .items=${e=this.hass,Object.entries(Ri).filter(([,e])=>e!=Ri.Other).map(([t,a])=>Object({value:a,name:Di(`panels.sensors.cards.editor.fields.device_type.choose.${a}.name`,e.language),description:Di(`panels.sensors.cards.editor.fields.device_type.choose.${a}.description`,e.language),icon:Ui[t]}))}
            label=${Di("panels.sensors.cards.editor.fields.device_type.heading",this.hass.language)}
            clearable=${!0}
            icons=${!0}
            value=${this.data.type}
            @value-changed=${e=>this.setType(e.target.value||Ri.Other)}
          ></alarmo-select>
        </settings-row>

        <settings-row .narrow=${this.narrow} .large=${this.modesByArea(this.data.area).length>3}>
          <span slot="heading">
            ${Di("panels.sensors.cards.editor.fields.modes.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${Di("panels.sensors.cards.editor.fields.modes.description",this.hass.language)}
          </span>
          ...
          <div>
            ${this.modesByArea(this.data.area).map(e=>q`
                ...
                >
                  <ha-icon icon="${Li[Object.entries(Vi).find(([,t])=>t==e)[0]]}"></ha-icon>
                  ${Di("common.modes_short."+e,this.hass.language)}
                </mwc-button>
              `)}
          </div>
        </settings-row>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${Di("panels.sensors.cards.editor.fields.group.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${Di("panels.sensors.cards.editor.fields.group.description",this.hass.language)}
          </span>
          ...
          <div>
            ${Object.keys(this.sensorGroups).length?q`
                  <alarmo-select
                    ...
                    label="${Di("panels.sensors.cards.editor.fields.group.heading",this.hass.language)}"
                    @value-changed=${e=>{this.data={...this.data,group:e.detail.value}}}
                  ></alarmo-select>
                `:""}
            <mwc-button @click=${this.manageGroupsClick}>
              ${Di("panels.sensors.cards.editor.actions.setup_groups",this.hass.language)}
            </mwc-button>
          </div>
        </settings-row>
        ...
        <collapsible-section
          .narrow=${this.narrow}
          header=${Di("panels.sensors.cards.editor.actions.toggle_advanced",this.hass.language)}
        >
          ${!this.data.type||[Ri.Environmental,Ri.Other].includes(this.data.type)?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${Di("panels.sensors.cards.editor.fields.always_on.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${Di("panels.sensors.cards.editor.fields.always_on.description",this.hass.language)}
                  </span>
              ...
              `:""}
          ${!this.data.type||[Ri.Window,Ri.Door,Ri.Motion,Ri.Other].includes(this.data.type)?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${Di("panels.sensors.cards.editor.fields.use_exit_delay.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${Di("panels.sensors.cards.editor.fields.use_exit_delay.description",this.hass.language)}
                  </span>
                ...
                ${this.data.type&&![Ri.Motion,Ri.Window,Ri.Other].includes(this.data.type)||!this.data.use_exit_delay?"":q`
                      <settings-row .narrow=${this.narrow} nested>
                        <span slot="heading">
                          ${Di("panels.sensors.cards.editor.fields.allow_open.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${Di("panels.sensors.cards.editor.fields.allow_open.description",this.hass.language)}
                        </span>
          ...
          ${!this.data.type||[Ri.Window,Ri.Door,Ri.Motion,Ri.Other].includes(this.data.type)?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${Di("panels.sensors.cards.editor.fields.use_entry_delay.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${Di("panels.sensors.cards.editor.fields.use_entry_delay.description",this.hass.language)}
                  </span>
              ...
              `:""}
          ${!this.data.type||[Ri.Door,Ri.Other].includes(this.data.type)?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${Di("panels.sensors.cards.editor.fields.arm_on_close.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${Di("panels.sensors.cards.editor.fields.arm_on_close.description",this.hass.language)}
                  </span>
              ...
              `:""}
          ${!this.data.type||[Ri.Window,Ri.Door,Ri.Other].includes(this.data.type)?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${Di("panels.sensors.cards.editor.fields.auto_bypass.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${Di("panels.sensors.cards.editor.fields.auto_bypass.description",this.hass.language)}
                  </span>
                ...
                ${this.data.auto_bypass?q`
                      <settings-row .narrow=${this.narrow} .large=${this.modesByArea(this.data.area).length>2} nested>
                        <span slot="heading">
                          ${Di("panels.sensors.cards.editor.fields.auto_bypass.modes",this.hass.language)}
                        </span>
                        <div>
                          ${this.modesByArea(this.data.area).map(e=>q`
                              <mwc-button
                              ...
                              >
                                <ha-icon
                                  icon="${Li[Object.entries(Vi).find(([,t])=>t==e)[0]]}"
                                ></ha-icon>
                                ${Di("common.modes_short."+e,this.hass.language)}
                              </mwc-button>
                            `)}
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${Di("panels.sensors.cards.editor.fields.trigger_unavailable.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.sensors.cards.editor.fields.trigger_unavailable.description",this.hass.language)}
            </span>
        ...
        <div class="card-actions">
          ...
          <mwc-button class="warning" @click=${this.deleteClick}>
            ${Di("panels.sensors.cards.editor.actions.remove",this.hass.language)}
          </mwc-button>
        </div>
      </ha-card>
    `;var e}modesByArea(e){const t=Object.keys(this.areas).reduce((e,t)=>Object.assign(e,{[t]:Object.entries(this.areas[t].modes).filter(([,e])=>e.enabled).map(([e])=>e)}),{});return e?t[e]:Object.values(t).reduce((e,t)=>e.filter(e=>t.includes(e)))}_SetData(e){if(this.data)for(const[t,a]of Object.entries(e))switch(t){case"always_on":this.data=Object.assign(Object.assign({},this.data),{always_on:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{arm_on_close:!1,use_exit_delay:!1,use_entry_delay:!1,allow_open:!1,auto_bypass:!1}));break;case"use_entry_delay":this.data=Object.assign(Object.assign({},this.data),{use_entry_delay:1==a});break;case"use_exit_delay":this.data=Object.assign(Object.assign({},this.data),{use_exit_delay:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{allow_open:!1}));break;case"arm_on_close":this.data=Object.assign(Object.assign({},this.data),{arm_on_close:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{always_on:!1,allow_open:!1}));break;case"allow_open":this.data=Object.assign(Object.assign({},this.data),{allow_open:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{arm_on_close:!1,always_on:!1,use_exit_delay:!0}));break;case"auto_bypass":this.data=Object.assign(Object.assign({},this.data),{auto_bypass:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{always_on:!1}));break;case"trigger_unavailable":this.data=Object.assign(Object.assign({},this.data),{trigger_unavailable:1==a})}}setMode(e){this.data&&(this.data=Object.assign(Object.assign({},this.data),{modes:this.data.modes.includes(e)?Ki(this.data.modes,e):Bi(this.data.modes.concat([e]))}))}setBypassMode(e){this.data&&(this.data=Object.assign(Object.assign({},this.data),{auto_bypass_modes:this.data.auto_bypass_modes.includes(e)?Ki(this.data.auto_bypass_modes,e):Bi(this.data.auto_bypass_modes.concat([e]))}))}setType(e){if(!this.data)return;const t=e!=Ri.Other?Gs(this.modesByArea(this.data.area))[e]:{};this.data=Object.assign(Object.assign(Object.assign({},this.data),{type:e}),t)}deleteClick(e){var t,a;(t=this.hass,a=this.item,t.callApi("POST","alarmo/sensors",{entity_id:a,remove:!0})).catch(t=>es(t,e)).then(()=>{this.cancelClick()})}saveClick(e){if(!this.data)return;const t=[];this.data=Object.assign(Object.assign({},this.data),{auto_bypass_modes:this.data.auto_bypass_modes.filter(e=>this.data.modes.includes(e))}),this.data.area||t.push(Di("panels.sensors.cards.editor.errors.no_area",this.hass.language)),this.data.modes.length||this.data.always_on||t.push(Di("panels.sensors.cards.editor.errors.no_modes",this.hass.language)),this.data.auto_bypass&&!this.data.auto_bypass_modes.length&&t.push(Di("panels.sensors.cards.editor.errors.no_auto_bypass_modes",this.hass.language)),t.length?Ji(e,q`
          ${Di("panels.sensors.cards.editor.errors.description",this.hass.language)}
          <ul>
            ${t.map(e=>q`
                  <li>${e}</li>
                `)}
          </ul>
        `):Ke(this.hass,Object.assign({},this.data)).catch(t=>es(t,e)).then(()=>{this.cancelClick()})}cancelClick(){Pe(0,os("sensors"),!0)}manageGroupsClick(e){const t=e.target;Ne(t,"show-dialog",{dialogTag:"manage-sensor-groups-dialog",dialogImport:()=>Promise.resolve().then((function(){return Zs})),dialogParams:{}})}getSensorGroups(){return Object.keys(this.sensorGroups).map(e=>Object({value:e,name:this.sensorGroups[e].name}))}};Qs.styles=ss,t([de()],Qs.prototype,"hass",void 0),t([de()],Qs.prototype,"narrow",void 0),t([de()],Qs.prototype,"item",void 0),t([de()],Qs.prototype,"data",void 0),t([de()],Qs.prototype,"showBypassModes",void 0),Qs=t([re("sensor-editor-card")],Qs);const Ws=e=>Object.keys(e.modes).filter(t=>e.modes[t].enabled),Xs=e=>{let t=[];return Object.values(e).forEach(e=>{t=[...t,...Ws(e)]}),t=Bi(t),t.sort((e,t)=>{const a=Object.values(Vi);return a.findIndex(t=>t==e)-a.findIndex(e=>e==t)}),t},Js="no_area";let en=class extends(et(ne)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Xe(this.hass),this.sensors=await Ge(this.hass))}async firstUpdated(){this.path&&2==this.path.length&&"filter"==this.path[0]&&(this.selectedArea=this.path[1])}render(){return this.hass&&this.areas&&this.sensors?q`
      <ha-card header="${Di("panels.sensors.title",this.hass.language)}">
        <div class="card-content">
          ${Di("panels.sensors.cards.sensors.description",this.hass.language)}
        </div>
        ...
        <alarmo-table
          ...
          @row-click=${e=>{Pe(0,os("sensors",{params:{edit:e.detail.id}}),!0)}}
        >
          ${Di("panels.sensors.cards.sensors.table.no_items",this.hass.language)}
        </alarmo-table>
      </ha-card>
    `:q``}tableColumns(){const e=()=>q`
      <simple-tooltip animation-delay="0">
        ${Di("panels.sensors.cards.sensors.table.no_area_warning",this.hass.language)}
      </simple-tooltip>
    `;return{icon:{width:"40px",renderer:t=>{const a=this.hass.states[t.entity_id],i=Object.keys(Ri).find(e=>Ri[e]==t.type),s=a?Ui[i]:"hass:help-circle-outline";return t.area==Js?q`
                ${e()}
                <ha-icon icon="mdi:alert" style="color: var(--error-color)"></ha-icon>
              `:q`
                <simple-tooltip animation-delay="0">
                  ${a?Di(`panels.sensors.cards.editor.fields.device_type.choose.${t.type}.name`,this.hass.language):this.hass.localize("state_badge.default.entity_not_found")}
                </simple-tooltip>
        ...
        `},modes:{title:Di("panels.sensors.cards.sensors.table.arm_modes",this.hass.language),width:"25%",hide:this.narrow,text:!0,renderer:t=>q`
          ${t.area==Js?e():""}
          <span class="${t.enabled?"":"disabled"}">
            ${t.always_on?Di("panels.sensors.cards.sensors.table.always_on",this.hass.language):t.modes.length?t.modes.map(e=>Di("common.modes_short."+e,this.hass.language)).join(", "):this.hass.localize("state_attributes.climate.preset_mode.none")}
          </span>
        `},enabled:{title:Di("common.enabled",this.hass.language),width:"68px",align:"center",renderer:e=>q`
          <ha-switch
            @click=${e=>{e.stopPropagation()}}
            ?checked=${e.enabled}
            @change=${t=>this.toggleEnabled(t,e.entity_id)}
          ></ha-switch>
        `}}}getTableData(){const e=Object.keys(this.sensors).map(e=>{const t=this.hass.states[e],a=this.sensors[e],i=a.area?Ws(this.areas[a.area]):Xs(this.areas);return Object.assign(Object.assign({},a),{id:e,name:Yi(t),modes:a.always_on?i:a.modes.filter(e=>i.includes(e)),warning:!a.area,area:a.area||Js})});return e.sort(is),e}toggleEnabled(e,t){const a=e.target.checked;Ke(this.hass,{entity_id:t,enabled:a}).catch(t=>es(t,e)).then()}removeCustomName(e){const t={entity_id:e,name:""};Ke(this.hass,t)}getTableFilterOptions(){let e=Object.values(this.areas).map(e=>Object({value:e.area_id,name:e.name,badge:t=>t.filter(t=>t.area==e.area_id).length})).sort(is);Object.values(this.sensors).filter(e=>!e.area).length&&(e=[{value:Js,name:this.hass.localize("state_attributes.climate.preset_mode.none"),badge:e=>e.filter(e=>e.area==Js).length},...e]);const t=Xs(this.areas).map(e=>Object({value:e,name:Di("common.modes_short."+e,this.hass.language),badge:t=>t.filter(t=>t.modes.includes(e)).length}));return{area:{name:Di("components.table.filter.item",this.hass.language,"name",Di("panels.actions.cards.new_action.fields.area.heading",this.hass.language)),items:e,value:this.selectedArea?[this.selectedArea]:[]},modes:{name:Di("components.table.filter.item",this.hass.language,"name",Di("panels.actions.cards.new_action.fields.mode.heading",this.hass.language)),items:t,value:this.selectedMode?[this.selectedMode]:[]}}}};en.styles=ss,t([de()],en.prototype,"hass",void 0),t([de()],en.prototype,"narrow",void 0),t([de()],en.prototype,"areas",void 0),t([de()],en.prototype,"sensors",void 0),t([de()],en.prototype,"selectedArea",void 0),t([de()],en.prototype,"selectedMode",void 0),t([de()],en.prototype,"path",void 0),en=t([re("sensors-overview-card")],en);let tn=class extends(et(ne)){constructor(){super(...arguments),this.addSelection=[],this.areas={},this.sensors={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Xe(this.hass))}async firstUpdated(){this.areas=await Xe(this.hass),this.sensors=await Ge(this.hass)}render(){const e={checkbox:{width:"48px",renderer:e=>q`
          <ha-checkbox
        ...
        `},type:{title:Di("panels.sensors.cards.add_sensors.table.type",this.hass.language),width:"40%",hide:this.narrow,text:!0,renderer:e=>e.type?Di(`panels.sensors.cards.editor.fields.device_type.choose.${e.type}.name`,this.hass.language):this.hass.localize("state.default.unknown")}},t=((e,t,a=!1)=>{const i=Object.values(e.states).filter(e=>Is(e,a)).filter(e=>!t.includes(e.entity_id)).map(e=>Object({id:e.entity_id,name:Yi(e),icon:Fi(e)}));return i.sort(is),i})(this.hass,Object.keys(this.sensors),!0).map(e=>Object.assign(Object.assign({},e),{type:Vs(this.hass.states[e.id]),isSupportedType:void 0!==Vs(this.hass.states[e.id])?"true":"false"}));return q`
      <ha-card header="${Di("panels.sensors.cards.add_sensors.title",this.hass.language)}">
        <div class="card-content">
          ${Di("panels.sensors.cards.add_sensors.description",this.hass.language)}
        </div>
        ...
        <alarmo-table
          ...
          .filters=${this.getTableFilterOptions()}
        >
          ${Di("panels.sensors.cards.add_sensors.no_items",this.hass.language)}
        </alarmo-table>

        <div class="card-actions">
          <mwc-button @click=${this.addSelected} ?disabled=${0==this.addSelection.length}>
            ${Di("panels.sensors.cards.add_sensors.actions.add_to_alarm",this.hass.language)}
          </mwc-button>
        </div>
      </ha-card>
    `}toggleSelect(e,t){const a=e.target.checked;this.addSelection=a&&!this.addSelection.includes(t)?[...this.addSelection,t]:a?this.addSelection:this.addSelection.filter(e=>e!=t)}addSelected(e){if(!this.hass)return;const t=Object.values(this.areas).map(e=>Object.entries(e.modes).filter(([,e])=>e.enabled).map(([e])=>e)).reduce((e,t)=>e.filter(e=>t.includes(e)));this.addSelection.map(e=>function(e,t){if(!e)return null;const a=Se(e.entity_id);let i={entity_id:e.entity_id,modes:[],use_entry_delay:!0,use_exit_delay:!0,arm_on_close:!1,allow_open:!1,always_on:!1,auto_bypass:!1,auto_bypass_modes:[],trigger_unavailable:!1,type:Ri.Other,enabled:!0};if("binary_sensor"==a){const a=Vs(e);a&&(i=Object.assign(Object.assign(Object.assign({},i),{type:a}),Gs(t)[a]))}return i}(this.hass.states[e],t)).map(e=>1==Object.keys(this.areas).length?Object.assign(e,{area:Object.keys(this.areas)[0]}):e).filter(e=>e).forEach(t=>{Ke(this.hass,t).catch(t=>es(t,e)).then()}),this.addSelection=[]}getTableFilterOptions(){return{isSupportedType:{name:Di("panels.sensors.cards.add_sensors.actions.filter_supported",this.hass.language),items:[{value:"true",name:"true"}],value:["true"],binary:!0}}}};tn.styles=ss,t([de()],tn.prototype,"hass",void 0),t([de()],tn.prototype,"narrow",void 0),t([de()],tn.prototype,"addSelection",void 0),t([de()],tn.prototype,"areas",void 0),t([de()],tn.prototype,"sensors",void 0),tn=t([re("add-sensors-card")],tn);let an=class extends ne{firstUpdated(){(async()=>{await Ue()})()}render(){var e,t;if(!this.hass)return q``;if(this.path.params.edit)return q`
        <sensor-editor-card
          .hass=${this.hass}
          .narrow=${this.narrow}
      ...
      `}}};t([de()],an.prototype,"hass",void 0),t([de()],an.prototype,"narrow",void 0),t([de()],an.prototype,"path",void 0),an=t([re("alarm-view-sensors")],an);let sn=class extends ne{constructor(){super(...arguments),this.data={can_arm:!0,can_disarm:!0,is_override_code:!1},this.repeatCode="",this.areas={}}async firstUpdated(){if(this.users=await Fe(this.hass),this.areas=await Xe(this.hass),this.item){const e=this.users[this.item];this.data=Qi(e,"code","code_format","code_length")}this.data=Object.assign(Object.assign({},this.data),{area_limit:(this.data.area_limit||[]).filter(e=>Object.keys(this.areas).includes(e))}),(this.data.area_limit||[]).length||(this.data=Object.assign(Object.assign({},this.data),{area_limit:Object.keys(this.areas)}))}render(){var e;return this.users?q`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${this.item?Di("panels.codes.cards.edit_user.title",this.hass.language):Di("panels.codes.cards.new_user.title",this.hass.language)}
          </div>
          <ha-icon-button .path=${cs} @click=${this.cancelClick}></ha-icon-button>
        </div>
        <div class="card-content">
          ${this.item?Di("panels.codes.cards.edit_user.description",this.hass.language,"{name}",this.users[this.item].name):Di("panels.codes.cards.new_user.description",this.hass.language)}
        </div>

        <settings-row .narrow=${this.narrow}>
          <span slot="heading">${Di("panels.codes.cards.new_user.fields.name.heading",this.hass.language)}</span>
          <span slot="description">
            ${Di("panels.codes.cards.new_user.fields.name.description",this.hass.language)}
          </span>

          <ha-textfield
            label="${Di("panels.codes.cards.new_user.fields.name.heading",this.hass.language)}"
            placeholder=""
            value=${this.data.name}
        ...
        ${this.item?q`
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${Di("panels.codes.cards.edit_user.fields.old_code.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${Di("panels.codes.cards.edit_user.fields.old_code.description",this.hass.language)}
                </span>

                <ha-textfield
                  label="${Di("panels.codes.cards.edit_user.fields.old_code.heading",this.hass.language)}"
                  placeholder=""
                  type="password"
        ...
        ${this.item&&!(null===(e=this.data.old_code)||void 0===e?void 0:e.length)?"":q`
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${Di("panels.codes.cards.new_user.fields.code.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${Di("panels.codes.cards.new_user.fields.code.description",this.hass.language)}
                </span>

                <ha-textfield
                  label="${Di("panels.codes.cards.new_user.fields.code.heading",this.hass.language)}"
                  placeholder=""
                  type="password"
              ...
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${Di("panels.codes.cards.new_user.fields.confirm_code.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${Di("panels.codes.cards.new_user.fields.confirm_code.description",this.hass.language)}
                </span>

                <ha-textfield
                  label="${Di("panels.codes.cards.new_user.fields.confirm_code.heading",this.hass.language)}"
                  placeholder=""
                  type="password"
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${Di("panels.codes.cards.new_user.fields.can_arm.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${Di("panels.codes.cards.new_user.fields.can_arm.description",this.hass.language)}
          </span>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${Di("panels.codes.cards.new_user.fields.can_disarm.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${Di("panels.codes.cards.new_user.fields.can_disarm.description",this.hass.language)}
          </span>
        ...
        ${this.getAreaOptions().length>=2?q`
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${Di("panels.codes.cards.new_user.fields.area_limit.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${Di("panels.codes.cards.new_user.fields.area_limit.description",this.hass.language)}
                </span>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${Di("panels.codes.cards.new_user.fields.is_override_code.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${Di("panels.codes.cards.new_user.fields.is_override_code.description",this.hass.language)}
          </span>
    ...
    `:q``}getAreaOptions(){let e=Object.keys(this.areas||{}).map(e=>Object({value:e,name:this.areas[e].name}));return e.sort(is),e}toggleSelectArea(e,t){if((this.data.area_limit||[]).length<=1&&!t)return;let a=this.data.area_limit||[];a=t?a.includes(e)?a:[...a,e]:a.includes(e)?a.filter(t=>t!=e):a,this.data=Object.assign(Object.assign({},this.data),{area_limit:a})}deleteClick(e){var t,a;this.item&&(t=this.hass,a=this.item,t.callApi("POST","alarmo/users",{user_id:a,remove:!0})).catch(t=>es(t,e)).then(()=>{this.cancelClick()})}saveClick(e){var t,a,i;let s=Object.assign({},this.data);(null===(t=s.name)||void 0===t?void 0:t.length)?(null===(a=s.code)||void 0===a?void 0:a.length)&&!(s.code.length<4)||this.item&&!(null===(i=s.old_code)||void 0===i?void 0:i.length)?(s.code||"").length&&s.code!==this.repeatCode?(Ji(e,Di("panels.codes.cards.new_user.errors.code_mismatch",this.hass.language)),this.data=Qi(this.data,"code"),this.repeatCode=""):(this.item&&(s.old_code||"").length<4&&Qi(s,"old_code","code"),this.getAreaOptions().length&&!this.getAreaOptions().every(e=>(this.data.area_limit||[]).includes(e.value))||(s=Object.assign(Object.assign({},s),{area_limit:[]})),Ze(this.hass,s).catch(t=>es(t,e)).then(()=>{this.cancelClick()})):Ji(e,Di("panels.codes.cards.new_user.errors.no_code",this.hass.language)):Ji(e,Di("panels.codes.cards.new_user.errors.no_name",this.hass.language))}cancelClick(){Pe(0,os("codes"),!0)}static get styles(){return o`
      ${ss}
      div.checkbox-list {
        display: flex;
        flex-direction: row;
    ...
    `}};t([de()],sn.prototype,"hass",void 0),t([de()],sn.prototype,"narrow",void 0),t([de()],sn.prototype,"item",void 0),t([de()],sn.prototype,"data",void 0),t([de()],sn.prototype,"repeatCode",void 0),sn=t([re("user-editor-card")],sn);let nn=class extends(et(ne)){constructor(){super(...arguments),this.users={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await Ve(this.hass);this.data=Zi(e,["code_arm_required","code_disarm_required","code_format"]);const t=await Fe(this.hass);this.users=t}render(){return this.hass&&this.data?"new_user"==this.path.subpage?q`
      ...
      `:this.path.params.edit_user?q`
        ...
        ></user-editor-card>
      `:q`
        <ha-card header="${Di("panels.codes.title",this.hass.language)}">
          <div class="card-content">${Di("panels.codes.cards.codes.description",this.hass.language)}</div>

          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${Di("panels.codes.cards.codes.fields.code_arm_required.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.codes.cards.codes.fields.code_arm_required.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${Di("panels.codes.cards.codes.fields.code_disarm_required.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.codes.cards.codes.fields.code_disarm_required.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${Di("panels.codes.cards.codes.fields.code_format.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.codes.cards.codes.fields.code_format.description",this.hass.language)}
            </span>
            <mwc-button
            ...
            >
              ${Di("panels.codes.cards.codes.fields.code_format.code_format_number",this.hass.language)}
            </mwc-button>
            <mwc-button
              ...
              ?disabled=${!this.data.code_arm_required&&!this.data.code_disarm_required}
            >
              ${Di("panels.codes.cards.codes.fields.code_format.code_format_text",this.hass.language)}
            </mwc-button>
          </settings-row>
        </ha-card>

        ${this.usersPanel()}
      `:q``}usersPanel(){if(!this.hass)return q``;const e=Object.values(this.users);e.sort(is);const t={icon:{width:"40px"},name:{title:this.hass.localize("ui.components.area-picker.add_dialog.name"),width:"40%",grow:!0,text:!0},code_format:{title:Di("panels.codes.cards.codes.fields.code_format.heading",this.hass.language),width:"40%",hide:this.narrow,text:!0},enabled:{title:Di("common.enabled",this.hass.language),width:"68px",align:"center"}},a=e.map(e=>({id:e.user_id,icon:q`
          <ha-icon icon="mdi:account-outline"></ha-icon>
        `,name:Hi(e.name),code_format:"number"==e.code_format?Hi(Di("panels.codes.cards.codes.fields.code_format.code_format_number",this.hass.language)):"text"==e.code_format?Hi(Di("panels.codes.cards.codes.fields.code_format.code_format_text",this.hass.language)):this.hass.localize("state.default.unknown"),enabled:q`
          <ha-switch
            @click=${e=>{e.stopPropagation()}}
            ?checked=${e.enabled}
          ...
          ></ha-switch>
        `}));return q`
      <ha-card header="${Di("panels.codes.cards.user_management.title",this.hass.language)}">
        <div class="card-content">
          ${Di("panels.codes.cards.user_management.description",this.hass.language)}
        </div>
        ...
        <alarmo-table
          ...
          .columns=${t}
          .data=${a}
          @row-click=${e=>{const t=String(e.detail.id);Pe(0,os("codes",{params:{edit_user:t}}),!0)}}
        >
          ${Di("panels.codes.cards.user_management.no_items",this.hass.language)}
        </alarmo-table>
        <div class="card-actions">
          <mwc-button @click=${this.addUserClick}>
            ${Di("panels.codes.cards.user_management.actions.new_user",this.hass.language)}
          </mwc-button>
        </div>
      </ha-card>
    `}addUserClick(){Pe(0,os("codes","new_user"),!0)}saveData(e){this.hass&&(this.data=Object.assign(Object.assign({},this.data),e),Be(this.hass,this.data).catch(e=>es(e,this.shadowRoot.querySelector("ha-card"))).then())}toggleEnabled(e,t){const a=e.target.checked;Ze(this.hass,{user_id:t,enabled:a}).catch(t=>es(t,e)).then()}};nn.styles=ss,t([de()],nn.prototype,"hass",void 0),t([de()],nn.prototype,"narrow",void 0),t([de()],nn.prototype,"path",void 0),t([de()],nn.prototype,"data",void 0),t([de()],nn.prototype,"users",void 0),nn=t([re("alarm-view-codes")],nn);const rn=(e,t)=>{switch(e){case Vi.ArmedAway:return{value:Vi.ArmedAway,name:Di("common.modes_short.armed_away",t.language),icon:Li.ArmedAway};case Vi.ArmedHome:return{value:Vi.ArmedHome,name:Di("common.modes_short.armed_home",t.language),icon:Li.ArmedHome};case Vi.ArmedNight:return{value:Vi.ArmedNight,name:Di("common.modes_short.armed_night",t.language),icon:Li.ArmedNight};case Vi.ArmedCustom:return{value:Vi.ArmedCustom,name:Di("common.modes_short.armed_custom_bypass",t.language),icon:Li.ArmedCustom};case Vi.ArmedVacation:return{value:Vi.ArmedVacation,name:Di("common.modes_short.armed_vacation",t.language),icon:Li.ArmedVacation}}},on=(e,t)=>{switch(e){case Gi.Armed:return{value:Gi.Armed,name:Di("panels.actions.cards.new_notification.fields.event.choose.armed.name",t.language),description:Di("panels.actions.cards.new_notification.fields.event.choose.armed.description",t.language),icon:"hass:shield-check-outline"};case Gi.Disarmed:return{value:Gi.Disarmed,name:Di("panels.actions.cards.new_notification.fields.event.choose.disarmed.name",t.language),description:Di("panels.actions.cards.new_notification.fields.event.choose.disarmed.description",t.language),icon:"hass:shield-off-outline"};case Gi.Triggered:return{value:Gi.Triggered,name:Di("panels.actions.cards.new_notification.fields.event.choose.triggered.name",t.language),description:Di("panels.actions.cards.new_notification.fields.event.choose.triggered.description",t.language),icon:"hass:bell-alert-outline"};case Gi.Untriggered:return{value:Gi.Untriggered,name:Di("panels.actions.cards.new_notification.fields.event.choose.untriggered.name",t.language),description:Di("panels.actions.cards.new_notification.fields.event.choose.untriggered.description",t.language),icon:"hass:bell-off-outline"};case Gi.ArmFailure:return{value:Gi.ArmFailure,name:Di("panels.actions.cards.new_notification.fields.event.choose.arm_failure.name",t.language),description:Di("panels.actions.cards.new_notification.fields.event.choose.arm_failure.description",t.language),icon:"hass:alert-outline"};case Gi.Arming:return{value:Gi.Arming,name:Di("panels.actions.cards.new_notification.fields.event.choose.arming.name",t.language),description:Di("panels.actions.cards.new_notification.fields.event.choose.arming.description",t.language),icon:"hass:home-export-outline"};case Gi.Pending:return{value:Gi.Pending,name:Di("panels.actions.cards.new_notification.fields.event.choose.pending.name",t.language),description:Di("panels.actions.cards.new_notification.fields.event.choose.pending.description",t.language),icon:"hass:home-import-outline"}}},dn=(e,t,a)=>0==e?{name:a.master.name,value:0}:Object.keys(t).includes(String(e))?{name:t[e].name,value:e}:{name:String(e),value:e},ln=(e,...t)=>{const a=t.map(t=>{if(!t)return null;const a=Se(t),i=Ce(t);let s={value:t,name:i.replace(/_/g," ").split(" ").map(e=>e.substring(0,1).toUpperCase()+e.substring(1)).join(" "),icon:"hass:home",description:t};switch(a){case"notify":const t=e.states["device_tracker."+i.replace("mobile_app_","")];s=t?Object.assign(Object.assign({},s),{name:t.attributes.friendly_name||Ce(t.entity_id),icon:t.attributes.icon||"hass:cellphone-text"}):Object.assign(Object.assign({},s),{icon:"hass:comment-alert"});break;case"tts":s=Object.assign(Object.assign({},s),{icon:"hass:microphone"})}return s}).filter(Wi);return a.sort((e,t)=>{const a=Se(e.value),i=Se(t.value);return a!=i?is(a,i):is(e,t)}),a},cn=(e,t)=>{let a=[];const i=Object.keys(e).filter(t=>Object.values(e[t].modes).some(e=>e.enabled));return t.master.enabled&&i.length>1&&(a=[...a,0]),a=[...a,...i],a},hn=(e,t)=>{const a=e=>Object.keys(e.modes).filter(t=>e.modes[t].enabled);if(Wi(e)&&Object.keys(t).includes(String(e)))return a(t[e]);{const e=Object.keys(t).map(e=>a(t[e]));return e[0].filter(t=>e.every(e=>e.includes(t)))}},mn=(e,t)=>e.map(e=>({value:e,name:e in t.states?t.states[e].attributes.friendly_name||Ce(e):e,icon:e in t.states?t.states[e].attributes.icon||Le(Se(e)):void 0,description:e})),un=e=>{let t=[];return"notify"in e.services&&(t=[...t,...Object.keys(e.services.notify).map(e=>"notify."+e)]),"tts"in e.services&&(t=[...t,...Object.keys(e.services.tts).filter(e=>"clear_cache"!=e).map(e=>"tts."+e)]),t},pn=(...e)=>{if(!e.length||!e.every(e=>e.length))return[];if(1==e.length&&e[0].length>1&&Bi(e[0].map(Se)).length>1)return pn(...e[0].map(e=>Array(e)));let t=[...e[0]];return e.forEach(e=>{t=t.map(t=>e.includes(t)?t:"script"==Se(t)&&e.map(Se).includes("script")?"script.script":e.map(Ce).includes(Ce(t))?"homeassistant."+Ce(t):null).filter(Wi)}),t},gn=(e,t,a=1)=>{if(a>10)return[];if(Array.isArray(e)){const i=e.map(e=>gn(e,t,a+1));return pn(...i)}if(!Wi(e))return[];const i=Se(e);switch(i){case"light":case"switch":case"input_boolean":case"siren":return[i+".turn_on",i+".turn_off"];case"script":return[e];case"lock":return["lock.lock","lock.unlock"];case"group":const s=e in t.states?t.states[e]:void 0,n=(null==s?void 0:s.attributes.entity_id)||[];return gn(n,t,a+1);default:return[]}},vn=(e,t)=>{let a=[...Object.keys(e.states).filter(t=>gn(t,e).length)];return t&&t.length&&(a=[...a,...t.filter(e=>!a.includes(e))]),a.sort(is),a},_n=e=>{let t=[...Object.keys(e.states).filter(e=>"media_player"==Se(e))];return t.sort(is),t},fn=e=>{let t=[{value:"{{arm_mode}}",name:e.translationMetadata.translations.en.nativeName}];return"en"!=e.language&&(t=[...t,{value:`{{arm_mode|lang=${e.language}}}`,name:e.translationMetadata.translations[e.language].nativeName}]),t},bn=e=>"string"==typeof e&&e.trim().length,yn=(e,t)=>bn(e)&&t.services[Se(e)]&&t.services[Se(e)][Ce(e)],wn=(e,t)=>bn(e)&&t.states[e],kn=e=>"object"==typeof e&&null!==e&&!Array.isArray(e),An=e=>"string"==typeof e;let $n=class extends ne{constructor(){super(...arguments),this.items=[],this.value=[],this.label="",this.invalid=!1}shouldUpdate(e){return e.get("items")&&(Xi(this.items,e.get("items"))||this.firstUpdated()),!0}firstUpdated(){this.value.some(e=>!this.items.map(e=>e.value).includes(e))&&(this.value=this.value.filter(e=>this.items.map(e=>e.value).includes(e)),Ne(this,"value-changed",{value:this.value}))}render(){return q`
      <div class="chip-set">
        ${this.value.length?this.value.map(e=>this.items.find(t=>t.value==e)).filter(Wi).map(e=>q`
          <div class="chip">
    ...
    `}};var jn;t([de()],$n.prototype,"hass",void 0),t([de()],$n.prototype,"items",void 0),t([de({type:Array})],$n.prototype,"value",void 0),t([de()],$n.prototype,"label",void 0),t([de({type:Boolean})],$n.prototype,"invalid",void 0),$n=t([re("alarmo-selector")],$n),function(e){e[e.Yaml=0]="Yaml",e[e.UI=1]="UI"}(jn||(jn={}));let xn=class extends ne{constructor(){super(...arguments),this.config={type:Ii.Notification,triggers:[{}],actions:[{}]},this.viewMode=jn.UI,this.errors={}}async firstUpdated(){if(await Ie(),this.areas=await Xe(this.hass),this.alarmoConfig=await Ve(this.hass),this.item){let e=this.item.actions.map(e=>Qi(e,"entity_id"));this.config=Object.assign(Object.assign({},this.item),{actions:[e[0],...e.slice(1)]}),this.config.triggers.length>1&&(this.config=Object.assign(Object.assign({},this.config),{triggers:[this.config.triggers[0]]}));let t=this.config.triggers[0].area;Wi(t)&&!cn(this.areas,this.alarmoConfig).includes(t)?t=void 0:null===t&&(t=0),this._setArea(new CustomEvent("value-changed",{detail:{value:t}}))}if(!Wi(this.config.triggers[0].area)){const e=cn(this.areas,this.alarmoConfig);1==e.length?this._setArea(new CustomEvent("value-changed",{detail:{value:e[0]}})):e.includes(0)&&this._setArea(new CustomEvent("value-changed",{detail:{value:0}}))}}render(){var e,t,a,i;return this.hass&&this.areas&&this.alarmoConfig?q`
      <div class="heading">
        <ha-icon-button .path=${cs} @click=${this._cancelClick} class="icon"></ha-icon-button>
        <div class="header">${Di("panels.actions.cards.new_notification.title",this.hass.language)}</div>
        <div class="description">
          ${Di("panels.actions.cards.new_notification.description",this.hass.language)}
        </div>
      </div>
      <div class="section-header">${Di("panels.actions.cards.new_notification.trigger",this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${Di("panels.actions.cards.new_notification.fields.event.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.actions.cards.new_notification.fields.event.description",this.hass.language)}
            </span>

            <alarmo-select
              .hass=${this.hass}
              .items=${Object.values(Gi).map(e=>on(e,this.hass))}
              label=${Di("panels.actions.cards.new_action.fields.event.heading",this.hass.language)}
              icons=${!0}
          ...
          ${Object.keys(this.areas).length>1?q`
                <settings-row .narrow=${this.narrow} .large=${!0}>
                  <span slot="heading">
                    ${Di("panels.actions.cards.new_action.fields.area.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${Di("panels.actions.cards.new_action.fields.area.description",this.hass.language)}
                  </span>

                  <alarmo-select
                    .hass=${this.hass}
                    .items=${cn(this.areas,this.alarmoConfig).map(e=>dn(e,this.areas,this.alarmoConfig))}
                    clearable=${!0}
                    label=${Di("panels.actions.cards.new_action.fields.area.heading",this.hass.language)}
          ...
          <settings-row .narrow=${this.narrow} .large=${!0} last>
            <span slot="heading">
              ${Di("panels.actions.cards.new_notification.fields.mode.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.actions.cards.new_notification.fields.mode.description",this.hass.language)}
            </span>

            <alarmo-selector
              .hass=${this.hass}
              .items=${hn(this.config.triggers[0].area,this.areas).map(e=>rn(e,this.hass))}
              label=${Di("panels.actions.cards.new_action.fields.mode.heading",this.hass.language)}
      ...
      <div class="section-header">${Di("panels.actions.cards.new_notification.action",this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          ${this.viewMode==jn.UI?q`
                <settings-row .narrow=${this.narrow} .large=${!0} first>
                  <span slot="heading">
                    ${Di("panels.actions.cards.new_notification.fields.target.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${Di("panels.actions.cards.new_notification.fields.target.description",this.hass.language)}
                  </span>

                  <alarmo-select
                    .hass=${this.hass}
                    .items=${ln(this.hass,...un(this.hass))}
                    ?disabled=${!un(this.hass).length}
                    label=${Di("panels.actions.cards.new_notification.fields.target.heading",this.hass.language)}
                    icons=${!0}
                ...
                ${this.config.actions[0].service&&"notify"!=Se(this.config.actions[0].service)?"":q`
                      <settings-row .narrow=${this.narrow}>
                        <span slot="heading">
                          ${Di("panels.actions.cards.new_notification.fields.title.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${Di("panels.actions.cards.new_notification.fields.title.description",this.hass.language)}
                        </span>

                        <ha-textfield
                          label="${Di("panels.actions.cards.new_notification.fields.title.heading",this.hass.language)}"
                ...
                ${this.config.actions[0].service&&"tts"==Se(this.config.actions[0].service)?q`
                      <settings-row .narrow=${this.narrow} .large=${!0} first>
                        <span slot="heading">
                          ${Di("panels.actions.cards.new_action.fields.entity.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${Di("panels.actions.cards.new_action.fields.entity.description",this.hass.language)}
                        </span>

                        <alarmo-select
                          .items=${mn(_n(this.hass),this.hass)}
                          label=${Di("panels.actions.cards.new_action.fields.entity.heading",this.hass.language)}
                ...
                <settings-row .narrow=${this.narrow} .large=${!0} last>
                  <span slot="heading">
                    ${Di("panels.actions.cards.new_notification.fields.message.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${Di("panels.actions.cards.new_notification.fields.message.description",this.hass.language)}
                  </span>

                  <ha-textarea
                    id="message"
                    label="${Di("panels.actions.cards.new_notification.fields.message.heading",this.hass.language)}"
                  ...
                  ${this.config.triggers[0].event?q`
                        <div style="margin-top: 10px">
                          <span style="padding-right: 10px">
                            ${Di("panels.actions.cards.new_notification.fields.message.insert_wildcard",this.hass.language)}:
                          </span>
                          <alarmo-chip-set
                            .items=${((e,t)=>{let a=[];return a=[],e&&![Gi.Pending,Gi.Triggered,Gi.ArmFailure].includes(e)||(a=[...a,{name:"Open Sensors",value:"{{open_sensors}}"}]),e&&![Gi.Armed].includes(e)||(a=[...a,{name:"Bypassed Sensors",value:"{{bypassed_sensors}}"}]),(!e||(null==t?void 0:t.code_arm_required)&&[Gi.Armed,Gi.Arming,Gi.ArmFailure].includes(e)||(null==t?void 0:t.code_disarm_required)&&[Gi.Disarmed,Gi.Untriggered].includes(e))&&(a=[...a,{name:"Changed By",value:"{{changed_by}}"}]),e&&![Gi.Armed,Gi.Arming,Gi.Pending,Gi.Triggered,Gi.ArmFailure].includes(e)||(a=[...a,{name:"Arm Mode",value:"{{arm_mode}}"}]),a})(this.config.triggers[0].event,this.alarmoConfig)}
                ...
                ${null!==this._getOpenSensorsFormat()?q`
                      <settings-row .narrow=${this.narrow} .large=${!0}>
                        <span slot="heading">
                          ${Di("panels.actions.cards.new_notification.fields.open_sensors_format.heading",this.hass.language)}
                        </span>

                        <span slot="description">
                          ${Di("panels.actions.cards.new_notification.fields.open_sensors_format.description",this.hass.language)}
                        </span>

                        <alarmo-select
                          .items=${(e=>{let t=[];return t="en"!=e.language?[...t,{value:"{{open_sensors}}",name:`${Di("panels.actions.cards.new_notification.fields.open_sensors_format.options.default",e.language)} (${e.translationMetadata.translations.en.nativeName})`},{value:`{{open_sensors|lang=${e.language}}}`,name:`${Di("panels.actions.cards.new_notification.fields.open_sensors_format.options.default",e.language)} (${e.translationMetadata.translations[e.language].nativeName})`}]:[...t,{value:"{{open_sensors}}",name:Di("panels.actions.cards.new_notification.fields.open_sensors_format.options.default",e.language)}],t=[...t,{value:"{{open_sensors|format=short}}",name:Di("panels.actions.cards.new_notification.fields.open_sensors_format.options.short",e.language)}],t})(this.hass)}
                          .value=${this._getOpenSensorsFormat(!0)}
                          @value-changed=${this._setOpenSensorsFormat}
                        ></alarmo-select>
                      </settings-row>
                    `:""}
                ${null!==this._getArmModeFormat()&&(fn(this.hass).length>1||1==fn(this.hass).length&&fn(this.hass)[0].value!=this._getArmModeFormat())?q`
                      <settings-row .narrow=${this.narrow} .large=${!0}>
                        <span slot="heading">
                          ${Di("panels.actions.cards.new_notification.fields.arm_mode_format.heading",this.hass.language)}
                        </span>

                        <span slot="description">
                          ${Di("panels.actions.cards.new_notification.fields.arm_mode_format.description",this.hass.language)}
                        </span>
                    ...
                    `:""}
              `:q`
                <h2>${Di("components.editor.edit_in_yaml",this.hass.language)}</h2>
        ...
        <div class="toggle-button">
          <mwc-button @click=${this._toggleYamlMode}>
            ...
            ${this.viewMode==jn.Yaml?Di("components.editor.ui_mode",this.hass.language):Di("components.editor.yaml_mode",this.hass.language)}
          </mwc-button>
        </div>

        <div class="card-actions">
          <mwc-button trailingIcon ?disabled=${!this._validAction()} @click=${this._testClick}>
            ${Di("panels.actions.cards.new_notification.actions.test",this.hass.language)}
            <ha-icon icon="hass:arrow-right"></ha-icon>
          </mwc-button>
        </div>
      </ha-card>

      <div class="section-header">${Di("panels.actions.cards.new_notification.options",this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${Di("panels.actions.cards.new_notification.fields.name.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.actions.cards.new_notification.fields.name.description",this.hass.language)}
            </span>

            <ha-textfield
              label="${Di("panels.actions.cards.new_notification.fields.name.heading",this.hass.language)}"
          ...
          ${(null===(i=this.item)||void 0===i?void 0:i.automation_id)?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${Di("panels.actions.cards.new_notification.fields.delete.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${Di("panels.actions.cards.new_notification.fields.delete.description",this.hass.language)}
                  </span>
                  <div>
    ...
    `}};var On;t([de({attribute:!1})],xn.prototype,"hass",void 0),t([de()],xn.prototype,"narrow",void 0),t([de()],xn.prototype,"config",void 0),t([de()],xn.prototype,"item",void 0),t([de()],xn.prototype,"areas",void 0),t([de()],xn.prototype,"alarmoConfig",void 0),t([de()],xn.prototype,"viewMode",void 0),t([de()],xn.prototype,"errors",void 0),xn=t([re("notification-editor-card")],xn),function(e){e[e.Yaml=0]="Yaml",e[e.UI=1]="UI"}(On||(On={}));let Tn=class extends ne{constructor(){super(...arguments),this.config={type:Ii.Action,triggers:[{}],actions:[{}]},this.viewMode=On.UI,this.errors={}}async firstUpdated(){if(await Ie(),this.areas=await Xe(this.hass),this.alarmoConfig=await Ve(this.hass),this.item){let e=this.item.actions.map(e=>e.entity_id?e:Qi(e,"entity_id"));this.config=Object.assign(Object.assign({},this.item),{actions:[e[0],...e.slice(1)]}),this.config.triggers.length>1&&(this.config=Object.assign(Object.assign({},this.config),{triggers:[this.config.triggers[0]]}));let t=this.config.triggers[0].area;Wi(t)&&!cn(this.areas,this.alarmoConfig).includes(t)?t=void 0:null===t&&(t=0),this._setArea(new CustomEvent("value-changed",{detail:{value:t}})),this._hasCustomEntities()&&(this.viewMode=On.Yaml)}if(!Wi(this.config.triggers[0].area)){const e=cn(this.areas,this.alarmoConfig);1==e.length?this._setArea(new CustomEvent("value-changed",{detail:{value:e[0]}})):e.includes(0)&&this._setArea(new CustomEvent("value-changed",{detail:{value:0}}))}!this.item||this.config.triggers[0].area||this.alarmoConfig.master.enabled||(this.errors=Object.assign(Object.assign({},this.errors),{area:!0}))}render(){var e;return this.hass&&this.areas&&this.alarmoConfig?q`
      <div class="heading">
        <ha-icon-button .path=${cs} @click=${this._cancelClick} class="icon"></ha-icon-button>
        <div class="header">${Di("panels.actions.cards.new_action.title",this.hass.language)}</div>
        <div class="description">${Di("panels.actions.cards.new_action.description",this.hass.language)}</div>
      </div>
      <div class="section-header">${Di("panels.actions.cards.new_notification.trigger",this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${Di("panels.actions.cards.new_action.fields.event.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.actions.cards.new_action.fields.event.description",this.hass.language)}
            </span>
      ...
      <ha-card>
        <div class="card-content">
          ${this.viewMode==On.UI?q`
                <settings-row .narrow=${this.narrow} .large=${!0} first>
                  ...
                  <alarmo-selector
                    .hass=${this.hass}
                    .items=${mn(vn(this.hass,this._getEntities()),this.hass)}
                    ?disabled=${!vn(this.hass,this._getEntities()).length}
                    label=${Di("panels.actions.cards.new_action.fields.entity.heading",this.hass.language)}
                ...
                ${this._getEntities().length?q`
                      <settings-row .narrow=${this.narrow} .large=${!0}>
                        <span slot="heading">
                          ${Di("panels.actions.cards.new_action.fields.action.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${Di("panels.actions.cards.new_action.fields.action.description",this.hass.language)}
                        </span>

                        <div>
                          ${this.renderActions()||Di("panels.actions.cards.new_action.fields.action.no_common_actions",this.hass.language)}
                        </div>
        ...
        <div class="toggle-button">
          <mwc-button @click=${this._toggleYamlMode}>
            <ha-icon icon="hass:shuffle-variant"></ha-icon>
            ${this.viewMode==On.Yaml?Di("components.editor.ui_mode",this.hass.language):Di("components.editor.yaml_mode",this.hass.language)}
          </mwc-button>
        </div>
      ...
      <ha-card>
        <div class="card-content">
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${Di("panels.actions.cards.new_action.fields.name.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${Di("panels.actions.cards.new_action.fields.name.description",this.hass.language)}
            </span>

            <ha-textfield
              label="${Di("panels.actions.cards.new_action.fields.name.heading",this.hass.language)}"
              .placeholder=${this._namePlaceholder()}
              .value=${this.config.name||""}
              @input=${this._setName}
              ?invalid=${this.errors.name}
    ...
    `:q``}renderActions(){let e=this.config.actions.map(e=>e.entity_id),t=gn(e,this.hass);if(!t.length)return;return t.map(e=>q`
        <mwc-button
          class="${((...e)=>!!e.every(Wi)&&1==Bi(pn(e.filter(Wi))).length)(this._selectedAction(),e)?"active":""}"
      ...
      `)}_selectedAction(){let e=this.config.actions.map(e=>e.service);return e.every(Wi)?(e=Bi(pn(e.filter(Wi))),1==e.length?e[0]:null):null}_setEvent(e){e.stopPropagation();const t=e.detail.value;let a=this.config.triggers;Object.assign(a,{0:Object.assign(Object.assign({},a[0]),{event:t})}),this.config=Object.assign(Object.assign({},this.config),{triggers:a}),Object.keys(this.errors).includes("event")&&this._validateConfig()}_setArea(e){var t;e.stopPropagation();const a=e.detail.value;let i=this.config.triggers;Object.assign(i,{0:Object.assign(Object.assign({},i[0]),{area:a})});const s=hn(a,this.areas);(null===(t=i[0].modes)||void 0===t?void 0:t.length)&&this._setModes(new CustomEvent("value-changed",{detail:{value:i[0].modes.filter(e=>s.includes(e))}})),this.config=Object.assign(Object.assign({},this.config),{triggers:i}),Object.keys(this.errors).includes("area")&&this._validateConfig()}_setModes(e){e.stopPropagation();const t=e.detail.value,a=this.config.triggers;Object.assign(a,{0:Object.assign(Object.assign({},a[0]),{modes:t})}),this.config=Object.assign(Object.assign({},this.config),{triggers:a}),Object.keys(this.errors).includes("service")&&this._validateConfig()}_setEntity(e){e.stopPropagation();const t=e.detail.value;let a=this.config.actions,i=null;if(t.length>a.length&&this._selectedAction()&&(i=this._selectedAction()),a.length>t.length){let e=a.findIndex(e=>!t.includes(e.entity_id||""));e<0&&(e=a.length-1),a.splice(e,1)}t.length||Object.assign(a,{0:Qi(a[0],"entity_id")}),t.forEach((e,t)=>{let i=a.length>t?Object.assign({},a[t]):{};i=i.entity_id==e?Object.assign({},i):{entity_id:e},Object.assign(a,{[t]:i})}),this.config=Object.assign(Object.assign({},this.config),{actions:a}),i&&this._setAction(i),Object.keys(this.errors).includes("entity_id")&&this._validateConfig()}_setAction(e){let t=this.config.actions,a=this.config.actions.map(e=>e.entity_id);gn(a,this.hass).length&&(t.forEach((a,i)=>{let s=gn(a.entity_id,this.hass),n=(r=e,s.find(e=>e==r||"turn_on"==Ce(r)&&"turn_on"==Ce(e)||"turn_off"==Ce(r)&&"turn_off"==Ce(e)||"script"==Se(r)&&"script"==Se(e)));var r;Object.assign(t,{[i]:Object.assign({service:n},Qi(a,"service"))})}),this.config=Object.assign(Object.assign({},this.config),{actions:t}),Object.keys(this.errors).includes("service")&&this._validateConfig())}_setName(e){e.stopPropagation();const t=e.target.value;this.config=Object.assign(Object.assign({},this.config),{name:t})}_setYaml(e){let t=e.detail.value,a=[{}];var i;kn(t)&&(t=[t]),"object"==typeof(i=t)&&null!==i&&Array.isArray(i)&&(t.forEach((e,t)=>{let i={};kn(e)&&An(e.service)&&(i=Object.assign(Object.assign({},i),{service:e.service})),kn(e)&&An(e.entity_id)&&(i=Object.assign(Object.assign({},i),{entity_id:e.entity_id})),kn(e)&&kn(e.data)&&(i=Object.assign(Object.assign({},i),{data:e.data})),Object.assign(a,{[t]:i})}),this.config=Object.assign(Object.assign({},this.config),{actions:a}))}_validateConfig(){this.errors={};const e=this._parseAutomation(),t=e.triggers[0];t.event&&Object.values(Gi).includes(t.event)||(this.errors=Object.assign(Object.assign({},this.errors),{event:!0})),Wi(t.area)&&cn(this.areas,this.alarmoConfig).includes(t.area)||(this.errors=Object.assign(Object.assign({},this.errors),{area:!0})),(t.modes||[]).every(e=>hn(t.area,this.areas).includes(e))||(this.errors=Object.assign(Object.assign({},this.errors),{modes:!0}));let a=e.actions.map(e=>e.entity_id);this.viewMode==On.Yaml&&(a=a.filter(Wi)),e.actions.length&&a.every(e=>wn(e,this.hass))||(this.errors=Object.assign(Object.assign({},this.errors),{entity_id:!0}));const i=e.actions.map(e=>e.service).filter(Wi);if(!i.length||!i.every(e=>yn(e,this.hass))){this.errors=Object.assign(Object.assign({},this.errors),{service:!0}),!gn(a,this.hass).length&&i.length&&(this.viewMode=On.Yaml)}return bn(e.name)||(this.errors=Object.assign(Object.assign({},this.errors),{name:!0})),!Object.values(this.errors).length}_validAction(){const e=this._parseAutomation(),t=e.actions.map(e=>e.service);let a=e.actions.map(e=>e.entity_id);return this.viewMode==On.Yaml&&(a=a.filter(Wi)),t.length&&t.every(e=>yn(e,this.hass))&&a.every(e=>wn(e,this.hass))}_toggleYamlMode(){this.viewMode=this.viewMode==On.UI?On.Yaml:On.UI,this.viewMode==On.Yaml&&(this.config=Object.assign(Object.assign({},this.config),{actions:Object.assign(this.config.actions,{0:Object.assign(Object.assign({},this.config.actions[0]),{service:this.config.actions[0].service||"",data:Object.assign({},this.config.actions[0].data||{})})})}))}_namePlaceholder(){var e,t,a,i;if(!this._validAction)return"";const s=this.config.triggers[0].event,n=this.config.actions.map(e=>e.entity_id).filter(Wi),r=mn(n,this.hass).map(e=>e.name).join(", "),o=Bi(this.config.actions.map(e=>e.service).filter(Wi).map(e=>Ce(e)));let d=void 0;return 1==o.length&&(null===(e=o[0])||void 0===e?void 0:e.includes("turn_on"))&&(d=this.hass.localize("state.default.on")),1==o.length&&(null===(t=o[0])||void 0===t?void 0:t.includes("turn_off"))&&(d=this.hass.localize("state.default.off")),1==o.length&&(null===(a=o[0])||void 0===a?void 0:a.includes("lock"))&&(d=this.hass.localize("component.lock.state._.locked")),1==o.length&&(null===(i=o[0])||void 0===i?void 0:i.includes("unlock"))&&(d=this.hass.localize("component.lock.state._.unlocked")),s&&r&&d?Di("panels.actions.cards.new_action.fields.name.placeholders."+s,this.hass.language,"entity",r,"state",d):""}_getEntities(){return Bi(this.config.actions.map(e=>e.entity_id).filter(Wi))||[]}_hasCustomEntities(){return this._getEntities().some(e=>!vn(this.hass).includes(e))}_parseAutomation(){let e=Object.assign({},this.config);return!bn(e.name)&&this._namePlaceholder()&&(e=Object.assign(Object.assign({},e),{name:this._namePlaceholder()})),e}_saveClick(e){if(!this._validateConfig())return;let t=this._parseAutomation();hn(t.triggers[0].area,this.areas).every(e=>{var a;return null===(a=t.triggers[0].modes)||void 0===a?void 0:a.includes(e)})&&(t=Object.assign(Object.assign({},t),{triggers:Object.assign(t.triggers,{0:Object.assign(Object.assign({},t.triggers[0]),{modes:[]})})})),Qe(this.hass,t).catch(t=>es(t,e)).then(()=>this._cancelClick())}_deleteClick(e){var t;(null===(t=this.item)||void 0===t?void 0:t.automation_id)&&We(this.hass,this.item.automation_id).catch(t=>es(t,e)).then(()=>this._cancelClick())}_testClick(e){this._parseAutomation().actions.forEach(t=>{const[a,i]=t.service.split(".");let s=Object.assign({},t.data);t.entity_id&&(s=Object.assign(Object.assign({},s),{entity_id:t.entity_id})),this.hass.callService(a,i,s).then().catch(t=>{Ji(e,t.message)})})}_cancelClick(){Pe(0,os("actions"),!0)}static get styles(){return o`
      div.content {
        padding: 28px 20px 0;
        max-width: 1040px;
        margin: 0 auto;
    ...
    `}};t([de({attribute:!1})],Tn.prototype,"hass",void 0),t([de()],Tn.prototype,"narrow",void 0),t([de()],Tn.prototype,"config",void 0),t([de()],Tn.prototype,"item",void 0),t([de()],Tn.prototype,"areas",void 0),t([de()],Tn.prototype,"alarmoConfig",void 0),t([de()],Tn.prototype,"viewMode",void 0),t([de()],Tn.prototype,"errors",void 0),Tn=t([re("automation-editor-card")],Tn);let En=class extends(et(ne)){constructor(){super(...arguments),this.areas={},this.getAreaForAutomation=e=>{if(!this.config)return;const t=cn(this.areas,this.config);let a=e.triggers[0].area;return Wi(a)&&t.includes(a)?a:void 0}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await He(this.hass);this.automations=Object.values(e),this.areas=await Xe(this.hass),this.config=await Ve(this.hass)}firstUpdated(){var e;this.path.filter&&(this.selectedArea=null===(e=this.path.filter)||void 0===e?void 0:e.area),(async()=>{await Ue()})()}render(){if(!this.hass||!this.automations||!this.config)return q``;if("new_notification"==this.path.subpage)return q`
        <notification-editor-card .hass=${this.hass} .narrow=${this.narrow}></notification-editor-card>
      `;if(this.path.params.edit_notification){const e=this.automations.find(e=>e.automation_id==this.path.params.edit_notification&&e.type==Ii.Notification);return q`
      ...
      `;if(this.path.params.edit_action){const e=this.automations.find(e=>e.automation_id==this.path.params.edit_action&&e.type==Ii.Action);return q`
        <automation-editor-card .hass=${this.hass} .narrow=${this.narrow} .item=${e}></automation-editor-card>
      `}{const e=()=>q`
        <paper-tooltip animation-delay="0">
          ${Di("panels.actions.cards.notifications.table.no_area_warning",this.hass.language)}
        </paper-tooltip>
      `,t={type:{width:"40px",renderer:t=>"no_area"!=t.area||this.config.master.enabled?t.type==Ii.Notification?q`
            ...
            <span class="${t.enabled?"":"disabled"}">${t.name}</span>
          `,width:"40%",grow:!0,text:!0},enabled:{title:Di("common.enabled",this.hass.language),width:"68px",align:"center",renderer:e=>q`
            <ha-switch
              ?checked=${e.enabled}
              @click=${t=>{t.stopPropagation(),this.toggleEnable(t,e.automation_id)}}
            ></ha-switch>
          `}},a=this.automations.filter(e=>e.type==Ii.Notification).map(e=>Object(Object.assign(Object.assign({},e),{id:e.automation_id,warning:!this.config.master.enabled&&!this.getAreaForAutomation(e),area:this.getAreaForAutomation(e)||"no_area"}))),i=this.automations.filter(e=>e.type==Ii.Action).map(e=>Object(Object.assign(Object.assign({},e),{id:e.automation_id,warning:!this.config.master.enabled&&!this.getAreaForAutomation(e),area:this.getAreaForAutomation(e)||"no_area"})));return q`
        <ha-card header="${Di("panels.actions.cards.notifications.title",this.hass.language)}">
          <div class="card-content">
            ${Di("panels.actions.cards.notifications.description",this.hass.language)}
          </div>
          ...
          <alarmo-table
            ...
            .data=${a}
            .filters=${this.getTableFilterOptions()}
            @row-click=${e=>Pe(0,os("actions",{params:{edit_notification:e.detail.id}}),!0)}
          >
            ${Di("panels.actions.cards.notifications.table.no_items",this.hass.language)}
          </alarmo-table>

          <div class="card-actions">
            <mwc-button @click=${this.addNotificationClick}>
              ${Di("panels.actions.cards.notifications.actions.new_notification",this.hass.language)}
            </mwc-button>
          </div>
        </ha-card>

        <ha-card header="${Di("panels.actions.title",this.hass.language)}">
          <div class="card-content">${Di("panels.actions.cards.actions.description",this.hass.language)}</div>
          ...
          <alarmo-table
            ...
            .data=${i}
            .filters=${this.getTableFilterOptions()}
            @row-click=${e=>Pe(0,os("actions",{params:{edit_action:e.detail.id}}),!0)}
          >
            ${Di("panels.actions.cards.actions.table.no_items",this.hass.language)}
          </alarmo-table>

          <div class="card-actions">
            <mwc-button @click=${this.addActionClick}>
              ${Di("panels.actions.cards.actions.actions.new_action",this.hass.language)}
            </mwc-button>
          </div>
        </ha-card>
      `}}toggleEnable(e,t){Qe(this.hass,{automation_id:t,enabled:!e.target.checked}).catch(t=>es(t,e)).then()}getTableFilterOptions(){if(!this.hass)return;let e=Object.values(this.areas).map(e=>Object({value:e.area_id,name:e.name,badge:t=>t.filter(t=>t.area==e.area_id).length})).sort(is);Object.values(this.automations||[]).filter(e=>!this.getAreaForAutomation(e)).length&&(e=[{value:"no_area",name:this.config.master.enabled?this.config.master.name:this.hass.localize("state_attributes.climate.preset_mode.none"),badge:e=>e.filter(e=>"no_area"==e.area).length},...e]);return{area:{name:Di("components.table.filter.item",this.hass.language,"name",Di("panels.actions.cards.new_action.fields.area.heading",this.hass.language)),items:e,value:this.selectedArea?[this.selectedArea]:[]}}}addNotificationClick(){Pe(0,os("actions","new_notification"),!0)}addActionClick(){Pe(0,os("actions","new_action"),!0)}};En.styles=ss,t([de()],En.prototype,"hass",void 0),t([de()],En.prototype,"narrow",void 0),t([de()],En.prototype,"path",void 0),t([de()],En.prototype,"alarmEntity",void 0),t([de()],En.prototype,"automations",void 0),t([de()],En.prototype,"areas",void 0),t([de()],En.prototype,"config",void 0),t([de()],En.prototype,"selectedArea",void 0),En=t([re("alarm-view-actions")],En),e.MyAlarmPanel=class extends ne{async firstUpdated(){window.addEventListener("location-changed",()=>{this.requestUpdate()}),await Ue(),this.userConfig=await Fe(this.hass),this.requestUpdate()}render(){if(!customElements.get("ha-panel-config")||!this.userConfig)return q`
        loading...
      `;const e=rs();return q`
      <div class="header">
        <div class="toolbar">
        ...
        >
          <paper-tab page-name="general">
            ${Di("panels.general.title",this.hass.language)}
          </paper-tab>
          <paper-tab page-name="sensors">
            ${Di("panels.sensors.title",this.hass.language)}
          </paper-tab>
          <paper-tab page-name="codes">
            ${Di("panels.codes.title",this.hass.language)}
          </paper-tab>
          <paper-tab page-name="actions">
            ${Di("panels.actions.title",this.hass.language)}
          </paper-tab>
        </ha-tabs>
      </div>
      <div class="view">
    ...
    `}getView(e){switch(e.page){case"general":return q`
        ...
        `}}handlePageSelected(e){const t=e.detail.item.getAttribute("page-name");t!==rs()?(Pe(0,os(t)),this.requestUpdate()):scrollTo(0,0)}static get styles(){return o`
      ${ss} :host {
        color: var(--primary-text-color);
