    ...
    `}};var cr;n([Qe()],lr.prototype,"hass",void 0),n([Qe()],lr.prototype,"items",void 0),n([Qe({type:Array})],lr.prototype,"value",void 0),n([Qe()],lr.prototype,"label",void 0),n([Qe({type:Boolean})],lr.prototype,"invalid",void 0),lr=n([Ke("alarmo-selector")],lr),function(e){e[e.Yaml=0]="Yaml",e[e.UI=1]="UI"}(cr||(cr={}));let hr=class extends Ge{constructor(){super(...arguments),this.config={type:bn.Notification,triggers:[{}],actions:[{}]},this.viewMode=cr.UI,this.errors={}}async firstUpdated(){if(await et(),this.areas=await ht(this.hass),this.alarmoConfig=await tt(this.hass),this.item){let e=this.item.actions.map(e=>xn(e,"entity_id"));this.config=Object.assign(Object.assign({},this.item),{actions:[e[0],...e.slice(1)]}),this.config.triggers.length>1&&(this.config=Object.assign(Object.assign({},this.config),{triggers:[this.config.triggers[0]]}));let t=this.config.triggers[0].area;Sn(t)&&!Qs(this.areas,this.alarmoConfig).includes(t)?t=void 0:null===t&&(t=0),this._setArea(new CustomEvent("value-changed",{detail:{value:t}}))}if(!Sn(this.config.triggers[0].area)){const e=Qs(this.areas,this.alarmoConfig);1==e.length?this._setArea(new CustomEvent("value-changed",{detail:{value:e[0]}})):e.includes(0)&&this._setArea(new CustomEvent("value-changed",{detail:{value:0}}))}}render(){var e,t,a,i,n;return this.hass&&this.areas&&this.alarmoConfig?Te`
                ...
                ${this.config.actions[0].service&&"tts.speak"==this.config.actions[0].service?Te`
                      <alarmo-settings-row .narrow=${this.narrow} .large=${!0}>
                        ...
                        <alarmo-select
                          ...
                          .value=${(null===(a=this.config.actions[0].data)||void 0===a?void 0:a.media_player_entity_id)||""}
      ...
      <ha-card>
        <div class="card-content">
          ...
          ${(null===(n=this.item)||void 0===n?void 0:n.automation_id)?Te`
                <alarmo-settings-row .narrow=${this.narrow}>
                  <span slot="heading">
