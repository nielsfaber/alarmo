...
class Ji extends class{constructor(e){}T(e,t,a){this.Σdt=e,this.M=t,this.Σct=a}S(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}{constructor(e){if(super(e),this.vt=I,e.type!==Zi)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===I)return this.Vt=void 0,this.vt=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.vt)return this.Vt;this.vt=e;const t=[e];return t.raw=t,this.Vt={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Ji.directiveName="unsafeHTML",Ji.resultType=1;const es=(e=>(...t)=>({_$litDirective$:e,values:t}))(Ji);let ts=class extends se{render(){return q`
    ...
    `:q``}_toggleFilterMenu(e){const t=e.target;this._menu.anchor=t,this._menu.open?this._menu.close():(this.filterSelection=Object.entries(this.filterConfig).reduce((e,[t,a])=>Object.assign(Object.assign({},e),{[t]:Ti(a,["value"])}),{}),this._menu.show())}renderFilterMenu(){return this.filterConfig&&this.filterSelection?q`
      ...
      ${Object.keys(this.filterConfig).map(e=>{if(this.filterConfig[e].binary)return q`
          ...
          `;let t=this.filterConfig[e].items;t=t.map(t=>{var a;return t.badge&&"function"==typeof t.badge?{...t,badge:t.badge(null===(a=this.data)||void 0===a?void 0:a.filter(t=>this.filterTableData(t,Oi(this.filterSelection,e))))}:t});const a=this.filterSelection[e].value;return q`
  ...
  `,t([oe()],is.prototype,"hass",void 0),t([oe()],is.prototype,"columns",void 0),t([oe()],is.prototype,"data",void 0),t([le()],is.prototype,"filterConfig",void 0),t([le()],is.prototype,"filterSelection",void 0),t([oe({type:Boolean})],is.prototype,"selectable",void 0),t([de("mwc-menu",!0)],is.prototype,"_menu",void 0),is=t([ne("alarmo-table")],is);let ss=class extends se{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
    ...
    `:q``}renderHeader(){return q`
      ...
      <ha-icon-button
        ...
        class="header_button"
      ></ha-icon-button>
    `}renderSensorOptions(){const e=Object.keys(this.sensors).filter(e=>!ji(this.sensors[e].group)||this.sensors[e].group===this.data.group_id).map(e=>{const t=this.hass.states[e],a=Object.entries(fi).find(([,t])=>t==this.sensors[e].type)[0];return{value:e,name:this.sensors[e].name||$i(Ai(t)),icon:_i[a]}});return e.sort(Li),e.length?q`
      <alarmo-chip-set
        .items=${e}
      ...
      <ha-card>
        ...
        <settings-row .narrow=${this.narrow}>
          ...
          <div>
            ...
            ${t&&(null===(e=this.data.name)||void 0===e?void 0:e.length)&&$i(Ai(t))!=this.data.name?q`
    ...
    `}toggleSelect(e,t){const a=e.target.checked;this.addSelection=a&&!this.addSelection.includes(t)?[...this.addSelection,t]:a?this.addSelection:this.addSelection.filter(e=>e!=t)}addSelected(e){if(!this.hass)return;const t=Object.values(this.areas).map(e=>Object.entries(e.modes).filter(([,e])=>e.enabled).map(([e])=>e)).reduce((e,t)=>e.filter(e=>t.includes(e)));this.addSelection.map(e=>function(e,t){if(!e)return null;const a=Se(e.entity_id);let i={entity_id:e.entity_id,name:e.attributes.friendly_name||e.entity_id,modes:[],use_entry_delay:!0,use_exit_delay:!0,arm_on_close:!1,allow_open:!1,always_on:!1,auto_bypass:!1,auto_bypass_modes:[],trigger_unavailable:!1,type:fi.Other,enabled:!0};if("binary_sensor"==a){const a=ms(e);a&&(i=Object.assign(Object.assign(Object.assign({},i),{type:a}),ps(t)[a]))}return i}(this.hass.states[e],t)).map(e=>1==Object.keys(this.areas).length?Object.assign(e,{area:Object.keys(this.areas)[0]}):e).filter(e=>e).forEach(t=>{Ye(this.hass,t).catch(t=>Mi(t,e)).then()}),this.addSelection=[]}getTableFilterOptions(){return{isSupportedType:{name:mi("panels.sensors.cards.add_sensors.actions.filter_supported",this.hass.language),items:[{value:"true",name:"true"}],value:["true"],binary:!0}}}};Es.styles=Pi,t([oe()],Es.prototype,"hass",void 0),t([oe()],Es.prototype,"narrow",void 0),t([oe()],Es.prototype,"addSelection",void 0),t([oe()],Es.prototype,"areas",void 0),t([oe()],Es.prototype,"sensors",void 0),Es=t([ne("add-sensors-card")],Es);let Ts=class extends se{firstUpdated(){(async()=>{await Re()})()}render(){var e,t;if(!this.hass)return q``;if(this.path.params.edit)return q`
        <sensor-editor-card
          .hass=${this.hass}
          .narrow=${this.narrow}
    ...
    `}};t([oe()],Os.prototype,"hass",void 0),t([oe()],Os.prototype,"narrow",void 0),t([oe()],Os.prototype,"item",void 0),t([oe()],Os.prototype,"data",void 0),t([oe()],Os.prototype,"repeatCode",void 0),Os=t([ne("user-editor-card")],Os);let js=class extends(Ze(se)){constructor(){super(...arguments),this.users={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await Ie(this.hass);this.data=Ti(e,["code_arm_required","code_disarm_required","code_format"]);const t=await Ge(this.hass);this.users=t}render(){return this.hass&&this.data?"new_user"==this.path.subpage?q`
