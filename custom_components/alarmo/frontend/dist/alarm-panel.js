...
/*! *****************************************************************************
    ...
    OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
    PERFORMANCE OF THIS SOFTWARE.
    ***************************************************************************** */var Ht,Yt,Bt,Kt=function(){return(Kt=Object.assign||function(e){for(var t,a=1,i=arguments.length;a<i;a++)for(var s in t=arguments[a])Object.prototype.hasOwnProperty.call(t,s)&&(e[s]=t[s]);return e}).apply(this,arguments)};function Qt(e){return e.type===Yt.literal}function Wt(e){return e.type===Yt.argument}function Xt(e){return e.type===Yt.number}function Zt(e){return e.type===Yt.date}function Jt(e){return e.type===Yt.time}function ea(e){return e.type===Yt.select}function ta(e){return e.type===Yt.plural}function aa(e){return e.type===Yt.pound}function ia(e){return e.type===Yt.tag}function sa(e){return!(!e||"object"!=typeof e||e.type!==Bt.number)}function na(e){return!(!e||"object"!=typeof e||e.type!==Bt.dateTime)}!function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"}(Ht||(Ht={})),function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"}(Yt||(Yt={})),function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"}(Bt||(Bt={}));var ra=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/,oa=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function la(e){var t={};return e.replace(oa,(function(e){var a=e.length;switch(e[0]){case"G":t.era=4===a?"long":5===a?"narrow":"short";break;case"y":t.year=2===a?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=4===a?"short":5===a?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][a-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][a-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][a-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][a-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][a-1];break;case"s":t.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""})),t}
/*! *****************************************************************************
    Copyright (c) Microsoft Corporation.
...
`,Ri=()=>{const e=e=>{let t={};for(var a=0;a<e.length;a+=2){const i=e[a],s=a<e.length?e[a+1]:void 0;t=Object.assign(Object.assign({},t),{[i]:s})}return t},t=window.location.pathname.split("/");let a={page:t[2]||"general",params:{}};if(t.length>3){let i=t.slice(3);if(t.includes("filter")){const t=i.findIndex(e=>"filter"==e),s=i.slice(t+1);i=i.slice(0,t),a=Object.assign(Object.assign({},a),{filter:e(s)})}i.length&&(i.length%2&&(a=Object.assign(Object.assign({},a),{subpage:i.shift()})),i.length&&(a=Object.assign(Object.assign({},a),{params:e(i)})))}return a},Ii=(e,...t)=>{let a={page:e,params:{}};t.forEach(e=>{"string"==typeof e?a=Object.assign(Object.assign({},a),{subpage:e}):"params"in e?a=Object.assign(Object.assign({},a),{params:e.params}):"filter"in e&&(a=Object.assign(Object.assign({},a),{filter:e.filter}))});const i=e=>{let t=Object.keys(e);t=t.filter(t=>e[t]),t.sort();let a="";return t.forEach(t=>{let i=e[t];a=a.length?`${a}/${t}/${i}`:`${t}/${i}`}),a};let s="/alarmo/"+a.page;return a.subpage&&(s=`${s}/${a.subpage}`),i(a.params).length&&(s=`${s}/${i(a.params)}`),a.filter&&(s=`${s}/filter/${i(a.filter)}`),s};let Ui=class extends se{constructor(){super(...arguments),this.min=0,this.max=100,this.step=10,this.value=0,this.scaleFactor=1,this.unit="",this.disabled=!1}firstUpdated(){this.value>0&&this.value<60&&(this.unit="sec"),"min"==this.unit&&(this.scaleFactor=1/60),"min"==this.unit&&(this.step=1)}render(){return q`
    ...
    `}getValue(){const e=Number(Math.round(this.value*this.scaleFactor));return!e&&this.zeroValue?this.zeroValue:`${e} ${this.getUnit()}`}getUnit(){switch(this.unit){case"sec":return pi("components.time_slider.seconds",this.hass.language);case"min":return pi("components.time_slider.minutes",this.hass.language);default:return""}}getSlider(){return q`
      <ha-slider
        pin
      ...
      ></ha-slider>
    `}updateValue(e){const t=Number(e.target.value);this.value=Math.round(t/this.scaleFactor)}toggleUnit(){this.unit="min"==this.unit?"sec":"min",this.scaleFactor="min"==this.unit?1/60:1,this.step="min"==this.unit?1:10}};Ui.styles=o`
    :host {
      display: flex;
      flex-direction: column;
      min-width: 250px;
  ...
  `,t([oe({type:Number})],Ui.prototype,"min",void 0),t([oe({type:Number})],Ui.prototype,"max",void 0),t([oe({type:Number})],Ui.prototype,"step",void 0),t([oe({type:Number})],Ui.prototype,"value",void 0),t([oe()],Ui.prototype,"scaleFactor",void 0),t([oe({type:String})],Ui.prototype,"unit",void 0),t([oe({type:Boolean})],Ui.prototype,"disabled",void 0),t([oe({type:String})],Ui.prototype,"zeroValue",void 0),Ui=t([ne("time-slider")],Ui);var Gi="M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z",Fi="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z";let Vi=class extends se{constructor(){super(...arguments),this.label="",this.items=[],this.clearable=!1,this.icons=!1,this.disabled=!1,this.invalid=!1,this.rowRenderer=(e,t,a)=>{const i=Si(a.item.description);!e.firstElementChild&&this.icons?e.innerHTML=`\n        <style>\n          mwc-list-item {\n            font-size: 15px;\n            --mdc-typography-body2-font-size: 14px;\n            --mdc-list-item-meta-size: 8px;\n            --mdc-list-item-graphic-margin: 8px;\n          }\n        </style>\n        <mwc-list-item graphic="avatar" ${i?"twoline":""}>\n          <ha-icon icon="" slot="graphic"></ha-icon>\n          <span class="name"></span>\n          <span slot="secondary"></span>\n        </mwc-list-item>\n        `:e.firstElementChild||(e.innerHTML=`\n        <style>\n          mwc-list-item {\n            font-size: 15px;\n            --mdc-typography-body2-font-size: 14px;\n          }\n        </style>\n        <mwc-list-item ${i?"twoline":""}>\n          <span class="name"></span>\n          <span slot="secondary"></span>\n        </mwc-list-item>\n        `),e.querySelector(".name").textContent=a.item.name,e.querySelector('[slot="secondary"]').textContent=a.item.description||"",this.icons&&(e.querySelector("ha-icon").icon=a.item.icon)}}open(){this.updateComplete.then(()=>{var e,t;null===(t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("vaadin-combo-box-light"))||void 0===t||t.open()})}focus(){this.updateComplete.then(()=>{var e;(null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("ha-textfield")).focus()})}shouldUpdate(e){if(e.get("items"))if(Ci(this.items,e.get("items"))){if(1==e.size)return!1}else this.firstUpdated();return!0}firstUpdated(){this._comboBox.items=this.items}render(){const e=Si(this._value)&&this.items.find(e=>e.value==this._value);return q`
    ...
    `}};t([oe()],Vi.prototype,"label",void 0),t([oe()],Vi.prototype,"value",void 0),t([oe()],Vi.prototype,"items",void 0),t([oe()],Vi.prototype,"clearable",void 0),t([oe()],Vi.prototype,"icons",void 0),t([oe({type:Boolean})],Vi.prototype,"disabled",void 0),t([le()],Vi.prototype,"_opened",void 0),t([oe({attribute:"allow-custom-value",type:Boolean})],Vi.prototype,"allowCustomValue",void 0),t([oe({type:Boolean})],Vi.prototype,"invalid",void 0),t([de("vaadin-combo-box-light",!0)],Vi.prototype,"_comboBox",void 0),Vi=t([ne("alarmo-select")],Vi);let Hi=class extends se{static get styles(){return o`
      :host {
        display: block;
      }
    `}render(){return q`
      <slot></slot>
    `}constructor(){super(),this.addEventListener("clickHeader",this.manageSpoilers)}manageSpoilers(e){const t=e.target;t.getAttribute("active")?t.removeAttribute("active"):t.setAttribute("active","true"),this.querySelectorAll("alarmo-collapsible-header[active]").forEach((function(e){e!==t&&e.removeAttribute("active")}))}};Hi=t([ne("alarmo-collapsible-group")],Hi);let Yi=class extends se{static get styles(){return o`
      :host {
        display: block;
      }
    `}render(){return q`
    ...
    `}};Ki=t([ne("alarmo-collapsible-body")],Ki);let Qi=class extends(Je(se)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Xe(this.hass),this.sensors=await Ge(this.hass))}async firstUpdated(){await this._fetchData(),this.selectedArea=Object.keys(this.areas)[0],this.data=Object.assign({},this.areas[this.selectedArea].modes)}render(){return this.data?q`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${pi("panels.general.cards.modes.title",this.hass.language)}
          </div>
        ...
        <div class="card-content">
          ${pi("panels.general.cards.modes.description",this.hass.language)}
        </div>

        <alarmo-collapsible-group>
          ${Object.entries(wi).map(([e,t])=>{var a;return q`
                <alarmo-collapsible-item>
                  <alarmo-collapsible-header>
                    <ha-icon slot="icon" icon="${gi[e]}"></ha-icon>
                    <span slot="title">
                      ${this.hass.localize("component.alarm_control_panel.state._."+t)}
                    </span>
                    <span slot="description">
                      ${(null===(a=this.data[t])||void 0===a?void 0:a.enabled)?q`
                            ${pi("common.enabled",this.hass.language)},
                            <a href="${Ii("sensors",{filter:{area:this.selectedArea,mode:t}})}">
                              ${pi("panels.general.cards.modes.number_sensors_active",this.hass.language,"number",this.getSensorsByMode(t))}
                            </a>
                          `:pi("common.disabled",this.hass.language)}
                    </span>
                  </alarmo-collapsible-header>
    ...
    `:q``}getSensorsByMode(e){return Object.values(this.sensors).filter(t=>t.modes.includes(e)||t.always_on).length}renderModeConfig(e){const t=e in this.data?this.data[e]:void 0;return q`
      <div class="description">
        ...
        ${pi("panels.general.cards.modes.modes."+e,this.hass.language)}
      </div>
      <settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${pi("panels.general.cards.modes.fields.status.heading",this.hass.language)}
        </span>
        <span slot="description">
          ${pi("panels.general.cards.modes.fields.status.description",this.hass.language)}
        </span>
        <div>
      ...
      <settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${pi("panels.general.cards.modes.fields.exit_delay.heading",this.hass.language)}
        </span>
        <span slot="description">
          ${pi("panels.general.cards.modes.fields.exit_delay.description",this.hass.language)}
        </span>
        <time-slider
          .hass=${this.hass}
          unit="sec"
          max="180"
          zeroValue=${pi("components.time_slider.none",this.hass.language)}
      ...
      <settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${pi("panels.general.cards.modes.fields.entry_delay.heading",this.hass.language)}
        </span>
        <span slot="description">
          ${pi("panels.general.cards.modes.fields.entry_delay.description",this.hass.language)}
        </span>
        <time-slider
          .hass=${this.hass}
          unit="sec"
    ...
    `}};t([oe()],Qi.prototype,"hass",void 0),t([oe({type:Boolean})],Qi.prototype,"narrow",void 0),t([oe()],Qi.prototype,"config",void 0),t([oe()],Qi.prototype,"areas",void 0),t([oe()],Qi.prototype,"sensors",void 0),t([oe()],Qi.prototype,"data",void 0),t([oe()],Qi.prototype,"selectedArea",void 0),Qi=t([ne("alarm-mode-card")],Qi);let Wi=class extends se{constructor(){super(...arguments),this.threeLine=!1}render(){return q`
      <div class="info">
    ...
    `}};t([oe({type:Boolean,reflect:!0})],Wi.prototype,"narrow",void 0),t([oe({type:Boolean,reflect:!0})],Wi.prototype,"large",void 0),t([oe({type:Boolean,attribute:"three-line"})],Wi.prototype,"threeLine",void 0),t([oe({type:Boolean})],Wi.prototype,"nested",void 0),t([oe({type:Boolean})],Wi.prototype,"dialog",void 0),Wi=t([ne("settings-row")],Wi);let Xi=class extends se{constructor(){super(...arguments),this.header="",this.open=!1}render(){return q`
      ${this.open?q`
          ...
          `:q`
            <div class="header">
              ...
              <ha-icon-button .path=${Gi} @click=${()=>{this.open=!0}}>
              </ha-icon-button>
            </div>
          `}
    `}static get styles(){return o`
    ...
    `}};t([oe({type:Boolean,reflect:!0})],Xi.prototype,"narrow",void 0),t([oe()],Xi.prototype,"header",void 0),t([oe()],Xi.prototype,"open",void 0),Xi=t([ne("collapsible-section")],Xi);let Zi=class extends(Je(se)){constructor(){super(...arguments),this.areas={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await Ue(this.hass);this.config=e,this.areas=await Xe(this.hass),this.selection=e.mqtt}firstUpdated(){(async()=>{await Re()})()}render(){return this.hass&&this.selection?q`
      <ha-card>
        <div class="card-header">
          <div class="name">${pi("panels.general.cards.mqtt.title",this.hass.language)}</div>
          <ha-icon-button .path=${Fi} @click=${this.cancelClick}></ha-icon-button>
        </div>
        <div class="card-content">${pi("panels.general.cards.mqtt.description",this.hass.language)}</div>

        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${pi("panels.general.cards.mqtt.fields.state_topic.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${pi("panels.general.cards.mqtt.fields.state_topic.description",this.hass.language)}
          </span>
          <ha-textfield
            label="${pi("panels.general.cards.mqtt.fields.state_topic.heading",this.hass.language)}"
        ...
        <collapsible-section
          .narrow=${this.narrow}
          header=${pi("panels.general.cards.mqtt.fields.state_payload.heading",this.hass.language)}
        >
          ${Object.values(vi).filter(e=>Object.values(this.areas).some(t=>Di(e,t.modes))).map(e=>q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">${Ai(e)}</span>
                  <span slot="description">
                    ${pi("panels.general.cards.mqtt.fields.state_payload.item",this.hass.language,"{state}",Ai(e))}
                  </span>
                  <ha-textfield
                    label=${Ai(e)}
                    placeholder=${e}
                    value=${this.selection.state_payload[e]||""}
                    @change=${t=>{this.selection=Li(this.selection,{state_payload:{[e]:t.target.value}})}}
                  ></ha-textfield>
                </settings-row>
              `)}
        </collapsible-section>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${pi("panels.general.cards.mqtt.fields.event_topic.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${pi("panels.general.cards.mqtt.fields.event_topic.description",this.hass.language)}
          </span>
          <ha-textfield
            label="${pi("panels.general.cards.mqtt.fields.event_topic.heading",this.hass.language)}"
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${pi("panels.general.cards.mqtt.fields.command_topic.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${pi("panels.general.cards.mqtt.fields.command_topic.description",this.hass.language)}
          </span>
          <ha-textfield
            label="${pi("panels.general.cards.mqtt.fields.command_topic.heading",this.hass.language)}"
        ...
        <collapsible-section
          .narrow=${this.narrow}
          header=${pi("panels.general.cards.mqtt.fields.command_payload.heading",this.hass.language)}
        >
          ${Object.values(fi).filter(e=>Object.values(this.areas).some(t=>Di((e=>{switch(e){case fi.COMMAND_ALARM_DISARM:return vi.STATE_ALARM_DISARMED;case fi.COMMAND_ALARM_ARM_HOME:return vi.STATE_ALARM_ARMED_HOME;case fi.COMMAND_ALARM_ARM_AWAY:return vi.STATE_ALARM_ARMED_AWAY;case fi.COMMAND_ALARM_ARM_NIGHT:return vi.STATE_ALARM_ARMED_NIGHT;case fi.COMMAND_ALARM_ARM_CUSTOM_BYPASS:return vi.STATE_ALARM_ARMED_CUSTOM_BYPASS;case fi.COMMAND_ALARM_ARM_VACATION:return vi.STATE_ALARM_ARMED_VACATION;default:return}})(e),t.modes))).map(e=>q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">${Ai(e)}</span>
                  <span slot="description">
                    ${pi("panels.general.cards.mqtt.fields.command_payload.item",this.hass.language,"{command}",Ai(e))}
                  </span>
                  <ha-textfield
                    label=${Ai(e)}
                    placeholder=${e}
                    value=${this.selection.command_payload[e]||""}
                    @change=${t=>{this.selection=Li(this.selection,{command_payload:{[e]:t.target.value}})}}
                  ></ha-textfield>
                </settings-row>
              `)}
        </collapsible-section>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${pi("panels.general.cards.mqtt.fields.require_code.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${pi("panels.general.cards.mqtt.fields.require_code.description",this.hass.language)}
          </span>
          <ha-switch
    ...
    `:q``}saveClick(e){this.hass&&Ye(this.hass,{mqtt:Object.assign(Object.assign({},this.selection),{enabled:!0})}).catch(t=>Ni(t,e)).then(()=>{this.cancelClick()})}cancelClick(){Pe(0,Ii("general"),!0)}};Zi.styles=zi,t([oe()],Zi.prototype,"narrow",void 0),t([oe()],Zi.prototype,"config",void 0),t([oe()],Zi.prototype,"areas",void 0),t([oe()],Zi.prototype,"selection",void 0),Zi=t([ne("mqtt-config-card")],Zi);
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
...
class es extends class{constructor(e){}T(e,t,a){this.Σdt=e,this.M=t,this.Σct=a}S(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}{constructor(e){if(super(e),this.vt=I,e.type!==Ji)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===I)return this.Vt=void 0,this.vt=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.vt)return this.Vt;this.vt=e;const t=[e];return t.raw=t,this.Vt={_$litType$:this.constructor.resultType,strings:t,values:[]}}}es.directiveName="unsafeHTML",es.resultType=1;const ts=(e=>(...t)=>({_$litDirective$:e,values:t}))(es);let as=class extends se{render(){return q`
    ...
    `}};t([oe()],is.prototype,"items",void 0),t([oe()],is.prototype,"value",void 0),t([oe({type:Boolean})],is.prototype,"selectable",void 0),is=t([ne("alarmo-chip-set")],is);let ss=class extends se{set filters(e){this.filterConfig||(this.filterConfig=e)}shouldUpdate(e){return e.get("filters")&&!this.filterConfig&&(this.filterConfig=e.get("filters")),!0}render(){if(!this.columns||!this.data)return q``;const e=this.data.filter(e=>this.filterTableData(e,this.filterConfig));return q`
    ...
    `:q``}filterTableData(e,t){return!t||Object.keys(t).every(a=>{if(!Object.keys(e).includes(a))return!0;const i=t[a].value;return!i||!i.length||(Array.isArray(e[a])?e[a].some(e=>i.includes(e)):i.includes(e[a]))})}_getFilteredItems(){return this.data.filter(e=>!this.filterTableData(e,this.filterConfig)).length}handleClick(e){if(!this.selectable)return;const t=new CustomEvent("row-click",{detail:{id:e}});this.dispatchEvent(t)}renderFilterRow(){var e;return this.filterConfig?q`
      <div class="table-filter">
        <ha-icon-button
          ...
          label=${pi("components.table.filter.label",this.hass.language)}
        ...
        ${this._getFilteredItems()?q`
              <alarmo-chip cancellable table @button-clicked=${this._clearFilters}>
                ${pi("components.table.filter.hidden_items",this.hass.language,"number",this._getFilteredItems())}
              </alarmo-chip>
            `:""}
      </div>
    `:q``}_toggleFilterMenu(e){const t=e.target;this._menu.anchor=t,this._menu.open?this._menu.close():(this.filterSelection=Object.entries(this.filterConfig).reduce((e,[t,a])=>Object.assign(Object.assign({},e),{[t]:Ti(a,["value"])}),{}),this._menu.show())}renderFilterMenu(){return this.filterConfig&&this.filterSelection?q`
      <span class="header">
        ${pi("components.table.filter.label",this.hass.language)}
      </span>
      <ha-icon-button
        .path=${Fi}
      ...
      ${Object.keys(this.filterConfig).map(e=>{if(this.filterConfig[e].binary)return q`
          ...
          `;let t=this.filterConfig[e].items;t=t.map(t=>{var a;return t.badge&&"function"==typeof t.badge?{...t,badge:t.badge(null===(a=this.data)||void 0===a?void 0:a.filter(t=>this.filterTableData(t,ji(this.filterSelection,e))))}:t});const a=this.filterSelection[e].value;return q`
  ...
  `,t([oe()],ss.prototype,"hass",void 0),t([oe()],ss.prototype,"columns",void 0),t([oe()],ss.prototype,"data",void 0),t([le()],ss.prototype,"filterConfig",void 0),t([le()],ss.prototype,"filterSelection",void 0),t([oe({type:Boolean})],ss.prototype,"selectable",void 0),t([de("mwc-menu",!0)],ss.prototype,"_menu",void 0),ss=t([ne("alarmo-table")],ss);let ns=class extends se{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
    ...
    `}};t([oe({attribute:!1})],ns.prototype,"hass",void 0),t([le()],ns.prototype,"_params",void 0),ns=t([ne("confirm-delete-dialog")],ns);var rs=Object.freeze({__proto__:null,get ConfirmDeleteDialog(){return ns}});let os=class extends(Je(se)){constructor(){super(...arguments),this.areas={},this.sensors={},this.automations={},this.name=""}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Xe(this.hass),this.sensors=await Ge(this.hass),this.automations=await Ve(this.hass))}async showDialog(e){await this._fetchData(),this._params=e,e.area_id&&(this.area_id=e.area_id,this.name=this.areas[this.area_id].name),await this.updateComplete}async closeDialog(){this._params=void 0,this.area_id=void 0,this.name=""}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        ...
        <div class="wrapper">
          ...
          ${this.area_id?q`
                <span class="note">
                  ${pi("panels.general.dialogs.edit_area.name_warning",this.hass.language)}
                </span>
              `:""}
          ${this.area_id?"":q`
                <alarmo-select
                  .items=${Object.values(this.areas).map(e=>Object({value:e.area_id,name:e.name}))}
                  value=${this.selectedArea}
                  label="${pi("panels.general.dialogs.create_area.fields.copy_from",this.hass.language)}"
                  clearable=${!0}
    ...
    `}};t([oe({attribute:!1})],os.prototype,"hass",void 0),t([le()],os.prototype,"_params",void 0),t([oe()],os.prototype,"areas",void 0),t([oe()],os.prototype,"sensors",void 0),t([oe()],os.prototype,"automations",void 0),t([oe()],os.prototype,"name",void 0),t([oe()],os.prototype,"area_id",void 0),t([oe()],os.prototype,"selectedArea",void 0),os=t([ne("create-area-dialog")],os);var ls=Object.freeze({__proto__:null,get CreateAreaDialog(){return os}});let ds=class extends(Je(se)){constructor(){super(...arguments),this.areas={},this.sensors={},this.automations={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Xe(this.hass),this.sensors=await Ge(this.hass),this.automations=await Ve(this.hass))}render(){if(!this.hass)return q``;const e=Object.values(this.areas);e.sort(Pi);const t={actions:{width:"48px"},name:{title:this.hass.localize("ui.components.area-picker.add_dialog.name"),width:"40%",grow:!0,text:!0},remarks:{title:pi("panels.general.cards.areas.table.remarks",this.hass.language),width:"60%",hide:this.narrow,text:!0}},a=Object.values(e).map(t=>{const a=Object.values(this.sensors).filter(e=>e.area==t.area_id).length,i=1==Object.values(e).length?Object.values(this.automations).filter(e=>{var a,i;return(null===(a=e.triggers)||void 0===a?void 0:a.map(e=>e.area).includes(t.area_id))||!(null===(i=e.triggers)||void 0===i?void 0:i.map(e=>e.area).length)}).length:Object.values(this.automations).filter(e=>{var a;return null===(a=e.triggers)||void 0===a?void 0:a.map(e=>e.area).includes(t.area_id)}).length,s=`<a href="${Ii("sensors",{filter:{area:t.area_id}})}">${pi("panels.general.cards.areas.table.summary_sensors",this.hass.language,"number",a)}</a>`,n=`<a href="${Ii("actions",{filter:{area:t.area_id}})}">${pi("panels.general.cards.areas.table.summary_automations",this.hass.language,"number",i)}</a>`;return{id:t.area_id,actions:q`
        ...
        `,name:Ai(t.name),remarks:ts(pi("panels.general.cards.areas.table.summary",this.hass.language,"summary_sensors",s,"summary_automations",n))}});return q`
      <ha-card header="${pi("panels.general.cards.areas.title",this.hass.language)}">
        <div class="card-content">
          ${pi("panels.general.cards.areas.description",this.hass.language)}
        </div>

        <alarmo-table .columns=${t} .data=${a}>
          ${pi("panels.general.cards.areas.no_items",this.hass.language)}
        </alarmo-table>
        <div class="card-actions">
          <mwc-button @click=${this.addClick}>
            ${pi("panels.general.cards.areas.actions.add",this.hass.language)}
          </mwc-button>
        </div>
      </ha-card>
    `}addClick(e){const t=e.target;Ne(t,"show-dialog",{dialogTag:"create-area-dialog",dialogImport:()=>Promise.resolve().then((function(){return ls})),dialogParams:{}})}editClick(e,t){const a=e.target;Ne(a,"show-dialog",{dialogTag:"create-area-dialog",dialogImport:()=>Promise.resolve().then((function(){return ls})),dialogParams:{area_id:t}})}};ds.styles=zi,t([oe()],ds.prototype,"narrow",void 0),t([oe()],ds.prototype,"path",void 0),t([oe()],ds.prototype,"config",void 0),t([oe()],ds.prototype,"areas",void 0),t([oe()],ds.prototype,"sensors",void 0),t([oe()],ds.prototype,"automations",void 0),ds=t([ne("area-config-card")],ds);let cs=class extends se{constructor(){super(...arguments),this.name=""}async showDialog(e){this._params=e;const t=await Ue(this.hass);this.name=t.master.name||"",await this.updateComplete}async closeDialog(){this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <div slot="heading">
          <ha-header-bar>
            <ha-icon-button slot="navigationIcon" dialogAction="cancel" .path=${Fi}></ha-icon-button>
            <span slot="title">${pi("panels.general.dialogs.edit_master.title",this.hass.language)}</span>
          </ha-header-bar>
        </div>
        <div class="wrapper">
          <ha-textfield
            ...
            value="${this.name}"
          ></ha-textfield>
          <span class="note">${pi("panels.general.dialogs.edit_area.name_warning",this.hass.language)}</span>
        </div>
        <mwc-button slot="primaryAction" @click=${this.saveClick}>
          ${this.hass.localize("ui.common.save")}
        </mwc-button>
    ...
    `}};t([oe({attribute:!1})],cs.prototype,"hass",void 0),t([le()],cs.prototype,"_params",void 0),t([oe()],cs.prototype,"name",void 0),cs=t([ne("edit-master-dialog")],cs);var hs=Object.freeze({__proto__:null,get EditMasterDialog(){return cs}});let us=class extends(Je(se)){constructor(){super(...arguments),this.areas={},this.automations={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.config=await Ue(this.hass),this.areas=await Xe(this.hass),this.automations=await Ve(this.hass),this.data=Ti(this.config,["trigger_time","disarm_after_trigger","mqtt","master"]))}firstUpdated(){(async()=>{await Re()})()}render(){var e,t,a,i,s,n,r,o;return this.hass&&this.config&&this.data?"mqtt_configuration"==this.path.subpage?q`
      ...
      `:this.path.params.edit_area?q`
        ...
        ></area-editor-card>
      `:q`
        <ha-card header="${pi("panels.general.title",this.hass.language)}">
          <div class="card-content">
            ${pi("panels.general.cards.general.description",this.hass.language)}
          </div>

          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${pi("panels.general.cards.general.fields.disarm_after_trigger.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${pi("panels.general.cards.general.fields.disarm_after_trigger.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${pi("panels.general.cards.general.fields.enable_mqtt.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${pi("panels.general.cards.general.fields.enable_mqtt.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          ${(null===(i=null===(a=this.data)||void 0===a?void 0:a.mqtt)||void 0===i?void 0:i.enabled)?q`
                <div style="padding: 0px 0px 16px 16px">
                  <mwc-button
                    outlined
                    @click=${()=>Pe(0,Ii("general","mqtt_configuration"),!0)}
                  >
                    ${pi("panels.general.cards.general.actions.setup_mqtt",this.hass.language)}
                  </mwc-button>
                </div>
              `:""}
          ${Object.keys(this.areas).length>=2?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${pi("panels.general.cards.general.fields.enable_master.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${pi("panels.general.cards.general.fields.enable_master.description",this.hass.language)}
                  </span>
                  <ha-switch
          ...
          ${(null===(o=null===(r=this.data)||void 0===r?void 0:r.master)||void 0===o?void 0:o.enabled)&&Object.keys(this.areas).length>=2?q`
                <div style="padding: 0px 0px 16px 16px">
                  <mwc-button outlined @click=${this.setupMasterClick}>
                    ${pi("panels.general.cards.general.actions.setup_master",this.hass.language)}
                  </mwc-button>
                </div>
              `:""}
        </ha-card>
      ...
      <ha-dialog open @closed=${this.closeDialog} @close-dialog=${this.closeDialog} .heading=${this.renderHeader()}>
        <div class="wrapper">
          ...
          <settings-row large dialog>
            <span slot="heading">
              ${pi("panels.sensors.dialogs.create_group.fields.sensors.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${pi("panels.sensors.dialogs.create_group.fields.sensors.description",this.hass.language)}
            </span>
            <div>
          ...
          <settings-row dialog>
            <span slot="heading">
              ${pi("panels.sensors.dialogs.create_group.fields.timeout.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${pi("panels.sensors.dialogs.create_group.fields.timeout.description",this.hass.language)}
            </span>
            <time-slider
              .hass=${this.hass}
              unit="min"
    ...
    `:q``}renderHeader(){return q`
      <span class="header_title">
        ${this.data.group_id?pi("panels.sensors.dialogs.edit_group.title",this.hass.language,"{name}",this.sensorGroups[this.data.group_id].name):pi("panels.sensors.dialogs.create_group.title",this.hass.language)}
      </span>
      <ha-icon-button
        ...
        class="header_button"
      ></ha-icon-button>
    `}renderSensorOptions(){const e=Object.keys(this.sensors).filter(e=>!Si(this.sensors[e].group)||this.sensors[e].group===this.data.group_id).map(e=>{const t=this.hass.states[e],a=Object.entries(_i).find(([,t])=>t==this.sensors[e].type)[0];return{value:e,name:Ai(xi(t)),icon:bi[a]}});return e.sort(Pi),e.length?q`
      <alarmo-chip-set
        .items=${e}
    ...
    `}};t([oe({attribute:!1})],_s.prototype,"hass",void 0),t([le()],_s.prototype,"_params",void 0),t([oe()],_s.prototype,"sensorGroups",void 0),t([oe()],_s.prototype,"sensors",void 0),t([oe()],_s.prototype,"data",void 0),_s=t([ne("create-sensor-group-dialog")],_s);var bs=Object.freeze({__proto__:null,get CreateSensorGroupDialog(){return _s}});let ys=class extends(Je(se)){constructor(){super(...arguments),this.sensorGroups={},this.sensors={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.sensorGroups=await He(this.hass),this.sensors=await Ge(this.hass))}async showDialog(e){await this._fetchData(),this._params=e,await this.updateComplete}async closeDialog(){this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${this.renderHeader()} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <div class="wrapper">
          <div class="description">
            ${pi("panels.sensors.dialogs.manage_groups.description",this.hass.language)}
          </div>
          <div class="container">
            ${Object.keys(this.sensorGroups).length?Object.values(this.sensorGroups).map(e=>this.renderGroup(e)):pi("panels.sensors.dialogs.manage_groups.no_items",this.hass.language)}
          </div>
        </div>
        <mwc-button slot="secondaryAction" @click=${this.createGroupClick}>
          <ha-icon icon="hass:plus"></ha-icon>
          ${pi("panels.sensors.dialogs.manage_groups.actions.new_group",this.hass.language)}
        </mwc-button>
      </ha-dialog>
    `:q``}renderHeader(){return q`
      <span class="header_title">${pi("panels.sensors.dialogs.manage_groups.title",this.hass.language)}</span>
      <ha-icon-button
        .label=${this.hass.localize("ui.dialogs.generic.close")}
        .path=${Fi}
        dialogAction="close"
    ...
    >
      ...
      <div>
        ...
        <span class="description">${pi("panels.general.cards.areas.table.summary_sensors",this.hass.language,"{number}",String(e.entities.length))}
      </div>
      <ha-icon-button .path=${Gi}>
      </ha-icon-button>
    </ha-card>
    ...
    `}};t([oe({attribute:!1})],ys.prototype,"hass",void 0),t([le()],ys.prototype,"_params",void 0),t([oe()],ys.prototype,"sensorGroups",void 0),t([oe()],ys.prototype,"sensors",void 0),ys=t([ne("manage-sensor-groups-dialog")],ys);var ws=Object.freeze({__proto__:null,get ManageSensorGroupsDialog(){return ys}});let ks=class extends(Je(se)){constructor(){super(...arguments),this.showBypassModes=!1}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){var e;if(!this.hass)return;const t=await Xe(this.hass);this.areas=t;const a=await He(this.hass);this.sensorGroups=a;const i=await Ge(this.hass);this.data=Object.keys(i).includes(this.item)?i[this.item]:void 0,this.data&&!(null===(e=this.data)||void 0===e?void 0:e.area)&&1==Object.keys(t).length&&(this.data=Object.assign(Object.assign({},this.data),{area:Object.keys(this.areas)[0]}))}render(){if(!this.data)return q``;this.hass.states[this.data.entity_id];return q`
      <ha-card>
        <div class="card-header">
          <div class="name">${pi("panels.sensors.cards.editor.title",this.hass.language)}</div>
          <ha-icon-button .path=${Fi} @click=${this.cancelClick}></ha-icon-button>
        </div>
        <div class="card-content">
          ${pi("panels.sensors.cards.editor.description",this.hass.language,"{entity}",xi(this.hass.states[this.item]))}
        </div>

        ${Object.keys(this.areas).length>1?q`
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${pi("panels.sensors.cards.editor.fields.area.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${pi("panels.sensors.cards.editor.fields.area.description",this.hass.language)}
                </span>

                <alarmo-select
                  .items=${Object.values(this.areas).map(e=>Object({value:e.area_id,name:e.name}))}
                  value=${this.data.area}
                  label=${pi("panels.sensors.cards.editor.fields.area.heading",this.hass.language)}
        ...
        <settings-row .narrow=${this.narrow} .large=${!0}>
          <span slot="heading">
            ${pi("panels.sensors.cards.editor.fields.device_type.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${pi("panels.sensors.cards.editor.fields.device_type.description",this.hass.language)}
          </span>

          <alarmo-select
            .hass=${this.hass}
            .items=${e=this.hass,Object.entries(_i).filter(([,e])=>e!=_i.Other).map(([t,a])=>Object({value:a,name:pi(`panels.sensors.cards.editor.fields.device_type.choose.${a}.name`,e.language),description:pi(`panels.sensors.cards.editor.fields.device_type.choose.${a}.description`,e.language),icon:bi[t]}))}
            label=${pi("panels.sensors.cards.editor.fields.device_type.heading",this.hass.language)}
            clearable=${!0}
            icons=${!0}
            value=${this.data.type}
            @value-changed=${e=>this.setType(e.target.value||_i.Other)}
          ></alarmo-select>
        </settings-row>

        <settings-row .narrow=${this.narrow} .large=${this.modesByArea(this.data.area).length>3}>
          <span slot="heading">
            ${pi("panels.sensors.cards.editor.fields.modes.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${pi("panels.sensors.cards.editor.fields.modes.description",this.hass.language)}
          </span>
          ...
          <div>
            ${this.modesByArea(this.data.area).map(e=>q`
                ...
                >
                  <ha-icon icon="${gi[Object.entries(wi).find(([,t])=>t==e)[0]]}"></ha-icon>
                  ${pi("common.modes_short."+e,this.hass.language)}
                </mwc-button>
              `)}
          </div>
        </settings-row>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${pi("panels.sensors.cards.editor.fields.group.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${pi("panels.sensors.cards.editor.fields.group.description",this.hass.language)}
          </span>
          ...
          <div>
            ${Object.keys(this.sensorGroups).length?q`
                  <alarmo-select
                    ...
                    label="${pi("panels.sensors.cards.editor.fields.group.heading",this.hass.language)}"
                    @value-changed=${e=>{this.data={...this.data,group:e.detail.value}}}
                  ></alarmo-select>
                `:""}
            <mwc-button @click=${this.manageGroupsClick}>
              ${pi("panels.sensors.cards.editor.actions.setup_groups",this.hass.language)}
            </mwc-button>
          </div>
        </settings-row>
        ...
        <collapsible-section
          .narrow=${this.narrow}
          header=${pi("panels.sensors.cards.editor.actions.toggle_advanced",this.hass.language)}
        >
          ${!this.data.type||[_i.Environmental,_i.Other].includes(this.data.type)?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${pi("panels.sensors.cards.editor.fields.always_on.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${pi("panels.sensors.cards.editor.fields.always_on.description",this.hass.language)}
                  </span>
              ...
              `:""}
          ${!this.data.type||[_i.Window,_i.Door,_i.Motion,_i.Other].includes(this.data.type)?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${pi("panels.sensors.cards.editor.fields.use_exit_delay.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${pi("panels.sensors.cards.editor.fields.use_exit_delay.description",this.hass.language)}
                  </span>
                ...
                ${this.data.type&&![_i.Motion,_i.Other].includes(this.data.type)||!this.data.use_exit_delay?"":q`
                      <settings-row .narrow=${this.narrow} nested>
                        <span slot="heading">
                          ${pi("panels.sensors.cards.editor.fields.allow_open.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${pi("panels.sensors.cards.editor.fields.allow_open.description",this.hass.language)}
                        </span>
          ...
          ${!this.data.type||[_i.Window,_i.Door,_i.Motion,_i.Other].includes(this.data.type)?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${pi("panels.sensors.cards.editor.fields.use_entry_delay.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${pi("panels.sensors.cards.editor.fields.use_entry_delay.description",this.hass.language)}
                  </span>
              ...
              `:""}
          ${!this.data.type||[_i.Door,_i.Other].includes(this.data.type)?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${pi("panels.sensors.cards.editor.fields.arm_on_close.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${pi("panels.sensors.cards.editor.fields.arm_on_close.description",this.hass.language)}
                  </span>
              ...
              `:""}
          ${!this.data.type||[_i.Window,_i.Door,_i.Other].includes(this.data.type)?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${pi("panels.sensors.cards.editor.fields.auto_bypass.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${pi("panels.sensors.cards.editor.fields.auto_bypass.description",this.hass.language)}
                  </span>
                ...
                ${this.data.auto_bypass?q`
                      <settings-row .narrow=${this.narrow} nested>
                        <span slot="heading">
                          ${pi("panels.sensors.cards.editor.fields.auto_bypass.modes",this.hass.language)}
                        </span>
                        <div>
                          ${this.modesByArea(this.data.area).map(e=>q`
                              <mwc-button
                              ...
                              >
                                <ha-icon
                                  icon="${gi[Object.entries(wi).find(([,t])=>t==e)[0]]}"
                                ></ha-icon>
                                ${pi("common.modes_short."+e,this.hass.language)}
                              </mwc-button>
                            `)}
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${pi("panels.sensors.cards.editor.fields.trigger_unavailable.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${pi("panels.sensors.cards.editor.fields.trigger_unavailable.description",this.hass.language)}
            </span>
    ...
    `;var e}modesByArea(e){const t=Object.keys(this.areas).reduce((e,t)=>Object.assign(e,{[t]:Object.entries(this.areas[t].modes).filter(([,e])=>e.enabled).map(([e])=>e)}),{});return e?t[e]:Object.values(t).reduce((e,t)=>e.filter(e=>t.includes(e)))}_SetData(e){if(this.data)for(const[t,a]of Object.entries(e))switch(t){case"always_on":this.data=Object.assign(Object.assign({},this.data),{always_on:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{arm_on_close:!1,use_exit_delay:!1,use_entry_delay:!1,allow_open:!1,auto_bypass:!1}));break;case"use_entry_delay":this.data=Object.assign(Object.assign({},this.data),{use_entry_delay:1==a});break;case"use_exit_delay":this.data=Object.assign(Object.assign({},this.data),{use_exit_delay:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{allow_open:!1}));break;case"arm_on_close":this.data=Object.assign(Object.assign({},this.data),{arm_on_close:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{always_on:!1,allow_open:!1}));break;case"allow_open":this.data=Object.assign(Object.assign({},this.data),{allow_open:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{arm_on_close:!1,always_on:!1,use_exit_delay:!0}));break;case"auto_bypass":this.data=Object.assign(Object.assign({},this.data),{auto_bypass:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{always_on:!1}));break;case"trigger_unavailable":this.data=Object.assign(Object.assign({},this.data),{trigger_unavailable:1==a})}}setMode(e){this.data&&(this.data=Object.assign(Object.assign({},this.data),{modes:this.data.modes.includes(e)?Ei(this.data.modes,e):Oi(this.data.modes.concat([e]))}))}setBypassMode(e){this.data&&(this.data=Object.assign(Object.assign({},this.data),{auto_bypass_modes:this.data.auto_bypass_modes.includes(e)?Ei(this.data.auto_bypass_modes,e):Oi(this.data.auto_bypass_modes.concat([e]))}))}setType(e){if(!this.data)return;const t=e!=_i.Other?gs(this.modesByArea(this.data.area))[e]:{};this.data=Object.assign(Object.assign(Object.assign({},this.data),{type:e}),t)}deleteClick(e){var t,a;(t=this.hass,a=this.item,t.callApi("POST","alarmo/sensors",{entity_id:a,remove:!0})).catch(t=>Ni(t,e)).then(()=>{this.cancelClick()})}saveClick(e){if(!this.data)return;const t=[];this.data=Object.assign(Object.assign({},this.data),{auto_bypass_modes:this.data.auto_bypass_modes.filter(e=>this.data.modes.includes(e))}),this.data.area||t.push(pi("panels.sensors.cards.editor.errors.no_area",this.hass.language)),this.data.modes.length||this.data.always_on||t.push(pi("panels.sensors.cards.editor.errors.no_modes",this.hass.language)),this.data.auto_bypass&&!this.data.auto_bypass_modes.length&&t.push(pi("panels.sensors.cards.editor.errors.no_auto_bypass_modes",this.hass.language)),t.length?Mi(e,q`
      ...
      <ha-card header="${pi("panels.sensors.title",this.hass.language)}">
        ...
        <alarmo-table
          ...
          @row-click=${e=>{Pe(0,Ii("sensors",{params:{edit:e.detail.id}}),!0)}}
        >
          ${pi("panels.sensors.cards.sensors.table.no_items",this.hass.language)}
        </alarmo-table>
      </ha-card>
    `:q``}tableColumns(){const e=()=>q`
      <paper-tooltip animation-delay="0">
        ${pi("panels.sensors.cards.sensors.table.no_area_warning",this.hass.language)}
      </paper-tooltip>
    `;return{icon:{width:"40px",renderer:t=>{const a=this.hass.states[t.entity_id],i=Object.keys(_i).find(e=>_i[e]==t.type),s=a?bi[i]:"hass:help-circle-outline";return t.area==xs?q`
                ${e()}
                <ha-icon icon="mdi:alert" style="color: var(--error-color)"></ha-icon>
              `:q`
                <paper-tooltip animation-delay="0">
                  ${a?pi(`panels.sensors.cards.editor.fields.device_type.choose.${t.type}.name`,this.hass.language):this.hass.localize("state_badge.default.entity_not_found")}
                </paper-tooltip>
    ...
    `}toggleSelect(e,t){const a=e.target.checked;this.addSelection=a&&!this.addSelection.includes(t)?[...this.addSelection,t]:a?this.addSelection:this.addSelection.filter(e=>e!=t)}addSelected(e){if(!this.hass)return;const t=Object.values(this.areas).map(e=>Object.entries(e.modes).filter(([,e])=>e.enabled).map(([e])=>e)).reduce((e,t)=>e.filter(e=>t.includes(e)));this.addSelection.map(e=>function(e,t){if(!e)return null;const a=Se(e.entity_id);let i={entity_id:e.entity_id,modes:[],use_entry_delay:!0,use_exit_delay:!0,arm_on_close:!1,allow_open:!1,always_on:!1,auto_bypass:!1,auto_bypass_modes:[],trigger_unavailable:!1,type:_i.Other,enabled:!0};if("binary_sensor"==a){const a=ps(e);a&&(i=Object.assign(Object.assign(Object.assign({},i),{type:a}),gs(t)[a]))}return i}(this.hass.states[e],t)).map(e=>1==Object.keys(this.areas).length?Object.assign(e,{area:Object.keys(this.areas)[0]}):e).filter(e=>e).forEach(t=>{Be(this.hass,t).catch(t=>Ni(t,e)).then()}),this.addSelection=[]}getTableFilterOptions(){return{isSupportedType:{name:pi("panels.sensors.cards.add_sensors.actions.filter_supported",this.hass.language),items:[{value:"true",name:"true"}],value:["true"],binary:!0}}}};Es.styles=zi,t([oe()],Es.prototype,"hass",void 0),t([oe()],Es.prototype,"narrow",void 0),t([oe()],Es.prototype,"addSelection",void 0),t([oe()],Es.prototype,"areas",void 0),t([oe()],Es.prototype,"sensors",void 0),Es=t([ne("add-sensors-card")],Es);let Ts=class extends se{firstUpdated(){(async()=>{await Re()})()}render(){var e,t;if(!this.hass)return q``;if(this.path.params.edit)return q`
      ...
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${this.item?pi("panels.codes.cards.edit_user.title",this.hass.language):pi("panels.codes.cards.new_user.title",this.hass.language)}
          </div>
          <ha-icon-button .path=${Fi} @click=${this.cancelClick}></ha-icon-button>
        </div>
        <div class="card-content">
          ${this.item?pi("panels.codes.cards.edit_user.description",this.hass.language,"{name}",this.users[this.item].name):pi("panels.codes.cards.new_user.description",this.hass.language)}
        </div>

        <settings-row .narrow=${this.narrow}>
          <span slot="heading">${pi("panels.codes.cards.new_user.fields.name.heading",this.hass.language)}</span>
          <span slot="description">
            ${pi("panels.codes.cards.new_user.fields.name.description",this.hass.language)}
          </span>

          <ha-textfield
            label="${pi("panels.codes.cards.new_user.fields.name.heading",this.hass.language)}"
            placeholder=""
            value=${this.data.name}
        ...
        ${this.item?q`
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${pi("panels.codes.cards.edit_user.fields.old_code.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${pi("panels.codes.cards.edit_user.fields.old_code.description",this.hass.language)}
                </span>

                <ha-textfield
                  label="${pi("panels.codes.cards.edit_user.fields.old_code.heading",this.hass.language)}"
                  placeholder=""
                  type="password"
        ...
        ${this.item&&!(null===(e=this.data.old_code)||void 0===e?void 0:e.length)?"":q`
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${pi("panels.codes.cards.new_user.fields.code.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${pi("panels.codes.cards.new_user.fields.code.description",this.hass.language)}
                </span>

                <ha-textfield
                  label="${pi("panels.codes.cards.new_user.fields.code.heading",this.hass.language)}"
                  placeholder=""
                  type="password"
              ...
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${pi("panels.codes.cards.new_user.fields.confirm_code.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${pi("panels.codes.cards.new_user.fields.confirm_code.description",this.hass.language)}
                </span>

                <ha-textfield
                  label="${pi("panels.codes.cards.new_user.fields.confirm_code.heading",this.hass.language)}"
                  placeholder=""
                  type="password"
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${pi("panels.codes.cards.new_user.fields.can_arm.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${pi("panels.codes.cards.new_user.fields.can_arm.description",this.hass.language)}
          </span>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${pi("panels.codes.cards.new_user.fields.can_disarm.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${pi("panels.codes.cards.new_user.fields.can_disarm.description",this.hass.language)}
          </span>
        ...
        ${this.getAreaOptions().length>=2?q`
              <settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${pi("panels.codes.cards.new_user.fields.area_limit.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${pi("panels.codes.cards.new_user.fields.area_limit.description",this.hass.language)}
                </span>
        ...
        <settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${pi("panels.codes.cards.new_user.fields.is_override_code.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${pi("panels.codes.cards.new_user.fields.is_override_code.description",this.hass.language)}
          </span>
    ...
    `}};t([oe()],js.prototype,"hass",void 0),t([oe()],js.prototype,"narrow",void 0),t([oe()],js.prototype,"item",void 0),t([oe()],js.prototype,"data",void 0),t([oe()],js.prototype,"repeatCode",void 0),js=t([ne("user-editor-card")],js);let Ss=class extends(Je(se)){constructor(){super(...arguments),this.users={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await Ue(this.hass);this.data=Ti(e,["code_arm_required","code_disarm_required","code_format"]);const t=await Fe(this.hass);this.users=t}render(){return this.hass&&this.data?"new_user"==this.path.subpage?q`
      ...
      `:this.path.params.edit_user?q`
        ...
        ></user-editor-card>
      `:q`
        <ha-card header="${pi("panels.codes.title",this.hass.language)}">
          <div class="card-content">${pi("panels.codes.cards.codes.description",this.hass.language)}</div>

          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${pi("panels.codes.cards.codes.fields.code_arm_required.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${pi("panels.codes.cards.codes.fields.code_arm_required.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${pi("panels.codes.cards.codes.fields.code_disarm_required.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${pi("panels.codes.cards.codes.fields.code_disarm_required.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${pi("panels.codes.cards.codes.fields.code_format.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${pi("panels.codes.cards.codes.fields.code_format.description",this.hass.language)}
            </span>
            <mwc-button
            ...
            >
              ${pi("panels.codes.cards.codes.fields.code_format.code_format_number",this.hass.language)}
            </mwc-button>
            <mwc-button
              ...
              ?disabled=${!this.data.code_arm_required&&!this.data.code_disarm_required}
            >
              ${pi("panels.codes.cards.codes.fields.code_format.code_format_text",this.hass.language)}
            </mwc-button>
          </settings-row>
        </ha-card>
      ...
      `:q``}usersPanel(){if(!this.hass)return q``;const e=Object.values(this.users);e.sort(Pi);const t={icon:{width:"40px"},name:{title:this.hass.localize("ui.components.area-picker.add_dialog.name"),width:"40%",grow:!0,text:!0},code_format:{title:pi("panels.codes.cards.codes.fields.code_format.heading",this.hass.language),width:"40%",hide:this.narrow,text:!0},enabled:{title:pi("common.enabled",this.hass.language),width:"68px",align:"center"}},a=e.map(e=>({id:e.user_id,icon:q`
        ...
        `,name:Ai(e.name),code_format:"number"==e.code_format?Ai(pi("panels.codes.cards.codes.fields.code_format.code_format_number",this.hass.language)):"text"==e.code_format?Ai(pi("panels.codes.cards.codes.fields.code_format.code_format_text",this.hass.language)):this.hass.localize("state.default.unknown"),enabled:q`
          <ha-switch
            @click=${e=>{e.stopPropagation()}}
            ?checked=${e.enabled}
          ...
          ></ha-switch>
        `}));return q`
      <ha-card header="${pi("panels.codes.cards.user_management.title",this.hass.language)}">
        <div class="card-content">
          ${pi("panels.codes.cards.user_management.description",this.hass.language)}
        </div>
    ...
    `}};var Ws;t([oe()],Qs.prototype,"hass",void 0),t([oe()],Qs.prototype,"items",void 0),t([oe({type:Array})],Qs.prototype,"value",void 0),t([oe()],Qs.prototype,"label",void 0),t([oe({type:Boolean})],Qs.prototype,"invalid",void 0),Qs=t([ne("alarmo-selector")],Qs),function(e){e[e.Yaml=0]="Yaml",e[e.UI=1]="UI"}(Ws||(Ws={}));let Xs=class extends se{constructor(){super(...arguments),this.config={type:yi.Notification,triggers:[{}],actions:[{}]},this.viewMode=Ws.UI,this.errors={}}async firstUpdated(){if(await Ie(),this.areas=await Xe(this.hass),this.alarmoConfig=await Ue(this.hass),this.item){let e=this.item.actions.map(e=>ji(e,"entity_id"));this.config=Object.assign(Object.assign({},this.item),{actions:[e[0],...e.slice(1)]}),this.config.triggers.length>1&&(this.config=Object.assign(Object.assign({},this.config),{triggers:[this.config.triggers[0]]}));let t=this.config.triggers[0].area;Si(t)&&!Ls(this.areas,this.alarmoConfig).includes(t)?t=void 0:null===t&&(t=0),this._setArea(new CustomEvent("value-changed",{detail:{value:t}}))}if(!Si(this.config.triggers[0].area)){const e=Ls(this.areas,this.alarmoConfig);1==e.length?this._setArea(new CustomEvent("value-changed",{detail:{value:e[0]}})):e.includes(0)&&this._setArea(new CustomEvent("value-changed",{detail:{value:0}}))}}render(){var e,t,a,i;return this.hass&&this.areas&&this.alarmoConfig?q`
      <div class="heading">
        <ha-icon-button .path=${Fi} @click=${this._cancelClick} class="icon"></ha-icon-button>
        <div class="header">${pi("panels.actions.cards.new_notification.title",this.hass.language)}</div>
        <div class="description">
          ${pi("panels.actions.cards.new_notification.description",this.hass.language)}
        </div>
      </div>
      <div class="section-header">${pi("panels.actions.cards.new_notification.trigger",this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${pi("panels.actions.cards.new_notification.fields.event.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${pi("panels.actions.cards.new_notification.fields.event.description",this.hass.language)}
            </span>

            <alarmo-select
              .hass=${this.hass}
              .items=${Object.values(ki).map(e=>Ms(e,this.hass))}
              label=${pi("panels.actions.cards.new_action.fields.event.heading",this.hass.language)}
              icons=${!0}
          ...
          ${Object.keys(this.areas).length>1?q`
                <settings-row .narrow=${this.narrow} .large=${!0}>
                  <span slot="heading">
                    ${pi("panels.actions.cards.new_action.fields.area.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${pi("panels.actions.cards.new_action.fields.area.description",this.hass.language)}
                  </span>

                  <alarmo-select
                    .hass=${this.hass}
                    .items=${Ls(this.areas,this.alarmoConfig).map(e=>Ns(e,this.areas,this.alarmoConfig))}
                    clearable=${!0}
                    label=${pi("panels.actions.cards.new_action.fields.area.heading",this.hass.language)}
          ...
          <settings-row .narrow=${this.narrow} .large=${!0} last>
            <span slot="heading">
              ${pi("panels.actions.cards.new_notification.fields.mode.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${pi("panels.actions.cards.new_notification.fields.mode.description",this.hass.language)}
            </span>

            <alarmo-selector
              .hass=${this.hass}
              .items=${Ps(this.config.triggers[0].area,this.areas).map(e=>Cs(e,this.hass))}
              label=${pi("panels.actions.cards.new_action.fields.mode.heading",this.hass.language)}
      ...
      <div class="section-header">${pi("panels.actions.cards.new_notification.action",this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          ${this.viewMode==Ws.UI?q`
                <settings-row .narrow=${this.narrow} .large=${!0} first>
                  <span slot="heading">
                    ${pi("panels.actions.cards.new_notification.fields.target.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${pi("panels.actions.cards.new_notification.fields.target.description",this.hass.language)}
                  </span>

                  <alarmo-select
                    .hass=${this.hass}
                    .items=${Ds(this.hass,...qs(this.hass))}
                    ?disabled=${!qs(this.hass).length}
                    label=${pi("panels.actions.cards.new_notification.fields.target.heading",this.hass.language)}
                    icons=${!0}
                ...
                ${this.config.actions[0].service&&"notify"!=Se(this.config.actions[0].service)?"":q`
                      <settings-row .narrow=${this.narrow}>
                        <span slot="heading">
                          ${pi("panels.actions.cards.new_notification.fields.title.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${pi("panels.actions.cards.new_notification.fields.title.description",this.hass.language)}
                        </span>

                        <ha-textfield
                          label="${pi("panels.actions.cards.new_notification.fields.title.heading",this.hass.language)}"
                ...
                ${this.config.actions[0].service&&"tts"==Se(this.config.actions[0].service)?q`
                      <settings-row .narrow=${this.narrow} .large=${!0} first>
                        <span slot="heading">
                          ${pi("panels.actions.cards.new_action.fields.entity.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${pi("panels.actions.cards.new_action.fields.entity.description",this.hass.language)}
                        </span>

                        <alarmo-select
                          .items=${zs(Gs(this.hass),this.hass)}
                          label=${pi("panels.actions.cards.new_action.fields.entity.heading",this.hass.language)}
                ...
                <settings-row .narrow=${this.narrow} .large=${!0} last>
                  <span slot="heading">
                    ${pi("panels.actions.cards.new_notification.fields.message.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${pi("panels.actions.cards.new_notification.fields.message.description",this.hass.language)}
                  </span>

                  <ha-textarea
                    id="message"
                    label="${pi("panels.actions.cards.new_notification.fields.message.heading",this.hass.language)}"
                ...
                ${null!==this._getArmModeFormat()&&(Fs(this.hass).length>1||1==Fs(this.hass).length&&Fs(this.hass)[0].value!=this._getArmModeFormat())?q`
                      <settings-row .narrow=${this.narrow} .large=${!0}>
                        <span slot="heading">
                          ${pi("panels.actions.cards.new_notification.fields.arm_mode_format.heading",this.hass.language)}
                        </span>

                        <span slot="description">
                          ${pi("panels.actions.cards.new_notification.fields.arm_mode_format.description",this.hass.language)}
                        </span>
                    ...
                    `:""}
              `:q`
                <h2>${pi("components.editor.edit_in_yaml",this.hass.language)}</h2>
        ...
        <div class="toggle-button">
          <mwc-button @click=${this._toggleYamlMode}>
            ...
            ${this.viewMode==Ws.Yaml?pi("components.editor.ui_mode",this.hass.language):pi("components.editor.yaml_mode",this.hass.language)}
          </mwc-button>
        </div>

        <div class="card-actions">
          <mwc-button trailingIcon ?disabled=${!this._validAction()} @click=${this._testClick}>
            ${pi("panels.actions.cards.new_notification.actions.test",this.hass.language)}
            <ha-icon icon="hass:arrow-right"></ha-icon>
          </mwc-button>
        </div>
      </ha-card>

      <div class="section-header">${pi("panels.actions.cards.new_notification.options",this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${pi("panels.actions.cards.new_notification.fields.name.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${pi("panels.actions.cards.new_notification.fields.name.description",this.hass.language)}
            </span>

            <ha-textfield
              label="${pi("panels.actions.cards.new_notification.fields.name.heading",this.hass.language)}"
          ...
          ${(null===(i=this.item)||void 0===i?void 0:i.automation_id)?q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${pi("panels.actions.cards.new_notification.fields.delete.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${pi("panels.actions.cards.new_notification.fields.delete.description",this.hass.language)}
                  </span>
                  <div>
    ...
    `}};var Zs;t([oe({attribute:!1})],Xs.prototype,"hass",void 0),t([oe()],Xs.prototype,"narrow",void 0),t([oe()],Xs.prototype,"config",void 0),t([oe()],Xs.prototype,"item",void 0),t([oe()],Xs.prototype,"areas",void 0),t([oe()],Xs.prototype,"alarmoConfig",void 0),t([oe()],Xs.prototype,"viewMode",void 0),t([oe()],Xs.prototype,"errors",void 0),Xs=t([ne("notification-editor-card")],Xs),function(e){e[e.Yaml=0]="Yaml",e[e.UI=1]="UI"}(Zs||(Zs={}));let Js=class extends se{constructor(){super(...arguments),this.config={type:yi.Action,triggers:[{}],actions:[{}]},this.viewMode=Zs.UI,this.errors={}}async firstUpdated(){if(await Ie(),this.areas=await Xe(this.hass),this.alarmoConfig=await Ue(this.hass),this.item){let e=this.item.actions.map(e=>e.entity_id?e:ji(e,"entity_id"));this.config=Object.assign(Object.assign({},this.item),{actions:[e[0],...e.slice(1)]}),this.config.triggers.length>1&&(this.config=Object.assign(Object.assign({},this.config),{triggers:[this.config.triggers[0]]}));let t=this.config.triggers[0].area;Si(t)&&!Ls(this.areas,this.alarmoConfig).includes(t)?t=void 0:null===t&&(t=0),this._setArea(new CustomEvent("value-changed",{detail:{value:t}})),this._hasCustomEntities()&&(this.viewMode=Zs.Yaml)}if(!Si(this.config.triggers[0].area)){const e=Ls(this.areas,this.alarmoConfig);1==e.length?this._setArea(new CustomEvent("value-changed",{detail:{value:e[0]}})):e.includes(0)&&this._setArea(new CustomEvent("value-changed",{detail:{value:0}}))}!this.item||this.config.triggers[0].area||this.alarmoConfig.master.enabled||(this.errors=Object.assign(Object.assign({},this.errors),{area:!0}))}render(){var e;return this.hass&&this.areas&&this.alarmoConfig?q`
      <div class="heading">
        <ha-icon-button .path=${Fi} @click=${this._cancelClick} class="icon"></ha-icon-button>
        <div class="header">${pi("panels.actions.cards.new_action.title",this.hass.language)}</div>
        <div class="description">${pi("panels.actions.cards.new_action.description",this.hass.language)}</div>
      </div>
      <div class="section-header">${pi("panels.actions.cards.new_notification.trigger",this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
      ...
      <ha-card>
        <div class="card-content">
          ${this.viewMode==Zs.UI?q`
                <settings-row .narrow=${this.narrow} .large=${!0} first>
                  ...
                  <alarmo-selector
                    .hass=${this.hass}
                    .items=${zs(Us(this.hass,this._getEntities()),this.hass)}
                    ?disabled=${!Us(this.hass,this._getEntities()).length}
                    label=${pi("panels.actions.cards.new_action.fields.entity.heading",this.hass.language)}
                ...
                ${this.config.actions.map(e=>e.entity_id).length?q`
                      <settings-row .narrow=${this.narrow} .large=${!this.renderActions()}>
                        <span slot="heading">
                          ${pi("panels.actions.cards.new_action.fields.action.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${pi("panels.actions.cards.new_action.fields.action.description",this.hass.language)}
                        </span>

                        <div>
                          ${this.renderActions()||pi("panels.actions.cards.new_action.fields.action.no_common_actions",this.hass.language)}
                        </div>
                      </settings-row>
                    `:""}
              `:q`
        ...
        <div class="toggle-button">
          <mwc-button @click=${this._toggleYamlMode}>
            <ha-icon icon="hass:shuffle-variant"></ha-icon>
            ${this.viewMode==Zs.Yaml?pi("components.editor.ui_mode",this.hass.language):pi("components.editor.yaml_mode",this.hass.language)}
          </mwc-button>
        </div>
      ...
      <ha-card>
        <div class="card-content">
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${pi("panels.actions.cards.new_action.fields.name.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${pi("panels.actions.cards.new_action.fields.name.description",this.hass.language)}
            </span>

            <ha-textfield
              label="${pi("panels.actions.cards.new_action.fields.name.heading",this.hass.language)}"
              .placeholder=${this._namePlaceholder()}
              .value=${this.config.name||""}
              @input=${this._setName}
              ?invalid=${this.errors.name}
    ...
    `:q``}renderActions(){let e=this.config.actions.map(e=>e.entity_id),t=Is(e,this.hass);if(!t.length)return;return t.map(e=>q`
        <mwc-button
          class="${((...e)=>!!e.every(Si)&&1==Oi(Rs(e.filter(Si))).length)(this._selectedAction(),e)?"active":""}"
    ...
    `}};t([oe({attribute:!1})],Js.prototype,"hass",void 0),t([oe()],Js.prototype,"narrow",void 0),t([oe()],Js.prototype,"config",void 0),t([oe()],Js.prototype,"item",void 0),t([oe()],Js.prototype,"areas",void 0),t([oe()],Js.prototype,"alarmoConfig",void 0),t([oe()],Js.prototype,"viewMode",void 0),t([oe()],Js.prototype,"errors",void 0),Js=t([ne("automation-editor-card")],Js);let en=class extends(Je(se)){constructor(){super(...arguments),this.areas={},this.getAreaForAutomation=e=>{if(!this.config)return;const t=Ls(this.areas,this.config);let a=e.triggers[0].area;return Si(a)&&t.includes(a)?a:void 0}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await Ve(this.hass);this.automations=Object.values(e),this.areas=await Xe(this.hass),this.config=await Ue(this.hass)}firstUpdated(){var e;this.path.filter&&(this.selectedArea=null===(e=this.path.filter)||void 0===e?void 0:e.area),(async()=>{await Re()})()}render(){if(!this.hass||!this.automations||!this.config)return q``;if("new_notification"==this.path.subpage)return q`
        <notification-editor-card .hass=${this.hass} .narrow=${this.narrow}></notification-editor-card>
      `;if(this.path.params.edit_notification){const e=this.automations.find(e=>e.automation_id==this.path.params.edit_notification&&e.type==yi.Notification);return q`
      ...
      `;if(this.path.params.edit_action){const e=this.automations.find(e=>e.automation_id==this.path.params.edit_action&&e.type==yi.Action);return q`
        <automation-editor-card .hass=${this.hass} .narrow=${this.narrow} .item=${e}></automation-editor-card>
      `}{const e=()=>q`
        <paper-tooltip animation-delay="0">
          ${pi("panels.actions.cards.notifications.table.no_area_warning",this.hass.language)}
        </paper-tooltip>
      `,t={type:{width:"40px",renderer:t=>"no_area"!=t.area||this.config.master.enabled?t.type==yi.Notification?q`
        ...
        <ha-card header="${pi("panels.actions.cards.notifications.title",this.hass.language)}">
          ...
          <alarmo-table
            ...
            .data=${a}
            .filters=${this.getTableFilterOptions()}
            @row-click=${e=>Pe(0,Ii("actions",{params:{edit_notification:e.detail.id}}),!0)}
          >
            ${pi("panels.actions.cards.notifications.table.no_items",this.hass.language)}
          </alarmo-table>

          <div class="card-actions">
            <mwc-button @click=${this.addNotificationClick}>
              ${pi("panels.actions.cards.notifications.actions.new_notification",this.hass.language)}
            </mwc-button>
          </div>
        </ha-card>

        <ha-card header="${pi("panels.actions.title",this.hass.language)}">
          <div class="card-content">${pi("panels.actions.cards.actions.description",this.hass.language)}</div>
        ...
        <app-header fixed slot="header">
          ...
          >
            ...
            <paper-tab page-name="sensors">
              ${pi("panels.sensors.title",this.hass.language)}
            </paper-tab>
            <paper-tab page-name="codes">
              ${pi("panels.codes.title",this.hass.language)}
            </paper-tab>
            <paper-tab page-name="actions">
              ${pi("panels.actions.title",this.hass.language)}
            </paper-tab>
          </ha-tabs>
        </app-header>
      </ha-app-layout>
    ...
    `}getView(e){switch(e.page){case"general":return q`
        ...
        `}}handlePageSelected(e){const t=e.detail.item.getAttribute("page-name");t!==Ri()?(Pe(0,Ii(t)),this.requestUpdate()):scrollTo(0,0)}static get styles(){return o`
      ${zi} :host {
        color: var(--primary-text-color);
