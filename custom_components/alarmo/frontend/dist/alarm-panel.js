 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const T=globalThis,E=T.trustedTypes,S=E?E.createPolicy("lit-html",{createHTML:e=>e}):void 0,C="$lit$",O=`lit$${Math.random().toFixed(9).slice(2)}$`,M="?"+O,x=`<${M}>`,N=document,L=()=>N.createComment(""),H=e=>null===e||"object"!=typeof e&&"function"!=typeof e,D=Array.isArray,P="[ \t\n\f\r]",B=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,q=/-->/g,V=/>/g,I=RegExp(`>|${P}(?:([^\\s"'>=/]+)(${P}*=${P}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),R=/'/g,U=/"/g,G=/^(?:script|style|textarea|title)$/i,K=(e=>(a,...t)=>({_$litType$:e,strings:a,values:t}))(1),F=Symbol.for("lit-noChange"),Z=Symbol.for("lit-nothing"),Q=new WeakMap,Y=N.createTreeWalker(N,129);function W(e,a){if(!D(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==S?S.createHTML(a):a}const X=(e,a)=>{const t=e.length-1,i=[];let n,s=2===a?"<svg>":3===a?"<math>":"",r=B;for(let a=0;a<t;a++){const t=e[a];let o,d,l=-1,c=0;for(;c<t.length&&(r.lastIndex=c,d=r.exec(t),null!==d);)c=r.lastIndex,r===B?"!--"===d[1]?r=q:void 0!==d[1]?r=V:void 0!==d[2]?(G.test(d[2])&&(n=RegExp("</"+d[2],"g")),r=I):void 0!==d[3]&&(r=I):r===I?">"===d[0]?(r=n??B,l=-1):void 0===d[1]?l=-2:(l=r.lastIndex-d[2].length,o=d[1],r=void 0===d[3]?I:'"'===d[3]?U:R):r===U||r===R?r=I:r===q||r===V?r=B:(r=I,n=void 0);const m=r===I&&e[a+1].startsWith("/>")?" ":"";s+=r===B?t+x:l>=0?(i.push(o),t.slice(0,l)+C+t.slice(l)+O+m):t+O+(-2===l?a:m)}return[W(e,s+(e[t]||"<?>")+(2===a?"</svg>":3===a?"</math>":"")),i]};class J{constructor({strings:e,_$litType$:a},t){let i;this.parts=[];let n=0,s=0;const r=e.length-1,o=this.parts,[d,l]=X(e,a);if(this.el=J.createElement(d,t),Y.currentNode=this.el.content,2===a||3===a){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(i=Y.nextNode())&&o.length<r;){if(1===i.nodeType){if(i.hasAttributes())for(const e of i.getAttributeNames())if(e.endsWith(C)){const a=l[s++],t=i.getAttribute(e).split(O),r=/([.?@])?(.*)/.exec(a);o.push({type:1,index:n,name:r[2],strings:t,ctor:"."===r[1]?ne:"?"===r[1]?se:"@"===r[1]?re:ie}),i.removeAttribute(e)}else e.startsWith(O)&&(o.push({type:6,index:n}),i.removeAttribute(e));if(G.test(i.tagName)){const e=i.textContent.split(O),a=e.length-1;if(a>0){i.textContent=E?E.emptyScript:"";for(let t=0;t<a;t++)i.append(e[t],L()),Y.nextNode(),o.push({type:2,index:++n});i.append(e[a],L())}}}else if(8===i.nodeType)if(i.data===M)o.push({type:2,index:n});else{let e=-1;for(;-1!==(e=i.data.indexOf(O,e+1));)o.push({type:7,index:n}),e+=O.length-1}n++}}static createElement(e,a){const t=N.createElement("template");return t.innerHTML=e,t}}function ee(e,a,t=e,i){if(a===F)return a;let n=void 0!==i?t._$Co?.[i]:t._$Cl;const s=H(a)?void 0:a._$litDirective$;return n?.constructor!==s&&(n?._$AO?.(!1),void 0===s?n=void 0:(n=new s(e),n._$AT(e,t,i)),void 0!==i?(t._$Co??=[])[i]=n:t._$Cl=n),void 0!==n&&(a=ee(e,n._$AS(e,a.values),n,i)),a}class ae{constructor(e,a){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=a}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:a},parts:t}=this._$AD,i=(e?.creationScope??N).importNode(a,!0);Y.currentNode=i;let n=Y.nextNode(),s=0,r=0,o=t[0];for(;void 0!==o;){if(s===o.index){let a;2===o.type?a=new te(n,n.nextSibling,this,e):1===o.type?a=new o.ctor(n,o.name,o.strings,this,e):6===o.type&&(a=new oe(n,this,e)),this._$AV.push(a),o=t[++r]}s!==o?.index&&(n=Y.nextNode(),s++)}return Y.currentNode=N,i}p(e){let a=0;for(const t of this._$AV)void 0!==t&&(void 0!==t.strings?(t._$AI(e,t,a),a+=t.strings.length-2):t._$AI(e[a])),a++}}class te{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,a,t,i){this.type=2,this._$AH=Z,this._$AN=void 0,this._$AA=e,this._$AB=a,this._$AM=t,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const a=this._$AM;return void 0!==a&&11===e?.nodeType&&(e=a.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,a=this){e=ee(this,e,a),H(e)?e===Z||null==e||""===e?(this._$AH!==Z&&this._$AR(),this._$AH=Z):e!==this._$AH&&e!==F&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>D(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==Z&&H(this._$AH)?this._$AA.nextSibling.data=e:this.T(N.createTextNode(e)),this._$AH=e}$(e){const{values:a,_$litType$:t}=e,i="number"==typeof t?this._$AC(e):(void 0===t.el&&(t.el=J.createElement(W(t.h,t.h[0]),this.options)),t);if(this._$AH?._$AD===i)this._$AH.p(a);else{const e=new ae(i,this),t=e.u(this.options);e.p(a),this.T(t),this._$AH=e}}_$AC(e){let a=Q.get(e.strings);return void 0===a&&Q.set(e.strings,a=new J(e)),a}k(e){D(this._$AH)||(this._$AH=[],this._$AR());const a=this._$AH;let t,i=0;for(const n of e)i===a.length?a.push(t=new te(this.O(L()),this.O(L()),this,this.options)):t=a[i],t._$AI(n),i++;i<a.length&&(this._$AR(t&&t._$AB.nextSibling,i),a.length=i)}_$AR(e=this._$AA.nextSibling,a){for(this._$AP?.(!1,!0,a);e!==this._$AB;){const a=e.nextSibling;e.remove(),e=a}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class ie{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,a,t,i,n){this.type=1,this._$AH=Z,this._$AN=void 0,this.element=e,this.name=a,this._$AM=i,this.options=n,t.length>2||""!==t[0]||""!==t[1]?(this._$AH=Array(t.length-1).fill(new String),this.strings=t):this._$AH=Z}_$AI(e,a=this,t,i){const n=this.strings;let s=!1;if(void 0===n)e=ee(this,e,a,0),s=!H(e)||e!==this._$AH&&e!==F,s&&(this._$AH=e);else{const i=e;let r,o;for(e=n[0],r=0;r<n.length-1;r++)o=ee(this,i[t+r],a,r),o===F&&(o=this._$AH[r]),s||=!H(o)||o!==this._$AH[r],o===Z?e=Z:e!==Z&&(e+=(o??"")+n[r+1]),this._$AH[r]=o}s&&!i&&this.j(e)}j(e){e===Z?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ne extends ie{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===Z?void 0:e}}class se extends ie{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==Z)}}class re extends ie{constructor(e,a,t,i,n){super(e,a,t,i,n),this.type=5}_$AI(e,a=this){if((e=ee(this,e,a,0)??Z)===F)return;const t=this._$AH,i=e===Z&&t!==Z||e.capture!==t.capture||e.once!==t.once||e.passive!==t.passive,n=e!==Z&&(t===Z||i);i&&this.element.removeEventListener(this.name,this,t),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class oe{constructor(e,a,t){this.element=e,this.type=6,this._$AN=void 0,this._$AM=a,this.options=t}get _$AU(){return this._$AM._$AU}_$AI(e){ee(this,e)}}const de=T.litHtmlPolyfillSupport;de?.(J,te),(T.litHtmlVersions??=[]).push("3.3.1");const le=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ue(e){return(a,t)=>"object"==typeof t?ge(e,a,t):((e,a,t)=>{const i=a.hasOwnProperty(t);return a.constructor.createProperty(t,e),i?Object.getOwnPropertyDescriptor(a,t):void 0})(e,a,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,bs=()=>{const e=e=>{let a={};for(var t=0;t<e.length;t+=2){const i=e[t],n=t<e.length?e[t+1]:void 0;a=Object.assign(Object.assign({},a),{[i]:n})}return a},a=window.location.pathname.split("/");let t={page:a[2]||"general",params:{}};if(a.length>3){let i=a.slice(3);if(a.includes("filter")){const a=i.findIndex(e=>"filter"==e),n=i.slice(a+1);i=i.slice(0,a),t=Object.assign(Object.assign({},t),{filter:e(n)})}i.length&&(i.length%2&&(t=Object.assign(Object.assign({},t),{subpage:i.shift()})),i.length&&(t=Object.assign(Object.assign({},t),{params:e(i)})))}return t},fs=(e,...a)=>{let t={page:e,params:{}};a.forEach(e=>{"string"==typeof e?t=Object.assign(Object.assign({},t),{subpage:e}):"params"in e?t=Object.assign(Object.assign({},t),{params:e.params}):"filter"in e&&(t=Object.assign(Object.assign({},t),{filter:e.filter}))});const i=e=>{let a=Object.keys(e);a=a.filter(a=>e[a]),a.sort();let t="";return a.forEach(a=>{let i=e[a];t=t.length?`${t}/${a}/${i}`:`${a}/${i}`}),t};let n=`/alarmo/${t.page}`;return t.subpage&&(n=`${n}/${t.subpage}`),i(t.params).length&&(n=`${n}/${i(t.params)}`),t.filter&&(n=`${n}/filter/${i(t.filter)}`),n},ys=60;let ks=class extends ce{constructor(){super(...arguments),this.min=0,this.max=300,this.value=0,this.step=15,this.disabled=!1,this.showArrows=!0,this.required=!1}render(){return K`
      <div class="wrapper">
        ...
        <div class="column">
          ...
          <span class="label">${zn("components.time_picker.minutes",this.hass.language)}</span>
        </div>
        <div class="column">
          <ha-input
            id="seconds"
          ...
          <span class="label">${zn("components.time_picker.seconds",this.hass.language)}</span>
        </div>
        ${this.showArrows?K`
        <div class="column">
          <wa-button
    ...
    `}_getMinutes(){return Math.floor(this.value/ys)}_getSeconds(){return this.value%ys}_minutesChanged(e){let a=Number(e.target.value),t=a*ys+this._getSeconds();t<this.min&&(t=this.min,a=Math.floor(t/ys),e.target.value=String(a)),t>this.max&&(t=this.max,a=Math.floor(t/ys),e.target.value=String(a)),this.value=t,this._valueChanged()}_secondsChanged(e){let a=Number(e.target.value);a>=ys&&(a=59,e.target.value=String(a));let t=this._getMinutes()*ys+a;t<this.min&&(t=this.min,a=this.value%ys,e.target.value=String(a)),t>this.max&&(t=this.max,a=this.value%ys,e.target.value=String(a)),this.value=t,this._valueChanged()}_validateMinutesInput(e,a){let t=null!==e.match(/^[0-9]+$/);return{valid:t,customError:!t}}_validateSecondsInput(e,a){let t=null!==e.match(/^[0-9]+$/);return{valid:t,customError:!t}}_secondsUpClick(){let e=Math.round(this.value/this.step)*this.step;e+=this.step,e>this.max&&(e=this.max),this.value=e,this._valueChanged()}_secondsDownClick(){let e=Math.round(this.value/this.step)*this.step;e-=this.step,e<this.min&&(e=this.min),this.value=e,this._valueChanged()}_toggleEnableClick(e){const a=e.target.checked;this.disabled=!a,e.target.blur(),this._valueChanged()}_onFocus(e){e.currentTarget.select()}_valueChanged(){let e=this.disabled?null:this.value;Xn(this,"value-changed",{value:e})}};ks.styles=c`
    :host {
      display: flex;
      padding: 8px 0px;
    }
  ...
  `,i([ue({attribute:!1})],ks.prototype,"hass",void 0),i([ue({type:Number})],ks.prototype,"min",void 0),i([ue({type:Number})],ks.prototype,"max",void 0),i([ue({type:Number})],ks.prototype,"value",void 0),i([ue({type:Number})],ks.prototype,"step",void 0),i([ue({type:Boolean})],ks.prototype,"disabled",void 0),i([ue({type:Boolean})],ks.prototype,"showArrows",void 0),i([ue({type:String})],ks.prototype,"placeholder",void 0),i([ue({type:Boolean})],ks.prototype,"required",void 0),ks=i([he("alarmo-duration-picker")],ks);const ws=[{name:"primary",weight:10},{name:"secondary",weight:8}];let zs=class extends ce{constructor(){super(...arguments),this.label="",this.items=[],this.disabled=!1,this.showSearch=!1,this.clearable=!1,this.invalid=!1,this._valueRenderer=e=>{const a=this.items.find(a=>a.value===e);return K`
   ...
   `;{const e=this.items.map(e=>({value:e.value,label:e.name,secondary:e.description,iconPath:e.icon}));return K`
    ...
    `)}_selectChanged(e){e.stopPropagation(),this.value=e.detail.value,Xn(this,"value-changed",{value:this.value})}_pickerChanged(e){e.stopPropagation(),this.value=e.detail.value,Xn(this,"value-changed",{value:this.value})}clearValue(){if(this.showSearch){const e=this.shadowRoot.querySelector("ha-generic-picker");this.value="",e.blur()}else{const e=this.shadowRoot.querySelector("ha-select");this.value=void 0,setTimeout(()=>{e.blur()},50)}}};zs.styles=c`
    ha-select {
      width: 100%;
    }
    .mdc-floating-label {
  ...
  `,i([ue()],zs.prototype,"hass",void 0),i([ue()],zs.prototype,"label",void 0),i([ue()],zs.prototype,"items",void 0),i([ue({type:String,reflect:!0})],zs.prototype,"value",void 0),i([ue({type:Boolean,reflect:!0})],zs.prototype,"disabled",void 0),i([ue()],zs.prototype,"helper",void 0),i([ue({type:Boolean})],zs.prototype,"showSearch",void 0),i([ue({type:Boolean})],zs.prototype,"clearable",void 0),i([ue({type:Boolean})],zs.prototype,"invalid",void 0),i([_e("ha-input")],zs.prototype,"_menu",void 0),zs=i([he("alarmo-select")],zs);let As=class extends ce{static get styles(){return c`
      :host {
        display: block;
      }
    `}render(){return K`
      <slot></slot>
    `}constructor(){super(),this.addEventListener("clickHeader",this.manageSpoilers)}manageSpoilers(e){const a=e.target;a.getAttribute("active")?a.removeAttribute("active"):a.setAttribute("active","true"),this.querySelectorAll("alarmo-collapsible-header[active]").forEach(function(e){e!==a&&e.removeAttribute("active")})}};As=i([he("alarmo-collapsible-group")],As);let js=class extends ce{static get styles(){return c`
      :host {
        display: block;
      }
    `}render(){return K`
      <slot></slot>
    `}};js=i([he("alarmo-collapsible-item")],js);let $s=class extends ce{constructor(){super(),this.clickHeader=new CustomEvent("clickHeader",{detail:{message:"clickHeader happened."},bubbles:!0,composed:!0}),this.active=!1,this.addEventListener("click",this.handleClick)}handleClick(){this.dispatchEvent(this.clickHeader)}render(){return K`
    ...
    `}};Ts=i([he("alarmo-collapsible-body")],Ts);let Es=class extends(Me(ce)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Ce(this.hass),this.sensors=await ke(this.hass))}async firstUpdated(){await this._fetchData(),this.selectedArea=Object.keys(this.areas)[0],this.data=Object.assign({},this.areas[this.selectedArea].modes)}render(){return this.data?K`
      <ha-card>
        ...
        <alarmo-collapsible-group>
          ${Object.entries(Yn).map(([e,a])=>{var t;return K`
                <alarmo-collapsible-item>
                  <alarmo-collapsible-header>
                    <ha-svg-icon slot="icon" .path=${Rn[e]}></ha-svg-icon>
                    <span slot="title">
                    ...
                    <span slot="description">
                      ${(null===(t=this.data[a])||void 0===t?void 0:t.enabled)?K`
                            ${zn("common.enabled",this.hass.language)},
                            <a href="${fs("sensors",{filter:{area:this.selectedArea,mode:a}})}">
                              ${zn("panels.general.cards.modes.number_sensors_active",this.hass.language,"number",this.getSensorsByMode(a))}
                            </a>
                          `:zn("common.disabled",this.hass.language)}
                    </span>
                  </alarmo-collapsible-header>
    ...
    `:K``}getSensorsByMode(e){return Object.values(this.sensors).filter(a=>a.area==this.selectedArea&&(a.modes.includes(e)||a.always_on)).length}renderModeConfig(e){const a=e in this.data?this.data[e]:void 0;return K`
      ...
      <alarmo-settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${zn("panels.general.cards.modes.fields.status.heading",this.hass.language)}
        </span>
        <span slot="description">
          ${zn("panels.general.cards.modes.fields.status.description",this.hass.language)}
        </span>
        <div>
          <ha-button
      ...
      <alarmo-settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${zn("panels.general.cards.modes.fields.exit_delay.heading",this.hass.language)}
        </span>
        <span slot="description">
          ${zn("panels.general.cards.modes.fields.exit_delay.description",this.hass.language)}
        </span>
        <alarmo-duration-picker
          ...
          ?disabled=${!(null==a?void 0:a.enabled)||!ss(null==a?void 0:a.exit_time)}
        ></alarmo-duration-picker>
      </alarmo-settings-row>
      <alarmo-settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${zn("panels.general.cards.modes.fields.entry_delay.heading",this.hass.language)}
        </span>
        <span slot="description">
          ${zn("panels.general.cards.modes.fields.entry_delay.description",this.hass.language)}
        </span>
        <alarmo-duration-picker
          .hass=${this.hass}
          max="300"
          ...
          ?disabled=${!(null==a?void 0:a.enabled)||!ss(null==a?void 0:a.entry_time)}
        ></alarmo-duration-picker>
      </alarmo-settings-row>
      <alarmo-settings-row .narrow=${this.narrow}>
        <span slot="heading">
          ${zn("panels.general.cards.modes.fields.trigger_time.heading",this.hass.language)}
        </span>
        <span slot="description">
          ${zn("panels.general.cards.modes.fields.trigger_time.description",this.hass.language)}
        </span>
        <alarmo-duration-picker
          .hass=${this.hass}
          max="3600"
          ...
          ?disabled=${!(null==a?void 0:a.enabled)||!ss(null==a?void 0:a.trigger_time)}
        ></alarmo-duration-picker>
      </alarmo-settings-row>
    `}selectArea(e){e!=this.selectedArea&&(this.selectedArea=e,this.data=Object.assign({},this.areas[e].modes))}saveClick(e){Oe(this.hass,{area_id:this.selectedArea,modes:this.data}).catch(a=>ds(a,e)).then()}saveData(e,a,t){this.data=Object.assign(Object.assign({},this.data),{[a]:Object.assign(Object.assign({},this.data[a]||{enabled:!1,exit_time:0,entry_time:0,trigger_time:0}),t)}),Oe(this.hass,{area_id:this.selectedArea,modes:this.data}).catch(a=>ds(a,e.target)).then()}static get styles(){return c`
      ${vs}
    ...
    `}};i([ue()],Es.prototype,"hass",void 0),i([ue({type:Boolean})],Es.prototype,"narrow",void 0),i([ue()],Es.prototype,"config",void 0),i([ue()],Es.prototype,"areas",void 0),i([ue()],Es.prototype,"sensors",void 0),i([ue()],Es.prototype,"data",void 0),i([ue()],Es.prototype,"selectedArea",void 0),Es=i([he("alarm-mode-card")],Es);let Ss=class extends ce{constructor(){super(...arguments),this.threeLine=!1}render(){return K`
      <div class="info">
    ...
    `}};i([ue({type:Boolean,reflect:!0})],Ss.prototype,"narrow",void 0),i([ue({type:Boolean,reflect:!0})],Ss.prototype,"large",void 0),i([ue({type:Boolean,attribute:"three-line"})],Ss.prototype,"threeLine",void 0),i([ue({type:Boolean})],Ss.prototype,"nested",void 0),i([ue({type:Boolean})],Ss.prototype,"dialog",void 0),Ss=i([he("alarmo-settings-row")],Ss);let Cs=class extends ce{constructor(){super(...arguments),this.header="",this.open=!1}render(){return K`
      ${this.open?K`
          ...
          `:K`
            <div class="header">
              ...
              <ha-icon-button .path=${Tn} @click=${()=>{this.open=!0}}>
              </ha-icon-button>
            </div>
          `}
    `}static get styles(){return c`
    ...
    `}};i([ue({type:Boolean,reflect:!0})],Cs.prototype,"narrow",void 0),i([ue()],Cs.prototype,"header",void 0),i([ue()],Cs.prototype,"open",void 0),Cs=i([he("alarmo-collapsible-section")],Cs);let Os=class extends(Me(ce)){constructor(){super(...arguments),this.areas={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await ye(this.hass);this.config=e,this.areas=await Ce(this.hass),this.selection=e.mqtt}firstUpdated(){(async()=>{await be()})()}render(){return this.hass&&this.selection?K`
      <ha-card>
        <div class="card-header">
          <div class="name">${zn("panels.general.cards.mqtt.title",this.hass.language)}</div>
          <ha-icon-button .path=${En} @click=${this.cancelClick}></ha-icon-button>
        </div>
        <div class="card-content">${zn("panels.general.cards.mqtt.description",this.hass.language)}</div>

        <alarmo-settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${zn("panels.general.cards.mqtt.fields.state_topic.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${zn("panels.general.cards.mqtt.fields.state_topic.description",this.hass.language)}
          </span>
          <ha-input
            label="${zn("panels.general.cards.mqtt.fields.state_topic.heading",this.hass.language)}"
        ...
        <alarmo-collapsible-section
          .narrow=${this.narrow}
          header=${zn("panels.general.cards.mqtt.fields.state_payload.heading",this.hass.language)}
        >
          ${Object.values(Un).filter(e=>Object.values(this.areas).some(a=>ls(e,a.modes))).map(e=>K`
                <alarmo-settings-row .narrow=${this.narrow}>
                  <span slot="heading">${Jn(e)}</span>
                  <span slot="description">
                    ${zn("panels.general.cards.mqtt.fields.state_payload.item",this.hass.language,"{state}",Jn(e))}
                  </span>
                  <ha-input
                    label=${Jn(e)}
                    placeholder=${e}
                    value=${this.selection.state_payload[e]||""}
                    @change=${a=>{this.selection=cs(this.selection,{state_payload:{[e]:a.target.value}})}}
                  ></ha-input>
                </alarmo-settings-row>
              `)}
        </alarmo-collapsible-section>
        ...
        <alarmo-settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${zn("panels.general.cards.mqtt.fields.event_topic.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${zn("panels.general.cards.mqtt.fields.event_topic.description",this.hass.language)}
          </span>
          <ha-input
            label="${zn("panels.general.cards.mqtt.fields.event_topic.heading",this.hass.language)}"
        ...
        <alarmo-settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${zn("panels.general.cards.mqtt.fields.command_topic.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${zn("panels.general.cards.mqtt.fields.command_topic.description",this.hass.language)}
          </span>
          <ha-input
            label="${zn("panels.general.cards.mqtt.fields.command_topic.heading",this.hass.language)}"
        ...
        <alarmo-collapsible-section
          .narrow=${this.narrow}
          header=${zn("panels.general.cards.mqtt.fields.command_payload.heading",this.hass.language)}
        >
          ${Object.values(Gn).filter(e=>Object.values(this.areas).some(a=>ls((e=>{switch(e){case Gn.COMMAND_ALARM_DISARM:return Un.STATE_ALARM_DISARMED;case Gn.COMMAND_ALARM_ARM_HOME:return Un.STATE_ALARM_ARMED_HOME;case Gn.COMMAND_ALARM_ARM_AWAY:return Un.STATE_ALARM_ARMED_AWAY;case Gn.COMMAND_ALARM_ARM_NIGHT:return Un.STATE_ALARM_ARMED_NIGHT;case Gn.COMMAND_ALARM_ARM_CUSTOM_BYPASS:return Un.STATE_ALARM_ARMED_CUSTOM_BYPASS;case Gn.COMMAND_ALARM_ARM_VACATION:return Un.STATE_ALARM_ARMED_VACATION;default:return}})(e),a.modes))).map(e=>K`
                <alarmo-settings-row .narrow=${this.narrow}>
                  <span slot="heading">${Jn(e)}</span>
                  <span slot="description">
                    ${zn("panels.general.cards.mqtt.fields.command_payload.item",this.hass.language,"{command}",Jn(e))}
                  </span>
                  <ha-input
                    label=${Jn(e)}
                    placeholder=${e}
                    value=${this.selection.command_payload[e]||""}
                    @change=${a=>{this.selection=cs(this.selection,{command_payload:{[e]:a.target.value}})}}
                  ></ha-input>
                </alarmo-settings-row>
              `)}
        </alarmo-collapsible-section>
        ...
        <alarmo-settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${zn("panels.general.cards.mqtt.fields.require_code.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${zn("panels.general.cards.mqtt.fields.require_code.description",this.hass.language)}
          </span>
          <ha-switch
    ...
    `:K``}saveClick(e){this.hass&&je(this.hass,{mqtt:Object.assign(Object.assign({},this.selection),{enabled:!0})}).catch(a=>ds(a,e)).then(()=>{this.cancelClick()})}cancelClick(){hs(0,fs("general"),!0)}};Os.styles=vs,i([ue()],Os.prototype,"narrow",void 0),i([ue()],Os.prototype,"config",void 0),i([ue()],Os.prototype,"areas",void 0),i([ue()],Os.prototype,"selection",void 0),Os=i([he("mqtt-config-card")],Os);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ms=2;class xs{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,a,t){this._$Ct=e,this._$AM=a,this._$Ci=t}_$AS(e,a){return this.update(e,a)}update(e,a){return this.render(...a)}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ns extends xs{constructor(e){if(super(e),this.it=Z,e.type!==Ms)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===Z||null==e)return this._t=void 0,this.it=e;if(e===F)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const a=[e];return a.raw=a,this._t={_$litType$:this.constructor.resultType,strings:a,values:[]}}}Ns.directiveName="unsafeHTML",Ns.resultType=1;const Ls=(e=>(...a)=>({_$litDirective$:e,values:a}))(Ns);let Hs=class extends ce{constructor(){super(...arguments),this.active=!1}render(){return K`
    ...
    `}};i([ue({attribute:!1})],Hs.prototype,"hass",void 0),i([ue({type:String})],Hs.prototype,"icon",void 0),i([ue({type:Boolean})],Hs.prototype,"selectable",void 0),i([ue({type:Boolean})],Hs.prototype,"removable",void 0),i([ue({type:Boolean})],Hs.prototype,"toggleable",void 0),i([ue({type:Boolean})],Hs.prototype,"active",void 0),i([ue({type:String})],Hs.prototype,"badge",void 0),i([ue({type:String})],Hs.prototype,"value",void 0),Hs=i([he("alarmo-chip")],Hs);let Ds=class extends ce{constructor(){super(...arguments),this.value=[]}render(){return this.items?K`
    ...
    `}};i([ue({attribute:!1})],Ds.prototype,"hass",void 0),i([ue({attribute:!1})],Ds.prototype,"items",void 0),i([ue({attribute:!1})],Ds.prototype,"value",void 0),i([ue({type:Boolean})],Ds.prototype,"selectable",void 0),i([ue({type:Boolean})],Ds.prototype,"toggleable",void 0),i([ue({type:Boolean})],Ds.prototype,"removable",void 0),Ds=i([he("alarmo-chip-set")],Ds);let Ps=class extends ce{set filters(e){this.filterConfig||(this.filterConfig=e)}shouldUpdate(e){return e.get("filters")&&!this.filterConfig&&(this.filterConfig=e.get("filters")),!0}render(){if(!this.columns||!this.data)return K``;const e=this.data.filter(e=>this.filterTableData(e,this.filterConfig));return K`
      ...
      <div class="table-filter">
        ...
        >
          <ha-icon-button
            ...
            label=${zn("components.table.filter.label",this.hass.language)}
          ></ha-icon-button>
        ...
        ${this._getFilteredItems()?K`
              ...
              >
                ${zn("components.table.filter.hidden_items",this.hass.language,"number",this._getFilteredItems())}
              </alarmo-chip>
            `:""}
      </div>
    `:K``}_showFilterMenu(){this.filterSelection=Object.entries(this.filterConfig).reduce((e,[a,t])=>Object.assign(Object.assign({},e),{[a]:is(t,["value"])}),{})}renderFilterMenu(){return this.filterConfig&&this.filterSelection?K`
      <span class="header">
        ${zn("components.table.filter.label",this.hass.language)}
      </span>
      <ha-icon-button
        class="close"
        .path=${En}
      ...
      ${Object.keys(this.filterConfig).map(e=>{if(this.filterConfig[e].binary)return K`
          ...
          `;let a=this.filterConfig[e].items;a=a.map(a=>{var t;return a.badge&&"function"==typeof a.badge?Object.assign(Object.assign({},a),{badge:a.badge(null===(t=this.data)||void 0===t?void 0:t.filter(a=>this.filterTableData(a,ns(this.filterSelection,e))))}):a});const t=this.filterSelection[e].value;return K`
  ...
  `,i([ue()],Ps.prototype,"hass",void 0),i([ue()],Ps.prototype,"columns",void 0),i([ue()],Ps.prototype,"data",void 0),i([ve()],Ps.prototype,"filterConfig",void 0),i([ve()],Ps.prototype,"filterSelection",void 0),i([ue({type:Boolean})],Ps.prototype,"selectable",void 0),i([_e("ha-dropdown")],Ps.prototype,"_menu",void 0),Ps=i([he("alarmo-table")],Ps);let Bs=class extends ce{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?K`
    ...
    `}};i([ue({attribute:!1})],Bs.prototype,"hass",void 0),i([ve()],Bs.prototype,"_params",void 0),Bs=i([he("confirm-delete-dialog")],Bs);var qs=Object.freeze({__proto__:null,get ConfirmDeleteDialog(){return Bs}});let Vs=class extends(Me(ce)){constructor(){super(...arguments),this.areas={},this.sensors={},this.automations={},this.name=""}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Ce(this.hass),this.sensors=await ke(this.hass),this.automations=await ze(this.hass))}async showDialog(e){await this._fetchData(),this._params=e,e.area_id&&(this.area_id=e.area_id,this.name=this.areas[this.area_id].name),await this.updateComplete}async closeDialog(){this._params=void 0,this.area_id=void 0,this.name=""}render(){return this._params?K`
      ...
      >
        ...
        <div class="wrapper">
          ...
          ${this.area_id?K`
                <span class="note">
                  ${zn("panels.general.dialogs.edit_area.name_warning",this.hass.language)}
                </span>
              `:""}
          ${this.area_id?"":K`
          <alarmo-select
            ...
            .items=${Object.values(this.areas).map(e=>Object({value:e.area_id,name:e.name}))}
            value=${this.selectedArea}
            label="${zn("panels.general.dialogs.create_area.fields.copy_from",this.hass.language)}"
            clearable=${!0}
    ...
    `}};i([ue({attribute:!1})],Vs.prototype,"hass",void 0),i([ve()],Vs.prototype,"_params",void 0),i([ue()],Vs.prototype,"areas",void 0),i([ue()],Vs.prototype,"sensors",void 0),i([ue()],Vs.prototype,"automations",void 0),i([ue()],Vs.prototype,"name",void 0),i([ue()],Vs.prototype,"area_id",void 0),i([ue()],Vs.prototype,"selectedArea",void 0),Vs=i([he("create-area-dialog")],Vs);var Is=Object.freeze({__proto__:null,get CreateAreaDialog(){return Vs}});let Rs=class extends(Me(ce)){constructor(){super(...arguments),this.areas={},this.sensors={},this.automations={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Ce(this.hass),this.sensors=await ke(this.hass),this.automations=await ze(this.hass))}render(){if(!this.hass)return K``;const e=Object.values(this.areas);e.sort(ms);const a={actions:{width:"48px"},name:{title:this.hass.localize("ui.common.name"),width:"40%",grow:!0,text:!0},remarks:{title:zn("panels.general.cards.areas.table.remarks",this.hass.language),width:"60%",hide:this.narrow,text:!0}},t=Object.values(e).map(a=>{const t=Object.values(this.sensors).filter(e=>e.area==a.area_id).length,i=1==Object.values(e).length?Object.values(this.automations).filter(e=>{var t,i;return(null===(t=e.triggers)||void 0===t?void 0:t.map(e=>e.area).includes(a.area_id))||!(null===(i=e.triggers)||void 0===i?void 0:i.map(e=>e.area).length)}).length:Object.values(this.automations).filter(e=>{var t;return null===(t=e.triggers)||void 0===t?void 0:t.map(e=>e.area).includes(a.area_id)}).length,n=`<a href="${fs("sensors",{filter:{area:a.area_id}})}">${zn("panels.general.cards.areas.table.summary_sensors",this.hass.language,"number",t)}</a>`,s=`<a href="${fs("actions",{filter:{area:a.area_id}})}">${zn("panels.general.cards.areas.table.summary_automations",this.hass.language,"number",i)}</a>`;return{id:a.area_id,actions:K`
        ...
        `,name:Jn(a.name),remarks:Ls(zn("panels.general.cards.areas.table.summary",this.hass.language,"summary_sensors",n,"summary_automations",s))}});return K`
      <ha-card header="${zn("panels.general.cards.areas.title",this.hass.language)}">
        <div class="card-content">
      ...
      >
        <ha-dialog-header slot="header">
          <ha-icon-button
            ...
            .path=${En}
          ></ha-icon-button>
          <div slot="title">${zn("panels.general.dialogs.edit_master.title",this.hass.language)}</div>
        </ha-dialog-header>
        <div class="wrapper">
          <ha-input
            label=${this.hass.localize("ui.common.name")}
            ...
            value="${this.name}"
          ></ha-input>
          <span class="note">${zn("panels.general.dialogs.edit_area.name_warning",this.hass.language)}</span>
        </div>
        <ha-dialog-footer slot="footer">
          <ha-button appearance="plain" slot="primaryAction" @click=${this.saveClick}>
            ${this.hass.localize("ui.common.save")}
    ...
    `}};i([ue({attribute:!1})],Us.prototype,"hass",void 0),i([ve()],Us.prototype,"_params",void 0),i([ue()],Us.prototype,"name",void 0),Us=i([he("edit-master-dialog")],Us);var Gs=Object.freeze({__proto__:null,get EditMasterDialog(){return Us}});let Ks=class extends(Me(ce)){constructor(){super(...arguments),this.areas={},this.automations={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.config=await ye(this.hass),this.areas=await Ce(this.hass),this.automations=await ze(this.hass),this.data=is(this.config,["trigger_time","disarm_after_trigger","ignore_blocking_sensors_after_trigger","mqtt","master"]))}firstUpdated(){(async()=>{await be()})()}render(){var e,a,t,i,n,s,r,o,d;return this.hass&&this.config&&this.data?"mqtt_configuration"==this.path.subpage?K`
      ...
      `:this.path.params.edit_area?K`
        ...
        ></area-editor-card>
      `:K`
        <ha-card header="${zn("panels.general.title",this.hass.language)}">
          <div class="card-content">
          ...
          <alarmo-settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${zn("panels.general.cards.general.fields.disarm_after_trigger.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.general.cards.general.fields.disarm_after_trigger.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          <alarmo-settings-row .narrow=${this.narrow} nested>
            <span slot="heading">
              ${zn("panels.general.cards.general.fields.ignore_blocking_sensors_after_trigger.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.general.cards.general.fields.ignore_blocking_sensors_after_trigger.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          <alarmo-settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${zn("panels.general.cards.general.fields.enable_mqtt.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.general.cards.general.fields.enable_mqtt.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          ${(null===(n=null===(i=this.data)||void 0===i?void 0:i.mqtt)||void 0===n?void 0:n.enabled)?K`
                <div style="padding: 0px 0px 16px 16px; margin-top: -8px">
                  <ha-button
                    appearance="filled"
                    @click=${()=>hs(0,fs("general","mqtt_configuration"),!0)}
                  >
                    ${zn("panels.general.cards.general.actions.setup_mqtt",this.hass.language)}
          ...
          ${Object.keys(this.areas).length>=2?K`
                <alarmo-settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${zn("panels.general.cards.general.fields.enable_master.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${zn("panels.general.cards.general.fields.enable_master.description",this.hass.language)}
                  </span>
                  <ha-switch
      ...
      >
        ...
        <div class="wrapper">
          <alarmo-settings-row dialog>
            <span slot="heading">
              ${zn("panels.sensors.dialogs.create_group.fields.name.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.sensors.dialogs.create_group.fields.name.description",this.hass.language)}
            </span>
            <ha-input
              label=${this.hass.localize("ui.common.name")}
          ...
          <alarmo-settings-row large dialog>
            <span slot="heading">
              ${zn("panels.sensors.dialogs.create_group.fields.sensors.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.sensors.dialogs.create_group.fields.sensors.description",this.hass.language)}
            </span>
            <div>
          ...
          <alarmo-settings-row dialog>
            <span slot="heading">
              ${zn("panels.sensors.dialogs.create_group.fields.timeout.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.sensors.dialogs.create_group.fields.timeout.description",this.hass.language)}
            </span>
            <alarmo-duration-picker
              .hass=${this.hass}
              min="10"
          ...
          <alarmo-settings-row dialog>
            <span slot="heading">
              ${zn("panels.sensors.dialogs.create_group.fields.event_count.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.sensors.dialogs.create_group.fields.event_count.description",this.hass.language)}
            </span>
            <alarmo-select
              .hass=${this.hass}
    ...
    `:K``}renderSensorOptions(){const e=Object.keys(this.sensors).filter(e=>!ss(this.sensors[e].group)||this.sensors[e].group===this.data.group_id).map(e=>{const a=this.hass.states[e],t=Object.entries(Kn).find(([,a])=>a==this.sensors[e].type)[0];return{value:e,name:Jn(es(a)),icon:Fn[t]}});return e.sort(ms),e.length?K`
      <alarmo-chip-set
        .hass=${this.hass}
        .items=${e}
      ...
      >
        <ha-dialog-header slot="header">
          <ha-icon-button
            ...
            .path=${En}
          ></ha-icon-button>
          <div slot="title">${zn("panels.sensors.dialogs.manage_groups.title",this.hass.language)}</div>
        </ha-dialog-header>
        <div class="wrapper">
          <div class="description">
    ...
    `}};i([ue({attribute:!1})],tr.prototype,"hass",void 0),i([ve()],tr.prototype,"_params",void 0),i([ue()],tr.prototype,"sensorGroups",void 0),i([ue()],tr.prototype,"sensors",void 0),tr=i([he("manage-sensor-groups-dialog")],tr);var ir=Object.freeze({__proto__:null,get ManageSensorGroupsDialog(){return tr}});let nr=class extends(Me(ce)){constructor(){super(...arguments),this.showBypassModes=!1,this.sensorsList=[],this.entityIdUnlocked=!1}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){var e;if(!this.hass)return;const a=await Ce(this.hass);this.areas=a;const t=await Ae(this.hass);this.sensorGroups=t;const i=await ke(this.hass);this.data=Object.keys(i).includes(this.item)?i[this.item]:void 0,this.data&&!(null===(e=this.data)||void 0===e?void 0:e.area)&&1==Object.keys(a).length&&(this.data=Object.assign(Object.assign({},this.data),{area:Object.keys(this.areas)[0]}));let n=Ys(this.hass,Object.keys(i),!0);this.sensorsList=n.map(e=>Object(Object.assign(Object.assign({},e),{description:e.id,value:e.id}))),this.hass.states[this.item]||(this.entityIdUnlocked=!0)}render(){if(!this.data)return K``;let e=[...this.sensorsList];return e.find(e=>e.value==this.data.entity_id)||(e=[{value:this.data.entity_id,description:this.data.entity_id,name:es(this.hass.states[this.item]),icon:Ws(this.hass.states[this.item])},...e]),this.hass.states[this.data.entity_id],K`
      <ha-card>
        <div class="card-header">
          <div class="name">${zn("panels.sensors.cards.editor.title",this.hass.language)}</div>
          <ha-icon-button .path=${En} @click=${this.cancelClick}></ha-icon-button>
        </div>
        <div class="card-content">
        ...
        <alarmo-settings-row .narrow=${this.narrow} .large=${!0}>
          <span slot="heading">
            ${zn("panels.sensors.cards.editor.fields.entity.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${zn("panels.sensors.cards.editor.fields.entity.description",this.hass.language)}
          </span>
          ...
          <div style="display: flex; flex-direction: row">
            <alarmo-select
              ...
              label="${zn("panels.sensors.cards.editor.fields.entity.heading",this.hass.language)}"
            ...
            <ha-icon-button
              .path=${this.entityIdUnlocked?Ln:Hn}
        ...
        ${Object.keys(this.areas).length>1?K`
              <alarmo-settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${zn("panels.sensors.cards.editor.fields.area.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${zn("panels.sensors.cards.editor.fields.area.description",this.hass.language)}
                </span>
                ...
                <alarmo-select
                  ...
                  label=${zn("panels.sensors.cards.editor.fields.area.heading",this.hass.language)}
        ...
        <alarmo-settings-row .narrow=${this.narrow} .large=${!0}>
          <span slot="heading">
            ${zn("panels.sensors.cards.editor.fields.device_type.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${zn("panels.sensors.cards.editor.fields.device_type.description",this.hass.language)}
          </span>

          <alarmo-select
            .hass=${this.hass}
            .items=${a=this.hass,Object.entries(Kn).filter(([,e])=>e!=Kn.Other).map(([e,t])=>Object({value:t,name:zn(`panels.sensors.cards.editor.fields.device_type.choose.${t}.name`,a.language),description:zn(`panels.sensors.cards.editor.fields.device_type.choose.${t}.description`,a.language),icon:Fn[e]}))}
            label=${zn("panels.sensors.cards.editor.fields.device_type.heading",this.hass.language)}
            clearable=${!0}
            icons=${!0}
        ...
        <alarmo-settings-row .narrow=${this.narrow} .large=${this.modesByArea(this.data.area).length>3}>
          <span slot="heading">
            ${zn("panels.sensors.cards.editor.fields.modes.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${zn("panels.sensors.cards.editor.fields.modes.description",this.hass.language)}
          </span>
          ...
          <div>
            ${this.modesByArea(this.data.area).map(e=>K`
                ...
                >
                  <ha-svg-icon slot="start" .path=${Rn[Object.entries(Yn).find(([,a])=>a==e)[0]]}></ha-svg-icon>
                  ${zn(`common.modes_short.${e}`,this.hass.language)}
                </ha-button>
              `)}
          </div>
        </alarmo-settings-row>
        ...
        <alarmo-settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${zn("panels.sensors.cards.editor.fields.group.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${zn("panels.sensors.cards.editor.fields.group.description",this.hass.language)}
          </span>
          ...
          <div style="padding: 8px 0px; max-width: 250px">
            ${Object.keys(this.sensorGroups).length?K`
                  <alarmo-select
                    ...
                    label="${zn("panels.sensors.cards.editor.fields.group.heading",this.hass.language)}"
            ...
            <ha-button appearance="filled" @click=${this.manageGroupsClick} style="margin-top: 4px">
              ${zn("panels.sensors.cards.editor.actions.setup_groups",this.hass.language)}
              <ha-icon slot="end" icon="mdi:open-in-new"></ha-icon>
            </ha-button>
          </div>
        </alarmo-settings-row>
        ...
        <alarmo-collapsible-section
          .narrow=${this.narrow}
          header=${zn("panels.sensors.cards.editor.actions.toggle_advanced",this.hass.language)}
        >
          ${!this.data.type||[Kn.Environmental,Kn.Tamper,Kn.Other].includes(this.data.type)?K`
                <alarmo-settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${zn("panels.sensors.cards.editor.fields.always_on.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${zn("panels.sensors.cards.editor.fields.always_on.description",this.hass.language)}
                  </span>
          ...
          ${!this.data.type||[Kn.Window,Kn.Door,Kn.Motion,Kn.Other].includes(this.data.type)?K`
                <alarmo-settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${zn("panels.sensors.cards.editor.fields.use_exit_delay.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${zn("panels.sensors.cards.editor.fields.use_exit_delay.description",this.hass.language)}
                  </span>
                ...
                ${this.data.type==Kn.Motion&&this.data.use_exit_delay?K`
                      <alarmo-settings-row .narrow=${this.narrow} nested>
                        <span slot="heading">
                          ${zn("panels.sensors.cards.editor.fields.allow_open.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${zn("panels.sensors.cards.editor.fields.allow_open.description",this.hass.language)}
                        </span>
          ...
          ${!this.data.type||[Kn.Window,Kn.Door,Kn.Motion,Kn.Other].includes(this.data.type)?K`
                <alarmo-settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${zn("panels.sensors.cards.editor.fields.use_entry_delay.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${zn("panels.sensors.cards.editor.fields.use_entry_delay.description",this.hass.language)}
                  </span>
          ...
          ${this.data.type&&![Kn.Window,Kn.Door,Kn.Motion,Kn.Other].includes(this.data.type)||!this.data.use_entry_delay?"":K`
                <alarmo-settings-row .narrow=${this.narrow} nested>
                  <span slot="heading">
                    ${zn("panels.sensors.cards.editor.fields.entry_delay.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${zn("panels.sensors.cards.editor.fields.entry_delay.description",this.hass.language)}
                  </span>
                  ...
                  <alarmo-duration-picker
                    ...
                    max="900"
                    placeholder="-"
                    ?disabled=${!ss(this.data.entry_delay)}
          ...
          ${!this.data.type||[Kn.Window,Kn.Door,Kn.Motion,Kn.Other].includes(this.data.type)?K`
                <alarmo-settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${zn("panels.sensors.cards.editor.fields.delay_on.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${zn("panels.sensors.cards.editor.fields.delay_on.description",this.hass.language)}
                  </span>
                  ...
                  <alarmo-duration-picker
                    ...
                    step="5"
                    placeholder="-"
                    ?disabled=${!ss(this.data.delay_on)}
          ...
          ${!this.data.type||[Kn.Door,Kn.Other].includes(this.data.type)?K`
                <alarmo-settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${zn("panels.sensors.cards.editor.fields.arm_on_close.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${zn("panels.sensors.cards.editor.fields.arm_on_close.description",this.hass.language)}
                  </span>
          ...
          ${!this.data.type||[Kn.Window,Kn.Door,Kn.Other].includes(this.data.type)?K`
                <alarmo-settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${zn("panels.sensors.cards.editor.fields.auto_bypass.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${zn("panels.sensors.cards.editor.fields.auto_bypass.description",this.hass.language)}
                  </span>
                ...
                ${this.data.auto_bypass?K`
                      <alarmo-settings-row .narrow=${this.narrow} .large=${this.modesByArea(this.data.area).length>2} nested>
                        <span slot="heading">
                          ${zn("panels.sensors.cards.editor.fields.auto_bypass.modes",this.hass.language)}
                        </span>
                        <div>
                          ${this.modesByArea(this.data.area).map(e=>K`
                              <ha-button
                              ...
                              >
                                <ha-svg-icon
                                  slot="start"
                                  .path=${Rn[Object.entries(Yn).find(([,a])=>a==e)[0]]}
                                ></ha-svg-icon>
                                ${zn(`common.modes_short.${e}`,this.hass.language)}
                              </ha-button>
                            `)}
        ...
        ${!this.data.type||[Kn.Window,Kn.Door,Kn.Other].includes(this.data.type)?K`
          ...
          <alarmo-settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${zn("panels.sensors.cards.editor.fields.trigger_unavailable.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.sensors.cards.editor.fields.trigger_unavailable.description",this.hass.language)}
            </span>
    ...
    `;var a}modesByArea(e){const a=Object.keys(this.areas).reduce((e,a)=>Object.assign(e,{[a]:Object.entries(this.areas[a].modes).filter(([,e])=>e.enabled).map(([e])=>e)}),{});return e?a[e]:Object.values(a).reduce((e,a)=>e.filter(e=>a.includes(e)))}_SetData(e){if(this.data)for(const[a,t]of Object.entries(e))switch(a){case"always_on":this.data=Object.assign(Object.assign({},this.data),{always_on:1==t}),t&&(this.data=Object.assign(Object.assign({},this.data),{arm_on_close:!1,use_exit_delay:!1,use_entry_delay:!1,allow_open:!1,auto_bypass:!1}));break;case"use_entry_delay":this.data=Object.assign(Object.assign({},this.data),{use_entry_delay:1==t});break;case"use_exit_delay":this.data=Object.assign(Object.assign({},this.data),{use_exit_delay:1==t}),this.data.type!==Kn.Motion||t||(this.data=Object.assign(Object.assign({},this.data),{allow_open:!1}));break;case"arm_on_close":this.data=Object.assign(Object.assign({},this.data),{arm_on_close:1==t}),t&&(this.data=Object.assign(Object.assign({},this.data),{always_on:!1,allow_open:!1}));break;case"allow_open":this.data=Object.assign(Object.assign({},this.data),{allow_open:1==t}),t&&(this.data=Object.assign(Object.assign({},this.data),{arm_on_close:!1,always_on:!1}));break;case"auto_bypass":this.data=Object.assign(Object.assign({},this.data),{auto_bypass:1==t}),t&&(this.data=Object.assign(Object.assign({},this.data),{always_on:!1}));break;case"trigger_unavailable":this.data=Object.assign(Object.assign({},this.data),{trigger_unavailable:1==t});break;case"entry_delay":this.data=Object.assign(Object.assign({},this.data),{entry_delay:t});break;case"delay_on":this.data=Object.assign(Object.assign({},this.data),{delay_on:t})}}setMode(e){this.data&&(this.data=Object.assign(Object.assign({},this.data),{modes:this.data.modes.includes(e)?ts(this.data.modes,e):as(this.data.modes.concat([e]))}))}setBypassMode(e){this.data&&(this.data=Object.assign(Object.assign({},this.data),{auto_bypass_modes:this.data.auto_bypass_modes.includes(e)?ts(this.data.auto_bypass_modes,e):as(this.data.auto_bypass_modes.concat([e]))}))}setType(e){if(!this.data)return;const a=e!=Kn.Other?Qs(this.modesByArea(this.data.area))[e]:{};this.data=Object.assign(Object.assign(Object.assign({},this.data),{type:e}),a)}deleteClick(e){var a,t;(a=this.hass,t=this.item,a.callApi("POST","alarmo/sensors",{entity_id:t,remove:!0})).catch(a=>ds(a,e)).then(()=>{this.cancelClick()})}saveClick(e){if(!this.data)return;const a=[];this.data.new_entity_id&&this.data.new_entity_id==this.data.entity_id&&(this.data=ns(this.data,"new_entity_id")),this.data=Object.assign(Object.assign({},this.data),{auto_bypass_modes:this.data.auto_bypass_modes.filter(e=>this.data.modes.includes(e))}),this.data.area||a.push(zn("panels.sensors.cards.editor.errors.no_area",this.hass.language)),this.data.modes.length||this.data.always_on||a.push(zn("panels.sensors.cards.editor.errors.no_modes",this.hass.language)),this.data.auto_bypass&&!this.data.auto_bypass_modes.length&&a.push(zn("panels.sensors.cards.editor.errors.no_auto_bypass_modes",this.hass.language)),a.length?os(e,K`
      ...
      <ha-card header="${zn("panels.sensors.title",this.hass.language)}">
        <div class="card-content">
    ...
    `}toggleSelect(e,a){const t=e.target.checked;this.addSelection=t&&!this.addSelection.includes(a)?[...this.addSelection,a]:t?this.addSelection:this.addSelection.filter(e=>e!=a)}addSelected(e){if(!this.hass)return;const a=Object.values(this.areas).map(e=>Object.entries(e.modes).filter(([,e])=>e.enabled).map(([e])=>e)).reduce((e,a)=>e.filter(e=>a.includes(e))),t=this.addSelection.map(e=>function(e,a){if(!e)return null;const t=ps(e.entity_id);let i={entity_id:e.entity_id,modes:[],use_entry_delay:!0,use_exit_delay:!0,entry_delay:null,delay_on:null,arm_on_close:!1,allow_open:!1,always_on:!1,auto_bypass:!1,auto_bypass_modes:[],trigger_unavailable:!1,type:Kn.Other,enabled:!0};if("binary_sensor"==t){const t=Zs(e);t&&(i=Object.assign(Object.assign(Object.assign({},i),{type:t}),Qs(a)[t]))}return i}(this.hass.states[e],a)).map(e=>1==Object.keys(this.areas).length?Object.assign(e,{area:Object.keys(this.areas)[0]}):e).filter(e=>e);t.forEach(a=>{$e(this.hass,a).catch(a=>ds(a,e)).then()}),this.addSelection=[]}getTableFilterOptions(){return{isSupportedType:{name:zn("panels.sensors.cards.add_sensors.actions.filter_supported",this.hass.language),items:[{value:"true",name:"true"}],value:["true"],binary:!0}}}};lr.styles=vs,i([ue()],lr.prototype,"hass",void 0),i([ue()],lr.prototype,"narrow",void 0),i([ue()],lr.prototype,"addSelection",void 0),i([ue()],lr.prototype,"areas",void 0),i([ue()],lr.prototype,"sensors",void 0),lr=i([he("add-sensors-card")],lr);let cr=class extends ce{firstUpdated(){(async()=>{await be()})()}render(){var e,a;if(!this.hass)return K``;if(this.path.params.edit)return K`
      ...
      <ha-card>
        ...
        <alarmo-settings-row .narrow=${this.narrow}>
          <span slot="heading">${zn("panels.codes.cards.new_user.fields.name.heading",this.hass.language)}</span>
          <span slot="description">
            ${zn("panels.codes.cards.new_user.fields.name.description",this.hass.language)}
          </span>

          <ha-input
            label="${zn("panels.codes.cards.new_user.fields.name.heading",this.hass.language)}"
            placeholder=""
            value=${this.data.name}
        ...
        ${this.item?K`
              <alarmo-settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${zn("panels.codes.cards.edit_user.fields.old_code.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${zn("panels.codes.cards.edit_user.fields.old_code.description",this.hass.language)}
                </span>

                <ha-input
                  label="${zn("panels.codes.cards.edit_user.fields.old_code.heading",this.hass.language)}"
                  placeholder=""
                  type="password"
        ...
        ${this.item&&!(null===(e=this.data.old_code)||void 0===e?void 0:e.length)?"":K`
              <alarmo-settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${zn("panels.codes.cards.new_user.fields.code.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${zn("panels.codes.cards.new_user.fields.code.description",this.hass.language)}
                </span>

                <ha-input
                  label="${zn("panels.codes.cards.new_user.fields.code.heading",this.hass.language)}"
                  placeholder=""
                  type="password"
              ...
              <alarmo-settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${zn("panels.codes.cards.new_user.fields.confirm_code.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${zn("panels.codes.cards.new_user.fields.confirm_code.description",this.hass.language)}
                </span>

                <ha-input
                  label="${zn("panels.codes.cards.new_user.fields.confirm_code.heading",this.hass.language)}"
                  placeholder=""
                  type="password"
        ...
        <alarmo-settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${zn("panels.codes.cards.new_user.fields.can_arm.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${zn("panels.codes.cards.new_user.fields.can_arm.description",this.hass.language)}
          </span>
        ...
        <alarmo-settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${zn("panels.codes.cards.new_user.fields.can_disarm.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${zn("panels.codes.cards.new_user.fields.can_disarm.description",this.hass.language)}
          </span>
        ...
        ${this.getAreaOptions().length>=2?K`
              <alarmo-settings-row .narrow=${this.narrow}>
                <span slot="heading">
                  ${zn("panels.codes.cards.new_user.fields.area_limit.heading",this.hass.language)}
                </span>
                <span slot="description">
                  ${zn("panels.codes.cards.new_user.fields.area_limit.description",this.hass.language)}
                </span>
        ...
        <alarmo-settings-row .narrow=${this.narrow}>
          <span slot="heading">
            ${zn("panels.codes.cards.new_user.fields.is_override_code.heading",this.hass.language)}
          </span>
          <span slot="description">
            ${zn("panels.codes.cards.new_user.fields.is_override_code.description",this.hass.language)}
          </span>
    ...
    `}};i([ue()],mr.prototype,"hass",void 0),i([ue()],mr.prototype,"narrow",void 0),i([ue()],mr.prototype,"item",void 0),i([ue()],mr.prototype,"data",void 0),i([ue()],mr.prototype,"repeatCode",void 0),mr=i([he("user-editor-card")],mr);let hr=class extends(Me(ce)){constructor(){super(...arguments),this.users={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await ye(this.hass);this.data=is(e,["code_arm_required","code_disarm_required","code_mode_change_required","code_format"]);const a=await we(this.hass);this.users=a}render(){if(!this.hass||!this.data)return K``;if("new_user"==this.path.subpage)return K`
      ...
      `;{const e=this.data.code_arm_required||this.data.code_disarm_required||this.data.code_mode_change_required;return K`
        <ha-card header="${zn("panels.codes.title",this.hass.language)}">
          <div class="card-content">${zn("panels.codes.cards.codes.description",this.hass.language)}</div>

          <alarmo-settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${zn("panels.codes.cards.codes.fields.code_arm_required.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.codes.cards.codes.fields.code_arm_required.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          <alarmo-settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${zn("panels.codes.cards.codes.fields.code_disarm_required.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.codes.cards.codes.fields.code_disarm_required.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          <alarmo-settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${zn("panels.codes.cards.codes.fields.code_mode_change_required.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.codes.cards.codes.fields.code_mode_change_required.description",this.hass.language)}
            </span>
            <ha-switch
          ...
          <alarmo-settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${zn("panels.codes.cards.codes.fields.code_format.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.codes.cards.codes.fields.code_format.description",this.hass.language)}
            </span>
            <ha-button
          ...
          : ''}"
              ...
              ?disabled=${!e}
            >
              ${zn("panels.codes.cards.codes.fields.code_format.code_format_number",this.hass.language)}
            </ha-button>
            <ha-button
          ...
          : ''
              ...
              ?disabled=${!e}
            >
              ${zn("panels.codes.cards.codes.fields.code_format.code_format_text",this.hass.language)}
            </ha-button>
          </alarmo-settings-row>
        </ha-card>
      ...
      `}}usersPanel(){if(!this.hass)return K``;const e=Object.values(this.users);e.sort(ms);const a={icon:{width:"40px"},name:{title:this.hass.localize("ui.common.name"),width:"40%",grow:!0,text:!0},code_format:{title:zn("panels.codes.cards.codes.fields.code_format.heading",this.hass.language),width:"40%",hide:this.narrow,text:!0},enabled:{title:zn("common.enabled",this.hass.language),width:"68px",align:"center"}},t=e.map(e=>({id:e.user_id,icon:K`
        ...
        `,code_format:K`
          <span class="${e.enabled?"":"disabled"}">
          ${"number"==e.code_format?Jn(zn("panels.codes.cards.codes.fields.code_format.code_format_number",this.hass.language)):"text"==e.code_format?Jn(zn("panels.codes.cards.codes.fields.code_format.code_format_text",this.hass.language)):this.hass.localize("state.default.unknown")}
          </span>
        `,enabled:K`
          <ha-switch
            @click=${e=>e.stopPropagation()}
          ...
          ></ha-switch>
        `}));return K`
      <ha-card header="${zn("panels.codes.cards.user_management.title",this.hass.language)}">
        <div class="card-content">
        ...
        <alarmo-table
          ...
          .columns=${a}
          .data=${t}
          @row-click=${e=>{const a=String(e.detail.id);hs(0,fs("codes",{params:{edit_user:a}}),!0)}}
        >
          ${zn("panels.codes.cards.user_management.no_items",this.hass.language)}
        </alarmo-table>
        <div class="card-actions">
    ...
    `}_removeClick(e){const a=e.detail;this.value=this.value.filter(e=>e!==a),Xn(this,"value-changed",{value:this.value})}_addClick(e){e.stopPropagation();const a=e.target,t=a.value;""!==t&&(this.value.includes(t)||(this.value=[...this.value,t]),Xn(this,"value-changed",{value:[...this.value]}),a.clearValue())}};var Mr;i([ue()],Or.prototype,"hass",void 0),i([ue()],Or.prototype,"items",void 0),i([ue({type:Array})],Or.prototype,"value",void 0),i([ue()],Or.prototype,"label",void 0),i([ue({type:Boolean})],Or.prototype,"invalid",void 0),i([ue({type:Boolean})],Or.prototype,"showSearch",void 0),Or=i([he("alarmo-selector")],Or),function(e){e[e.Yaml=0]="Yaml",e[e.UI=1]="UI"}(Mr||(Mr={}));let xr=class extends ce{constructor(){super(...arguments),this.config={type:Qn.Notification,triggers:[{}],actions:[{}]},this.viewMode=Mr.UI,this.errors={}}async firstUpdated(){if(await fe(),this.areas=await Ce(this.hass),this.alarmoConfig=await ye(this.hass),this.item){let e=[...this.item.actions];this.config=Object.assign(Object.assign({},this.item),{actions:[e[0],...e.slice(1)]}),null===this.config.actions[0].entity_id&&Object.assign(this.config.actions,{0:ns(this.config.actions[0],"entity_id")}),this.config.triggers.length>1&&(this.config=Object.assign(Object.assign({},this.config),{triggers:[this.config.triggers[0]]}));let a=this.config.triggers[0].area;ss(a)&&!_r(this.areas,this.alarmoConfig).includes(a)?a=void 0:null===a&&(a=0),this._setArea(new CustomEvent("value-changed",{detail:{value:a}}))}if(!ss(this.config.triggers[0].area)){const e=_r(this.areas,this.alarmoConfig);1==e.length?this._setArea(new CustomEvent("value-changed",{detail:{value:e[0]}})):e.includes(0)&&this._setArea(new CustomEvent("value-changed",{detail:{value:0}}))}}render(){var e,a,t,i,n,s,r;return this.hass&&this.areas&&this.alarmoConfig?K`
      <div class="heading">
        <ha-icon-button .path=${En} @click=${this._cancelClick} class="icon"></ha-icon-button>
        <div class="header">${zn("panels.actions.cards.new_notification.title",this.hass.language)}</div>
        <div class="description">
          ${zn("panels.actions.cards.new_notification.description",this.hass.language)}
        </div>
      </div>
      <div class="section-header">${zn("panels.actions.cards.new_notification.trigger",this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          <alarmo-settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${zn("panels.actions.cards.new_notification.fields.event.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.actions.cards.new_notification.fields.event.description",this.hass.language)}
            </span>

            <alarmo-select
              .hass=${this.hass}
              .items=${Object.values(Wn).map(e=>gr(e,this.hass))}
              label=${zn("panels.actions.cards.new_action.fields.event.heading",this.hass.language)}
              icons=${!0}
          ...
          ${Object.keys(this.areas).length>1?K`
                <alarmo-settings-row .narrow=${this.narrow} .large=${!0}>
                  <span slot="heading">
                    ${zn("panels.actions.cards.new_action.fields.area.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${zn("panels.actions.cards.new_action.fields.area.description",this.hass.language)}
                  </span>

                  <alarmo-select
                    .hass=${this.hass}
                    .items=${_r(this.areas,this.alarmoConfig).map(e=>ur(e,this.areas,this.alarmoConfig))}
                    label=${zn("panels.actions.cards.new_action.fields.area.heading",this.hass.language)}
          ...
          <alarmo-settings-row .narrow=${this.narrow} .large=${!0} last>
            <span slot="heading">
              ${zn("panels.actions.cards.new_notification.fields.mode.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.actions.cards.new_notification.fields.mode.description",this.hass.language)}
            </span>

            <alarmo-selector
              .hass=${this.hass}
              .items=${br(this.config.triggers[0].area,this.areas).map(e=>pr(e,this.hass))}
              label=${zn("panels.actions.cards.new_action.fields.mode.heading",this.hass.language)}
      ...
      <div class="section-header">${zn("panels.actions.cards.new_notification.action",this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          ${this.viewMode==Mr.UI?K`
                <alarmo-settings-row .narrow=${this.narrow} .large=${!0} first>
                  <span slot="heading">
                    ${zn("panels.actions.cards.new_notification.fields.target.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${zn("panels.actions.cards.new_notification.fields.target.description",this.hass.language)}
                  </span>

                  <alarmo-select
                    .hass=${this.hass}
                    .items=${vr(this.hass,...yr(this.hass))}
                    ?disabled=${!yr(this.hass).length}
                    label=${zn("panels.actions.cards.new_notification.fields.target.heading",this.hass.language)}
                    .value=${(null===(e=yr(this.hass).find(e=>e.entity_id==this.config.actions[0].entity_id&&e.service==this.config.actions[0].service))||void 0===e?void 0:e.entity_id)||(null===(a=yr(this.hass).find(e=>e.service==this.config.actions[0].service))||void 0===a?void 0:a.service)||void 0}
                ...
                ${this.config.actions[0].service&&"notify"!=ps(this.config.actions[0].service)?"":K`
                      <alarmo-settings-row .narrow=${this.narrow}>
                        <span slot="heading">
                          ${zn("panels.actions.cards.new_notification.fields.title.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${zn("panels.actions.cards.new_notification.fields.title.description",this.hass.language)}
                        </span>

                        <ha-input
                          label="${zn("panels.actions.cards.new_notification.fields.title.heading",this.hass.language)}"
                    ...
                    `}
                ${this.config.actions[0].service&&"tts"==ps(this.config.actions[0].service)?K`
                      <alarmo-settings-row .narrow=${this.narrow} .large=${!0} first>
                        <span slot="heading">
                          ${zn("panels.actions.cards.new_action.fields.entity.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${zn("panels.actions.cards.new_action.fields.entity.description",this.hass.language)}
                        </span>

                        <alarmo-select
                          .hass=${this.hass}
                          .items=${fr("tts.speak"==this.config.actions[0].service?Ar(this.hass,"tts"):Ar(this.hass,"media_player","tts"),this.hass)}
                          label=${zn("panels.actions.cards.new_action.fields.entity.heading",this.hass.language)}
                ...
                ${this.config.actions[0].service&&"tts.speak"==this.config.actions[0].service?K`
                      <alarmo-settings-row .narrow=${this.narrow} .large=${!0}>
                        <span slot="heading">
                          ${zn("panels.actions.cards.new_notification.fields.media_player_entity.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${zn("panels.actions.cards.new_notification.fields.media_player_entity.description",this.hass.language)}
                        </span>

                        <alarmo-select
                          .hass=${this.hass}
                          .items=${fr(Ar(this.hass,"media_player"),this.hass)}
                          label=${zn("panels.actions.cards.new_notification.fields.media_player_entity.heading",this.hass.language)}
                ...
                <alarmo-settings-row .narrow=${this.narrow} .large=${!0} last>
                  <span slot="heading">
                    ${zn("panels.actions.cards.new_notification.fields.message.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${zn("panels.actions.cards.new_notification.fields.message.description",this.hass.language)}
                  </span>
                  ...
                  <ha-selector
                    ...
                    id="message"
                    label="${zn("panels.actions.cards.new_notification.fields.message.heading",this.hass.language)}"
                  ...
                  ${this.config.triggers[0].event?K`
                        <div style="margin-top: 10px">
                          <span style="padding-right: 10px">
                            ${zn("panels.actions.cards.new_notification.fields.message.insert_wildcard",this.hass.language)}:
                          </span>
                          <alarmo-chip-set
                            selectable
                            .items=${((e,a)=>{let t=[];return t=[],e&&![Wn.Pending,Wn.Triggered,Wn.ArmFailure].includes(e)||(t=[...t,{name:"Open Sensors",value:"{{open_sensors}}"}]),e&&![Wn.Armed].includes(e)||(t=[...t,{name:"Bypassed Sensors",value:"{{bypassed_sensors}}"}]),(!e||(null==a?void 0:a.code_arm_required)&&[Wn.Armed,Wn.Arming,Wn.ArmFailure].includes(e)||(null==a?void 0:a.code_disarm_required)&&[Wn.Disarmed,Wn.Untriggered].includes(e))&&(t=[...t,{name:"Changed By",value:"{{changed_by}}"}]),e&&![Wn.Armed,Wn.Arming,Wn.Pending,Wn.Triggered,Wn.ArmFailure].includes(e)||(t=[...t,{name:"Arm Mode",value:"{{arm_mode}}"}]),e&&![Wn.Arming,Wn.Pending].includes(e)||(t=[...t,{name:"Delay",value:"{{delay}}"}]),t})(this.config.triggers[0].event,this.alarmoConfig)}
                ...
                ${null!==this._getOpenSensorsFormat()?K`
                      <alarmo-settings-row .narrow=${this.narrow} .large=${!0}>
                        <span slot="heading">
                          ${zn("panels.actions.cards.new_notification.fields.open_sensors_format.heading",this.hass.language)}
                        </span>

                        <span slot="description">
                          ${zn("panels.actions.cards.new_notification.fields.open_sensors_format.description",this.hass.language)}
                        </span>

                        <alarmo-select
                          .hass=${this.hass}
                          .items=${(e=>{let a=[];return a="en"!=e.language?[...a,{value:"{{open_sensors}}",name:`${zn("panels.actions.cards.new_notification.fields.open_sensors_format.options.default",e.language)} (${e.translationMetadata.translations.en.nativeName})`},{value:`{{open_sensors|lang=${e.language}}}`,name:`${zn("panels.actions.cards.new_notification.fields.open_sensors_format.options.default",e.language)} (${e.translationMetadata.translations[e.language].nativeName})`}]:[...a,{value:"{{open_sensors}}",name:zn("panels.actions.cards.new_notification.fields.open_sensors_format.options.default",e.language)}],a=[...a,{value:"{{open_sensors|format=short}}",name:zn("panels.actions.cards.new_notification.fields.open_sensors_format.options.short",e.language)}],a})(this.hass)}
                          .value=${this._getOpenSensorsFormat(!0)}
                          @value-changed=${this._setOpenSensorsFormat}
                        ></alarmo-select>
                      </alarmo-settings-row>
                    `:""}
                ${null!==this._getArmModeFormat()&&(jr(this.hass).length>1||1==jr(this.hass).length&&jr(this.hass)[0].value!=this._getArmModeFormat())?K`
                      <alarmo-settings-row .narrow=${this.narrow} .large=${!0}>
                        <span slot="heading">
                          ${zn("panels.actions.cards.new_notification.fields.arm_mode_format.heading",this.hass.language)}
                        </span>

                        <span slot="description">
                          ${zn("panels.actions.cards.new_notification.fields.arm_mode_format.description",this.hass.language)}
                        </span>
                    ...
                    `:""}
              `:K`
                <h2>${zn("components.editor.edit_in_yaml",this.hass.language)}</h2>
      ...
      <div class="section-header">${zn("panels.actions.cards.new_notification.options",this.hass.language)}</div>
      <ha-card>
        <div class="card-content">
          <alarmo-settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${zn("panels.actions.cards.new_notification.fields.name.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.actions.cards.new_notification.fields.name.description",this.hass.language)}
            </span>

            <ha-input
              label="${zn("panels.actions.cards.new_notification.fields.name.heading",this.hass.language)}"
          ...
          ${(null===(r=this.item)||void 0===r?void 0:r.automation_id)?K`
                <alarmo-settings-row .narrow=${this.narrow}>
                  <span slot="heading">
                    ${zn("panels.actions.cards.new_notification.fields.delete.heading",this.hass.language)}
                  </span>
                  <span slot="description">
                    ${zn("panels.actions.cards.new_notification.fields.delete.description",this.hass.language)}
                  </span>
                  <div>
    ...
    `}};var Nr;i([ue({attribute:!1})],xr.prototype,"hass",void 0),i([ue()],xr.prototype,"narrow",void 0),i([ue()],xr.prototype,"config",void 0),i([ue()],xr.prototype,"item",void 0),i([ue()],xr.prototype,"areas",void 0),i([ue()],xr.prototype,"alarmoConfig",void 0),i([ue()],xr.prototype,"viewMode",void 0),i([ue()],xr.prototype,"errors",void 0),xr=i([he("notification-editor-card")],xr),function(e){e[e.Yaml=0]="Yaml",e[e.UI=1]="UI"}(Nr||(Nr={}));let Lr=class extends ce{constructor(){super(...arguments),this.config={type:Qn.Action,triggers:[{}],actions:[{}]},this.viewMode=Nr.UI,this.errors={}}async firstUpdated(){if(await fe(),this.areas=await Ce(this.hass),this.alarmoConfig=await ye(this.hass),this.item){let e=this.item.actions.map(e=>e.entity_id?e:ns(e,"entity_id"));this.config=Object.assign(Object.assign({},this.item),{actions:[e[0],...e.slice(1)]}),this.config.triggers.length>1&&(this.config=Object.assign(Object.assign({},this.config),{triggers:[this.config.triggers[0]]}));let a=this.config.triggers[0].area;ss(a)&&!_r(this.areas,this.alarmoConfig).includes(a)?a=void 0:null===a&&(a=0),this._setArea(new CustomEvent("value-changed",{detail:{value:a}})),this._hasCustomEntities()&&(this.viewMode=Nr.Yaml)}if(!ss(this.config.triggers[0].area)){const e=_r(this.areas,this.alarmoConfig);1==e.length?this._setArea(new CustomEvent("value-changed",{detail:{value:e[0]}})):e.includes(0)&&this._setArea(new CustomEvent("value-changed",{detail:{value:0}}))}!this.item||this.config.triggers[0].area||this.alarmoConfig.master.enabled||(this.errors=Object.assign(Object.assign({},this.errors),{area:!0}))}render(){var e;return this.hass&&this.areas&&this.alarmoConfig?K`
      ...
      <ha-card>
        <div class="card-content">
          <alarmo-settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${zn("panels.actions.cards.new_action.fields.event.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.actions.cards.new_action.fields.event.description",this.hass.language)}
            </span>
        ...
        <div class="card-content">
          ${this.viewMode==Nr.UI?K`
                <alarmo-settings-row .narrow=${this.narrow} .large=${!0} first>
                  ...
                  <alarmo-selector
                    .hass=${this.hass}
                    .items=${fr(zr(this.hass,this._getEntities()),this.hass)}
                    ?disabled=${!zr(this.hass,this._getEntities()).length}
                    label=${zn("panels.actions.cards.new_action.fields.entity.heading",this.hass.language)}
                ...
                ${this._getEntities().length?K`
                      <alarmo-settings-row .narrow=${this.narrow} .large=${!0}>
                        <span slot="heading">
                          ${zn("panels.actions.cards.new_action.fields.action.heading",this.hass.language)}
                        </span>
                        <span slot="description">
                          ${zn("panels.actions.cards.new_action.fields.action.description",this.hass.language)}
                        </span>
      ...
      <ha-card>
        <div class="card-content">
          <alarmo-settings-row .narrow=${this.narrow} .large=${!0} first>
            <span slot="heading">
              ${zn("panels.actions.cards.new_action.fields.name.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${zn("panels.actions.cards.new_action.fields.name.description",this.hass.language)}
            </span>

            <ha-input
              label="${zn("panels.actions.cards.new_action.fields.name.heading",this.hass.language)}"
              .placeholder=${this._namePlaceholder()}
              .value=${this.config.name||""}
              @input=${this._setName}
              ?invalid=${this.errors.name}
    ...
    `}};i([ue({attribute:!1})],Lr.prototype,"hass",void 0),i([ue()],Lr.prototype,"narrow",void 0),i([ue()],Lr.prototype,"config",void 0),i([ue()],Lr.prototype,"item",void 0),i([ue()],Lr.prototype,"areas",void 0),i([ue()],Lr.prototype,"alarmoConfig",void 0),i([ue()],Lr.prototype,"viewMode",void 0),i([ue()],Lr.prototype,"errors",void 0),Lr=i([he("automation-editor-card")],Lr);const Hr="no_area";let Dr=class extends(Me(ce)){constructor(){super(...arguments),this.areas={},this.getAreaForAutomation=e=>{if(!this.config)return;const a=_r(this.areas,this.config);let t=e.triggers[0].area;return ss(t)&&a.includes(t)?t:void 0}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await ze(this.hass);this.automations=Object.values(e),this.areas=await Ce(this.hass),this.config=await ye(this.hass)}firstUpdated(){var e;this.path.filter&&(this.selectedArea=null===(e=this.path.filter)||void 0===e?void 0:e.area),(async()=>{await be()})()}render(){if(!this.hass||!this.automations||!this.config)return K``;if("new_notification"==this.path.subpage)return K`
      ...
      `;if(this.path.params.edit_action){const e=this.automations.find(e=>e.automation_id==this.path.params.edit_action&&e.type==Qn.Action);return K`
        <automation-editor-card .hass=${this.hass} .narrow=${this.narrow} .item=${e}></automation-editor-card>
      `}{const e=()=>K`
        <paper-tooltip animation-delay="0">
          ${zn("panels.actions.cards.notifications.table.no_area_warning",this.hass.language)}
        </paper-tooltip>
      `,a={type:{width:"40px",renderer:a=>a.area!=Hr||this.config.master.enabled?a.type==Qn.Notification?K`
        ...
        <ha-card header="${zn("panels.actions.cards.notifications.title",this.hass.language)}">
          ...
          <alarmo-table
            ...
            .data=${t}
            .filters=${this.getTableFilterOptions()}
            @row-click=${e=>hs(0,fs("actions",{params:{edit_notification:e.detail.id}}),!0)}
          >
            ${zn("panels.actions.cards.notifications.table.no_items",this.hass.language)}
          </alarmo-table>
        ...
        <ha-card header="${zn("panels.actions.title",this.hass.language)}">
          <div class="card-content">${zn("panels.actions.cards.actions.description",this.hass.language)}</div>
          ...
          <alarmo-table
            ...
            .data=${i}
            .filters=${this.getTableFilterOptions()}
            @row-click=${e=>hs(0,fs("actions",{params:{edit_action:e.detail.id}}),!0)}
          >
            ${zn("panels.actions.cards.actions.table.no_items",this.hass.language)}
          </alarmo-table>
      ...
      <div class="header">
        ...
        >
          ${Object.values(Pr).map(a=>K`
            <ha-tab-group-tab slot="nav" panel="${a}" .active=${e.page===a}>
              ${zn(`panels.${a}.title`,this.hass.language)}
            </ha-tab-group-tab>
          `)}
        </ha-tab-group>
      </div>
    ...
    `}getView(e){switch(e.page){case"general":return K`
        ...
        `}}handlePageSelected(e){const a=e.detail.name;a!==bs().page?(hs(0,fs(a)),this.requestUpdate()):scrollTo(0,0)}static get styles(){return c`
      ${vs} :host {
        color: var(--primary-text-color);
    ...
    `}};i([ue({attribute:!1})],Br.prototype,"hass",void 0),i([ue({type:Boolean,reflect:!0})],Br.prototype,"narrow",void 0),i([ue({attribute:!1})],Br.prototype,"userConfig",void 0),Br=i([he("alarm-panel")],Br);export{Br as MyAlarmPanel};
