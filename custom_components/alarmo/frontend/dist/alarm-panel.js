...
const Ji=2,es=6,ts=e=>(...t)=>({_$litDirective$:e,values:t});class as{constructor(e){}T(e,t,a){this.Σdt=e,this.M=t,this.Σct=a}S(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}let is=class extends ne{constructor(){super(...arguments),this.label="",this.items=[],this.clearable=!1,this.icons=!1,this.disabled=!1,this.invalid=!1,this.rowRenderer=e=>{const t=Mi(e.description);return this.icons?q`
    ...
    `}};t([de()],is.prototype,"label",void 0),t([de()],is.prototype,"value",void 0),t([de()],is.prototype,"items",void 0),t([de()],is.prototype,"clearable",void 0),t([de()],is.prototype,"icons",void 0),t([de({type:Boolean})],is.prototype,"disabled",void 0),t([le()],is.prototype,"_opened",void 0),t([de({attribute:"allow-custom-value",type:Boolean})],is.prototype,"allowCustomValue",void 0),t([de({type:Boolean})],is.prototype,"invalid",void 0),t([ce("vaadin-combo-box-light",!0)],is.prototype,"_comboBox",void 0),is=t([re("alarmo-select")],is);const ss={};class ns extends as{constructor(e){if(super(e),this.previousValue=ss,e.type!==es)throw new Error("renderer only supports binding to element")}render(e,t){return U}update(e,[t,a]){var i;const s=this.previousValue===ss;if(!this.hasChanged(a))return U;this.previousValue=Array.isArray(a)?Array.from(a):a;const n=e.element;if(s){const a=null===(i=e.options)||void 0===i?void 0:i.host;this.addRenderer(n,t,{host:a})}else this.runRenderer(n);return U}hasChanged(e){let t=!0;return Array.isArray(e)?Array.isArray(this.previousValue)&&this.previousValue.length===e.length&&e.every((e,t)=>e===this.previousValue[t])&&(t=!1):this.previousValue===e&&(t=!1),t}}const rs=ts(class extends ns{addRenderer(e,t,a){e.renderer=(e,i,s)=>{V(t.call(a.host,s.item,s,i),e,a)}}runRenderer(e){e.requestContentUpdate()}}),os=(e,t)=>rs(e,t);let ds=class extends ne{static get styles(){return o`
      :host {
        display: block;
      }
    `}render(){return q`
      <slot></slot>
    `}constructor(){super(),this.addEventListener("clickHeader",this.manageSpoilers)}manageSpoilers(e){const t=e.target;t.getAttribute("active")?t.removeAttribute("active"):t.setAttribute("active","true"),this.querySelectorAll("alarmo-collapsible-header[active]").forEach((function(e){e!==t&&e.removeAttribute("active")}))}};ds=t([re("alarmo-collapsible-group")],ds);let ls=class extends ne{static get styles(){return o`
      :host {
        display: block;
      }
    `}render(){return q`
      <slot></slot>
    `}};ls=t([re("alarmo-collapsible-item")],ls);let cs=class extends ne{constructor(){super(),this.clickHeader=new CustomEvent("clickHeader",{detail:{message:"clickHeader happened."},bubbles:!0,composed:!0}),this.active=!1,this.addEventListener("click",this.handleClick)}handleClick(){this.dispatchEvent(this.clickHeader)}render(){return q`
    ...
    `}};ms=t([re("alarmo-collapsible-body")],ms);let hs=class extends(je(ne)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Ae(this.hass),this.sensors=await pe(this.hass))}async firstUpdated(){await this._fetchData(),this.selectedArea=Object.keys(this.areas)[0],this.data=Object.assign({},this.areas[this.selectedArea].modes)}render(){return this.data?q`
      <ha-card>
    ...
    `}selectArea(e){e!=this.selectedArea&&(this.selectedArea=e,this.data=Object.assign({},this.areas[e].modes))}saveClick(e){$e(this.hass,{area_id:this.selectedArea,modes:this.data}).catch(t=>Pi(t,e)).then()}saveData(e,t){this.data=Object.assign(Object.assign({},this.data),{[e]:Object.assign(Object.assign({},this.data[e]||{enabled:!1,exit_time:0,entry_time:0,trigger_time:0}),t)}),$e(this.hass,{area_id:this.selectedArea,modes:this.data}).catch(e=>Pi(e,this.shadowRoot.querySelector("ha-card"))).then()}static get styles(){return o`
      ${Fi}
    ...
    `}};t([de()],hs.prototype,"hass",void 0),t([de({type:Boolean})],hs.prototype,"narrow",void 0),t([de()],hs.prototype,"config",void 0),t([de()],hs.prototype,"areas",void 0),t([de()],hs.prototype,"sensors",void 0),t([de()],hs.prototype,"data",void 0),t([de()],hs.prototype,"selectedArea",void 0),hs=t([re("alarm-mode-card")],hs);let us=class extends ne{constructor(){super(...arguments),this.threeLine=!1}render(){return q`
      <div class="info">
    ...
    `}};t([de({type:Boolean,reflect:!0})],us.prototype,"narrow",void 0),t([de({type:Boolean,reflect:!0})],us.prototype,"large",void 0),t([de({type:Boolean,attribute:"three-line"})],us.prototype,"threeLine",void 0),t([de({type:Boolean})],us.prototype,"nested",void 0),t([de({type:Boolean})],us.prototype,"dialog",void 0),us=t([re("settings-row")],us);let ps=class extends ne{constructor(){super(...arguments),this.header="",this.open=!1}render(){return q`
      ${this.open?q`
          ...
          `:q`
            <div class="header">
              ...
              <ha-icon-button .path=${Wi} @click=${()=>{this.open=!0}}>
              </ha-icon-button>
            </div>
          `}
    `}static get styles(){return o`
    ...
    `}};t([de({type:Boolean,reflect:!0})],ps.prototype,"narrow",void 0),t([de()],ps.prototype,"header",void 0),t([de()],ps.prototype,"open",void 0),ps=t([re("collapsible-section")],ps);let gs=class extends(je(ne)){constructor(){super(...arguments),this.areas={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await ue(this.hass);this.config=e,this.areas=await Ae(this.hass),this.selection=e.mqtt}firstUpdated(){(async()=>{await me()})()}render(){return this.hass&&this.selection?q`
      <ha-card>
        <div class="card-header">
          <div class="name">${vi("panels.general.cards.mqtt.title",this.hass.language)}</div>
          <ha-icon-button .path=${Xi} @click=${this.cancelClick}></ha-icon-button>
        </div>
        ...
        >
          ${Object.values(fi).filter(e=>Object.values(this.areas).some(t=>Li(e,t.modes))).map(e=>q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">${Ti(e)}</span>
                  <span slot="description">
                    ${vi("panels.general.cards.mqtt.fields.state_payload.item",this.hass.language,"{state}",Ti(e))}
                  </span>
                  <ha-textfield
                    label=${Ti(e)}
                    placeholder=${e}
        ...
        >
          ${Object.values(bi).filter(e=>Object.values(this.areas).some(t=>Li((e=>{switch(e){case bi.COMMAND_ALARM_DISARM:return fi.STATE_ALARM_DISARMED;case bi.COMMAND_ALARM_ARM_HOME:return fi.STATE_ALARM_ARMED_HOME;case bi.COMMAND_ALARM_ARM_AWAY:return fi.STATE_ALARM_ARMED_AWAY;case bi.COMMAND_ALARM_ARM_NIGHT:return fi.STATE_ALARM_ARMED_NIGHT;case bi.COMMAND_ALARM_ARM_CUSTOM_BYPASS:return fi.STATE_ALARM_ARMED_CUSTOM_BYPASS;case bi.COMMAND_ALARM_ARM_VACATION:return fi.STATE_ALARM_ARMED_VACATION;default:return}})(e),t.modes))).map(e=>q`
                <settings-row .narrow=${this.narrow}>
                  <span slot="heading">${Ti(e)}</span>
                  <span slot="description">
                    ${vi("panels.general.cards.mqtt.fields.command_payload.item",this.hass.language,"{command}",Ti(e))}
                  </span>
                  <ha-textfield
                    label=${Ti(e)}
                    placeholder=${e}
    ...
    `:q``}saveClick(e){this.hass&&fe(this.hass,{mqtt:Object.assign(Object.assign({},this.selection),{enabled:!0})}).catch(t=>Pi(t,e)).then(()=>{this.cancelClick()})}cancelClick(){Ui(0,Ki("general"),!0)}};gs.styles=Fi,t([de()],gs.prototype,"narrow",void 0),t([de()],gs.prototype,"config",void 0),t([de()],gs.prototype,"areas",void 0),t([de()],gs.prototype,"selection",void 0),gs=t([re("mqtt-config-card")],gs);
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */
class vs extends as{constructor(e){if(super(e),this.vt=U,e.type!==Ji)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===U)return this.Vt=void 0,this.vt=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.vt)return this.Vt;this.vt=e;const t=[e];return t.raw=t,this.Vt={_$litType$:this.constructor.resultType,strings:t,values:[]}}}vs.directiveName="unsafeHTML",vs.resultType=1;const _s=ts(vs);let fs=class extends ne{render(){return q`
    ...
    `}};t([de({type:String})],fs.prototype,"value",void 0),t([de({type:Boolean})],fs.prototype,"checked",void 0),t([de({type:Boolean})],fs.prototype,"checkmark",void 0),t([de({type:Boolean})],fs.prototype,"selectable",void 0),t([de({type:Boolean})],fs.prototype,"clickable",void 0),t([de({type:Boolean})],fs.prototype,"cancellable",void 0),t([de({type:Number})],fs.prototype,"badge",void 0),t([de({type:Boolean})],fs.prototype,"table",void 0),fs=t([re("alarmo-chip")],fs);let bs=class extends ne{constructor(){super(...arguments),this.value=[]}render(){return this.items?q`
    ...
    `}};t([de()],bs.prototype,"items",void 0),t([de()],bs.prototype,"value",void 0),t([de({type:Boolean})],bs.prototype,"selectable",void 0),bs=t([re("alarmo-chip-set")],bs);let ys=class extends ne{set filters(e){this.filterConfig||(this.filterConfig=e)}shouldUpdate(e){return e.get("filters")&&!this.filterConfig&&(this.filterConfig=e.get("filters")),!0}render(){if(!this.columns||!this.data)return q``;const e=this.data.filter(e=>this.filterTableData(e,this.filterConfig));return q`
  ...
  `,t([de()],ys.prototype,"hass",void 0),t([de()],ys.prototype,"columns",void 0),t([de()],ys.prototype,"data",void 0),t([le()],ys.prototype,"filterConfig",void 0),t([le()],ys.prototype,"filterSelection",void 0),t([de({type:Boolean})],ys.prototype,"selectable",void 0),t([ce("mwc-menu",!0)],ys.prototype,"_menu",void 0),ys=t([re("alarmo-table")],ys);let ws=class extends ne{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button slot="navigationIcon" dialogAction="cancel" .path=${Xi}>
          </ha-icon-button>
    ...
    `:q``}saveClick(e){const t=this.name.trim();if(!t.length)return;let a={name:t};this.area_id?a=Object.assign(Object.assign({},a),{area_id:this.area_id}):this.selectedArea&&(a=Object.assign(Object.assign({},a),{modes:Object.assign({},this.areas[this.selectedArea].modes)})),$e(this.hass,a).catch(t=>Pi(t,e)).then(()=>{this.closeDialog()})}async deleteClick(e){if(!this.area_id)return;const t=Object.values(this.sensors).filter(e=>e.area==this.area_id).length,a=Object.values(this.automations).filter(e=>{var t;return null===(t=e.triggers)||void 0===t?void 0:t.map(e=>e.area).includes(this.area_id)}).length;let i=!1;var s,n;i=!t&&!a||await new Promise(i=>{zi(e.target,"show-dialog",{dialogTag:"confirm-delete-dialog",dialogImport:()=>Promise.resolve().then((function(){return ks})),dialogParams:{title:vi("panels.general.dialogs.remove_area.title",this.hass.language),description:vi("panels.general.dialogs.remove_area.description",this.hass.language,"sensors",String(t),"automations",String(a)),cancel:()=>i(!1),confirm:()=>i(!0)}})}),i&&(s=this.hass,n=this.area_id,s.callApi("POST","alarmo/area",{area_id:n,remove:!0})).catch(t=>Pi(t,e)).then(()=>{this.closeDialog()})}static get styles(){return o`
      ${Fi}
      div.wrapper {
        color: var(--primary-text-color);
      }
    ...
    `}};t([de({attribute:!1})],As.prototype,"hass",void 0),t([le()],As.prototype,"_params",void 0),t([de()],As.prototype,"areas",void 0),t([de()],As.prototype,"sensors",void 0),t([de()],As.prototype,"automations",void 0),t([de()],As.prototype,"name",void 0),t([de()],As.prototype,"area_id",void 0),t([de()],As.prototype,"selectedArea",void 0),As=t([re("create-area-dialog")],As);var $s=Object.freeze({__proto__:null,get CreateAreaDialog(){return As}});let js=class extends(je(ne)){constructor(){super(...arguments),this.areas={},this.sensors={},this.automations={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Ae(this.hass),this.sensors=await pe(this.hass),this.automations=await ve(this.hass))}render(){if(!this.hass)return q``;const e=Object.values(this.areas);e.sort(Ri);const t={actions:{width:"48px"},name:{title:this.hass.localize("ui.components.area-picker.add_dialog.name"),width:"40%",grow:!0,text:!0},remarks:{title:vi("panels.general.cards.areas.table.remarks",this.hass.language),width:"60%",hide:this.narrow,text:!0}},a=Object.values(e).map(t=>{const a=Object.values(this.sensors).filter(e=>e.area==t.area_id).length,i=1==Object.values(e).length?Object.values(this.automations).filter(e=>{var a,i;return(null===(a=e.triggers)||void 0===a?void 0:a.map(e=>e.area).includes(t.area_id))||!(null===(i=e.triggers)||void 0===i?void 0:i.map(e=>e.area).length)}).length:Object.values(this.automations).filter(e=>{var a;return null===(a=e.triggers)||void 0===a?void 0:a.map(e=>e.area).includes(t.area_id)}).length,s=`<a href="${Ki("sensors",{filter:{area:t.area_id}})}">${vi("panels.general.cards.areas.table.summary_sensors",this.hass.language,"number",a)}</a>`,n=`<a href="${Ki("actions",{filter:{area:t.area_id}})}">${vi("panels.general.cards.areas.table.summary_automations",this.hass.language,"number",i)}</a>`;return{id:t.area_id,actions:q`
        ...
        `,name:Ti(t.name),remarks:_s(vi("panels.general.cards.areas.table.summary",this.hass.language,"summary_sensors",s,"summary_automations",n))}});return q`
    ...
    `}addClick(e){const t=e.target;zi(t,"show-dialog",{dialogTag:"create-area-dialog",dialogImport:()=>Promise.resolve().then((function(){return $s})),dialogParams:{}})}editClick(e,t){const a=e.target;zi(a,"show-dialog",{dialogTag:"create-area-dialog",dialogImport:()=>Promise.resolve().then((function(){return $s})),dialogParams:{area_id:t}})}};js.styles=Fi,t([de()],js.prototype,"narrow",void 0),t([de()],js.prototype,"path",void 0),t([de()],js.prototype,"config",void 0),t([de()],js.prototype,"areas",void 0),t([de()],js.prototype,"sensors",void 0),t([de()],js.prototype,"automations",void 0),js=t([re("area-config-card")],js);let zs=class extends ne{constructor(){super(...arguments),this.name=""}async showDialog(e){this._params=e;const t=await ue(this.hass);this.name=t.master.name||"",await this.updateComplete}async closeDialog(){this._params=void 0}render(){return this._params?q`
      <ha-dialog open .heading=${!0} @closed=${this.closeDialog} @close-dialog=${this.closeDialog}>
        <ha-dialog-header slot="heading">
          <ha-icon-button slot="navigationIcon" dialogAction="cancel" .path=${Xi}>
          </ha-icon-button>
    ...
    `}};t([de({attribute:!1})],zs.prototype,"hass",void 0),t([le()],zs.prototype,"_params",void 0),t([de()],zs.prototype,"name",void 0),zs=t([re("edit-master-dialog")],zs);var Ts=Object.freeze({__proto__:null,get EditMasterDialog(){return zs}});let xs=class extends(je(ne)){constructor(){super(...arguments),this.areas={},this.automations={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.config=await ue(this.hass),this.areas=await Ae(this.hass),this.automations=await ve(this.hass),this.data=Si(this.config,["trigger_time","disarm_after_trigger","mqtt","master"]))}firstUpdated(){(async()=>{await me()})()}render(){var e,t,a,i,s,n,r,o;return this.hass&&this.config&&this.data?"mqtt_configuration"==this.path.subpage?q`
    ...
    `:q``}renderHeader(){return q`
      ...
      <ha-icon-button
        ...
        class="header_button"
      ></ha-icon-button>
    `}renderSensorOptions(){const e=Object.keys(this.sensors).filter(e=>!Mi(this.sensors[e].group)||this.sensors[e].group===this.data.group_id).map(e=>{const t=this.hass.states[e],a=Object.entries(yi).find(([,t])=>t==this.sensors[e].type)[0];return{value:e,name:Ti(xi(t)),icon:wi[a]}});return e.sort(Ri),e.length?q`
      <alarmo-chip-set
        .items=${e}
    ...
    `}};t([de({attribute:!1})],Ds.prototype,"hass",void 0),t([le()],Ds.prototype,"_params",void 0),t([de()],Ds.prototype,"sensorGroups",void 0),t([de()],Ds.prototype,"sensors",void 0),t([de()],Ds.prototype,"data",void 0),Ds=t([re("create-sensor-group-dialog")],Ds);var Ps=Object.freeze({__proto__:null,get CreateSensorGroupDialog(){return Ds}});let Ls=class extends(je(ne)){constructor(){super(...arguments),this.sensorGroups={},this.sensors={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.sensorGroups=await _e(this.hass),this.sensors=await pe(this.hass))}async showDialog(e){await this._fetchData(),this._params=e,await this.updateComplete}async closeDialog(){this._params=void 0}render(){return this._params?q`
    ...
    >
      ...
      <ha-icon-button .path=${Wi}>
      </ha-icon-button>
    </ha-card>
    `}createGroupClick(e){const t=e.target;zi(t,"show-dialog",{dialogTag:"create-sensor-group-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ps})),dialogParams:{}})}editGroupClick(e,t){const a=e.target;zi(a,"show-dialog",{dialogTag:"create-sensor-group-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ps})),dialogParams:{group_id:t}})}static get styles(){return o`
      ${Bi}
    ...
    `}};t([de({attribute:!1})],Ls.prototype,"hass",void 0),t([le()],Ls.prototype,"_params",void 0),t([de()],Ls.prototype,"sensorGroups",void 0),t([de()],Ls.prototype,"sensors",void 0),Ls=t([re("manage-sensor-groups-dialog")],Ls);var qs=Object.freeze({__proto__:null,get ManageSensorGroupsDialog(){return Ls}});let Rs=class extends(je(ne)){constructor(){super(...arguments),this.showBypassModes=!1}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){var e;if(!this.hass)return;const t=await Ae(this.hass);this.areas=t;const a=await _e(this.hass);this.sensorGroups=a;const i=await pe(this.hass);this.data=Object.keys(i).includes(this.item)?i[this.item]:void 0,this.data&&!(null===(e=this.data)||void 0===e?void 0:e.area)&&1==Object.keys(t).length&&(this.data=Object.assign(Object.assign({},this.data),{area:Object.keys(this.areas)[0]}))}render(){if(!this.data)return q``;this.hass.states[this.data.entity_id];return q`
      <ha-card>
        <div class="card-header">
    ...
    `;var e}modesByArea(e){const t=Object.keys(this.areas).reduce((e,t)=>Object.assign(e,{[t]:Object.entries(this.areas[t].modes).filter(([,e])=>e.enabled).map(([e])=>e)}),{});return e?t[e]:Object.values(t).reduce((e,t)=>e.filter(e=>t.includes(e)))}_SetData(e){if(this.data)for(const[t,a]of Object.entries(e))switch(t){case"always_on":this.data=Object.assign(Object.assign({},this.data),{always_on:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{arm_on_close:!1,use_exit_delay:!1,use_entry_delay:!1,allow_open:!1,auto_bypass:!1}));break;case"use_entry_delay":this.data=Object.assign(Object.assign({},this.data),{use_entry_delay:1==a});break;case"use_exit_delay":this.data=Object.assign(Object.assign({},this.data),{use_exit_delay:1==a}),this.data.type!==yi.Motion||a||(this.data=Object.assign(Object.assign({},this.data),{allow_open:!1}));break;case"arm_on_close":this.data=Object.assign(Object.assign({},this.data),{arm_on_close:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{always_on:!1,allow_open:!1}));break;case"allow_open":this.data=Object.assign(Object.assign({},this.data),{allow_open:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{arm_on_close:!1,always_on:!1}));break;case"auto_bypass":this.data=Object.assign(Object.assign({},this.data),{auto_bypass:1==a}),a&&(this.data=Object.assign(Object.assign({},this.data),{always_on:!1}));break;case"trigger_unavailable":this.data=Object.assign(Object.assign({},this.data),{trigger_unavailable:1==a})}}setMode(e){this.data&&(this.data=Object.assign(Object.assign({},this.data),{modes:this.data.modes.includes(e)?Ei(this.data.modes,e):Oi(this.data.modes.concat([e]))}))}setBypassMode(e){this.data&&(this.data=Object.assign(Object.assign({},this.data),{auto_bypass_modes:this.data.auto_bypass_modes.includes(e)?Ei(this.data.auto_bypass_modes,e):Oi(this.data.auto_bypass_modes.concat([e]))}))}setType(e){if(!this.data)return;const t=e!=yi.Other?Ss(this.modesByArea(this.data.area))[e]:{};this.data=Object.assign(Object.assign(Object.assign({},this.data),{type:e}),t)}deleteClick(e){var t,a;(t=this.hass,a=this.item,t.callApi("POST","alarmo/sensors",{entity_id:a,remove:!0})).catch(t=>Pi(t,e)).then(()=>{this.cancelClick()})}saveClick(e){if(!this.data)return;const t=[];this.data=Object.assign(Object.assign({},this.data),{auto_bypass_modes:this.data.auto_bypass_modes.filter(e=>this.data.modes.includes(e))}),this.data.area||t.push(vi("panels.sensors.cards.editor.errors.no_area",this.hass.language)),this.data.modes.length||this.data.always_on||t.push(vi("panels.sensors.cards.editor.errors.no_modes",this.hass.language)),this.data.auto_bypass&&!this.data.auto_bypass_modes.length&&t.push(vi("panels.sensors.cards.editor.errors.no_auto_bypass_modes",this.hass.language)),t.length?Di(e,q`
        ...
        `):be(this.hass,Object.assign({},this.data)).catch(t=>Pi(t,e)).then(()=>{this.cancelClick()})}cancelClick(){Ui(0,Ki("sensors"),!0)}manageGroupsClick(e){const t=e.target;zi(t,"show-dialog",{dialogTag:"manage-sensor-groups-dialog",dialogImport:()=>Promise.resolve().then((function(){return qs})),dialogParams:{}})}getSensorGroups(){return Object.keys(this.sensorGroups).map(e=>Object({value:e,name:this.sensorGroups[e].name}))}};Rs.styles=Fi,t([de()],Rs.prototype,"hass",void 0),t([de()],Rs.prototype,"narrow",void 0),t([de()],Rs.prototype,"item",void 0),t([de()],Rs.prototype,"data",void 0),t([de()],Rs.prototype,"showBypassModes",void 0),Rs=t([re("sensor-editor-card")],Rs);const Us=e=>Object.keys(e.modes).filter(t=>e.modes[t].enabled),Is=e=>{let t=[];return Object.values(e).forEach(e=>{t=[...t,...Us(e)]}),t=Oi(t),t.sort((e,t)=>{const a=Object.values($i);return a.findIndex(t=>t==e)-a.findIndex(e=>e==t)}),t},Vs="no_area";let Gs=class extends(je(ne)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Ae(this.hass),this.sensors=await pe(this.hass))}async firstUpdated(){this.path&&2==this.path.length&&"filter"==this.path[0]&&(this.selectedArea=this.path[1])}shouldUpdate(e){const t=e.get("hass");return!t||1!=e.size||!this.sensors||Object.keys(this.sensors).some(e=>t.states[e]!==this.hass.states[e])}render(){return this.hass&&this.areas&&this.sensors?q`
    ...
    `;return{icon:{width:"40px",renderer:t=>{const a=this.hass.states[t.entity_id],i=Object.keys(yi).find(e=>yi[e]==t.type),s=a?"on"===a.state?ki[i]:wi[i]:"hass:help-circle-outline";return t.area==Vs?q`
                ${e()}
        ...
        `},enabled:{title:vi("common.enabled",this.hass.language),width:"68px",align:"center",renderer:e=>q`
          ...
          ></ha-switch>
        `}}}getTableData(){const e=Object.keys(this.sensors).map(e=>{const t=this.hass.states[e],a=this.sensors[e],i=a.area?Us(this.areas[a.area]):Is(this.areas);return Object.assign(Object.assign({},a),{id:e,name:xi(t),modes:a.always_on?i:a.modes.filter(e=>i.includes(e)),warning:!a.area,area:a.area||Vs})});return e.sort(Ri),e}toggleEnabled(e,t){const a=e.target.checked;be(this.hass,{entity_id:t,enabled:a}).catch(t=>Pi(t,e)).then()}removeCustomName(e){const t={entity_id:e,name:""};be(this.hass,t)}getTableFilterOptions(){let e=Object.values(this.areas).map(e=>Object({value:e.area_id,name:e.name,badge:t=>t.filter(t=>t.area==e.area_id).length})).sort(Ri);Object.values(this.sensors).filter(e=>!e.area).length&&(e=[{value:Vs,name:this.hass.localize("state_attributes.climate.preset_mode.none"),badge:e=>e.filter(e=>e.area==Vs).length},...e]);const t=Is(this.areas).map(e=>Object({value:e,name:vi("common.modes_short."+e,this.hass.language),badge:t=>t.filter(t=>t.modes.includes(e)).length}));return{area:{name:vi("components.table.filter.item",this.hass.language,"name",vi("panels.actions.cards.new_action.fields.area.heading",this.hass.language)),items:e,value:this.selectedArea?[this.selectedArea]:[]},modes:{name:vi("components.table.filter.item",this.hass.language,"name",vi("panels.actions.cards.new_action.fields.mode.heading",this.hass.language)),items:t,value:this.selectedMode?[this.selectedMode]:[]}}}};Gs.styles=Fi,t([de()],Gs.prototype,"hass",void 0),t([de()],Gs.prototype,"narrow",void 0),t([de()],Gs.prototype,"areas",void 0),t([de()],Gs.prototype,"sensors",void 0),t([de()],Gs.prototype,"selectedArea",void 0),t([de()],Gs.prototype,"selectedMode",void 0),t([de()],Gs.prototype,"path",void 0),Gs=t([re("sensors-overview-card")],Gs);let Fs=class extends(je(ne)){constructor(){super(...arguments),this.addSelection=[],this.areas={},this.sensors={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await Ae(this.hass))}async firstUpdated(){this.areas=await Ae(this.hass),this.sensors=await pe(this.hass)}render(){const e={checkbox:{width:"48px",renderer:e=>q`
          <ha-checkbox
    ...
    `}toggleSelect(e,t){const a=e.target.checked;this.addSelection=a&&!this.addSelection.includes(t)?[...this.addSelection,t]:a?this.addSelection:this.addSelection.filter(e=>e!=t)}addSelected(e){if(!this.hass)return;const t=Object.values(this.areas).map(e=>Object.entries(e.modes).filter(([,e])=>e.enabled).map(([e])=>e)).reduce((e,t)=>e.filter(e=>t.includes(e)));this.addSelection.map(e=>function(e,t){if(!e)return null;const a=Ii(e.entity_id);let i={entity_id:e.entity_id,modes:[],use_entry_delay:!0,use_exit_delay:!0,arm_on_close:!1,allow_open:!1,always_on:!1,auto_bypass:!1,auto_bypass_modes:[],trigger_unavailable:!1,type:yi.Other,enabled:!0};if("binary_sensor"==a){const a=Es(e);a&&(i=Object.assign(Object.assign(Object.assign({},i),{type:a}),Ss(t)[a]))}return i}(this.hass.states[e],t)).map(e=>1==Object.keys(this.areas).length?Object.assign(e,{area:Object.keys(this.areas)[0]}):e).filter(e=>e).forEach(t=>{be(this.hass,t).catch(t=>Pi(t,e)).then()}),this.addSelection=[]}getTableFilterOptions(){return{isSupportedType:{name:vi("panels.sensors.cards.add_sensors.actions.filter_supported",this.hass.language),items:[{value:"true",name:"true"}],value:["true"],binary:!0}}}};Fs.styles=Fi,t([de()],Fs.prototype,"hass",void 0),t([de()],Fs.prototype,"narrow",void 0),t([de()],Fs.prototype,"addSelection",void 0),t([de()],Fs.prototype,"areas",void 0),t([de()],Fs.prototype,"sensors",void 0),Fs=t([re("add-sensors-card")],Fs);let Bs=class extends ne{firstUpdated(){(async()=>{await me()})()}render(){var e,t;if(!this.hass)return q``;if(this.path.params.edit)return q`
        <sensor-editor-card
          .hass=${this.hass}
          .narrow=${this.narrow}
    ...
    `}};t([de()],Hs.prototype,"hass",void 0),t([de()],Hs.prototype,"narrow",void 0),t([de()],Hs.prototype,"item",void 0),t([de()],Hs.prototype,"data",void 0),t([de()],Hs.prototype,"repeatCode",void 0),Hs=t([re("user-editor-card")],Hs);let Ks=class extends(je(ne)){constructor(){super(...arguments),this.users={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await ue(this.hass);this.data=Si(e,["code_arm_required","code_disarm_required","code_mode_change_required","code_format"]);const t=await ge(this.hass);this.users=t}render(){if(!this.hass||!this.data)return q``;if("new_user"==this.path.subpage)return q`
      ...
      `;{const e=this.data.code_arm_required||this.data.code_disarm_required||this.data.code_mode_change_required;return q`
        <ha-card header="${vi("panels.codes.title",this.hass.language)}">
          ...
          <settings-row .narrow=${this.narrow}>
            <span slot="heading">
              ${vi("panels.codes.cards.codes.fields.code_mode_change_required.heading",this.hass.language)}
            </span>
            <span slot="description">
              ${vi("panels.codes.cards.codes.fields.code_mode_change_required.description",this.hass.language)}
            </span>
            <ha-switch
      ...
      `}}usersPanel(){if(!this.hass)return q``;const e=Object.values(this.users);e.sort(Ri);const t={icon:{width:"40px"},name:{title:this.hass.localize("ui.components.area-picker.add_dialog.name"),width:"40%",grow:!0,text:!0},code_format:{title:vi("panels.codes.cards.codes.fields.code_format.heading",this.hass.language),width:"40%",hide:this.narrow,text:!0},enabled:{title:vi("common.enabled",this.hass.language),width:"68px",align:"center"}},a=e.map(e=>({id:e.user_id,icon:q`
        ...
        `,name:Ti(e.name),code_format:"number"==e.code_format?Ti(vi("panels.codes.cards.codes.fields.code_format.code_format_number",this.hass.language)):"text"==e.code_format?Ti(vi("panels.codes.cards.codes.fields.code_format.code_format_text",this.hass.language)):this.hass.localize("state.default.unknown"),enabled:q`
          <ha-switch
            @click=${e=>{e.stopPropagation()}}
            ?checked=${e.enabled}
    ...
    `}addUserClick(){Ui(0,Ki("codes","new_user"),!0)}saveData(e){this.hass&&(this.data=Object.assign(Object.assign({},this.data),e),fe(this.hass,this.data).catch(e=>Pi(e,this.shadowRoot.querySelector("ha-card"))).then())}toggleEnabled(e,t){const a=e.target.checked;ye(this.hass,{user_id:t,enabled:a}).catch(t=>Pi(t,e)).then()}};Ks.styles=Fi,t([de()],Ks.prototype,"hass",void 0),t([de()],Ks.prototype,"narrow",void 0),t([de()],Ks.prototype,"path",void 0),t([de()],Ks.prototype,"data",void 0),t([de()],Ks.prototype,"users",void 0),Ks=t([re("alarm-view-codes")],Ks);const Zs=(e,t)=>{switch(e){case $i.ArmedAway:return{value:$i.ArmedAway,name:vi("common.modes_short.armed_away",t.language),icon:_i.ArmedAway};case $i.ArmedHome:return{value:$i.ArmedHome,name:vi("common.modes_short.armed_home",t.language),icon:_i.ArmedHome};case $i.ArmedNight:return{value:$i.ArmedNight,name:vi("common.modes_short.armed_night",t.language),icon:_i.ArmedNight};case $i.ArmedCustom:return{value:$i.ArmedCustom,name:vi("common.modes_short.armed_custom_bypass",t.language),icon:_i.ArmedCustom};case $i.ArmedVacation:return{value:$i.ArmedVacation,name:vi("common.modes_short.armed_vacation",t.language),icon:_i.ArmedVacation}}},Qs=(e,t)=>{switch(e){case ji.Armed:return{value:ji.Armed,name:vi("panels.actions.cards.new_notification.fields.event.choose.armed.name",t.language),description:vi("panels.actions.cards.new_notification.fields.event.choose.armed.description",t.language),icon:"hass:shield-check-outline"};case ji.Disarmed:return{value:ji.Disarmed,name:vi("panels.actions.cards.new_notification.fields.event.choose.disarmed.name",t.language),description:vi("panels.actions.cards.new_notification.fields.event.choose.disarmed.description",t.language),icon:"hass:shield-off-outline"};case ji.Triggered:return{value:ji.Triggered,name:vi("panels.actions.cards.new_notification.fields.event.choose.triggered.name",t.language),description:vi("panels.actions.cards.new_notification.fields.event.choose.triggered.description",t.language),icon:"hass:bell-alert-outline"};case ji.Untriggered:return{value:ji.Untriggered,name:vi("panels.actions.cards.new_notification.fields.event.choose.untriggered.name",t.language),description:vi("panels.actions.cards.new_notification.fields.event.choose.untriggered.description",t.language),icon:"hass:bell-off-outline"};case ji.ArmFailure:return{value:ji.ArmFailure,name:vi("panels.actions.cards.new_notification.fields.event.choose.arm_failure.name",t.language),description:vi("panels.actions.cards.new_notification.fields.event.choose.arm_failure.description",t.language),icon:"hass:alert-outline"};case ji.Arming:return{value:ji.Arming,name:vi("panels.actions.cards.new_notification.fields.event.choose.arming.name",t.language),description:vi("panels.actions.cards.new_notification.fields.event.choose.arming.description",t.language),icon:"hass:home-export-outline"};case ji.Pending:return{value:ji.Pending,name:vi("panels.actions.cards.new_notification.fields.event.choose.pending.name",t.language),description:vi("panels.actions.cards.new_notification.fields.event.choose.pending.description",t.language),icon:"hass:home-import-outline"}}},Ys=(e,t,a)=>0==e?{name:a.master.name,value:0}:Object.keys(t).includes(String(e))?{name:t[e].name,value:e}:{name:String(e),value:e},Ws=(e,...t)=>{const a=t.map(t=>{if(!t)return null;const a=Ii(t),i=Vi(t);let s={value:t,name:i.replace(/_/g," ").split(" ").map(e=>e.substring(0,1).toUpperCase()+e.substring(1)).join(" "),icon:"hass:home",description:t};switch(a){case"notify":const t=e.states["device_tracker."+i.replace("mobile_app_","")];s=t?Object.assign(Object.assign({},s),{name:t.attributes.friendly_name||Vi(t.entity_id),icon:t.attributes.icon||"hass:cellphone-text"}):Object.assign(Object.assign({},s),{icon:"hass:comment-alert"});break;case"tts":s=Object.assign(Object.assign({},s),{icon:"hass:microphone"})}return s}).filter(Mi);return a.sort((e,t)=>{const a=Ii(e.value),i=Ii(t.value);return a!=i?Ri(a,i):Ri(e,t)}),a},Xs=(e,t)=>{let a=[];const i=Object.keys(e).filter(t=>Object.values(e[t].modes).some(e=>e.enabled));return t.master.enabled&&i.length>1&&(a=[...a,0]),a=[...a,...i],a},Js=(e,t)=>{const a=e=>Object.keys(e.modes).filter(t=>e.modes[t].enabled);if(Mi(e)&&Object.keys(t).includes(String(e)))return a(t[e]);{const e=Object.keys(t).map(e=>a(t[e]));return e[0].filter(t=>e.every(e=>e.includes(t)))}},en=(e,t)=>e.map(e=>({value:e,name:e in t.states?t.states[e].attributes.friendly_name||Vi(e):e,icon:e in t.states?t.states[e].attributes.icon||Gi(Ii(e)):void 0,description:e})),tn=e=>{let t=[];return"notify"in e.services&&(t=[...t,...Object.keys(e.services.notify).map(e=>"notify."+e)]),"tts"in e.services&&(t=[...t,...Object.keys(e.services.tts).filter(e=>"clear_cache"!=e).map(e=>"tts."+e)]),t},an=(...e)=>{if(!e.length||!e.every(e=>e.length))return[];if(1==e.length&&e[0].length>1&&Oi(e[0].map(Ii)).length>1)return an(...e[0].map(e=>Array(e)));let t=[...e[0]];return e.forEach(e=>{t=t.map(t=>e.includes(t)?t:"script"==Ii(t)&&e.map(Ii).includes("script")?"script.script":e.map(Vi).includes(Vi(t))?"homeassistant."+Vi(t):null).filter(Mi)}),t},sn=(e,t,a=1)=>{if(a>10)return[];if(Array.isArray(e)){const i=e.map(e=>sn(e,t,a+1));return an(...i)}if(!Mi(e))return[];const i=Ii(e);switch(i){case"light":case"switch":case"input_boolean":case"siren":return[i+".turn_on",i+".turn_off"];case"script":return[e];case"lock":return["lock.lock","lock.unlock"];case"group":const s=e in t.states?t.states[e]:void 0,n=(null==s?void 0:s.attributes.entity_id)||[];return sn(n,t,a+1);default:return[]}},nn=(e,t)=>{let a=[...Object.keys(e.states).filter(t=>sn(t,e).length)];return t&&t.length&&(a=[...a,...t.filter(e=>!a.includes(e))]),a.sort(Ri),a},rn=(e,...t)=>{let a=[...Object.keys(e.states).filter(e=>t.includes(Ii(e)))];return a.sort(Ri),a},on=e=>{let t=[{value:"{{arm_mode}}",name:e.translationMetadata.translations.en.nativeName}];return"en"!=e.language&&(t=[...t,{value:`{{arm_mode|lang=${e.language}}}`,name:e.translationMetadata.translations[e.language].nativeName}]),t},dn=e=>"string"==typeof e&&e.trim().length,ln=(e,t)=>dn(e)&&t.services[Ii(e)]&&t.services[Ii(e)][Vi(e)],cn=(e,t)=>dn(e)&&t.states[e],mn=e=>"object"==typeof e&&null!==e&&!Array.isArray(e),hn=e=>"string"==typeof e;let un=class extends ne{constructor(){super(...arguments),this.items=[],this.value=[],this.label="",this.invalid=!1}shouldUpdate(e){return e.get("items")&&(Ni(this.items,e.get("items"))||this.firstUpdated()),!0}firstUpdated(){this.value.some(e=>!this.items.map(e=>e.value).includes(e))&&(this.value=this.value.filter(e=>this.items.map(e=>e.value).includes(e)),zi(this,"value-changed",{value:this.value}))}render(){return q`
      <div class="chip-set">
      ...
      ></alarmo-select>
    `}_removeClick(e){this.value=this.value.filter(t=>t!==e),zi(this,"value-changed",{value:this.value})}_addClick(e){e.stopPropagation();const t=e.target,a=t.value;this.value.includes(a)||(this.value=[...this.value,a]),t.value="",zi(this,"value-changed",{value:[...this.value]})}static get styles(){return o`
      div.chip-set {
        margin: 0px -4px;
      }
      div.chip {
    ...
    `}};var pn;t([de()],un.prototype,"hass",void 0),t([de()],un.prototype,"items",void 0),t([de({type:Array})],un.prototype,"value",void 0),t([de()],un.prototype,"label",void 0),t([de({type:Boolean})],un.prototype,"invalid",void 0),un=t([re("alarmo-selector")],un),function(e){e[e.Yaml=0]="Yaml",e[e.UI=1]="UI"}(pn||(pn={}));let gn=class extends ne{constructor(){super(...arguments),this.config={type:Ai.Notification,triggers:[{}],actions:[{}]},this.viewMode=pn.UI,this.errors={}}async firstUpdated(){if(await he(),this.areas=await Ae(this.hass),this.alarmoConfig=await ue(this.hass),this.item){let e=this.item.actions.map(e=>Ci(e,"entity_id"));this.config=Object.assign(Object.assign({},this.item),{actions:[e[0],...e.slice(1)]}),this.config.triggers.length>1&&(this.config=Object.assign(Object.assign({},this.config),{triggers:[this.config.triggers[0]]}));let t=this.config.triggers[0].area;Mi(t)&&!Xs(this.areas,this.alarmoConfig).includes(t)?t=void 0:null===t&&(t=0),this._setArea(new CustomEvent("value-changed",{detail:{value:t}}))}if(!Mi(this.config.triggers[0].area)){const e=Xs(this.areas,this.alarmoConfig);1==e.length?this._setArea(new CustomEvent("value-changed",{detail:{value:e[0]}})):e.includes(0)&&this._setArea(new CustomEvent("value-changed",{detail:{value:0}}))}}render(){var e,t,a,i;return this.hass&&this.areas&&this.alarmoConfig?q`
      <div class="heading">
        <ha-icon-button .path=${Xi} @click=${this._cancelClick} class="icon"></ha-icon-button>
      ...
      <ha-card>
        <div class="card-content">
          <settings-row .narrow=${this.narrow} .large=${!0} first>
            ...
            <alarmo-select
              .hass=${this.hass}
              .items=${Object.values(ji).map(e=>Qs(e,this.hass))}
          ...
          ${Object.keys(this.areas).length>1?q`
                <settings-row .narrow=${this.narrow} .large=${!0}>
                  ...
                  <alarmo-select
                    .hass=${this.hass}
                    .items=${Xs(this.areas,this.alarmoConfig).map(e=>Ys(e,this.areas,this.alarmoConfig))}
                    clearable=${!0}
          ...
          <settings-row .narrow=${this.narrow} .large=${!0} last>
            ...
            <alarmo-selector
              .hass=${this.hass}
              .items=${Js(this.config.triggers[0].area,this.areas).map(e=>Zs(e,this.hass))}
        ...
        <div class="card-content">
          ${this.viewMode==pn.UI?q`
                <settings-row .narrow=${this.narrow} .large=${!0} first>
                  ...
                  <alarmo-select
                    .hass=${this.hass}
                    .items=${Ws(this.hass,...tn(this.hass))}
                    ?disabled=${!tn(this.hass).length}
                ...
                ${this.config.actions[0].service&&"tts"==Ii(this.config.actions[0].service)?q`
                      <settings-row .narrow=${this.narrow} .large=${!0} first>
                        ...
                        <alarmo-select
                          .items=${en(rn(this.hass,"media_player","tts"),this.hass)}
                ...
                ${null!==this._getOpenSensorsFormat()?q`
                    ...
                    `:""}
                ${null!==this._getArmModeFormat()&&(on(this.hass).length>1||1==on(this.hass).length&&on(this.hass)[0].value!=this._getArmModeFormat())?q`
                      <settings-row .narrow=${this.narrow} .large=${!0}>
                        <span slot="heading">
    ...
    `}};var vn;t([de({attribute:!1})],gn.prototype,"hass",void 0),t([de()],gn.prototype,"narrow",void 0),t([de()],gn.prototype,"config",void 0),t([de()],gn.prototype,"item",void 0),t([de()],gn.prototype,"areas",void 0),t([de()],gn.prototype,"alarmoConfig",void 0),t([de()],gn.prototype,"viewMode",void 0),t([de()],gn.prototype,"errors",void 0),gn=t([re("notification-editor-card")],gn),function(e){e[e.Yaml=0]="Yaml",e[e.UI=1]="UI"}(vn||(vn={}));let _n=class extends ne{constructor(){super(...arguments),this.config={type:Ai.Action,triggers:[{}],actions:[{}]},this.viewMode=vn.UI,this.errors={}}async firstUpdated(){if(await he(),this.areas=await Ae(this.hass),this.alarmoConfig=await ue(this.hass),this.item){let e=this.item.actions.map(e=>e.entity_id?e:Ci(e,"entity_id"));this.config=Object.assign(Object.assign({},this.item),{actions:[e[0],...e.slice(1)]}),this.config.triggers.length>1&&(this.config=Object.assign(Object.assign({},this.config),{triggers:[this.config.triggers[0]]}));let t=this.config.triggers[0].area;Mi(t)&&!Xs(this.areas,this.alarmoConfig).includes(t)?t=void 0:null===t&&(t=0),this._setArea(new CustomEvent("value-changed",{detail:{value:t}})),this._hasCustomEntities()&&(this.viewMode=vn.Yaml)}if(!Mi(this.config.triggers[0].area)){const e=Xs(this.areas,this.alarmoConfig);1==e.length?this._setArea(new CustomEvent("value-changed",{detail:{value:e[0]}})):e.includes(0)&&this._setArea(new CustomEvent("value-changed",{detail:{value:0}}))}!this.item||this.config.triggers[0].area||this.alarmoConfig.master.enabled||(this.errors=Object.assign(Object.assign({},this.errors),{area:!0}))}render(){var e;return this.hass&&this.areas&&this.alarmoConfig?q`
      ...
      <ha-card>
        <div class="card-content">
          ${this.viewMode==vn.UI?q`
                <settings-row .narrow=${this.narrow} .large=${!0} first>
                  ...
                  <alarmo-selector
                    .hass=${this.hass}
                    .items=${en(nn(this.hass,this._getEntities()),this.hass)}
                    ?disabled=${!nn(this.hass,this._getEntities()).length}
                    label=${vi("panels.actions.cards.new_action.fields.entity.heading",this.hass.language)}
        ...
        <div class="toggle-button">
          <mwc-button @click=${this._toggleYamlMode}>
            <ha-icon icon="hass:shuffle-variant"></ha-icon>
            ${this.viewMode==vn.Yaml?vi("components.editor.ui_mode",this.hass.language):vi("components.editor.yaml_mode",this.hass.language)}
          </mwc-button>
        </div>
    ...
    `:q``}renderActions(){let e=this.config.actions.map(e=>e.entity_id),t=sn(e,this.hass);if(!t.length)return;return t.map(e=>q`
        <mwc-button
          class="${((...e)=>!!e.every(Mi)&&1==Oi(an(e.filter(Mi))).length)(this._selectedAction(),e)?"active":""}"
      ...
      `)}_selectedAction(){let e=this.config.actions.map(e=>e.service);return e.every(Mi)?(e=Oi(an(e.filter(Mi))),1==e.length?e[0]:null):null}_setEvent(e){e.stopPropagation();const t=e.detail.value;let a=this.config.triggers;Object.assign(a,{0:Object.assign(Object.assign({},a[0]),{event:t})}),this.config=Object.assign(Object.assign({},this.config),{triggers:a}),Object.keys(this.errors).includes("event")&&this._validateConfig()}_setArea(e){var t;e.stopPropagation();const a=e.detail.value;let i=this.config.triggers;Object.assign(i,{0:Object.assign(Object.assign({},i[0]),{area:a})});const s=Js(a,this.areas);(null===(t=i[0].modes)||void 0===t?void 0:t.length)&&this._setModes(new CustomEvent("value-changed",{detail:{value:i[0].modes.filter(e=>s.includes(e))}})),this.config=Object.assign(Object.assign({},this.config),{triggers:i}),Object.keys(this.errors).includes("area")&&this._validateConfig()}_setModes(e){e.stopPropagation();const t=e.detail.value,a=this.config.triggers;Object.assign(a,{0:Object.assign(Object.assign({},a[0]),{modes:t})}),this.config=Object.assign(Object.assign({},this.config),{triggers:a}),Object.keys(this.errors).includes("service")&&this._validateConfig()}_setEntity(e){e.stopPropagation();const t=e.detail.value;let a=this.config.actions,i=null;if(t.length>a.length&&this._selectedAction()&&(i=this._selectedAction()),a.length>t.length){let e=a.findIndex(e=>!t.includes(e.entity_id||""));e<0&&(e=a.length-1),a.splice(e,1)}t.length||Object.assign(a,{0:Ci(a[0],"entity_id")}),t.forEach((e,t)=>{let i=a.length>t?Object.assign({},a[t]):{};i=i.entity_id==e?Object.assign({},i):{entity_id:e},Object.assign(a,{[t]:i})}),this.config=Object.assign(Object.assign({},this.config),{actions:a}),i&&this._setAction(i),Object.keys(this.errors).includes("entity_id")&&this._validateConfig()}_setAction(e){let t=this.config.actions,a=this.config.actions.map(e=>e.entity_id);sn(a,this.hass).length&&(t.forEach((a,i)=>{let s=sn(a.entity_id,this.hass),n=(r=e,s.find(e=>e==r||"turn_on"==Vi(r)&&"turn_on"==Vi(e)||"turn_off"==Vi(r)&&"turn_off"==Vi(e)||"script"==Ii(r)&&"script"==Ii(e)));var r;Object.assign(t,{[i]:Object.assign({service:n},Ci(a,"service"))})}),this.config=Object.assign(Object.assign({},this.config),{actions:t}),Object.keys(this.errors).includes("service")&&this._validateConfig())}_setName(e){e.stopPropagation();const t=e.target.value;this.config=Object.assign(Object.assign({},this.config),{name:t})}_setYaml(e){let t=e.detail.value,a=[{}];var i;mn(t)&&(t=[t]),"object"==typeof(i=t)&&null!==i&&Array.isArray(i)&&(t.forEach((e,t)=>{let i={};mn(e)&&hn(e.service)&&(i=Object.assign(Object.assign({},i),{service:e.service})),mn(e)&&hn(e.entity_id)&&(i=Object.assign(Object.assign({},i),{entity_id:e.entity_id})),mn(e)&&mn(e.data)&&(i=Object.assign(Object.assign({},i),{data:e.data})),Object.assign(a,{[t]:i})}),this.config=Object.assign(Object.assign({},this.config),{actions:a}))}_validateConfig(){this.errors={};const e=this._parseAutomation(),t=e.triggers[0];t.event&&Object.values(ji).includes(t.event)||(this.errors=Object.assign(Object.assign({},this.errors),{event:!0})),Mi(t.area)&&Xs(this.areas,this.alarmoConfig).includes(t.area)||(this.errors=Object.assign(Object.assign({},this.errors),{area:!0})),(t.modes||[]).every(e=>Js(t.area,this.areas).includes(e))||(this.errors=Object.assign(Object.assign({},this.errors),{modes:!0}));let a=e.actions.map(e=>e.entity_id);this.viewMode==vn.Yaml&&(a=a.filter(Mi)),e.actions.length&&a.every(e=>cn(e,this.hass))||(this.errors=Object.assign(Object.assign({},this.errors),{entity_id:!0}));const i=e.actions.map(e=>e.service).filter(Mi);if(!i.length||!i.every(e=>ln(e,this.hass))){this.errors=Object.assign(Object.assign({},this.errors),{service:!0}),!sn(a,this.hass).length&&i.length&&(this.viewMode=vn.Yaml)}return dn(e.name)||(this.errors=Object.assign(Object.assign({},this.errors),{name:!0})),!Object.values(this.errors).length}_validAction(){const e=this._parseAutomation(),t=e.actions.map(e=>e.service);let a=e.actions.map(e=>e.entity_id);return this.viewMode==vn.Yaml&&(a=a.filter(Mi)),t.length&&t.every(e=>ln(e,this.hass))&&a.every(e=>cn(e,this.hass))}_toggleYamlMode(){this.viewMode=this.viewMode==vn.UI?vn.Yaml:vn.UI,this.viewMode==vn.Yaml&&(this.config=Object.assign(Object.assign({},this.config),{actions:Object.assign(this.config.actions,{0:Object.assign(Object.assign({},this.config.actions[0]),{service:this.config.actions[0].service||"",data:Object.assign({},this.config.actions[0].data||{})})})}))}_namePlaceholder(){var e,t,a,i;if(!this._validAction)return"";const s=this.config.triggers[0].event,n=this.config.actions.map(e=>e.entity_id).filter(Mi),r=en(n,this.hass).map(e=>e.name).join(", "),o=Oi(this.config.actions.map(e=>e.service).filter(Mi).map(e=>Vi(e)));let d=void 0;return 1==o.length&&(null===(e=o[0])||void 0===e?void 0:e.includes("turn_on"))&&(d=this.hass.localize("state.default.on")),1==o.length&&(null===(t=o[0])||void 0===t?void 0:t.includes("turn_off"))&&(d=this.hass.localize("state.default.off")),1==o.length&&(null===(a=o[0])||void 0===a?void 0:a.includes("lock"))&&(d=this.hass.localize("component.lock.state._.locked")),1==o.length&&(null===(i=o[0])||void 0===i?void 0:i.includes("unlock"))&&(d=this.hass.localize("component.lock.state._.unlocked")),s&&r&&d?vi("panels.actions.cards.new_action.fields.name.placeholders."+s,this.hass.language,"entity",r,"state",d):""}_getEntities(){return Oi(this.config.actions.map(e=>e.entity_id).filter(Mi))||[]}_hasCustomEntities(){return this._getEntities().some(e=>!nn(this.hass).includes(e))}_parseAutomation(){let e=Object.assign({},this.config);return!dn(e.name)&&this._namePlaceholder()&&(e=Object.assign(Object.assign({},e),{name:this._namePlaceholder()})),e}_saveClick(e){if(!this._validateConfig())return;let t=this._parseAutomation();Js(t.triggers[0].area,this.areas).every(e=>{var a;return null===(a=t.triggers[0].modes)||void 0===a?void 0:a.includes(e)})&&(t=Object.assign(Object.assign({},t),{triggers:Object.assign(t.triggers,{0:Object.assign(Object.assign({},t.triggers[0]),{modes:[]})})})),we(this.hass,t).catch(t=>Pi(t,e)).then(()=>this._cancelClick())}_deleteClick(e){var t;(null===(t=this.item)||void 0===t?void 0:t.automation_id)&&ke(this.hass,this.item.automation_id).catch(t=>Pi(t,e)).then(()=>this._cancelClick())}_testClick(e){this._parseAutomation().actions.forEach(t=>{const[a,i]=t.service.split(".");let s=Object.assign({},t.data);t.entity_id&&(s=Object.assign(Object.assign({},s),{entity_id:t.entity_id})),this.hass.callService(a,i,s).then().catch(t=>{Di(e,t.message)})})}_cancelClick(){Ui(0,Ki("actions"),!0)}static get styles(){return o`
      div.content {
        padding: 28px 20px 0;
        max-width: 1040px;
        margin: 0 auto;
    ...
    `}};t([de({attribute:!1})],_n.prototype,"hass",void 0),t([de()],_n.prototype,"narrow",void 0),t([de()],_n.prototype,"config",void 0),t([de()],_n.prototype,"item",void 0),t([de()],_n.prototype,"areas",void 0),t([de()],_n.prototype,"alarmoConfig",void 0),t([de()],_n.prototype,"viewMode",void 0),t([de()],_n.prototype,"errors",void 0),_n=t([re("automation-editor-card")],_n);let fn=class extends(je(ne)){constructor(){super(...arguments),this.areas={},this.getAreaForAutomation=e=>{if(!this.config)return;const t=Xs(this.areas,this.config);let a=e.triggers[0].area;return Mi(a)&&t.includes(a)?a:void 0}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"alarmo_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await ve(this.hass);this.automations=Object.values(e),this.areas=await Ae(this.hass),this.config=await ue(this.hass)}firstUpdated(){var e;this.path.filter&&(this.selectedArea=null===(e=this.path.filter)||void 0===e?void 0:e.area),(async()=>{await me()})()}render(){if(!this.hass||!this.automations||!this.config)return q``;if("new_notification"==this.path.subpage)return q`
